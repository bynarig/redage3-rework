                ...
                <template v-else>
                    <div>
                        ...
                        <div @click="editType = 0">
                            <div>Парня</div>
                            <div><input type="checkbox" disabled :checked="editType === 0"><label></label></div>
                        </div>
                        <div @click="editType = 1">
                            <div>Девушку</div>
                            <div><input type="checkbox" disabled :checked="editType === 1"><label></label></div>
                        </div>
                        <div @click="editType = 2">
                            <div>Друзей</div>
                            <div><input type="checkbox" disabled :checked="editType === 2"><label></label></div>
                        </div>
