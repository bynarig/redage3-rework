export default {
    job: {
        ...
        post_empty: {//Когда закончились посылки
        ...
        taxi_rent: {//Когда арендовал транспорт
            desc: "Транспорт арендован, осталось дождаться первого заказа!",
        },
        taxi_order: {//Когда появился заказ
        ...
        taxi_client: {//Когда клиент сел в транспорт
        ...
        mechanik_rent: {//Когда арендовал транспорт
            desc: "Транспорт арендован, осталось дождаться первого заказа!",
        },
        mechanik_order: {//Когда появился заказ
        ...
        mechanik_arrived: {//Когда приехал на заказ
    ...
    other: {
        ...
        money_house: {//Игрок имеет больше 50.000$ и не владеет домом
        ...
        money_car: {//Игрок имеет дом и больше 10.000
        ...
        bag_bought: {//Когда игрок купил сумку
    ...
    vehicles: {
        ...
        key_locked: {//Игрок попытался сесть в чужой закрытый транспорт
        ...
        seat_fraction: {//Когда игрок пытается сесть на водительское место фракционного транспорта
    ...
    licenses: {
        ...
        gun_licensed: {//Игрок получил лицензию на оружие
