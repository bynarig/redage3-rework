...
//         };
//
//         private static readonly IReadOnlyDictionary<int, DonateClothesData> DonateClothesList =
//             new Dictionary<int, DonateClothesData>
//             {
...
//             };
//
//         private readonly List<List<object>> SimData = new List<List<object>>
//         {
...
//         };
//
//         private readonly List<List<object>> VehicleNumberData = new List<List<object>>
//         {
...
//                                 LangFunc.GetText(LangType.Ru, DataName.SubAlreadyBuy), 3000);
//
//                             return;
//                         }
//
//                         var price = DonatesPremiumData[0].Price;
//
...
//                             LangFunc.GetText(LangType.Ru, DataName.YouBoughtSub), 3000);
//
//                         break;
//
...
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.AlreadyBoughtVIP), 3000);
//
//                             return;
//                         }
//
...
//                         }
//
//                         UpdateData.RedBucks(player, -DonatesPremiumData[1].Price,
//                             LangFunc.GetText(LangType.Ru, DataName.BoughtSilverVIP));
//
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.BuySilverVIP), 3000);
//
//                         break;
//
//                     case 2: // Type.GoldVIP:
...
//                         }
//
//                         UpdateData.RedBucks(player, -DonatesPremiumData[2].Price,
//                             LangFunc.GetText(LangType.Ru, DataName.BoughtGoldVIP));
//
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.BuyGoldVIP), 3000);
//
//                         break;
//
...
//                         }
//
//                         UpdateData.RedBucks(player, -DonatesPremiumData[3].Price,
//                             LangFunc.GetText(LangType.Ru, DataName.BoughtPlatinumVIP));
//
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.BuyPlatinumVIP), 3000);
//
//                         break;
//
...
//                         }
//
//                         UpdateData.RedBucks(player, -DonatesPremiumData[4].Price,
//                             LangFunc.GetText(LangType.Ru, DataName.BoughtDiamondVIP));
//
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.BuyDiamondVIP), 3000);
//
//                         break;
//                 }
//             }
...
//
//             {
//                 Log.Write($"BuyPremium Exception: {e}");
//             }
//         }
//
...
//                 {
//                     Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                         LangFunc.GetText(LangType.Ru, DataName.NoSubscription), 3000);
//
//                     return;
//                 }
//
//                 if (accountData.SubscribeTime > DateTime.Now)
//
//                 {
//                     Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                         LangFunc.GetText(LangType.Ru, DataName.Only24hPrize), 3000);
//
//                     return;
//                 }
//
...
//
//                 var moneyCash = DonatesPremiumData[0].GiveMoney;
//
...
//
//
//                 var donateCash = DonatesPremiumData[0].GiveRb;
//
//                 UpdateData.RedBucks(player, donateCash, LangFunc.GetText(LangType.Ru, DataName.SubBonus));
//
//                 accountData.SubscribeTime = DateTime.Now.AddDays(1);
//
//                 Repository.AddNewItemWarehouse(player, ItemId.Case5);
//
//                 Trigger.ClientEvent(player, "client.accountStore.Subscribe",
//                     JsonConvert.SerializeObject(accountData.SubscribeTime));
//             }
//
//             catch (Exception e)
//
//             {
//                 Log.Write($"RewardSubscribe Exception: {e}");
//             }
//         }
//
...
//                 Repository.RoulleteCategoryListJson, JsonConvert.SerializeObject(Repository.RouletteCasesDataJson));
//         }
//
...
//
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[0]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.CarCoupon,
//                                 1, "Casco") == -1)
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case3, 2) ==
//                             -1) // КЕЙС
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.NaHodDonPack, Main.DonatePack.PriceRB[0]), 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.NaHodDonPack, Main.DonatePack.PriceRB[0]));
//
//                         break;
//                     }
//
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[1]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Mask, 1,
//                                 "208_0_True") == -1)
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NoSpaceForAccessory), 3000);
//
//                             return;
//                         }
//
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case4, 5) ==
//                             -1) // КЕЙС
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.StarterDonPack, Main.DonatePack.PriceRB[1]), 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.StarterDonPack, Main.DonatePack.PriceRB[1]));
//
//                         break;
//                     }
//
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[2]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case5, 5) ==
//                             -1) // КЕЙС ПОТОМ ГЛЯНУТЬ
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.PromotedDonPack, Main.DonatePack.PriceRB[2]), 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.PromotedDonPack, Main.DonatePack.PriceRB[2]));
//
//                         break;
//                     }
//
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[3]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case6, 2) ==
//                             -1) // КЕЙС ПОТОМ ГЛЯНУТЬ
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.LoadedDonPack, Main.DonatePack.PriceRB[3]), 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.LoadedDonPack, Main.DonatePack.PriceRB[3]));
//
//                         break;
//                     }
//
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[4]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.MaxCarsDonPack), 6000);
//
//                             return;
//                         }
//
...
//                             {
//                                 Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                     LangFunc.GetText(LangType.Ru, DataName.MaxCarsDonPack), 3000);
//                                 return;
//                             }
//                         }
//
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.GoodStartDonPack, Main.DonatePack.PriceRB[4]), 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.GoodStartDonPack, Main.DonatePack.PriceRB[4]));
//
//                         break;
//                     }
//
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[5]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.BigPlansDonPack, Main.DonatePack.PriceRB[5]), 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.BigPlansDonPack, Main.DonatePack.PriceRB[5]));
//
//                         break;
//                     }
//
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[6]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case6, 5) ==
//                             -1)
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Bag, 1,
//                                 "92_0_True") == -1)
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.BigCheckDonPack, Main.DonatePack.PriceRB[6]), 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.BigCheckDonPack, Main.DonatePack.PriceRB[6]));
//
//                         break;
//                     }
//
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[7]))
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
//                             return;
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.GreatDonPack, Main.DonatePack.PriceRB[7]), 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.GreatDonPack, Main.DonatePack.PriceRB[7]));
//
//                         break;
//                     }
//
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[8]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case7, 5) ==
//                             -1)
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//
//                         Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.SimCard, 1,
//                             number.ToString());
//
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.LegendPackDon, Main.DonatePack.PriceRB[8]), 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.LegendPackDon, Main.DonatePack.PriceRB[8]));
//
//                         break;
//                     }
//
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[9]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.BuyDonateGreatStart, Main.DonatePack.PriceRB[9]),
//                             3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             LangFunc.GetText(LangType.Ru, DataName.BuyDonateGreatStart, Main.DonatePack.PriceRB[9]));
...
//                     {
//                         if (accountData.RedBucks <
//                             GetPrice(accountData.Unique, "packages", id, Main.DonatePack.PriceRB[10]))
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NetRB), 3000);
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Hat, 1,
//                                 "210_0_True") == -1)
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case14,
//                                 2) == -1)
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//                         }
//
//                         if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case15) ==
//                             -1)
//
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             "Вы успешно приобрели набор «Батя»!", 3000);
//
//                         GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub,
//                             $"Куплен набор «Батя» (-{Main.DonatePack.GiveMoney[10]} RedBucks)");
//
//                         break;
//                     }
//                 }
...
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.NoCreatorDemorgan), 5000);
//
//                             return;
//                         }
//
//                         UpdateData.RedBucks(player, -1000, LangFunc.GetText(LangType.Ru, DataName.SendCreator));
//
...
//                             {
//                                 Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                     LangFunc.GetText(LangType.Ru, DataName.NoName), 3000);
//
//                                 return;
//                             }
//
//                             if (split[1] == "null" || string.IsNullOrEmpty(split[1]))
//
//                             {
//                                 Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                     LangFunc.GetText(LangType.Ru, DataName.NoFamily), 3000);
//
//                                 return;
//                             }
//                         }
...
//
//
//                         var target = (ExtPlayer)NAPI.Player.GetPlayerFromName(player.Name);
//
//
//                         if (target == null || target.IsNull) return;
//
//                         Admin.AdminsLog(1,
//                             LangFunc.GetText(LangType.Ru, DataName.ChangeNameAdmins, player.Name, player.Value, name),
//                             1);
//
//                         UpdateData.RedBucks(player, -800, LangFunc.GetText(LangType.Ru, DataName.ChangeName));
//
...
//                         {
//                             Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                                 LangFunc.GetText(LangType.Ru, DataName.Nowarn), 3000);
//
//                             return;
//                         }
//
...
//                         }
//
//                         UpdateData.RedBucks(player, -1000, LangFunc.GetText(LangType.Ru, DataName.SnyatieWarn));
//
...
//
//                         Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                             LangFunc.GetText(LangType.Ru, DataName.SucUnwarn), 3000);
//
//                         break;
//                 }
//             }
...
//                 {
//                     Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
//                         LangFunc.GetText(LangType.Ru, DataName.Amount1OrMore), 3000);
//
//                     return;
//                 }
//
...
//                 }
//
//                 var totalamount = amount * Convert.ToInt32(10 * Main.DonateSettings.Convert);
//
//                 Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge,
//                     LangFunc.GetText(LangType.Ru, DataName.SucConvertRbToMoney, amount, totalamount), DateTime.Now);
...
//
//                 UpdateData.RedBucks(player, -amount, LangFunc.GetText(LangType.Ru, DataName.ConvertRbTo, totalamount));
//
...
//
//                 var cData = DonateClothesList[id];
//
//
//                 var accountData = player.GetAccountData();
//
...
//                 if (characterData == null) return;
//
//                 if (Repository.isFreeSlots(player, cData.ItemId) != 0) return;
//
//                 Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", cData.ItemId, 1, cData.Data);
//
//                 UpdateData.RedBucks(player, -cData.PriceRB,
//                     LangFunc.GetText(LangType.Ru, DataName.LKLogBuyClothes, id));
//
//                 Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
//                     LangFunc.GetText(LangType.Ru, DataName.PremiumClothesBuy), 3000);
//             }
//
//             catch (Exception e)
//
//             {
//                 Log.Write($"BuyClothes Exception: {e}");
//             }
//         }
//
...
//
//             var rg = new Regex(@"([A-Za-z]{1,1})([0-9]{1,1})([0-9]{1,1})([0-9]{1,1})([A-Za-z]{1,1})",
...
//             }
//
//             if (Repository.isFreeSlots(player, ItemId.VehicleNumber) != 0)
//                 return;
//
//             Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.VehicleNumber, 1, number);
//
...
//             {
//                 Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge,
//                     LangFunc.GetText(LangType.Ru, DataName.DonNumBuy, number, money), DateTime.Now);
...
//             }
//
//             if (Repository.isFreeSlots(player, ItemId.SimCard) != 0)
//                 return;
//
//             Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.SimCard, 1, sim.ToString());
//
//             Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge,
//                 LangFunc.GetText(LangType.Ru, DataName.DonSimBuy, sim, money), DateTime.Now);
//             UpdateData.RedBucks(player, -money, LangFunc.GetText(LangType.Ru, DataName.DonSimBuy, sim, money));
//             //client.donate.close
//             Trigger.ClientEvent(player, "client.donate.close");
//         }
//
//         private class DonateClothesData
//         {
...
//             }
//
//             public int PriceRB { get; }
//             public ItemId ItemId { get; } = ItemId.Debug;
