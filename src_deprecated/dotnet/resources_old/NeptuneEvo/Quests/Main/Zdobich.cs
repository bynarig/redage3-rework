...
namespace NeptuneEvo.Quests
{
    ...
    public class Zdobich : Script
    {
        ...
        {
            Repository.CreateQuest("u_m_m_partytarget", new Vector3(-480.28732, -305.2201, 35.106697), -157f,
                questName: QuestName, title: "~y~NPC~w~ Виталий Дебич\nКвесты новичков",
                colShapeEnums: ColShapeEnums.QuestZdobich);
  ...
  PedSystem.Repository.CreateQuest("s_m_m_ciasec_01", new Vector3(-844.27655, -2013.892, 27.714827), 52f, questName: "s_m_m_ciasec_01", isBlipVisible: false);
        ...
        public static zdobich_quests Get(ExtPlayer player, int line, bool reward = false)
        {
            ...
            switch ((zdobich_quests)line)
            {
                ...
                case zdobich_quests.Stage7:
                    ...
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Firework2,
                        addInWarehouse: true);
                    return zdobich_quests.Stage8;

                case zdobich_quests.Stage8:
                    Wallet.Change(player, 4500);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case0,
                        addInWarehouse: true);
                    return zdobich_quests.Stage9;

                case zdobich_quests.Stage9:
                    UpdateData.Exp(player, 1);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Bear,
                        addInWarehouse: true);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Note,
                        addInWarehouse: true);
                    return zdobich_quests.Stage10;

                case zdobich_quests.Stage10:
                    Wallet.Change(player, 4800);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Rose,
                        addInWarehouse: true);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Firework4,
                        addInWarehouse: true);
                    return zdobich_quests.Stage11;

                case zdobich_quests.Stage11:
                    Wallet.Change(player, 15000);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case2,
                        addInWarehouse: true);
                    return zdobich_quests.Stage20;

                case zdobich_quests.Stage20:
                    Wallet.Change(player, 10000);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Bong, 1,
                        "420", addInWarehouse: true);
                ...
                case zdobich_quests.Stage23:
                    Wallet.Change(player, 10000);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case1,
                        addInWarehouse: true);
                ...
                case zdobich_quests.Stage24:
                    UpdateData.Exp(player, 1);
                    Wallet.Change(player, 15000);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Firework3,
                        addInWarehouse: true);
                ...
                case zdobich_quests.Stage26:
                    UpdateData.Exp(player, 1);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.BodyArmor, 1,
                        "100", addInWarehouse: true);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Bear,
                        addInWarehouse: true);
                    return zdobich_quests.Stage28;

                case zdobich_quests.Stage28:
                    Wallet.Change(player, 3500);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Vape, 1,
                        "100", addInWarehouse: true);
                    return zdobich_quests.Stage29;

                case zdobich_quests.Stage29:
                    UpdateData.Exp(player, 1);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Guitar,
                        addInWarehouse: true);
                    return zdobich_quests.Stage30;

                case zdobich_quests.Stage30:
                    Wallet.Change(player, 3500);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.LoveNote, 1,
                        "1000", addInWarehouse: true);
                    return zdobich_quests.Stage31;

                case zdobich_quests.Stage31:
                    UpdateData.Exp(player, 1);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Firework4, 3,
                        addInWarehouse: true);
                    return zdobich_quests.Stage33;

                case zdobich_quests.Stage33:
                    UpdateData.Exp(player, 1);
                    Wallet.Change(player, 8500);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Case0,
                        addInWarehouse: true);
                    Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Binoculars,
                        addInWarehouse: true);
            ...
            switch ((zdobich_quests)Line)
            {
                case zdobich_quests.Start:
                    if (characterData.Gender)
                        Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Top, 1,
                            "210_0_True");
                    else
                        Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Top, 1,
                            "65_0_False");
                ...
                case zdobich_quests.Stage9:
                    ...
                    if (characterData.Handshaked >= 5)
                        Timers.StartOnce(50, () =>
                        {
                            qMain.UpdateQuestsStage(player, QuestName, (int)zdobich_quests.Stage9, 1, true);
                ...
                case zdobich_quests.Stage24:
                    ...
                    if (house != null)
                        Timers.StartOnce(50, () =>
                        {
                            qMain.UpdateQuestsStage(player, QuestName, (int)zdobich_quests.Stage24, 1, true);
                ...
                case zdobich_quests.Stage26:
                    ...
                    if (vehiclesCount > 0)
                        Timers.StartOnce(50, () =>
                        {
                            qMain.UpdateQuestsStage(player, QuestName, (int)zdobich_quests.Stage26, 1, true);
        ...
        private static void QuestZdobich(ExtPlayer player, int index, int speed = 0)
        {
            ...
            var isBool = qMain.SetQuests(player, QuestName, true);
            if (!isBool) return;
            var questData = player.GetQuest();
            if (questData == null)
                return;

            if (questData.Line == (int)zdobich_quests.Stage8 && !questData.Complete &&
                Chars.Repository.isItem(player, "inventory", ItemId.GasCan) != null &&
                Chars.Repository.isItem(player, "inventory", ItemId.Wrench) != null)
            {
            ...
            {
                qMain.UpdateQuestsStage(player, QuestName, (int)zdobich_quests.Stage33, 2, true);
                qMain.UpdateQuestsComplete(player, QuestName, (int)zdobich_quests.Stage33, true);
                questData.Complete = true;
            }


            Trigger.ClientEvent(player, "client.quest.open", index, QuestName, questData.Line, questData.Status,
                questData.Complete, speed);
        }
    }
}