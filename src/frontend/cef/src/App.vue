...
import "./views/components/ui/index.ts"
...
// import PopupDonatePopup from '@/views/popups/donate/donate.popup.vue'
// import CirclePopupMenu from '@/views/popups/circle/circle.popup.vue'
// import PopupSelectPopup from '@/views/popups/select/select.popup.vue'
// import PopupMainPopup from '@/views/popups/main/main.popup.vue'
// import PopupUpgradePopup from '@/views/popups/upgrade/upgrade.popup.vue'
// import PopupRoulettePopup from '@/views/popups/roulette/roulette.popup.vue'
// import PopupCameraPopup from '@/views/popups/camera/camera.popup.vue'
// import PopupWarPopup from '@/views/popups/war/war.popup.vue'
import PlayerHud from '@/views/player/hud/PlayerHud.vue'
...
const VIEW_LOADERS: Record<string, () => Promise<{ default: Component }>> = {
	PlayerAuthentication: () => import('@/views/player/authentication/PlayerAuthentication.vue'),
	PlayerCreation: () => import('@/views/player/creation/PlayerCreation.vue'),
	PlayerCustomization: () => import('@/views/player/customization/PlayerCustomization.vue'),
...
onMounted(async () => {
	...
	const isMultiplayer = typeof (window as any).mp !== 'undefined'
	if (!isMultiplayer) {
		...
		;(window as any).FadeScreen?.(false, 250)
	}
})
