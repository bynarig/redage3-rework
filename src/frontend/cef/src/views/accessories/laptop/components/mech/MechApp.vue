...
<template>
    ...
    <div v-else class="mech-app" ref="mainElement">
        <div class="map-area">
            <PhoneMap
            ...
            <div class="app-badge">
                <span class="badge-red">Red</span>Age Mechanic
            </div>
        </div>
        ...
        <div class="panel-area" ref="otherElement">
            ...
            <template v-if="selectView === 'List'">
                ...
                <div class="panel-body">
                    <p class="panel-desc">В этом приложении вы можете вызвать механика либо начать работать механиком.</p>
                    <div class="mode-card" @click="onSelectView('Client')">
                        ...
                        <div class="mode-info">
                            ...
                            <div class="mode-sub">Вы хотите вызвать механика</div>
                        </div>
                    ...
                    <div class="mode-card" @click="onSelectView('Driver')">
                        ...
                        <div class="mode-info">
                            <div class="mode-title">Механик</div>
                            <div class="mode-sub">Вы хотите работать механиком</div>
                        </div>
                        <svg class="mode-chevron" width="7" height="12" viewBox="0 0 7 12" fill="none">
                            <path d="M1 1l5 5-5 5" stroke="#6e6e73" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
            ...
            <template v-else-if="selectView === 'Client'">
                <div class="panel-header">
                    ...
                    <span class="panel-title">Вызов механика</span>
                </div>
                <div v-if="clientOrder.driver" class="driver-active-banner">
                    <div class="driver-info">
                        <span class="driver-label">Механик:</span>
...
.mode-card:hover { background: rgba(0,0,0,0.03); }
...
.driver-label { font-size: 12px; color: #6e6e73; }
.driver-name { font-size: 14px; font-weight: 600; color: #1d1d1f; }
.driver-number { font-size: 13px; color: #ff9500; }
...
.location-label { font-size: 11px; color: #6e6e73; margin-bottom: 2px; }
...
.route-built { font-size: 13px; color: #34c759; font-weight: 500; padding: 8px 0; }
...
.order-client { font-size: 12px; color: #6e6e73; margin-top: 2px; }
...
.primary-btn.sm { padding: 8px 16px; font-size: 13px; white-space: nowrap; }
