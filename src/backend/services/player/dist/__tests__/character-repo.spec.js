...
describe('CharacterRepository.create', () => {
    ...
    it('creates character + customization in a transaction and writes to all account-side surfaces', async () => {
        ...
        expect(customizationCreate).toHaveBeenCalledWith(expect.objectContaining({ data: expect.objectContaining({ uuid: 200, gender: 'MALE', is_created: false }) }));
        expect(accountsUpdateMany).toHaveBeenCalledWith(expect.objectContaining({
...
//# sourceMappingURL=character-repo.spec.js.map