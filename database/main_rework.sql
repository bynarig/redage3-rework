...
-- Дамп структуры для таблица server1.fractions
CREATE TABLE IF NOT EXISTS fractions
(
    id             integer  NOT NULL,
    drugs          integer  NOT NULL,
    ...
    ironore        integer  NOT NULL DEFAULT 0,
    sulfurore      integer  NOT NULL DEFAULT 0,
    preciousore    integer  NOT NULL DEFAULT 0,
    money          integer  NOT NULL,
    lastserial     integer  NOT NULL DEFAULT 0,
    weapons        text              DEFAULT NULL,
    isopen         smallint NOT NULL DEFAULT 0,
    isopengunstock smallint NOT NULL DEFAULT 0,
    fuellimit      integer  NOT NULL,
    fuelleft       integer  NOT NULL,
    clothingsets   text     NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_vehicles_holder ON vehicles (holder);
