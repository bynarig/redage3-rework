...
{
    internal class Army : Script
    {
        public static bool is_warg;
        ...
        public void onResourceStart()
        {
            try
            {
                NAPI.TextLabel.CreateTextLabel("Ketrin Kellerman", new Vector3(-2348.598, 3210.923, 29.224812), 5f,
                    0.3f, 4, new Color(255, 255, 255), false, 3244522);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(ArmyCheckpoints[0].X, ArmyCheckpoints[0].Y, ArmyCheckpoints[0].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255), dimension: 3244522);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[1], 1, 2, 3244522, ColShapeEnums.FractionArmy, 1);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(ArmyCheckpoints[1].X, ArmyCheckpoints[1].Y, ArmyCheckpoints[1].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255), dimension: 3244522);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Лифт"),
                    new Vector3(ArmyCheckpoints[3].X, ArmyCheckpoints[3].Y, ArmyCheckpoints[3].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[4], 1, 2, 0, ColShapeEnums.FractionArmy, 3);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Лифт"),
                    new Vector3(ArmyCheckpoints[4].X, ArmyCheckpoints[4].Y, ArmyCheckpoints[4].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Открыть оружейный склад"),
                    new Vector3(ArmyCheckpoints[5].X, ArmyCheckpoints[5].Y, ArmyCheckpoints[5].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255), dimension: 3244522);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Ремонт наземного транспорта"),
                    new Vector3(ArmyCheckpoints[6].X, ArmyCheckpoints[6].Y, ArmyCheckpoints[6].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[7], 5, 2, 0, ColShapeEnums.FractionArmy, 6);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Ремонт воздушного транспорта"),
                    new Vector3(ArmyCheckpoints[7].X, ArmyCheckpoints[7].Y, ArmyCheckpoints[7].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[8], 1, 2, 0, ColShapeEnums.FractionArmy, 7);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Кнопка общей тревоги"),
                    new Vector3(ArmyCheckpoints[8].X, ArmyCheckpoints[8].Y, ArmyCheckpoints[8].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255), true);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[9], 1, 2, 0, ColShapeEnums.FractionArmy, 8);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(ArmyCheckpoints[9].X, ArmyCheckpoints[9].Y, ArmyCheckpoints[9].Z), 5F, 0.3F, 0,
                    new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[10], 1, 2, 3244522, ColShapeEnums.FractionArmy,
                    9);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(ArmyCheckpoints[10].X, ArmyCheckpoints[10].Y, ArmyCheckpoints[10].Z), 5F, 0.3F, 0,
                    new Color(255, 255, 255), dimension: 3244522);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[11], 1, 2, 0, ColShapeEnums.FractionArmy, 10);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(ArmyCheckpoints[11].X, ArmyCheckpoints[11].Y, ArmyCheckpoints[11].Z), 5F, 0.3F, 0,
                    new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[12], 1, 2, 4566544, ColShapeEnums.FractionArmy,
                    11);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(ArmyCheckpoints[12].X, ArmyCheckpoints[12].Y, ArmyCheckpoints[12].Z), 5F, 0.3F, 0,
                    new Color(255, 255, 255), dimension: 4566544);

                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[0] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    1f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[1] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    1f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[2], new Vector3(), new Vector3(), 5f, new Color(155, 0, 0));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[3] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    1f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[4] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    1f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[5] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    1f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[6] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    3f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[7] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    5f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(1, ArmyCheckpoints[8] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    1f, new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(21, ArmyCheckpoints[9], new Vector3(), new Vector3(), 1f,
                    new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(21, ArmyCheckpoints[10], new Vector3(), new Vector3(), 1f,
                    new Color(255, 255, 255, 220), dimension: 3244522);
                NAPI.Marker.CreateMarker(21, ArmyCheckpoints[11], new Vector3(), new Vector3(), 1f,
                    new Color(255, 255, 255, 220));
                NAPI.Marker.CreateMarker(21, ArmyCheckpoints[12], new Vector3(), new Vector3(), 1f,
                    new Color(255, 255, 255, 220), dimension: 4566544);

                //Main.CreateBlip(new Main.BlipData(305, "National Guard", new Vector3(-2062.0103, 3196.759, 32.795883), 2, true));

                Repository.CreateQuest("s_m_m_marine_01", new Vector3(-276.09488, -2636.1191, 6.0462055), -50.05095f,
                    title: "~y~NPC~w~ Рекрут Астраханский\nВызвать сотрудника",
                    colShapeEnums: ColShapeEnums.CallArmyMember);
            }
            catch (Exception e)
            {
        ...
        public static void callback_armyGuns(ExtPlayer player, int index)
        {
            try
            {
                ...
                if (player.Position.DistanceTo(ArmyCheckpoints[0]) >= 5)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.TooFarFromWeaponTake), 3000);
                    return;
                }
                ...
                switch (index)
                {
                    ...
                    case 3: //armor
                        ...
                        if (fractionData.Materials > Manager.matsForArmor &&
                            Chars.Repository.itemCount(player, "inventory", ItemId.BodyArmor) <
                            Chars.Repository.maxItemCount)
                        {
                            if (Chars.Repository.AddNewItem(player, $"char_{player.GetUUID()}", "inventory",
            ...
            {
                Log.Write($"callback_armyGuns Exception: {e}");
            }
        }
        ...
        public static void OpenCallArmyMemberDialog(ExtPlayer player, int _)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "openDialog", "CallArmyMemberDialog",
                    LangFunc.GetText(LangType.Ru, DataName.AreYouWantToCallGov));
            }
            catch (Exception e)
            {
                Log.Write($"OpenCallArmyMemberDialog Exception: {e}");
            }
        }
        ...
        public static void OnFractionArmy(ExtPlayer player, int interact)
        {
            try
            {
                ...
                switch (interact)
                {
                    case 0:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.DostupOn), 3000);
                            return;
                        }
                    ...
                    case 1:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.DostupOff), 3000);
                            return;
                        }
                    ...
                    case 2:
                        ...
                        if (vehicleLocalData != null)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.CarCantMoveMats), 3000);
                                return;
                            }
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.CantLoadMatsToCar), 3000);
                                return;
                            }
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.AlreadyLoadingMatsToCar), 3000);
                                return;
                            }

                            if (!Stocks.maxMats.ContainsKey(veh.Model)) return;
                            var count = Chars.Repository.getCountItem(
                                VehicleManager.GetVehicleToInventory(veh.NumberPlate), ItemId.Material);
                            ...
                            sessionData.TimersData.LoadMatsTimer =
                                Timers.StartOnce(20000, () => loadMaterialsTimer(player), true);
                            ...
                            Trigger.ClientEvent(player, "showLoader",
                                LangFunc.GetText(LangType.Ru, DataName.LoadingMats), 1);
                        }
                    ...
                    case 3:
                        ...
                        {
                            player.Position = new Vector3(ArmyCheckpoints[3].X, ArmyCheckpoints[3].Y,
                                ArmyCheckpoints[3].Z + 1);
                            Main.PlayerEnterInterior(player,
                                new Vector3(ArmyCheckpoints[3].X, ArmyCheckpoints[3].Y, ArmyCheckpoints[3].Z + 1));
                        }
                        else
                        {
                            player.Position = new Vector3(ArmyCheckpoints[4].X, ArmyCheckpoints[4].Y,
                                ArmyCheckpoints[4].Z + 1);
                            Main.PlayerEnterInterior(player,
                                new Vector3(ArmyCheckpoints[4].X, ArmyCheckpoints[4].Y, ArmyCheckpoints[4].Z + 1));
                        }
                    ...
                    case 4: // open stock gun
                        ...
                        Chars.Repository.LoadOtherItemsData(player, "Fraction", "14", 5,
                    ...
                    case 5: // Наземный
                        ...
                        {
                            var ticks = Main.NextFixcarVeh.Ticks - DateTime.Now.Ticks;
                            if (ticks <= 0) return;
                        ...
                        if (vehicleLocalData != null)
                        {
                            if (vehicleLocalData.Access == VehicleAccess.Fraction &&
                                vehicleLocalData.Fraction == (int)Models.Fractions.ARMY)
                            {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.MustArmyVeh), 3000);
                            }
                        }
                    ...
                    case 6: // Воздушный
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.MustFlyingVeh), 3000);
                            return;
                        }
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.RepairOnlyFlyingVeh), 3000);
                            return;
                        }

                        if (DateTime.Now < Main.NextFixcarPlane)
                        {
                            var ticks = Main.NextFixcarPlane.Ticks - DateTime.Now.Ticks;
                            if (ticks <= 0) return;
                            var g = new DateTime(ticks);
                            if (g.Hour >= 1)
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                    ...
                    case 7: // Общая тревога
                        ...
                        foreach (var foreachPlayer in Character.Repository.GetPlayers())
                        {
                            ...
                            if (foreachMemberFractionData.Id == (int)Models.Fractions.CITY ||
                                Configs.IsFractionPolic(foreachMemberFractionData.Id) ||
                                foreachMemberFractionData.Id == (int)Models.Fractions.ARMY)
            ...
            {
                Log.Write($"OnFractionArmy Exception: {e}");
            }
        }
        ...
        public static void OutFractionArmy(ExtPlayer player, int Index)
        {
            try
            {
                ...
                if (sessionData.TimersData.LoadMatsTimer != null)
                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Загрузка материалов отменена, так как транспорт покинул чекпоинт", 3000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"onEntityExitArmyMats Exception: {e}");
            }
        }
        ...
        public static void loadMaterialsTimer(ExtPlayer player)
        {
            try
            {
                ...
                var itemCount = Chars.Repository.getCountItem(VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                    ItemId.Material);
                if (sessionData.WhereLoad == "WAR" && !MatsWar.isWar)
                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.TimeOver), 3000);
                    return;
                }
                ...
                {
                    var count = Stocks.maxMats[vehicle.Model] - itemCount;
                ...
                else
                {
                    ...
                    if (vehicle.Model == (uint)VehicleHash.Cargobob)
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.CargobobDayLimit, Stocks.MaxCargobobMats), 3000);
                            return;
                        }

                        // Если может
                        if (Stocks.CargobobMats - iCount <
                            0) // Если остаток загрузки меньше, чем мы хотим загрузить, то уменьшаем сколько хотим загрузить до лимита.
                        {
                        ...
                        {
                            Stocks.CargobobMats -=
                                iCount; // Если всё хорошо, то уменьшаем от общего лимита столько, сколько мы загрузили.
                        }
                    }

                    Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats,
                        LangFunc.GetText(LangType.Ru, DataName.MatLoads, iCount));
                    player.AddTableScore(TableTaskId.Item17);
                }

                Chars.Repository.AddNewItem(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate), "vehicle",
                    ItemId.Material, iCount, MaxSlots: vMain.GetMaxSlots(vehicle.Model));
                if (sessionData.TimersData.LoadMatsTimer != null) Timers.Stop(sessionData.TimersData.LoadMatsTimer);
                sessionData.TimersData.LoadMatsTimer = null;
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.MatSucLoading), 3000);
            }
            catch (Exception e)
            {
                Log.Write($"loadMaterialsTimer Exception: {e}");
            }
        }
        ...
        public static void Event_PlayerDeath(ExtPlayer player, ExtPlayer entityKiller, uint weapon)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MatLoadingCancelByDeath), 3000);
                    Timers.Stop(sessionData.TimersData.LoadMatsTimer);
                    sessionData.TimersData.LoadMatsTimer = null;
