...

{
    public class LibraryEn
    {
        ...
        public static void Init()
        {
            ...
            EnText[DataName.NoEvacSidit] =
                "You cannot evacuate this vehicle because it is far away or someone is sitting in it.";
            EnText[DataName.NoEvac1Hours] =
                "The owner recently left the vehicle and cannot be evacuated yet, but it will be possible through {0}: {1}: {2}";
            EnText[DataName.NoEvac0Hours] =
                "The owner recently left the vehicle and cannot be evacuated yet, but it will be possible through {0}: {1}";
            ...
            EnText[DataName.EvacSymbols] =
                "You have exceeded the character limit in the violation description. Maximum 45.";
            ...
            EnText[DataName.PoliceSdalsya] =
                "{0} surrendered in the act and was imprisoned in the bullpen for {1} minutes.";
            ...
            EnText[DataName.DoesntCallEmsOrAlready] =
                "The player did not call EMS or someone has already accepted this call";
            ...
            EnText[DataName.InfoDead] =
                "You are unconscious and cannot speak or hear. If you exit the game, all your criminal inventory will disappear. If no one cures you within 1 minute, you will be taken to the hospital.";
            ...
            EnText[DataName.HealStarted] =
                "You have started healing, but if you move too far, the treatment will be interrupted.";
            ...
            EnText[DataName.BronikReturn] =
                "You returned the body armor ({0}%) to the warehouse and returned {1} materials.";
            ...
            EnText[DataName.CargobobDayLimit] =
                "Cargobob cannot load more than {0} materials per day, come back tomorrow.";
            ...
            EnText[DataName.MatLoadingCancelByCheckpoint] =
                "Loading content was canceled because the car left the checkpoint.";
            ...
            EnText[DataName.FromCarToClubWarehouse] =
                "You have unloaded all the material from the car to the club's warehouse.";
            ...
            EnText[DataName.GovSucReactToCall] =
                "Employee {player.Name} ({player.Value}) has accepted your request and will come back soon.";
            ...
            EnText[DataName.RestrictedWordsTableNews] =
                "Some words forbidden for sending were found in your message, sending is blocked for 10 minutes.";
            ...
            EnText[DataName.SuccessEditRankVehWithPrikol] =
                "You have successfully changed the rank of the vehicle {0} ({1})";
            ...
            EnText[DataName.CantUseOnThisPlayerWhenCuffed] =
                "Cannot be cast on this player while being led or leading someone.";
            ...
            EnText[DataName.MinorYearsToDoThis] =
                "This person does not live enough in the state for this specialty yet";
            ...
            EnText[DataName.YouCanClaimGangRegion1h] =
                "You can start capturing the territory of this gang only through {g.Hour}: {g.Minute}: {g.Second}.";
            EnText[DataName.YouCanClaimGangRegion] =
                "You can start capturing the territory of this gang only through {g.Minute}: {g.Second}.";
            ...
            EnText[DataName.CaptureAlertDefend] =
                "[Capture] Attention, {Manager.getName (attackersFracID)} decided to capture our territory! (/ Tpcapture - teleport to the zone)";
            EnText[DataName.CaptureAlertAttack] =
                "[Capture] You have started a war that will start soon. (/ Tpcapture - teleport to the zone)";
            ...
            EnText[DataName.YouOnTheClaimRegion] =
                "You have entered a war territory. If you leave this territory, you will not be able to return.";
            ...
            EnText[DataName.YouWasTpCenterClaimRegion] =
                "You have been teleported to the center of the zone where the war for territory is taking place.";
            EnText[DataName.YouWasTpNearClaimRegion] =
                "You have been teleported to an area close to where the war for territory is taking place.";
            ...
            EnText[DataName.AdToList] =
                "Announcement from {0} has been sent to the queue, in the queue: {1} announcements.";
            ...
            EnText[DataName.SuccRentVehJob] =
                "You have successfully rented a vehicle on {0} {1}. The tag has been placed on the map.";
            ...
            EnText[DataName.RentExpandConfirm] =
                "Your transport was paid until {0}, are you sure you want to pay for it for another hour for {1} $?";
            EnText[DataName.RentCancelConfirm] =
                "Your vehicle has been paid for until {0}, are you sure you want to cancel its rental?";
            ...
            EnText[DataName.PlayerTriesToCallYou] =
                "{0} tried to call you, the call was recorded in the Event Log (M -> Contacts)";
            ...
            EnText[DataName.PanicActivator] =
                "{0} ({1}) activated the panic button, coordinates transferred to GPS, CODE 0.";
            ...
            EnText[DataName.MaxcarsCoupon] =
                "You already have the maximum number of cars, you cannot activate the coupon.";
            ...
            EnText[DataName.PersonWantTradeHouse] =
                "The player wants to exchange for real estate. Y / N - accept / reject";
            ...
            EnText[DataName.PersonWantTradeVeh] =
                "Player ({0}) wants to exchange for a vehicle. Y / N - accept / reject";
            ...
            EnText[DataName.DialogBuyFromTent] =
                "Are you sure you want to buy {0}? <br/> <br/> The cost of selling {1} $";
            ...
            EnText[DataName.TransactionConfirm1] =
                "You really confirm the transaction for the amount of $ {0} from your account,";
            ...
            EnText[DataName.MechanikRepairFrom] =
                "You offered the player ({0}) to repair the vehicle for {MoneySystem.Wallet.Format (1)} $";
            ...
            EnText[DataName.QuestPartComplete] =
                "You have completed one of the parts of the quest. Move on. You can read the information about the passage:";
            EnText[DataName.PointsQuestGot] = "You have passed {0} points. There are {1} more points.";
            EnText[DataName.NoLicenceB] =
                "You do not have a category B license. You can get it at the Driving School: M-GPS-Other-Driving School.";
            ...
            EnText[DataName.VehjobNotify] =
                "If you do not get on the transport within 3 minutes, the working day will end";
            EnText[DataName.AutomechNotCall] = "The player did not call the auto mechanic.";
            EnText[DataName.NoLicenceC] =
                "You do not have a C category license. You can get it at the Driving School: M-GPS-Other-Driving School.";
            ...
            EnText[DataName.Podskazka3] =
                "There is also an autopilot by the key! _ !, but you need an active marker on the map.";
            ...
            EnText[DataName.SuccHijackWeaponSafeW] =
                "You have successfully hacked the Weapon Safe and retrieved $ 1,200 from it, as well as a weapon.";
            EnText[DataName.SuccHijackWeaponSafe] =
                "You successfully hacked the Weapon Safe and retrieved $ 1,200 from it.";
            EnText[DataName.SuccHijackItemSafeW] =
                "You have successfully hacked the Item Cabinet and retrieved $ 900 and an item from it.";
            EnText[DataName.SuccHijackItemSafe] =
                "You have successfully hacked the Item Cabinet and retrieved $ 900 from it.";
            EnText[DataName.SuccHijackClothesSafeW] =
                "You successfully hacked into the Closet and retrieved $ 600 and clothes from it.";
            EnText[DataName.SuccHijackClothesSafe] =
                "You have successfully hacked the Closet and retrieved $ 600 from it.";
            ...
            EnText[DataName.HijackBagazhWithLockpickOnly] =
                "You need a lockpick to lock the trunk. You can buy it on the black market. (GPS Other)";
            ...
            EnText[DataName.somanymuted] =
                "You have too many players in the mut, clear the list by restarting your voice chat!";
            ...
            EnText[DataName.AdminTransferRestricted] =
                "Such monetary transactions are not available to the administration.";
            ...
            EnText[DataName.HandshakeYou] =
                "The player ({player.Value}) wants to shake your hand. Y / N - accept / reject";
            ...
            EnText[DataName.Greetings1] =
                "Welcome to the project !{{#ff3333}}RedAge!{{#FFF}} and thank you from the bottom of our hearts for being with us now ❤️"; // NOT WORKING
            EnText[DataName.Greetings2] =
                "Dozens of people have been trying every day for the third year to make your day a little brighter."; // NOT WORKING
            EnText[DataName.Greetings3] =
                "Follow the rules, be friendly and provide general comfort. Remember, this is just a game."; // NOT WORKING
            EnText[DataName.Greetings4] =
                "To contact the administration use / report. Open the FAQ on the server: F10. Mute toxic - /pmute."; //NOT WORKING
            EnText[DataName.Greetings5] =
                "You can find a lot of useful information about the project on our Wikipedia - !{{#Ff3333}}wiki.redage.net!{{#FFF}}."; // NOT WORKING
            ...
            EnText[DataName.AutoACBan] =
                "!{#DF5353}Anticheat issued a lifetime banhammer to player {player.Name}. Reason: Cheats ({0})";
            ...
            EnText[DataName.IHaveDemorgan] =
                "At the moment there is a penalty hanging on you, so this functionality is disabled for you until it ends.";
            ...
            EnText[DataName.PlayerNeVladeetVehTrade] =
                "The person no longer owns the vehicle that he offered for exchange";
            ...
            EnText[DataName.CaseWinVip] =
                "You got <span> {0} </span> status for <span> {1} </span> days, your status is now: {0} <br/> When you press the button <b > 'Pick up' </b>, the current status will be <span> <b> REPLACED </b> </span> with a new one. ";
            EnText[DataName.CaseWinVipHueviy] =
                "You got <span> {0} </span> status for <span> {1} </span> days. </br> <b> Your current VIP is better than this, so this the prize will have to be sold into the system. ";
            EnText[DataName.CaseWinVipNoVip] = "You got <span> {0} </span> status for <span> {1} </span> days.";
            EnText[DataName.CaseWinMoney] =
                "You got a <span> Game currency </span> in the amount of <span> {0} $ </span>";
            ...
            EnText[DataName.CaseWinFlylicEst] =
                "You have a <span> 'Helicopter Control' license! </span>. </br> <b> You already have one, so this prize will have to be sold into the system. </ B > ";
            EnText[DataName.CaseWinFlylic] = "You've got a <span> License for 'Controlling Helicopters' </span>!";
            EnText[DataName.CaseWinSamoletEst] =
                "You got a <span> 'Aircraft Control' license! </span>. </br> <b> You already have one, so this prize will have to be sold into the system. </ B > ";
            EnText[DataName.CaseWinSamolet] = "You have received a <span> License to 'Control Aircraft' </span>!";
            EnText[DataName.CaseWinParamedic] =
                "You have a <span> paramedic license! </span>. </br> <b> You already have one, so this prize will have to be sold into the system. </b>";
            ...
            EnText[DataName.CaseGetSklad] =
                "Successful! Cases were sent to the warehouse because there was not enough space in the inventory.";
            ...
            EnText[DataName.NoSpaceInventoryThenSclad] =
                "Since there was no room in the inventory, the item was sent to the warehouse.";
            EnText[DataName.AlreadyHaveItemStack] =
                "There is no room for {0}, maximum you can have with you - {1} pcs.";
            EnText[DataName.AlreadyHaveWeapon] =
                "Unable to take {0} because you already have this type of weapon in your inventory.";
            ...
            EnText[DataName.fireworkstand] =
                "You have installed the fireworks, run away! The explosion will happen in 5 seconds.";
            ...
            EnText[DataName.RepairSelf] =
                "Here you can repair your vehicle for $ 50 if there is no mechanic on staff. Are you sure you want to repair your vehicle?";
            ...
            EnText[DataName.SocialClubDoesntCorrect] =
                "The SocialClub you are connected to does not match the one that is linked to your account.";
            EnText[DataName.ConnectError] =
                "Connection error, please go back to the server or, if it fails, contact the technical section on the forum.";
            EnText[DataName.CharDataGetError] =
                "An error occurred while trying to get data about account characters, please refer to the technical section on the forum.";
            ...
            EnText[DataName.CharSuccMerged] =
                "Your character {0} _ {1} has been renamed and you have received RedBucks to change your name. Do not forget to change his name before playing.";
            ...
            EnText[DataName.RecoveryError] =
                "An error occured, please try again. If not, please refer to the technical section on the forum.";
            ...
            EnText[DataName.PlatinumVIP30d] =
                "Since you already had Diamond VIP, instead of Gold you received 7 days of renewal of your status!";
            ...
            EnText[DataName.RbTransferLimit] =
                "This function can send at least 25 and no more than 9.999 RedBucks at a time.";
            ...
            EnText[DataName.JackPotLottery] =
                "The size of the jackpot is the sum of the number of tickets purchased, taking into account a tax deduction of 30% ($ 150) from each ticket.";
            EnText[DataName.Chance70Lottery] =
                "Be careful, since your chance exceeds 70%, if you win, you will not recoup the costs!";
            EnText[DataName.Chance50Lottery] =
                "Beware, your chance is already over 50%! The higher the chance, the less profit if you win.";
            ...
            EnText[DataName.YouRentedTent] =
                "You rented a tent for 1 hour. To start selling, stand behind the counter and press E.";
            EnText[DataName.TentRentGo] =
                "The tent rental period has expired. Items have been returned to the warehouse.";
            EnText[DataName.TentRentCancel] = "You canceled the lease, the items have been returned to the warehouse.";
            EnText[DataName.TentZoneCancel] =
                "You have left the trade zone, so the lease has been canceled. Items have been returned to the warehouse.";
            ...
            EnText[DataName.MebelError] =
                "An error occurred while installing furniture, please submit the error to the technical section.";
            EnText[DataName.MebelTooNear] =
                "Furniture cannot be placed too close to existing furniture. Try it elsewhere!";
            ...
            EnText[DataName.Ochered] =
                "You have been added to the connection queue, your number in the list is {0} / {1}.";
            EnText[DataName.PetDying] =
                "The pet was in critical condition and you missed the moment it was picked up by the veterinarians ... It will be waiting for you at the hospital.";
            ...
            EnText[DataName.PetSellRb] =
                "Are you sure you want to give up your pet? <br/> 50% of the cost will be returned to you, namely {0} RB";
            EnText[DataName.PetSellMoney] =
                "Are you sure you want to give up your pet? <br/> 50% of the cost will be returned to you, namely {0} $";
            ...
            EnText[DataName.YouBoughtInfo] =
                "You bought property location information, it is displayed on your map. Good luck.";
            ...
            EnText[DataName.NoCreatorDemorgan] =
                "It is impossible to change the appearance of the character while serving a sentence in a prison or demorgan";
            EnText[DataName.NoSpaceForAccessory] =
                "You don't have enough space in your inventory for a unique accessory.";
            EnText[DataName.BuyDonateGreatStart] = "Purchased Great Start Pack (-29999 RedBucks)";
            EnText[DataName.MaxCarsDonPack] =
                "You already have the maximum number of cars in your garage, you cannot buy a set at the moment.";
            ...
            EnText[DataName.NoMoneyForIt] =
                "You do not have enough {0} $ to complete the operation, the action has been canceled.";
            ...
            EnText[DataName.GosZapravit] =
                "To refuel a vehicle at a government expense, you must be a member of a government organization";
            ...
            EnText[DataName.BizCantSellPrice] =
                "The business cannot be sold at this price. Please enter a price from {0} $";
        ...
        public static Dictionary<DataName, string> Data()
        {
            return EnText;
        }
    }
