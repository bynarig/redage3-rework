    ...
    class Configs : Script
    {
        ...
        public static void LoadFractionConfigs()
        {
            try
            {
                ...
                using NpgsqlCommand cmdFraction = new NpgsqlCommand
                {
                ...
                using NpgsqlCommand cmdFractionVehicles = new NpgsqlCommand()
                {
                ...
                if (resultFractionVehicles != null && resultFractionVehicles.Rows.Count > 0)
                {
                    foreach (DataRow dataRow in resultFractionVehicles.Rows)
                    {
                        ...
                        if (defaultrank == -1)
                        {
                            ...
                            using NpgsqlCommand ucmd = new NpgsqlCommand
                            {
                                CommandText =
                ...
                using NpgsqlCommand cmdFractionRanksSetting = new NpgsqlCommand()
                {
                ...
                using NpgsqlCommand cmdFractionaccess = new NpgsqlCommand()
                {
