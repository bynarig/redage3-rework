...
namespace NeptuneEvo.Fractions.Table.Player
{
    public class Repository
    {
        ...
        public static void GetMembers(ExtPlayer player)
        {
            ...
            Trigger.ClientEvent(player, "client.frac.main.members", JsonConvert.SerializeObject(playerData),
        ...
        public static void Reprimand(ExtPlayer player, int uuid, string name, string text)
        {
            try
            {
                ...
                ;
                Logs.Repository.AddLogs(player, FractionLogsType.Reprimand,
        ...
        public static void Leave(ExtPlayer player)
        {
            try
            {
                ...
                Logs.Repository.AddLogs(player, FractionLogsType.UnInvite,
