...
namespace NeptuneEvo.Fractions
{
    internal class Ems : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                NAPI.TextLabel.CreateTextLabel("~w~Donna Hart", new Vector3(322.785, -586.43, 44.35), 8f, 0.3f, 0,
                    new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.TextLabel.CreateTextLabel("~w~Gregory Parks", new Vector3(332.85, -594.66, 44.35), 8f, 0.3f, 0,
                    new Color(255, 255, 255), true, NAPI.GlobalDimension);

                #region cols

                CustomColShape.CreateCylinderColShape(emsCheckpoints[3], 1, 2, 0, ColShapeEnums.FractionEms,
                    1); // open ho spital stock
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Открыть склад"),
                    new Vector3(emsCheckpoints[3].X, emsCheckpoints[3].Y, emsCheckpoints[3].Z + 0.3), 5F, 0.3F, 0,
                    new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(emsCheckpoints[4], 1, 2, 0, ColShapeEnums.FractionEms,
                    2); // duty change
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(emsCheckpoints[4].X, emsCheckpoints[4].Y, emsCheckpoints[4].Z + 0.3), 5F, 0.3F, 0,
                    new Color(255, 255, 255));


                CustomColShape.CreateCylinderColShape(emsCheckpoints[6], 1, 2, 0, ColShapeEnums.FractionEms,
                    4); // tattoo delete
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Удаление татуировки"),
                    new Vector3(emsCheckpoints[6].X, emsCheckpoints[6].Y, emsCheckpoints[6].Z + 0.3), 5F, 0.3F, 0,
                    new Color(255, 255, 255));

                #region Load Medkits

                CustomColShape.CreateCylinderColShape(new Vector3(-53.072685, -2416.0156, 6.000165), 4, 5, 0,
                    ColShapeEnums.FractionEms, 5); // take meds
                NAPI.Marker.CreateMarker(1, new Vector3(-53.072685, -2416.0156, 3.000165), new Vector3(), new Vector3(),
                    4, new Color(255, 0, 0));

                CustomColShape.CreateCylinderColShape(new Vector3(-34.496403, -2419.0205, 5.994418), 4, 5, 0,
                    ColShapeEnums.FractionEms, 5); // take meds
                NAPI.Marker.CreateMarker(1, new Vector3(-34.496403, -2419.0205, 2.994418), new Vector3(), new Vector3(),
                    4, new Color(255, 0, 0));
                Main.CreateBlip(new Main.BlipData(499, "Humane Labs", new Vector3(-53.072685, -2416.0156, 6.000165), 4,
                    true));

                #endregion

                CustomColShape.CreateCylinderColShape(emsCheckpoints[7], 1, 2, 0, ColShapeEnums.FractionEms, 6); // roof
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~В больницу"),
                    new Vector3(emsCheckpoints[7].X, emsCheckpoints[7].Y, emsCheckpoints[7].Z + 0.3), 5F, 0.3F, 0,
                    new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(emsCheckpoints[8], 1, 2, 0, ColShapeEnums.FractionEms,
                    6); // to roof
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~На крышу"),
                    new Vector3(emsCheckpoints[8].X, emsCheckpoints[8].Y, emsCheckpoints[8].Z + 0.3), 5F, 0.3F, 0,
                    new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(emsCheckpoints[9], 1, 2, 0, ColShapeEnums.FractionEms, 7); // roof

                CustomColShape.CreateCylinderColShape(emsCheckpoints[10], 1, 2, 0, ColShapeEnums.FractionEms,
                    7); // roof
                ...
                for (var i = 3; i < 11; i++)
                {
                    ...
                    var marker = NAPI.Marker.CreateMarker(1, emsCheckpoints[i] - new Vector3(0, 0, 0.7), new Vector3(),
                        new Vector3(), 1, new Color(255, 255, 255, 220));
                }

                Repository.CreateQuest("s_m_m_scientist_01", new Vector3(315.63, -585.912, 43.26), 75.82f,
                    title: "~y~NPC~w~ Эммануэль\nДежурный врач", colShapeEnums: ColShapeEnums.FracEms);
                Repository.CreateQuest("s_m_y_autopsy_01", new Vector3(318.3019, -590.71857, 43.266674), 164.38774f,
                    title: "~y~NPC~w~ Михаил\nВетеринар", colShapeEnums: ColShapeEnums.FracEmsVeterinarian);
                Repository.CreateQuest("s_m_m_doctor_01", new Vector3(315.7822, -588.0856, 43.261223), 107.24092f,
                    title: "~y~NPC~w~ Мед.брат Станислав\nВызвать сотрудника",
                    colShapeEnums: ColShapeEnums.CallEmsMember);
                Repository.CreateQuest("a_f_y_business_04", new Vector3(-1289.9895, -572.3277, 30.572992), -45.4007f,
                    title: "~y~NPC~w~ Сара Каримова\nВызвать сотрудника", colShapeEnums: ColShapeEnums.CallGovMember);
            }
            catch (Exception e)
            {
        ...
        public static string OnCallEms(ExtPlayer player, bool death = false)
        {
            try
            {
                ...
                {
                    if (characterData.InsideHouseID != -1 || characterData.InsideGarageID != -1 ||
                        characterData.InsideOrganizationID != -1)
                        return "Вы не можете вызвать сюда медиков";
                }

                var EMSBlip = NAPI.Blip.CreateBlip(0, player.Position, 1, 70, $"EMS Call from [{player.Value}]", 0, 0,
                    false, 0, NAPI.GlobalDimension);
                ...
                foreach (var foreachPlayer in Character.Repository.GetPlayers())
                {
                    ...
                    Notify.Send(foreachPlayer, NotifyType.Warning, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MedicCallFrom, player.Name, player.Value), 5000);
                    NAPI.Chat.SendChatMessageToPlayer(foreachPlayer,
                        "!{#F08080}" + LangFunc.GetText(LangType.Ru, DataName.MedicCallFromDistance, player.Name,
                            player.Value, Math.Round(player.Position.DistanceTo(foreachPlayer.Position), 2)));
                }
            ...
            {
                Log.Write($"OnCallEms Exception: {e}");
            }
            ...
            try
            {
                ...
                if (!EMSCalls.ContainsKey(target))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.DoesntCallEmsOrAlready), 3000);
                    return;
                }
                ...
                Manager.sendFractionMessage((int)Models.Fractions.EMS,
                    LangFunc.GetText(LangType.Ru, DataName.CallAccept, player.Name.Replace("_", " "), target.Value));
                Manager.sendFractionMessage((int)Models.Fractions.EMS,
                    "!{#F08080}[F] " + LangFunc.GetText(LangType.Ru, DataName.CallAccept, player.Name.Replace("_", " "),
                        target.Value), true);
                Notify.Send(target, NotifyType.Info, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.YouCallAccepted, player.Value), 3000);
            }
            catch (Exception e)
            {
                Log.Write($"acceptCall Exception: {e}");
            }
        }
        ...
        public static void onPlayerDisconnectedhandler(ExtPlayer player, DisconnectionType type, string reason)
        {
            try
            {
                ...
                if (EMSCalls.ContainsKey(player))
                {
                    ...
                    Manager.sendFractionMessage((int)Models.Fractions.EMS,
                        LangFunc.GetText(LangType.Ru, DataName.CallCancel, player.Value));
                }
            }
            catch (Exception e)
            {
        ...
        public void OnPlayerDeathHandler(ExtPlayer player, ExtPlayer entityKiller, uint weapon)
        {
            try
            {
                ...
                try
                {
                    if (entityKiller.IsCharacterData() && Events.AirDrop.Repository.IsPlayerToEvents(player) &&
                        Events.AirDrop.Repository.IsPlayerToEvents(entityKiller))
                        Events.AirDrop.Repository.AirDropDeathHandler(player, entityKiller);
                }
                catch (Exception e)
                {
                    Log.Write($"onPlayerDeathHandler - AirDropTeamsInfoUpdate Exception: {e}");
                }
                ...
                try
                {
                    if (killerCharacterData != null && killerSessionData != null &&
                        !Voice.Voice.isGov(entityKiller.GetFractionId()) && player != entityKiller)
                        if ((!entityKiller.HasSharedData("IS_MASK") || !entityKiller.GetSharedData<bool>("IS_MASK")) &&
                            killerSessionData.InAirsoftLobby == -1 && killerSessionData.InTanksLobby == -1 &&
                            !killerSessionData.WarData.IsWarZone)
                        {
                            ...
                            var wantedLevel = new WantedLevel(correctLevel,
                                LangFunc.GetText(LangType.Ru, DataName.Police), DateTime.Now,
                                LangFunc.GetText(LangType.Ru, DataName.Murder));
                            Police.setPlayerWantedLevel(entityKiller, wantedLevel);
                        }
                }
                catch (Exception e)
                {
                    Log.Write($"onPlayerDeathHandler - setPlayerWantedLevel Exception: {e}");
                }

                if (sessionData.InTanksLobby > -1)
                {
                    TankRoyale.DeathCheck(player);
                    return;
                }
                ...
                if (sessionData.InAirsoftLobby >= 0)
                {
                    if (player.GetSharedData<int>("PlayerAirsoftTeam") == 0 ||
                        ...
                        (Airsoft.AirsoftPlayerData.ContainsKey(player) &&
                         Airsoft.AirsoftPlayerData[player].IsGunGamePlayer))
                    {
                        Airsoft.DeathCheck(player, entityKiller, weapon);
                        return;
                    }
                ...
                if (EventSys.AdminEvent.EventState != 0 && EventSys.ExitFromMP(player))
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MPfail), 7000);
                    return;
                }

                if (CarRoom.OnExitTestDrive(player,
                        true)) // Если вдруг что-то пойдёт не так и игрок в тест-драйве умрёт с GM'ом каким-то чудом.
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.TestDriveExpired), 5000);
                    return;
                }
                ...
                HouseManager.Event_OnPlayerDeath(player, entityKiller, weapon);
                ...
                else
                {
                    ...
                    if (!sessionData.DeathData.IsDying)
                    {
                        ...
                        sessionData.DeathData.InDeath = true;
                        player.SetSharedData("InDeath", true);
                        var medics = Manager.FractionMembersCount((int)Models.Fractions.EMS);

                        if (entityKiller.IsCharacterData() && entityKiller != player)
                            Trigger.ClientEvent(player, "openHospitalDialog",
                                LangFunc.GetText(LangType.Ru, DataName.YouAreDeadFromPlayer, entityKiller.Value,
                                    medics));
                        else
                            Trigger.ClientEvent(player, "openHospitalDialog",
                                LangFunc.GetText(LangType.Ru, DataName.YouAreDead, medics));
                        //}
                    }
                }
            }
        ...
        public void OnHospitalDialogCallback(ExtPlayer player, int state)
        {
            try
            {
                ...
                if (state == 2)
                {
                    ...
                    Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Ems,
                        LangFunc.GetText(LangType.Ru, DataName.SuccessCallMedic), DateTime.Now);
            ...
            {
                Log.Write($"OnHospitalDialogCallback Exception: {e}");
            }
        }
        ...
        public static void DeathConfirm(ExtPlayer player)
        {
            try
            {
                ...
                characterData.IsAlive = false;
                characterData.CurPosition = characterData.Gender ? emsCheckpoints[1] : emsCheckpoints[2];
                ...
                Notify.Send(player, NotifyType.Alert, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.InfoDead), 20000);
                Trigger.ClientEvent(player, "DeathTimer", 60000);
            }
            catch (Exception e)
            {
                Log.Write($"DeathConfirm Exception: {e}");
            }
        }
        ...
        public static void ReviveFunc(ExtPlayer player, bool reviveonplace = false)
        {
            try
            {
                ...
                if (!reviveonplace)
                {
                    ...
                    {
                        spawnPos = Manager.FractionSpawns[18] + new Vector3(0, 0, 1.12);
                    }
                    else if (fracId == (int)Models.Fractions.FIB)
                    {
                        spawnPos = Manager.FractionSpawns[(int)Models.Fractions.FIB] + new Vector3(0, 0, 1.12);
                    }
                    else
                    {
                        spawnPos = characterData.Gender ? emsCheckpoints[1] : emsCheckpoints[2];
                    }
                ...
                {
                    spawnPos = player.Position + new Vector3(0, 0, 0.5);
                }
            ...
            {
                Log.Write($"ReviveFunc Exception: {e}");
            }
        }
        ...
        public static void payMedkit(ExtPlayer player)
        {
            try
            {
                ...
                if (!target.IsCharacterData() || player.Position.DistanceTo(target.Position) > 2)
                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.YouFarFromSeller), 3000);
                    return;
                }
                ...
                var item = Chars.Repository.isItem(target, "inventory", ItemId.HealthKit);
                if (item == null || item.Item.Count < 1)
                {
                    targetSessionData.SellItemData = new SellItemData();
                    sessionData.SellItemData = new SellItemData();
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MedicNoApteka), 3000);
                    return;
                }

                if (Chars.Repository.isFreeSlots(player, ItemId.HealthKit) != 0)
                {
                    targetSessionData.SellItemData = new SellItemData();
                    sessionData.SellItemData = new SellItemData();
                    return;
                ...
                Chars.Repository.RemoveIndex(target, item.Location, item.Index);
                ...
                Wallet.Change(target, Convert.ToInt32(price * 0.15));
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.YouBuyApteka), 3000);
                Notify.Send(target, NotifyType.Info, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.YouSellApteka, player.Value), 3000);
                targetSessionData.SellItemData = new SellItemData();
                sessionData.SellItemData = new SellItemData();
            }
            catch (Exception e)
            {
                Log.Write($"payMedkit Exception: {e}");
            }
        }
            ...
            try
            {
                ...
                if (NAPI.Player.IsPlayerInAnyVehicle(target) && NAPI.Player.IsPlayerInAnyVehicle(player))
                {
                    ...
                    if (pveh != tveh)
                    {
                        ...
                        sessionData.SellItemData = new SellItemData();
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.PlayerInOtherVehicle), 3000);
                        return;
                    }
                    ...
                    if (vehicleLocalData != null)
                    {
                        if (vehicleLocalData.Access == VehicleAccess.Fraction &&
                            ...
                            (pveh.Model == NAPI.Util.GetHashKey("emsnspeedo") ||
                             pveh.Model == NAPI.Util.GetHashKey("emsroamer") ||
                             pveh.Model == NAPI.Util.GetHashKey("vapidse") ||
                             pveh.Model == (uint)VehicleHash.Ambulance || pveh.Model == (uint)VehicleHash.Frogger ||
                             pveh.Model == (uint)VehicleHash.Supervolito || pveh.Model == (uint)VehicleHash.Maverick ||
                             pveh.Model == (uint)VehicleHash.Lguard))
                        {
                            Notify.Send(target, NotifyType.Success, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.YouHealSomeone, player.Value), 4000);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.SomeoneHealYou, target.Value), 4000);
                        ...
                        else
                        {
                            ...
                            sessionData.SellItemData = new SellItemData();
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NotEmsCar), 3000);
                        }
                    }
                ...
                if (SafeZones.IsSafeZone(sessionData.InsideSafeZone, SafeZones.ZoneName.EMS) &&
        ...
        public static void OpenCallEmsMemberDialog(ExtPlayer player, int _)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "openDialog", "CallEmsMemberDialog",
                    LangFunc.GetText(LangType.Ru, DataName.AreYouWantToCallGov));
            }
            catch (Exception e)
            {
                Log.Write($"OpenCallEmsMemberDialog Exception: {e}");
            }
        }
        ...
        public static void Perform(ExtPlayer player)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.NoNeedHeal), 3000);
                return;
            }
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.AlreadyHealing), 3000);
                return;
            }

            //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.HealStarted), 7000);
            EventSys.SendCoolMsg(player, "Больница", "Лечение",
                $"{LangFunc.GetText(LangType.Ru, DataName.HealStarted)}", "", 5000);
            BattlePass.Repository.UpdateReward(player, 15);
            BattlePass.Repository.UpdateReward(player, 98);
        ...
        public static void OnFractionEms(ExtPlayer player, int interact)
        {
            try
            {
                ...
                switch (interact)
                {
                    case 1:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NotEMS), 3000);
                            return;
                        }
                    ...
                    case 5:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.CarCantMoveAptekas), 3000);
                            break;
                        }
                        ...
                        if (vehicleLocalData != null)
                        {
                            ...
                            var medCount = Chars.Repository.getCountItem(
                                VehicleManager.GetVehicleToInventory(vehicle.NumberPlate), ItemId.HealthKit);
                            if (medCount >= vMain.GetMaxSlots(vehicle.Model))
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.MaxAptekas), 3000);
                                break;
                            }

                            var zagruz = 75 - medCount;
                            GameLog.FracLog(memberFractionData.Id, player.GetUUID(), -1, player.Name, "-1",
                                $"HumaneLabs({zagruz})");

                            Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits,
                                LangFunc.GetText(LangType.Ru, DataName.FillAptekas, zagruz));

                            Chars.Repository.AddNewItem(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                "vehicle", ItemId.HealthKit, zagruz, MaxSlots: vMain.GetMaxSlots(vehicle.Model));
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.FulledAptekas), 3000);
                        }
                    ...
                    case 6:
                        ...
                        else
                        {
                            ...
                            if (memberFractionData.Id == (int)Models.Fractions.CITY &&
                                memberFractionData.Rank <= (int)Models.Fractions.THELOST)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
            ...
            {
                Log.Write($"OnFractionEms Exception: {e}");
            }
        }
        ...
        private static void healTimer(ExtPlayer player)
        {
            try
            {
                ...
                if (!SafeZones.IsSafeZone(sessionData.InsideSafeZone, SafeZones.ZoneName.EMS) || player.Health == 100)
                {
                    ...
                    Trigger.ClientEvent(player, "stopScreenEffect", "PPFilter");
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.HealEnded), 3000);
                    return;
                }
            ...
            {
                Log.Write($"healTimer Exception: {e}");
            }
        }
        ...
        public static void OpenHospitalStockMenu(ExtPlayer player)
        {
            ...
            {
                Log.Write($"OpenHospitalStockMenu Exception: {e}");
            }
        }
        ...
        private static void callback_hospitalstock(ExtPlayer player, object listItem)
        {
            try
            {
                ...
                switch (listItem)
                {
                    case "takemed":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                "На складе не осталось аптечек", 3000);
                            return;
                        }
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Вы взяли аптечку. У Вас {Chars.Repository.getCountItem($"char_{player.GetUUID()}", ItemId.HealthKit)} штук",
                            3000);
                        ...
                        break;
                    case "putmed":
                        var ItemStruct = Chars.Repository.isItem(player, "inventory", ItemId.HealthKit);
                        if (ItemStruct == null)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "У Вас нет аптечек",
                                3000);
                            return;
                        }
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Вы положили аптечку. У Вас осталось {Chars.Repository.getCountItem($"char_{player.GetUUID()}", ItemId.HealthKit)} штук",
                            3000);
                        fractionData.MedKits++;
                        fractionData.UpdateLabel();
                        GameLog.Stock(memberFractionData.Id, player.GetUUID(), player.Name, "medkit", 1, "in");
                        Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits, "Положил на склад аптечку");
                        break;
                    case "tazer":
                        ...
                        var serial = WeaponRepository.GetSerial(true, 8);
                        Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeSpecial,
                            $"Создал StunGun ({serial})");
            ...
            {
                Log.Write($"callback_hospitalstock Exception: {e}");
            }
        }
        ...
        public static void OpenTattooDeleteMenu(ExtPlayer player)
        {
            try
            {
                ...
                var frameList = new FrameListData();
                frameList.Header =
                    LangFunc.GetText(LangType.Ru,
                        DataName.TattooSved); //LangFunc.GetText(LangType.Ru, DataName.SelectZoneTattoo)
            ...
            {
                Log.Write($"OpenTattooDeleteMenu Exception: {e}");
            }
        }

        private static readonly string[] TattooZonesNames = new string[6]
            { "торса", "головы", "левой руки", "правой руки", "левой ноги", "правой ноги" };
        ...
        private static void callback_tattoodelete(ExtPlayer player, object listItem)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "У Вас нет татуировок в этой зоне", 3000);
                    return;
                }
                ...
                foreach (var tattoo in custom.Tattoos[Convert.ToInt32(zone)])
                {
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    "Вы свели татуировки с " + TattooZonesNames[Convert.ToInt32(zone)], 3000);
            }
            catch (Exception e)
            {
                Log.Write($"callback_tattoodelete Exception: {e}");
            }
        }
