...
{
    internal class WeaponComponents : Script
    {
        private static readonly nLog Log = new nLog("Chars.WeaponComponents");

        public static IReadOnlyDictionary<uint, wComponentsData> WeaponsComponents =
            new Dictionary<uint, wComponentsData>
            {
                {
                    NAPI.Util.GetHashKey("WEAPON_SNIPERRIFLE"), new wComponentsData(4,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_SNIPERRIFLE_VARMOD_LUXE"),
                                new wComponentData("WCT_VAR_WOOD", "WCD_VAR_WOOD", 30000, wComponentsType.Varmod)
                            },
                            //{ NAPI.Util.GetHashKey("COMPONENT_SNIPERRIFLE_CLIP_01"), new wComponentData("WCT_CLIP1", "WCD_SR_CLIP1", 0, wComponentsType.Clip) },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_SUPP_02"),
                                new wComponentData("WCT_SUPP", "WCD_AR_SUPP2", 9000, wComponentsType.Suppressor)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_MAX"),
                                new wComponentData("WCT_SCOPE_MAX", "WCD_SCOPE_MAX", 17000, wComponentsType.Scope)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_LARGE"),
                                new wComponentData("WCT_SCOPE_LRG", "WCD_SCOPE_LRG", 13000, wComponentsType.Scope)
                            }
                        })
                },
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_COMBATPDW"), new wComponentsData(3,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_AFGRIP"),
                                new wComponentData("WCT_GRIP", "WCD_GRIP", 900, wComponentsType.Grip)
                            },
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_FLSH"),
                                new wComponentData("WCT_FLASH", "WCD_FLASH", 1200, wComponentsType.Flashlight)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_SMALL"),
                                new wComponentData("WCT_SCOPE_SML", "WCD_SCOPE_SML", 1500, wComponentsType.Scope)
                            }
                        })
                },
                ...
                },*/
                {
                    NAPI.Util.GetHashKey("WEAPON_MICROSMG"), new wComponentsData(4, new Dictionary<uint, wComponentData>
                    {
                        ...
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_PI_FLSH"),
                            new wComponentData("WCT_FLASH", "WCD_FLASH", 800, wComponentsType.Flashlight)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_MICROSMG_VARMOD_LUXE"),
                            new wComponentData("WCT_VAR_GOLD", "WCD_VAR_GOLD", 900, wComponentsType.Varmod)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_MACRO"),
                            new wComponentData("WCT_SCOPE_MAC", "WCD_SCOPE_MAC", 1100, wComponentsType.Scope)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_AR_SUPP_02"),
                            new wComponentData("WCT_SUPP", "WCD_AR_SUPP2", 1000, wComponentsType.Suppressor)
                        }
                ...
                },
                {
                    NAPI.Util.GetHashKey("WEAPON_PISTOL"), new wComponentsData(3, new Dictionary<uint, wComponentData>
                    {
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_PI_FLSH"),
                            new wComponentData("WCT_FLASH", "WCD_FLASH", 400, wComponentsType.Flashlight)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_PI_SUPP_02"),
                            new wComponentData("WCT_SUPP", "WCD_PI_SUPP", 600, wComponentsType.Suppressor)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_PISTOL_VARMOD_LUXE"),
                            new wComponentData("WCT_VAR_GOLD", "WCD_VAR_GOLD", 500, wComponentsType.Varmod)
                        }
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_PUMPSHOTGUN"), new wComponentsData(3,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_FLSH"),
                                new wComponentData("WCT_FLASH", "WCD_FLASH", 500, wComponentsType.Flashlight)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_VARMOD_LOWRIDER"),
                                new wComponentData("WCT_VAR_GOLD", "WCD_VAR_GOLD", 600, wComponentsType.Varmod)
                            },
                            //{ NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_CLIP_01"), new wComponentData("WCT_INVALID", "WCD_INVALID", 0, wComponentsType.Clip) },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SR_SUPP"),
                                new wComponentData("WCT_SUPP", "WCD_SR_SUPP", 700, wComponentsType.Suppressor)
                            }
                        })
                },
                {
                    NAPI.Util.GetHashKey("WEAPON_APPISTOL"), new wComponentsData(3, new Dictionary<uint, wComponentData>
                    {
                        ...
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_PI_FLSH"),
                            new wComponentData("WCT_FLASH", "WCD_FLASH", 900, wComponentsType.Flashlight)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_APPISTOL_VARMOD_LUXE"),
                            new wComponentData("WCT_VAR_METAL", "WCD_VAR_METAL", 1000, wComponentsType.Varmod)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_PI_SUPP"),
                            new wComponentData("WCT_SUPP", "WCD_PI_SUPP", 1100, wComponentsType.Suppressor)
                        }
                    })
                },
                {
                    NAPI.Util.GetHashKey("WEAPON_SMG"), new wComponentsData(5, new Dictionary<uint, wComponentData>
                    {
                        ...
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_PI_SUPP"),
                            new wComponentData("WCT_SUPP", "WCD_PI_SUPP", 1400, wComponentsType.Suppressor)
                        }
                    })
                },
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_COMBATPISTOL"), new wComponentsData(3,
                        new Dictionary<uint, wComponentData>
                        {
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_COMBATPISTOL_VARMOD_LOWRIDER"),
                                new wComponentData("WCT_VAR_GOLD", "WCD_VAR_GOLD", 500, wComponentsType.Varmod)
                            }
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_SAWNOFFSHOTGUN"), new wComponentsData(1,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_SAWNOFFSHOTGUN_VARMOD_LUXE"),
                                new wComponentData("WCT_VAR_METAL", "WCD_VAR_METAL", 600, wComponentsType.Varmod)
                            }
                            //{ NAPI.Util.GetHashKey("COMPONENT_SAWNOFFSHOTGUN_CLIP_01"), new wComponentData("WCT_INVALID", "WCD_INVALID", 0, wComponentsType.Clip) },
                        })
                },
                {
                    NAPI.Util.GetHashKey("WEAPON_BULLPUPRIFLE"), new wComponentsData(5,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_AFGRIP"),
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_SUPP"),
                                new wComponentData("WCT_SUPP", "WCD_AR_SUPP", 700, wComponentsType.Suppressor)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_BULLPUPRIFLE_VARMOD_LOW"),
                                new wComponentData("WCT_VAR_METAL", "WCD_VAR_BPR", 1600, wComponentsType.Varmod)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_SMALL"),
                                new wComponentData("WCT_SCOPE_SML", "WCD_SCOPE_SML", 900, wComponentsType.Scope)
                            }
                ...
                },*/
                {
                    ...
                    {
                        {
                            NAPI.Util.GetHashKey("COMPONENT_REVOLVER_VARMOD_BOSS"),
                            new wComponentData("WCT_REV_VARB", "WCD_REV_VARB", 1300, wComponentsType.Varmod)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_REVOLVER_VARMOD_GOON"),
                            new wComponentData("WCT_REV_VARG", "WCD_REV_VARG", 1000, wComponentsType.Varmod)
                        }
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_MACHINEPISTOL"), new wComponentsData(1,
                        new Dictionary<uint, wComponentData>
                        {
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_PI_SUPP"),
                                new wComponentData("WCT_SUPP", "WCD_PI_SUPP", 900, wComponentsType.Suppressor)
                            }
                        })
                },
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_HEAVYPISTOL"), new wComponentsData(3,
                        new Dictionary<uint, wComponentData>
                        {
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_HEAVYPISTOL_VARMOD_LUXE"),
                                new wComponentData("WCT_VAR_WOOD", "WCD_VAR_HPST", 1000, wComponentsType.Varmod)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_PI_SUPP"),
                                new wComponentData("WCT_SUPP", "WCD_PI_SUPP", 1100, wComponentsType.Suppressor)
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_MARKSMANRIFLE"), new wComponentsData(6,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_AFGRIP"),
                                new wComponentData("WCT_GRIP", "WCD_GRIP", 9000, wComponentsType.Grip)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_MARKSMANRIFLE_VARMOD_LUXE"),
                                new wComponentData("WCT_VAR_GOLD", "WCD_VAR_MKRF", 35000, wComponentsType.Varmod)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_LARGE_FIXED_ZOOM"),
                                new wComponentData("WCT_SCOPE_LRG", "WCD_SCOPE_LRF", 16000, wComponentsType.Scope)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_FLSH"),
                                new wComponentData("WCT_FLASH", "WCD_FLASH", 11000, wComponentsType.Flashlight)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_SUPP"),
                                new wComponentData("WCT_SUPP", "WCD_AR_SUPP", 14000, wComponentsType.Suppressor)
                            }
                ...
                },
                {
                    NAPI.Util.GetHashKey("WEAPON_PISTOL50"), new wComponentsData(3, new Dictionary<uint, wComponentData>
                    {
                        ...
                        {
                            NAPI.Util.GetHashKey("COMPONENT_PISTOL50_VARMOD_LUXE"),
                            new wComponentData("WCT_VAR_SIL", "WCD_VAR_SIL", 500, wComponentsType.Varmod)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_AR_SUPP_02"),
                            new wComponentData("WCT_SUPP", "WCD_AR_SUPP2", 600, wComponentsType.Suppressor)
                        }
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_ASSAULTRIFLE"), new wComponentsData(5,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_AFGRIP"),
                                new wComponentData("WCT_GRIP", "WCD_GRIP", 1200, wComponentsType.Grip)
                            }, //Invalid
                            {
                                NAPI.Util.GetHashKey("COMPONENT_ASSAULTRIFLE_VARMOD_LUXE"),
                                new wComponentData("WCT_VAR_GOLD", "WCD_VAR_GOLD", 2000, wComponentsType.Varmod)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_FLSH"),
                                new wComponentData("WCT_FLASH", "WCD_FLASH", 900, wComponentsType.Flashlight)
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_MACRO"),
                                new wComponentData("WCT_SCOPE_MAC", "WCD_SCOPE_MAC", 1400, wComponentsType.Scope)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_SUPP_02"),
                                new wComponentData("WCT_SUPP", "WCD_AR_SUPP2", 1100, wComponentsType.Suppressor)
                            }
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_CARBINERIFLE"), new wComponentsData(5,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_AFGRIP"),
                                new wComponentData("WCT_GRIP", "WCD_GRIP", 1300, wComponentsType.Grip)
                            },
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_SUPP"),
                                new wComponentData("WCT_SUPP", "WCD_AR_SUPP", 1100, wComponentsType.Suppressor)
                            },
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_MEDIUM"),
                                new wComponentData("WCT_SCOPE_LRG", "WCD_SCOPE_LRG", 1400, wComponentsType.Scope)
                            },
                            //{ NAPI.Util.GetHashKey("COMPONENT_CARBINERIFLE_CLIP_03"), new wComponentData("WCT_CLIP_BOX", "WCD_CLIP_BOX", 0, wComponentsType.Clip) },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_CARBINERIFLE_VARMOD_LUXE"),
                                new wComponentData("WCT_VAR_GOLD", "WCD_VAR_GOLD", 2000, wComponentsType.Varmod)
                            }
                        })
                },
                {
                    NAPI.Util.GetHashKey("WEAPON_ADVANCEDRIFLE"), new wComponentsData(4,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_ADVANCEDRIFLE_VARMOD_LUXE"),
                                new wComponentData("WCT_VAR_METAL", "WCD_VAR_METAL", 2000, wComponentsType.Varmod)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_FLSH"),
                                new wComponentData("WCT_FLASH", "WCD_FLASH", 900, wComponentsType.Flashlight)
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_SMALL"),
                                new wComponentData("WCT_SCOPE_SML", "WCD_SCOPE_SML", 1400, wComponentsType.Scope)
                            }
                ...
                {
                    NAPI.Util.GetHashKey("WEAPON_BULLPUPSHOTGUN"), new wComponentsData(3,
                        new Dictionary<uint, wComponentData>
                        {
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_AFGRIP"),
                                new wComponentData("WCT_GRIP", "WCD_GRIP", 400, wComponentsType.Grip)
                            }, //Invalid
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_FLSH"),
                                new wComponentData("WCT_FLASH", "WCD_FLASH", 600, wComponentsType.Flashlight)
                            }, //Invalid
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_SUPP_02"),
                                new wComponentData("WCT_SUPP", "WCD_AR_SUPP2", 800, wComponentsType.Suppressor)
                            }
                            //{ NAPI.Util.GetHashKey("COMPONENT_BULLPUPSHOTGUN_CLIP_01"), new wComponentData("WCT_INVALID", "WCD_INVALID", 0, wComponentsType.Clip) },
                        })
                },
                {
                    NAPI.Util.GetHashKey("WEAPON_PUMPSHOTGUN_MK2"), new wComponentsData(5,
                        new Dictionary<uint, wComponentData>
                        {
                            //{ NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CLIP_01"), new wComponentData("WCT_SHELL", "WCD_SHELL", 0, wComponentsType.Clip) },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SIGHTS"),
                                new wComponentData("WCT_HOLO", "WCD_HOLO", 1200, wComponentsType.Scope)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_MACRO_MK2"),
                                new wComponentData("WCT_SCOPE_MAC2", "WCD_SCOPE_MAC", 1200, wComponentsType.Scope)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_SMALL_MK2"),
                                new wComponentData("WCT_SCOPE_SML2", "WCD_SCOPE_SML", 1200, wComponentsType.Scope)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_AR_FLSH"),
                                new wComponentData("WCT_FLASH", "WCD_FLASH", 600, wComponentsType.Flashlight)
                            ...
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_SR_SUPP_03"),
                                new wComponentData("WCT_SUPP", "WCD_SR_SUPP", 800, wComponentsType.Suppressor)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_AT_MUZZLE_08"),
                                new wComponentData("WCT_MUZZ8", "WCD_MUZZ_SR", 1800, wComponentsType.Muzzlebrake)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO"),
                                new wComponentData("WCT_CAMO_1", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_02"),
                                new wComponentData("WCT_CAMO_2", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_03"),
                                new wComponentData("WCT_CAMO_3", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_04"),
                                new wComponentData("WCT_CAMO_4", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_05"),
                                new wComponentData("WCT_CAMO_5", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_06"),
                                new wComponentData("WCT_CAMO_6", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_07"),
                                new wComponentData("WCT_CAMO_7", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_08"),
                                new wComponentData("WCT_CAMO_8", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_09"),
                                new wComponentData("WCT_CAMO_9", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_10"),
                                new wComponentData("WCT_CAMO_10", "WCD_INVALID", 1100, wComponentsType.Camo)
                            },
                            {
                                NAPI.Util.GetHashKey("COMPONENT_PUMPSHOTGUN_MK2_CAMO_IND_01"),
                                new wComponentData("WCT_CAMO_IND", "WCD_INVALID", 1100, wComponentsType.Camo)
                            }
                        })
                },
                {
                    NAPI.Util.GetHashKey("WEAPON_SMG_MK2"), new wComponentsData(6, new Dictionary<uint, wComponentData>
                    {
                        ...
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_SIGHTS_SMG"),
                            new wComponentData("WCT_HOLO", "WCD_HOLO", 1500, wComponentsType.Scope)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_MACRO_02_SMG_MK2"),
                            new wComponentData("WCT_SCOPE_MAC2", "WCD_SCOPE_MAC", 1500, wComponentsType.Scope)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_SCOPE_SMALL_SMG_MK2"),
                            new wComponentData("WCT_SCOPE_SML2", "WCD_SCOPE_SML", 1500, wComponentsType.Scope)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_PI_SUPP"),
                            new wComponentData("WCT_SUPP", "WCD_PI_SUPP", 1000, wComponentsType.Suppressor)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_MUZZLE_01"),
                            new wComponentData("WCT_MUZZ1", "WCD_MUZZ", 1800, wComponentsType.Muzzlebrake)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_MUZZLE_02"),
                            new wComponentData("WCT_MUZZ2", "WCD_MUZZ", 1800, wComponentsType.Muzzlebrake)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_MUZZLE_03"),
                            new wComponentData("WCT_MUZZ3", "WCD_MUZZ", 1800, wComponentsType.Muzzlebrake)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_MUZZLE_04"),
                            new wComponentData("WCT_MUZZ4", "WCD_MUZZ", 1800, wComponentsType.Muzzlebrake)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_MUZZLE_05"),
                            new wComponentData("WCT_MUZZ5", "WCD_MUZZ", 1800, wComponentsType.Muzzlebrake)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_MUZZLE_06"),
                            new wComponentData("WCT_MUZZ6", "WCD_MUZZ", 1800, wComponentsType.Muzzlebrake)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_MUZZLE_07"),
                            new wComponentData("WCT_MUZZ7", "WCD_MUZZ", 1800, wComponentsType.Muzzlebrake)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_SB_BARREL_01"),
                            new wComponentData("WCT_BARR", "WCD_BARR", 2100, wComponentsType.Barrel)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_AT_SB_BARREL_02"),
                            new wComponentData("WCT_BARR2", "WCD_BARR2", 2100, wComponentsType.Barrel)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO"),
                            new wComponentData("WCT_CAMO_1", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_02"),
                            new wComponentData("WCT_CAMO_2", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_03"),
                            new wComponentData("WCT_CAMO_3", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_04"),
                            new wComponentData("WCT_CAMO_4", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_05"),
                            new wComponentData("WCT_CAMO_5", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_06"),
                            new wComponentData("WCT_CAMO_6", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_07"),
                            new wComponentData("WCT_CAMO_7", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_08"),
                            new wComponentData("WCT_CAMO_8", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_09"),
                            new wComponentData("WCT_CAMO_9", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_10"),
                            new wComponentData("WCT_CAMO_10", "WCD_INVALID", 1100, wComponentsType.Camo)
                        },
                        {
                            NAPI.Util.GetHashKey("COMPONENT_SMG_MK2_CAMO_IND_01"),
                            new wComponentData("WCT_CAMO_IND", "WCD_INVALID", 1100, wComponentsType.Camo)
                        }
                    })
                }
        ...
        public static void Give(ExtPlayer player, uint weaponHash, string locationName, string Location)
        {
            try
            {
                ...
                {
                    var Components = WeaponsComponents[weaponHash].Components;
                    var _JsonInventoryItemData = new List<uint>();

                    foreach (var item in Repository.ItemsData[locationName][Location].Values) //Todo
                        if (item.ItemId != ItemId.Debug && item.Data != null && item.Data.Split('_').Length > 0 &&
                            Components.ContainsKey(Convert.ToUInt32(item.Data.Split('_')[1])))
                            _JsonInventoryItemData.Add(Convert.ToUInt32(item.Data.Split('_')[1]));

                    player.SetSharedData("weaponComponents",
                        $"{weaponHash}|" + JsonConvert.SerializeObject(_JsonInventoryItemData));
                }
            }
            catch (Exception e)
            {
                Log.Write($"Give Exception: {e}");
            }
        }
