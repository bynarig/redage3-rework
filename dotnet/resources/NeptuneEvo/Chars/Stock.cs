...
namespace NeptuneEvo.Chars
{
    internal class Stock : Script
    {
        ...
        public void Init()
        {
            try
            {
                Main.CreateBlip(new Main.BlipData(478, "Хранилище 'GoPostal'",
                    new Vector3(-545.02136, -204.28348, 38.2), 32, true));
                Main.CreateBlip(new Main.BlipData(525, "Центр занятости", new Vector3(-116.56201, -604.71436, 36.28072),
                    0, true));
                ...
                CustomColShape.CreateCylinderColShape(new Vector3(1048.2255, -3097.1624, -38.9999), 1f, 2, 5,
                    ColShapeEnums.WarehouseExit);
                PedSystem.Repository.CreateQuest("s_m_m_postal_01", new Vector3(-545.02136, -204.28348, 38.2),
                    -151.96516f, title: "~y~NPC~w~ Почтальон Александр\nСклад посылок",
                    colShapeEnums: ColShapeEnums.Warehouse);
            }
            catch (Exception e)
            {
