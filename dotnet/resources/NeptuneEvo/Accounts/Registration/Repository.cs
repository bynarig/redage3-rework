...
namespace NeptuneEvo.Accounts.Registration
{
    internal class Repository
    {
        ...
        public static async Task<RegistrationEnum> Register(ExtPlayer player, string login, string pass_, string email,
            string promo_, string ga)
        {
            try
            {
                ...
                HelperThread.AddEvent("login_new_user", accountData.Email, accountData.Ga);
                ...
                {
                    LoadCharacter.Repository.Load(player, DateTime.Now, true);
