    ...
    public class Repository
    {
                ...
                foreach (var foreachMemberOrganizationData in Manager.AllMembers[orgId].ToList())
                    if (foreachMemberOrganizationData.DepartmentId >= 0)
                    {
                        ...
                        if (foreachMemberOrganizationData.DepartmentRank == chiefRank)
                            departmentsChiefsName[foreachMemberOrganizationData.DepartmentId] =
                                foreachMemberOrganizationData.Name;
                    }

                var departments = NeptuneEvo.Table.Repository.GetDepartmentData(organizationData.Departments,
                    departmentsMembersCount, departmentsChiefsName);

                Trigger.ClientEvent(player, "client.org.main.departmentsInit",
        ...
        public static void DepartmentLoad(ExtPlayer player, int index)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "client.org.main.departmentInit", JsonConvert.SerializeObject(department),
                    JsonConvert.SerializeObject(playersList), JsonConvert.SerializeObject(membersOnlineStats));
            }
            catch (Exception e)
            {
                Debugs.Repository.Exception(e);
        ...
        public static void DepartmentRankLoad(ExtPlayer player, int index)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "client.org.main.departmentRankInit",
                    JsonConvert.SerializeObject(ranksData));
            }
            catch (Exception e)
            {
                Debugs.Repository.Exception(e);
        ...
        public static void DepartmentRankAccessLoad(ExtPlayer player, int index, int id)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "client.org.main.rankAccessInit",
                    JsonConvert.SerializeObject(departmentData.Ranks[id].Access),
                    JsonConvert.SerializeObject(departmentData.Ranks[id].Lock));
            }
            catch (Exception e)
            {
                Debugs.Repository.Exception(e);
            ...
            try
            {
                ...
                foreach (var foreachMemberOrganizationData in Manager.AllMembers[orgId].ToList())
                {
                    if (!organizationData.IsLeader(memberOrganizationData.UUID))
                    {
                        ...
                        if (memberOrganizationData.DepartmentId != 0 && memberOrganizationData.DepartmentId !=
                            foreachMemberOrganizationData.DepartmentId)
                            continue;

                        if (memberOrganizationData.DepartmentId != 0 && memberOrganizationData.DepartmentRank <=
                            foreachMemberOrganizationData.DepartmentRank)
                            continue;
                    }
                    ...
                    {
                        Organizations.Player.Repository.SetDepartment(orgId, foreachMemberOrganizationData.UUID, index,
                            0);
                        isSave = true;
                    }
        ...
        public static void DeletePlayerDepartment(ExtPlayer player, int index, int uuid)
        {
            try
            {
                ...
                if (!organizationData.IsLeader(memberOrganizationData.UUID))
                {
                    if (memberOrganizationData.DepartmentId != targetMemberOrganizationData.DepartmentId) return;

                    if (memberOrganizationData.DepartmentRank <= targetMemberOrganizationData.DepartmentRank) return;
                }
        ...
        public static void InvitePlayerDepartment(ExtPlayer player, int index, int uuid)
        {
            try
            {
                ...
                if (!organizationData.IsLeader(memberOrganizationData.UUID))
                {
                    if ((index > 0 && memberOrganizationData.DepartmentId != index) || (index == 0 &&
                            memberOrganizationData.DepartmentId != targetMemberOrganizationData.DepartmentId))
                    {
                        //Это не ваш отряд
                    ...
                    if (index > 0 && targetMemberOrganizationData.DepartmentId != 0)
                    {
                        ...
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Игрок в другом отряде",
                            3000);
                        return;
                    }
                }
