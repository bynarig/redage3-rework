...
namespace NeptuneEvo.Core
{
    internal class Animations : Script
    {
        ...
        private static readonly IReadOnlyDictionary<string, Animation> AnimList = new Dictionary<string, Animation>
        {
            {
                "1_1",
                new Animation("anim@amb@business@cfid@cfid_desk_no_work_bgen_chair_no_work@", "leg_smacking_lazyworker",
                    39)
            },
            ...
            { "1_4", new Animation("missdrfriedlanderdrf_idles", "drf_idle_drf", 39) },
            {
                ...
                new Animation("anim@amb@business@cfid@cfid_desk_no_work_bgen_chair_no_work@",
                    "look_around_v1_lazyworkerfemale", 39)
            },
            {
                "1_6",
                new Animation("anim@amb@business@bgen@bgen_no_work@", "sit_phone_phoneputdown_idle-noworkfemale", 39)
            },
            ...
            {
                "1_10",
                new Animation("anim@amb@business@bgen@bgen_no_work@", "sit_phone_phoneputdown_fallasleep_nowork", 39)
            },
            { "1_11", new Animation("switch@trevor@on_toilet", "trev_on_toilet_loop", 39) },
            {
                "1_12",
                new Animation("anim@amb@business@bgen@bgen_no_work@", "sit_phone_phoneputdown_wakeup_nowork", 39)
            },
            ...
            {
                "1_24",
                new Animation("anim@special_peds@casino@vince@steps@cas_vince_ig2", "cas_vince_ig2_id_go_home", 39)
            },
            ...
            {
                "1_50",
                new Animation("anim@amb@business@bgen@bgen_no_work@", "sit_phone_phoneputdown_sleeping-noworkfemale",
                    39)
            },
            ...
            {
                "3_10",
                new Animation("anim@amb@business@bgen@bgen_no_work@", "stand_phone_phoneputdown_idle_nowork", 39)
            },
            ...
            { "3_41", new Animation("missheistdockssetup1ig_10@idle_d", "talk_pipe_d_worker2", 39) },
            {
                ...
                new Animation("anim@amb@business@bgen@bgen_no_work@",
                    "stand_phone_phoneputdown_stretching-noworkfemale", 39)
            },
            { "3_43", new Animation("friends@frt@ig_1", "trevor_impatient_wait_4", 39) },
            {
                "3_44",
                new Animation("anim@amb@business@bgen@bgen_no_work@", "stand_phone_phoneputdown_sleeping_nowork", 39)
            },
            ...
            {
                "3_73",
                new Animation("anim@amb@nightclub@dancers@club_ambientpeds@low-med_intensity",
                    "li-mi_amb_club_10_v1_male^3", 39)
            },
            ...
            {
                "6_1",
                new Animation("special_ped@mountain_dancer@monologue_1@monologue_1a",
                    "mtn_dnc_if_you_want_to_get_to_heaven", 39)
            },
            ...
            {
                "6_5",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj@low_intesnsity",
                    "li_dance_facedj_09_v1_male^2", 39)
            },
            {
                "6_6",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj@low_intesnsity",
                    "li_dance_facedj_09_v1_male^1", 39)
            },
            ...
            {
                "6_50",
                new Animation("anim@amb@nightclub@dancers@solomun_entourage@", "mi_dance_facedj_17_v1_female^1", 39)
            },
            {
                "6_51",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity",
                    "hi_dance_facedj_09_v2_female^1", 39)
            },
            {
                "6_52",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity",
                    "hi_dance_facedj_09_v2_female^3", 39)
            },
            { "6_53", new Animation("anim@amb@nightclub@mini@dance@dance_solo@female@var_b@", "high_center", 39) },
            {
                "6_54",
                new Animation("anim@amb@nightclub@dancers@club_ambientpeds@", "mi-hi_amb_club_13_v1_female^1", 39)
            },
            {
                "6_55",
                new Animation("anim@amb@nightclub@dancers@club_ambientpeds@", "mi-hi_amb_club_11_v1_female^1", 39)
            },
            {
                "6_56",
                new Animation("anim@amb@nightclub@dancers@club_ambientpeds@med-hi_intensity",
                    "mi-hi_amb_club_11_v1_female^6", 39)
            },
            {
                "6_57",
                new Animation("anim@amb@nightclub@dancers@club_ambientpeds@med-hi_intensity",
                    "mi-hi_amb_club_09_v1_male^3", 39)
            },
            ...
            {
                "6_61",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_13_v2_female^6", 39)
            },
            {
                "6_62",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_09_v1_female^6", 39)
            },
            {
                "6_63",
            ...
            { "6_64", new Animation("anim@amb@nightclub@djs@dixon@", "dixn_dance_a_dixon", 39) },
            {
                ...
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj_transitions@",
                    "trans_dance_facedj_hi_to_li_09_v1_female^1", 39)
            },
            {
                "6_66",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj_transitions@",
                    "trans_dance_facedj_hi_to_li_09_v1_female^6", 39)
            },
            {
                "6_67",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj_transitions@from_med_intensity",
                    "trans_dance_facedj_mi_to_hi_08_v1_female^3", 39)
            },
            {
                "6_68",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj_transitions@from_med_intensity",
                    "trans_dance_facedj_mi_to_hi_08_v1_male^1", 39)
            },
            {
                "6_69",
                new Animation("anim@amb@nightclub@dancers@crowddance_facedj_transitions@from_med_intensity",
                    "trans_dance_facedj_mi_to_hi_08_v1_male^3", 39)
            },
            {
                "6_70",
            ...
            {
                "6_72",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_09_v2_female^5", 39)
            },
            {
                "6_73",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_09_v2_female^6", 39)
            },
            {
                "6_74",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_09_v1_female^3", 39)
            },
            {
                "6_75",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_09_v2_male^2", 39)
            },
            {
                "6_76",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_09_v1_male^3", 39)
            },
            {
                "6_77",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_09_v1_male^6", 39)
            },
            {
                "6_78",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_17_v2_female^1", 39)
            },
            {
                "6_79",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_17_v1_female^2", 39)
            },
            {
                "6_80",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_17_v1_female^3", 39)
            },
            {
                "6_81",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_17_v1_female^6", 39)
            },
            {
                "6_82",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_15_v1_female^1", 39)
            },
            {
                "6_83",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_15_v1_female^2", 39)
            },
            {
                "6_84",
                new Animation("anim@amb@nightclub@dancers@crowddance_groups@", "hi_dance_crowd_15_v1_female^3", 39)
            },
            {
                "6_85",
                new Animation("anim@amb@nightclub@dancers@crowddance_single_props@", "hi_dance_prop_09_v1_female^2", 39)
            }
        };
        ...
        public static void AnimationStop(ExtPlayer player)
        {
            ...
            {
                Log.Write($"AnimationStop Exception: {e}");
            }
        }
        ...
        public static void AnimationPlay(ExtPlayer player, string category, bool vehCheck = true)
        {
            try
            {
                var sessionData = player.GetSessionData();
                if (sessionData == null) return;
                if (sessionData.AntiAnimDown || sessionData.Following != null || sessionData.SitPos != -1 ||
                    sessionData.InAirsoftLobby >= 0) return;
                ...
                Repository.UpdateReward(player, 70);
                qMain.UpdateQuestsStage(player, Zdobich.QuestName, (int)zdobich_quests.Stage10, 1, true);
            ...
            {
                Log.Write($"animationSelected Exception: {e}");
            }
        }
        ...
        public static void playerInteractionTarget(ExtPlayer player, ExtPlayer target)
        {
            try
            {
                ...
                if (targetSessionData == null || targetSessionData.AnimationUse == null ||
                    !AnimList.ContainsKey(targetSessionData.AnimationUse))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.PlayerDontAnim), 3000);
                    return;
                }

                AnimationPlay(player, targetSessionData.AnimationUse);
                Repository.UpdateReward(player, 56);
            }
            catch (Exception e)
            {
                Log.Write($"playerInteractionTarget Exception: {e}");
            }
        }
        ...
        public void AnimationDavorite(ExtPlayer player, string json)
        {
            ...
            {
                Log.Write($"AnimationDavorite Exception: {e}");
            }
        }
