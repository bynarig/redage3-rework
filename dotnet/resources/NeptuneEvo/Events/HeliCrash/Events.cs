...
namespace NeptuneEvo.Events.HeliCrash
{
    public class Events : Script
    {
        ...
        public static void CMD_t1(ExtPlayer player, string name)
        {
            ...
            var veh = (ExtVehicle)NAPI.Vehicle.CreateVehicle(NAPI.Util.GetHashKey("adder"), new Vector3(-4, 15, 71), 0,
                1, 1, "numberPlate", 0, true);
            NAPI.Task.Run(() =>
            {
                veh.Delete();
                NAPI.Vehicle.CreateVehicle(NAPI.Util.GetHashKey("adder"), new Vector3(7, 15, 71), 0, 33, 33,
                    "numberPlate", 0, true);
            }, 1);
        }
