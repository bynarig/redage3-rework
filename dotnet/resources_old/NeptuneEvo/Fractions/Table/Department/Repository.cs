    ...
    public class Repository
    {
                ...
                foreach (var foreachMemberFractionData in Manager.AllMembers[fracId].ToList())
                    if (foreachMemberFractionData.DepartmentId >= 0)
                    {
                        ...
                        if (foreachMemberFractionData.DepartmentRank == chiefRank)
                            departmentsChiefsName[foreachMemberFractionData.DepartmentId] =
                                foreachMemberFractionData.Name;
                    }

                var departments = NeptuneEvo.Table.Repository.GetDepartmentData(fractionData.Departments,
                    departmentsMembersCount, departmentsChiefsName);

                Trigger.ClientEvent(player, "client.frac.main.departmentsInit",
        ...
        public static void DepartmentLoad(ExtPlayer player, int index)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "client.frac.main.departmentInit", JsonConvert.SerializeObject(department),
        ...
        public static void DepartmentRankLoad(ExtPlayer player, int index)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "client.frac.main.departmentRankInit",
        ...
        public static void DepartmentRankAccessLoad(ExtPlayer player, int index, int id)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "client.frac.main.rankAccessInit",
            ...
            try
            {
                ...
                foreach (var foreachMemberFractionData in Manager.AllMembers[fracId].ToList())
                {
                    if (!fractionData.IsLeader(memberFractionData.Rank))
                    {
                        ...
                        if (foreachMemberFractionData.DepartmentId != 0 && memberFractionData.DepartmentId !=
                            foreachMemberFractionData.DepartmentId)
                            continue;

                        if (foreachMemberFractionData.DepartmentId != 0 && memberFractionData.DepartmentRank <=
                            foreachMemberFractionData.DepartmentRank)
                            continue;
                    }

                    if (foreachMemberFractionData.DepartmentId == index &&
                        rankToUUid.ContainsKey(foreachMemberFractionData.DepartmentRank) &&
        ...
        public static void DeletePlayerDepartment(ExtPlayer player, int index, int uuid)
        {
            try
            {
                ...
                if (!fractionData.IsLeader(memberFractionData.Rank))
                {
                    if (memberFractionData.DepartmentId != targetMemberFractionData.DepartmentId) return;

                    if (memberFractionData.DepartmentRank <= targetMemberFractionData.DepartmentRank) return;
                }
        ...
        public static void InvitePlayerDepartment(ExtPlayer player, int index, int uuid)
        {
            try
            {
                ...
                if (!fractionData.IsLeader(memberFractionData.Rank))
                {
                    if ((index > 0 && memberFractionData.DepartmentId != index) || (index == 0 &&
                            memberFractionData.DepartmentId != targetMemberFractionData.DepartmentId))
                    {
                        //Это не ваш отряд
