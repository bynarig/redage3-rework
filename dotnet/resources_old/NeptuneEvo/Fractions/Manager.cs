...
{
    internal class Manager : Script
    {
        public static readonly nLog Log = new nLog("Fractions.FractionManager");

        public static IReadOnlyDictionary<WeaponRepository.Hash, int> matsForGun =
            new Dictionary<WeaponRepository.Hash, int>
            {
        ...
        private static readonly List<string>[] gangGuns = new List<string>[5]
        {
            new List<string>
            {
                "Pistol",
        ...
        private static readonly List<string>[] nongovGuns = new List<string>[4]
        {
            new List<string>
            {
                "PistolMk2",
        ...
        private static readonly List<string>[] mafiaGuns = new List<string>[5]
        {
            new List<string>
            {
                "PistolMk2",
        ...
        private static readonly List<string>[] organizationsGuns = new List<string>[4]
        {
            new List<string>
            {
                "Pistol",
        ...
        private static readonly List<string>[] bikersGuns = new List<string>[4]
        {
            new List<string>
            {
                "PistolMk2",
        ...
        public static ConcurrentDictionary<int, List<FractionMemberData>> AllMembers =
            new ConcurrentDictionary<int, List<FractionMemberData>>();
        ...
        public static IReadOnlyDictionary<int, Vector3> FractionSpawns = new Dictionary<int, Vector3>
        {
            ...
            {
                (int)Models.Fractions.LSNEWS, new Vector3(-563.7617, -934.2492, 23.866652)
            }, // LSNews -1063.046, -249.463, 44.0211
        ...
        public static IReadOnlyDictionary<int, FractionsType> FractionTypes =
            new Dictionary<int, FractionsType>() // 0 - mafia, 1 gangs, 2 - gov, 3 -  nongov, 4 - bikers
            {
        ...
        private static readonly IReadOnlyList<GarageData> GaragesData = new List<GarageData>
        {
        ...
        public static IReadOnlyDictionary<WeaponRepository.Hash, int> WeaponsMaxAmmo =
            new Dictionary<WeaponRepository.Hash, int>
            {
        ...
        public static Dictionary<int, FracMatsData> FractionDataMats = new Dictionary<int, FracMatsData>
        {
            ...
            {
                1,
                new FracMatsData(1, Repository.ItemsInfo[ItemId.BagWithDrill].Name,
                    Repository.ItemsInfo[ItemId.BagWithDrill].Icon, $"{Main.BlackMarketDrill}$")
            },
            {
                2,
                new FracMatsData(2, Repository.ItemsInfo[ItemId.Lockpick].Name,
                    Repository.ItemsInfo[ItemId.Lockpick].Icon, $"{Main.BlackMarketLockPick}$")
            },
            {
                3,
                new FracMatsData(3, Repository.ItemsInfo[ItemId.ArmyLockpick].Name,
                    Repository.ItemsInfo[ItemId.ArmyLockpick].Icon, $"{Main.BlackMarketArmyLockPick}$")
            },
            {
                4,
                new FracMatsData(4, Repository.ItemsInfo[ItemId.Cuffs].Name, Repository.ItemsInfo[ItemId.Cuffs].Icon,
                    $"{Main.BlackMarketCuffs}$")
            },
            {
                5,
                new FracMatsData(5, Repository.ItemsInfo[ItemId.Pocket].Name, Repository.ItemsInfo[ItemId.Pocket].Icon,
                    $"{Main.BlackMarketPocket}$")
            },
            { 6, new FracMatsData(6, "Понизить розыск", "sm-icon-wanted", $"{Main.BlackMarketWanted}$") },
            {
                7,
                new FracMatsData(7, Repository.ItemsInfo[ItemId.BodyArmor].Name,
                    Repository.ItemsInfo[ItemId.BodyArmor].Icon, "150 мат.")
            },
            ...
            {
                79,
                new FracMatsData(79, "Мед. карта", Repository.ItemsInfo[ItemId.Note].Icon,
                    $"{Main.BlackMarketMedCard}$")
            },
            { 80, new FracMatsData(80, "QR-код", Repository.ItemsInfo[ItemId.Note].Icon, $"{Main.BlackQrFake}$") },
            {
                81,
                new FracMatsData(81, "Радиоперехватчик", Repository.ItemsInfo[ItemId.RadioInterceptor].Icon,
                    $"{Main.BlackRadioInterceptord}$")
            },

            //Для фракций
            {
                8,
                new FracMatsData(8, Repository.ItemsInfo[ItemId.Nightstick].Name,
                    Repository.ItemsInfo[ItemId.Nightstick].Icon, null)
            },
            {
                9,
                new FracMatsData(9, Repository.ItemsInfo[ItemId.StunGun].Name,
                    Repository.ItemsInfo[ItemId.StunGun].Icon, null)
            },
            {
                10,
                new FracMatsData(10, Repository.ItemsInfo[ItemId.CombatPistol].Name,
                    Repository.ItemsInfo[ItemId.CombatPistol].Icon, null)
            },
            {
                11,
                new FracMatsData(11, Repository.ItemsInfo[ItemId.SMG].Name, Repository.ItemsInfo[ItemId.SMG].Icon, null)
            },
            {
                12,
                new FracMatsData(12, Repository.ItemsInfo[ItemId.PumpShotgun].Name,
                    Repository.ItemsInfo[ItemId.PumpShotgun].Icon, null)
            },
            {
                13,
                new FracMatsData(13, Repository.ItemsInfo[ItemId.CombatPDW].Name,
                    Repository.ItemsInfo[ItemId.CombatPDW].Icon, null)
            },
            {
                14,
                new FracMatsData(14, Repository.ItemsInfo[ItemId.CarbineRifle].Name,
                    Repository.ItemsInfo[ItemId.CarbineRifle].Icon, null)
            },
            {
                15,
                new FracMatsData(15, Repository.ItemsInfo[ItemId.HeavySniper].Name,
                    Repository.ItemsInfo[ItemId.HeavySniper].Icon, null)
            },
            {
                16,
                new FracMatsData(16, Repository.ItemsInfo[ItemId.AdvancedRifle].Name,
                    Repository.ItemsInfo[ItemId.AdvancedRifle].Icon, null)
            },
            {
                17,
                new FracMatsData(17, Repository.ItemsInfo[ItemId.Gusenberg].Name,
                    Repository.ItemsInfo[ItemId.Gusenberg].Icon, null)
            },
            {
                18,
                new FracMatsData(18, Repository.ItemsInfo[ItemId.CombatMG].Name,
                    Repository.ItemsInfo[ItemId.CombatMG].Icon, null)
            },
            {
                19,
                new FracMatsData(19, Repository.ItemsInfo[ItemId.PistolAmmo].Name,
                    Repository.ItemsInfo[ItemId.PistolAmmo].Icon, null)
            },
            {
                20,
                new FracMatsData(20, Repository.ItemsInfo[ItemId.ShotgunsAmmo].Name,
                    Repository.ItemsInfo[ItemId.ShotgunsAmmo].Icon, null)
            },
            {
                21,
                new FracMatsData(21, Repository.ItemsInfo[ItemId.SMGAmmo].Name,
                    Repository.ItemsInfo[ItemId.SMGAmmo].Icon, null)
            },
            ...
            {
                23,
                new FracMatsData(23, Repository.ItemsInfo[ItemId.RiflesAmmo].Name,
                    Repository.ItemsInfo[ItemId.RiflesAmmo].Icon, null)
            },
            {
                24,
                new FracMatsData(24, Repository.ItemsInfo[ItemId.SniperAmmo].Name,
                    Repository.ItemsInfo[ItemId.SniperAmmo].Icon, null)
            },
            ...
            {
                32,
                new FracMatsData(32, Repository.ItemsInfo[ItemId.HealthKit].Name,
                    Repository.ItemsInfo[ItemId.HealthKit].Icon, null)
            },
            {
                33,
                new FracMatsData(33, Repository.ItemsInfo[ItemId.BodyArmor].Name,
                    Repository.ItemsInfo[ItemId.BodyArmor].Icon, null)
            },


            {
                34,
                new FracMatsData(34, Repository.ItemsInfo[ItemId.CeramicPistol].Name,
                    Repository.ItemsInfo[ItemId.CeramicPistol].Icon, null)
            },
            {
                35,
                new FracMatsData(35, Repository.ItemsInfo[ItemId.HeavyPistol].Name,
                    Repository.ItemsInfo[ItemId.HeavyPistol].Icon, null)
            },
            {
                36,
                new FracMatsData(36, Repository.ItemsInfo[ItemId.VintagePistol].Name,
                    Repository.ItemsInfo[ItemId.VintagePistol].Icon, null)
            },
            {
                37,
                new FracMatsData(37, Repository.ItemsInfo[ItemId.Pistol50].Name,
                    Repository.ItemsInfo[ItemId.Pistol50].Icon, null)
            },
            {
                38,
                new FracMatsData(38, Repository.ItemsInfo[ItemId.PumpShotgun].Name,
                    Repository.ItemsInfo[ItemId.PumpShotgun].Icon, null)
            },
            {
                39,
                new FracMatsData(38, Repository.ItemsInfo[ItemId.SMGMk2].Name, Repository.ItemsInfo[ItemId.SMGMk2].Icon,
                    null)
            },
            {
                40,
                new FracMatsData(40, Repository.ItemsInfo[ItemId.MachinePistol].Name,
                    Repository.ItemsInfo[ItemId.MachinePistol].Icon, null)
            },
            {
                41,
                new FracMatsData(41, Repository.ItemsInfo[ItemId.MiniSMG].Name,
                    Repository.ItemsInfo[ItemId.MiniSMG].Icon, null)
            },
            {
                42,
                new FracMatsData(42, Repository.ItemsInfo[ItemId.CompactRifle].Name,
                    Repository.ItemsInfo[ItemId.CompactRifle].Icon, null)
            },
            {
                43,
                new FracMatsData(43, Repository.ItemsInfo[ItemId.AssaultRifle].Name,
                    Repository.ItemsInfo[ItemId.AssaultRifle].Icon, null)
            },
            {
                44,
                new FracMatsData(44, Repository.ItemsInfo[ItemId.PistolMk2].Name,
                    Repository.ItemsInfo[ItemId.PistolMk2].Icon, null)
            },
            ...
            {
                46,
                new FracMatsData(46, Repository.ItemsInfo[ItemId.SNSPistolMk2].Name,
                    Repository.ItemsInfo[ItemId.SNSPistolMk2].Icon, null)
            },
            {
                47,
                new FracMatsData(47, Repository.ItemsInfo[ItemId.DoubleBarrelShotgun].Name,
                    Repository.ItemsInfo[ItemId.DoubleBarrelShotgun].Icon, null)
            },
            {
                48,
                new FracMatsData(48, Repository.ItemsInfo[ItemId.SawnOffShotgun].Name,
                    Repository.ItemsInfo[ItemId.SawnOffShotgun].Icon, null)
            },
            {
                49,
                new FracMatsData(49, Repository.ItemsInfo[ItemId.PumpShotgunMk2].Name,
                    Repository.ItemsInfo[ItemId.PumpShotgunMk2].Icon, null)
            },
            {
                50,
                new FracMatsData(50, Repository.ItemsInfo[ItemId.SweeperShotgun].Name,
                    Repository.ItemsInfo[ItemId.SweeperShotgun].Icon, null)
            },
            {
                51,
                new FracMatsData(51, Repository.ItemsInfo[ItemId.MicroSMG].Name,
                    Repository.ItemsInfo[ItemId.MicroSMG].Icon, null)
            },
            {
                52,
                new FracMatsData(52, Repository.ItemsInfo[ItemId.SMGMk2].Name, Repository.ItemsInfo[ItemId.SMGMk2].Icon,
                    null)
            },
            {
                53,
                new FracMatsData(53, Repository.ItemsInfo[ItemId.AssaultRifleMk2].Name,
                    Repository.ItemsInfo[ItemId.AssaultRifleMk2].Icon, null)
            },
            {
                54,
                new FracMatsData(54, Repository.ItemsInfo[ItemId.BullpupRifle].Name,
                    Repository.ItemsInfo[ItemId.BullpupRifle].Icon, null)
            },
            {
                55,
                new FracMatsData(55, Repository.ItemsInfo[ItemId.APPistol].Name,
                    Repository.ItemsInfo[ItemId.APPistol].Icon, null)
            },
            {
                56,
                new FracMatsData(56, Repository.ItemsInfo[ItemId.GrenadeLauncherSmoke].Name,
                    Repository.ItemsInfo[ItemId.GrenadeLauncherSmoke].Icon, null)
            },
            {
                57,
                new FracMatsData(57, Repository.ItemsInfo[ItemId.AssaultShotgun].Name,
                    Repository.ItemsInfo[ItemId.AssaultShotgun].Icon, null)
            },
            {
                58,
                new FracMatsData(58, Repository.ItemsInfo[ItemId.AssaultSMG].Name,
                    Repository.ItemsInfo[ItemId.AssaultSMG].Icon, null)
            },
            //59
            {
                60,
                new FracMatsData(60, Repository.ItemsInfo[ItemId.CombatMGMk2].Name,
                    Repository.ItemsInfo[ItemId.CombatMGMk2].Icon, null)
            },
            {
                61,
                new FracMatsData(61, Repository.ItemsInfo[ItemId.CarbineRifleMk2].Name,
                    Repository.ItemsInfo[ItemId.CarbineRifleMk2].Icon, null)
            },
            {
                62,
                new FracMatsData(62, Repository.ItemsInfo[ItemId.BullpupRifleMk2].Name,
                    Repository.ItemsInfo[ItemId.BullpupRifleMk2].Icon, null)
            },
            {
                63,
                new FracMatsData(63, Repository.ItemsInfo[ItemId.MarksmanRifleMk2].Name,
                    Repository.ItemsInfo[ItemId.MarksmanRifleMk2].Icon, null)
            },
            {
                64,
                new FracMatsData(64, Repository.ItemsInfo[ItemId.HeavyShotgun].Name,
                    Repository.ItemsInfo[ItemId.HeavyShotgun].Icon, null)
            },
            {
                65,
                new FracMatsData(65, Repository.ItemsInfo[ItemId.BullpupShotgun].Name,
                    Repository.ItemsInfo[ItemId.BullpupShotgun].Icon, null)
            },
            {
                66,
                new FracMatsData(66, Repository.ItemsInfo[ItemId.SpecialCarbine].Name,
                    Repository.ItemsInfo[ItemId.SpecialCarbine].Icon, null)
            },
            {
                67,
                new FracMatsData(67, Repository.ItemsInfo[ItemId.SpecialCarbineMk2].Name,
                    Repository.ItemsInfo[ItemId.SpecialCarbineMk2].Icon, null)
            },
            {
                68,
                new FracMatsData(68, Repository.ItemsInfo[ItemId.SniperRifle].Name,
                    Repository.ItemsInfo[ItemId.SniperRifle].Icon, null)
            },

            //Магазин фейверков
            {
                70,
                new FracMatsData(70, Repository.ItemsInfo[ItemId.Firework1].Name,
                    Repository.ItemsInfo[ItemId.Firework1].Icon, Main.PricesSettings.FireworkPrices[0] + "$")
            },
            {
                71,
                new FracMatsData(71, Repository.ItemsInfo[ItemId.Firework2].Name,
                    Repository.ItemsInfo[ItemId.Firework2].Icon, Main.PricesSettings.FireworkPrices[1] + "$")
            },
            {
                72,
                new FracMatsData(72, Repository.ItemsInfo[ItemId.Firework3].Name,
                    Repository.ItemsInfo[ItemId.Firework3].Icon, Main.PricesSettings.FireworkPrices[2] + "$")
            },
            {
                73,
                new FracMatsData(73, Repository.ItemsInfo[ItemId.Firework4].Name,
                    Repository.ItemsInfo[ItemId.Firework4].Icon, Main.PricesSettings.FireworkPrices[3] + "$")
            },

            //Охотничий магазин
            {
                74,
                new FracMatsData(74, Repository.ItemsInfo[ItemId.WorkAxe].Name,
                    Repository.ItemsInfo[ItemId.WorkAxe].Icon, Main.PricesSettings.InstrumentPrices[0] + "$")
            },
            {
                75,
                new FracMatsData(75, Repository.ItemsInfo[ItemId.Pickaxe1].Name,
                    Repository.ItemsInfo[ItemId.Pickaxe1].Icon, Main.PricesSettings.InstrumentPrices[1] + "$")
            },
            {
                76,
                new FracMatsData(76, Repository.ItemsInfo[ItemId.Pickaxe2].Name,
                    Repository.ItemsInfo[ItemId.Pickaxe2].Icon, Main.PricesSettings.InstrumentPrices[2] + "$")
            },
            {
                77,
                new FracMatsData(77, Repository.ItemsInfo[ItemId.Pickaxe3].Name,
                    Repository.ItemsInfo[ItemId.Pickaxe3].Icon, Main.PricesSettings.InstrumentPrices[3] + "$")
            },

            // Предметы новые у пд
            {
                82,
                new FracMatsData(82, Repository.ItemsInfo[ItemId.Konus].Name, Repository.ItemsInfo[ItemId.Konus].Icon,
                    null)
            },
            {
                83,
                new FracMatsData(83, Repository.ItemsInfo[ItemId.Konuss].Name, Repository.ItemsInfo[ItemId.Konuss].Icon,
                    null)
            },
            {
                84,
                new FracMatsData(84, Repository.ItemsInfo[ItemId.Otboynik1].Name,
                    Repository.ItemsInfo[ItemId.Otboynik1].Icon, null)
            },
            {
                85,
                new FracMatsData(85, Repository.ItemsInfo[ItemId.Otboynik2].Name,
                    Repository.ItemsInfo[ItemId.Otboynik2].Icon, null)
            },
            {
                86,
                new FracMatsData(86, Repository.ItemsInfo[ItemId.Dontcross].Name,
                    Repository.ItemsInfo[ItemId.Dontcross].Icon, null)
            },
            {
                87,
                new FracMatsData(87, Repository.ItemsInfo[ItemId.Stop].Name, Repository.ItemsInfo[ItemId.Stop].Icon,
                    null)
            },
            {
                88,
                new FracMatsData(88, Repository.ItemsInfo[ItemId.NetProezda].Name,
                    Repository.ItemsInfo[ItemId.NetProezda].Icon, null)
            },
            {
                89,
                new FracMatsData(89, Repository.ItemsInfo[ItemId.Kpp].Name, Repository.ItemsInfo[ItemId.Kpp].Icon, null)
            },
            {
                90,
                new FracMatsData(90, Repository.ItemsInfo[ItemId.Zabor1].Name, Repository.ItemsInfo[ItemId.Zabor1].Icon,
                    null)
            },
            {
                91,
                new FracMatsData(91, Repository.ItemsInfo[ItemId.Zabor2].Name, Repository.ItemsInfo[ItemId.Zabor2].Icon,
                    null)
            },
            {
                92,
                new FracMatsData(92, Repository.ItemsInfo[ItemId.Airlight].Name,
                    Repository.ItemsInfo[ItemId.Airlight].Icon, null)
            },
            {
                93,
                new FracMatsData(93, Repository.ItemsInfo[ItemId.Camera1].Name,
                    Repository.ItemsInfo[ItemId.Camera1].Icon, null)
            },
            {
                94,
                new FracMatsData(94, Repository.ItemsInfo[ItemId.Camera2].Name,
                    Repository.ItemsInfo[ItemId.Camera2].Icon, null)
            }
        };
        ...
        public static void onResourceStart()
        {
            try
            {
                ...
                Main.CreateBlip(new Main.BlipData(621, LangFunc.GetText(LangType.Ru, DataName.Bolnica),
                    Ems.emsCheckpoints[0], 1, true));

                Main.CreateBlip(new Main.BlipData(60, "FIB", Fbi.GpsPosition, 4, true));

                Main.CreateBlip(new Main.BlipData(478, LangFunc.GetText(LangType.Ru, DataName.WarPort),
                    Army.ArmyCheckpoints[2], 52, true));
        ...
        public static void RemoveFractionMemberData(string name)
        {
            ...
            {
                Log.Write($"RemoveFromAllMembersOffline Exception: {e}");
            }
        }
        ...
        private static void CreateGarageData()
        {
            ...
            {
                CustomColShape.CreateCylinderColShape(garageData.VehEnterPosPoint, 3f, 2, 0,
                    ColShapeEnums.FractionGarageEnter, index); // Телепорт из улицы в гараж
                ...
                NAPI.Marker.CreateMarker(1, garageData.VehEnterPosPoint - new Vector3(0, 0, 0.7), new Vector3(),
                    new Vector3(), 3, new Color(255, 255, 255, 220), dimension: 0);

                CustomColShape.CreateCylinderColShape(garageData.VehExitPosPoint, 3f, 2,
                    (uint)(garageData.DefaultDimension + garageData.FractionId), ColShapeEnums.FractionGarageExit,
                    index); // Телепорт с гаража на улицу
                NAPI.Marker.CreateMarker(1, garageData.VehExitPosPoint - new Vector3(0, 0, 0.7), new Vector3(),
                    new Vector3(), 3, new Color(255, 255, 255, 220),
                    dimension: (uint)(garageData.DefaultDimension + garageData.FractionId));

                CustomColShape.CreateCylinderColShape(garageData.PlayerExitPos, 1.5f, 2,
                    (uint)(garageData.DefaultDimension + garageData.FractionId), ColShapeEnums.FractionGarageExit,
                    index); // Телепорт с гаража на улицу
                NAPI.Marker.CreateMarker(1, garageData.PlayerExitPos - new Vector3(0, 0, 1.2), new Vector3(),
                    new Vector3(), 1, new Color(255, 255, 255, 220),
                    dimension: (uint)(garageData.DefaultDimension + garageData.FractionId));
        ...
        public static void FractionGarageEnter(ExtPlayer player, int index)
        {
            try
            {
                ...
                if (fracId != garageData.FractionId && characterData.AdminLVL == 0)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.YouNotInFraction), 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.IsFollowing), 3000);
                    return;
                }
            ...
            {
                Log.Write($"FractionGarageEnter Exception: {e}");
            }
        }
        ...
        public static void FractionGarageExit(ExtPlayer player, int index)
        {
            ...
            {
                Log.Write($"FractionGarageExit Exception: {e}");
            }
        }
        ...
        public static void fractionChat(ExtPlayer player, string message)
        {
            try
            {
                ...
                var msgSender =
                    $"~b~[F] {GetDepartmentTag(fracId, memberFractionData.DepartmentId)} {GetFractionRankName(fracId, memberFractionData.Rank)} " +
                    player.Name.Replace('_', ' ') + " (" + player.Value + "): " + Commands.RainbowExploit(message);
                foreach (var foreachPlayer in Character.Repository.GetPlayers())
                {
                    ...
                    if (foreachMemberFractionData.Id == fracId)
                    {
                        ...
                        if (Configs.IsFractionPolic(fracId) || fracId == (int)Models.Fractions.ARMY)
                            foreachPlayer.Eval(
                                "mp.game.audio.playPoliceReport(\"LAMAR_1_POLICE_LOST\", 0.0);"); // Police Report Sound for LSPD & FBI
                    }
                }
            ...
            {
                Log.Write($"fractionChat Exception: {e}");
            }
        }
        ...
        public static void fractionChatOOC(ExtPlayer player, string message)
        {
            try
            {
                ...
                if (characterData.DemorganTime >= 1) return;
                var msgSender = "~b~ (( [F] " + player.Name.Replace('_', ' ') + " (" + player.Value + "): " +
                                Commands.RainbowExploit(message) + " ))";
                foreach (var foreachPlayer in Character.Repository.GetPlayers())
                {
                    var foreachMemberFractionData = foreachPlayer.GetFractionMemberData();
                    if (foreachMemberFractionData == null)
            ...
            {
                Log.Write($"fractionChatOOC Exception: {e}");
            }
        }
        ...
        public static void govFractionChat(ExtPlayer player, string message)
        {
            try
            {
                ...
                var msgSender = "!{#B8962E}" +
                                $"[{GovTags[fracId]}] {GetFractionRankName(fracId, memberFractionData.Rank)} " +
                                player.Name.Replace('_', ' ') + " (" + player.Value + "): " +
                                Commands.RainbowExploit(message);
                foreach (var foreachPlayer in Character.Repository.GetPlayers())
                {
                    var foreachMemberFractionData = foreachPlayer.GetFractionMemberData();
            ...
            {
                Log.Write($"govFractionChat Exception: {e}");
            }
        }
        ...
        public static int FractionMembersCount(int fracId)
        {
            ...
            {
                Log.Write($"countOfFractionMembers Exception: {e}");
                return 0;
            }
        }
        ...
        public static void AcceptCallFractionMemberDialog(ExtPlayer player, int fracId)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.CallGov15sec), 3000);
                    return;
                }

                if (Main.IHaveDemorgan(player, true)) return;

                var numberInfo = characterData.Sim == -1 ? "" : characterData.Sim.ToString();

                sendFractionMessage(fracId,
                    "!{#F08080}[F] " +
                    LangFunc.GetText(LangType.Ru, DataName.PlayerCallGov, player.Name, player.Value) + " " + numberInfo,
                    true);
                EventSys.SendCoolMsg(player, "Успешно", "Вызов сотрудника",
                    $"{LangFunc.GetText(LangType.Ru, DataName.PlayerSucCallGov)}", "", 10000);
                ...
                NAPI.Task.Run(() =>
                {
                    ...
                    {
                        Log.Write($"AcceptCallFractionMemberDialog Task Exception: {e}");
                    }
                }, 60000);
            }
            catch (Exception e)
            {
                Log.Write($"AcceptCallFractionMemberDialog Exception: {e}");
            }
        }
            ...
            try
            {
                if (inChat)
                    foreach (var foreachPlayer in Character.Repository.GetPlayers())
                        ...
                        {
                            Log.Write($"sendFractionMessage Foreach #1 Exception: {e}");
                        }
                else
                    foreach (var foreachPlayer in Character.Repository.GetPlayers())
                        try
                        {
                            ...
                            if (foreachMemberFractionData.Id == fracid)
                                Notify.Send(foreachPlayer, NotifyType.Warning, NotifyPosition.BottomCenter, message,
                                    3000);
                        }
                        catch (Exception e)
                        {
                            Log.Write($"sendFractionMessage Foreach #2 Exception: {e}");
                        }
            }
            catch (Exception e)
            {
                Log.Write($"sendFractionMessage Exception: {e}");
            }
        }


        public static void SendCoolFractionMsg(int fracid, string subTitle, string title, string desc, string image,
            ushort timeWait)
        {
            try
            {
                {
                    foreach (var foreachPlayer in Character.Repository.GetPlayers())
                        try
                        {
                            ...
                            if (foreachMemberFractionData.Id == fracid)
                                Trigger.ClientEvent(foreachPlayer, "hud.event.cool", subTitle, title, desc, image,
                                    timeWait);
                        }
                        catch (Exception e)
                        {
            ...
            {
                Log.Write($"sendFractionCoolMessage Exception: {e}");
            }
        }

        public static void SendCoolOrganizationMsg(int orgId, string subTitle, string title, string desc, string image,
            ushort timeWait)
        {
            try
            {
            ...
            try
            {
                if (inChat)
                    foreach (var foreachPlayer in Character.Repository.GetPlayers())
                        ...
                        {
                            Log.Write($"sendOrganizationMessage Foreach #1 Exception: {e}");
                        }
                else
                    foreach (var foreachPlayer in Character.Repository.GetPlayers())
                        try
                        ...
                        {
                            Log.Write($"sendOrganizationMessage Foreach #2 Exception: {e}");
                        }
            }
            catch (Exception e)
            {
                Log.Write($"sendOrganizationMessage Exception: {e}");
            }
        }

        public static void sendFractionPictureNotification(int fracid, string sender, string submessage, string message,
            string pic)
        {
            try
            {
                foreach (var foreachPlayer in Character.Repository.GetPlayers())
                {
                    ...
                    if (foreachMemberFractionData.Id == fracid)
                        NAPI.Notification.SendPictureNotificationToPlayer(foreachPlayer, message, pic, 0, 0, sender,
                            submessage);
                }
            }
            catch (Exception e)
            {
                Log.Write($"sendFractionPictureNotification Exception: {e}");
            }
        }
        ...
        public static bool canGetWeapon(ExtPlayer player, string weapon, bool notify = true)
        {
            ...
            {
                Log.Write($"canGetWeapon Exception: {e}");
                return false;
            }
        }
        ...
        public static void SetSkin(ExtPlayer player)
        {
            ...
            {
                Log.Write($"SetSkin Exception: {e}");
            }
        }

        public static string GetFractionRankName(int fractionId, int fracRank)
        {
            var fractionData = GetFractionData(fractionId);
            ...
            try
            {
                ...
                switch (type)
                {
                    case "fbi":
                        ...
                        {
                            9, 10, 44, 55, 35 /*, 56*/, 49, 48, 57, 50, 13, 11, 58, 60, 61, 62, 16, 15, 63, 33, 32, 19,
                            20, 21, 23, 24, 25, 26, 82, 83, 84, 85, 86, 87, 88, 89, 90, 91, 92, 93, 94
                        };
                        break;
                    case "gov":
                        title = "Выдача оружия";
                        ...
                        ListItems = new List<int>
                            { 9, 10, 44, 37, 35, 11, 58, 13, 16, 14, 33, 32, 19, 20, 21, 23, 24, 26 };
                        break;
                    case "polic":
                        title = "Выдача оружия";
                        ...
                        ListItems = new List<int>
                        {
                            8, 9, 44, 37, 10, 35, 34, 49, 64, 48, 65, 11, 13, 14, 54, 33, 32, 19, 20, 21, 23, 24, 26,
                    ...
                    case "army":
                        ...
                        ListItems = new List<int>
                        {
                            9, 10, 44, 37, 35, 49, 48, 65, 13, 11, 18, 14, 61, 66, 67, 68, 63, 33, 32, 19, 20, 21, 23,
                            24, 26
                        };
                        break;
                    case "gang":
                ...
                var _JsonData = new List<FracMatsData>();

                foreach (var i in ListItems)
                    if (FractionDataMats.ContainsKey(i))
                        _JsonData.Add(FractionDataMats[i]);

                Trigger.ClientEvent(player, "client.sm.open", title, titleIcon, JsonConvert.SerializeObject(_JsonData));
            }
            catch (Exception e)
            {
                Log.Write($"OpenFractionSM Exception: {e}");
            }
        }
        ...
        public static void callback_policeGuns(ExtPlayer player, int index)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.TooFarFromVidacha), 3000);
                    return;
                }
                ...
                switch (index)
                {
                    case 33:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.WarehouseNoMats), 3000);
                            return;
                        }

                        if (Repository.itemCount(player, "inventory", ItemId.BodyArmor) >= Repository.maxItemCount)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.AlreadyHaveBronik), 3000);
                            return;
                        }

                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.BodyArmor,
                                1, 100.ToString()) == -1)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.GetBronik), 3000);
                        GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "armor", 1, "out");
                        Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats,
                            LangFunc.GetText(LangType.Ru, DataName.VzyalBron));

                        if (fractionData.Id == (int)Models.Fractions.POLICE ||
                            fractionData.Id == (int)Models.Fractions.SHERIFF ||
                            fractionData.Id == (int)Models.Fractions.CITY ||
                            fractionData.Id == (int)Models.Fractions.ARMY ||
                            fractionData.Id == (int)Models.Fractions.FIB)
                            sendFractionMessage(fractionData.Id,
                                LangFunc.GetText(LangType.Ru, DataName.FTakenBronik, player.Name, player.Value), true);
                        return;
                    case 26:
                        ...
                        if (!canGetWeapon(player, "Armor")) return;
                        var ItemStruct = Repository.isItem(player, "inventory", ItemId.BodyArmor);
                        if (ItemStruct == null)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.YouHaveNoBronik), 3000);
                            return;
                        }
                        ...
                        if (ItemStruct.Location == "accessories")
                        {
                            if (sessionData.ArmorHealth != -1 && player.Armor > sessionData.ArmorHealth)
                            {
                                Trigger.SendToAdmins(3,
                                    LangFunc.GetText(LangType.Ru, DataName.AdminACBronik, player.Name));
                                armorp = 0;
                            }
                            else
                            {
                        ...
                        {
                            armorp = Convert.ToInt32(ItemStruct.Item.Data);
                        }
                        ...
                        fractionData.Materials = fractionData.Materials + matstoadd > 300000
                            ? 300000
                            : fractionData.Materials + matstoadd;
                        fractionData.UpdateLabel();
                        Repository.RemoveIndex(player, ItemStruct.Location, ItemStruct.Index);
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.BronikReturn, armorp, matstoadd), 5000);
                        ...
                        if (fractionData.Id == (int)Models.Fractions.POLICE ||
                            ...
                            fractionData.Id == (int)Models.Fractions.FIB)
                            sendFractionMessage(fractionData.Id,
                                LangFunc.GetText(LangType.Ru, DataName.SdalBronik, player.Name, player.Value, armorp,
                                    matstoadd), true);
                        return;
                    case 32: // medkit
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.WarehouseNoAptekas), 3000);
                            return;
                        }

                        if (Repository.isFreeSlots(player, ItemId.HealthKit) != 0) return;
                        Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.HealthKit);
                        fractionData.MedKits--;
                        fractionData.UpdateLabel();
                        GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "medkit", 1, "out");
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.GotApteka), 3000);
                        Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits,
                            LangFunc.GetText(LangType.Ru, DataName.GetApteka));
                        ...
                        if (fractionData.Id == (int)Models.Fractions.POLICE ||
                            ...
                            fractionData.Id == (int)Models.Fractions.FIB)
                            sendFractionMessage(fractionData.Id,
                                LangFunc.GetText(LangType.Ru, DataName.FTakeApteka, player.Name, player.Value), true);
                        return;

                    case 25:
                        if (!canGetWeapon(player, "FIBB")) return;
                        var data = characterData.Gender ? "128_0_true" : "98_0_false";
                        if (Repository.isItem(player, "inventory", ItemId.Jewelry, data) != null)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.YouAlreadyHaveBadge), 3000);
                            return;
                        }

                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Jewelry, 1,
                                data) == -1)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeSpecial,
                            LangFunc.GetText(LangType.Ru, DataName.GetNewBadge));
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotFibBadge), 3000);
                        return;
                    ...
                    case 19:
                        ...
                        Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.Ru, DataName.Ammo),
                            LangFunc.GetText(LangType.Ru, DataName.EnterAmmoHoches), 4, "take_frac_ammo");
                        return;
                    case 20:
                    ...
                    case 68:
                        ...
                        return;
                    case 82:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Konus, 1,
                                "0") == -1)
                        {
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem, Repository.ItemsInfo[ItemId.Konus].Name),
                            3000);
                        return;
                    case 83:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Konuss, 1,
                                "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem,
                                Repository.ItemsInfo[ItemId.Konuss].Name), 3000);
                        return;
                    case 84:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Otboynik1,
                                1, "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem,
                                Repository.ItemsInfo[ItemId.Otboynik1].Name), 3000);
                        return;
                    case 85:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Otboynik2,
                                1, "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem,
                                Repository.ItemsInfo[ItemId.Otboynik2].Name), 3000);
                        return;
                    case 86:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Dontcross,
                                1, "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem,
                                Repository.ItemsInfo[ItemId.Dontcross].Name), 3000);
                        return;
                    case 87:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Stop, 1,
                                "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem, Repository.ItemsInfo[ItemId.Stop].Name),
                            3000);
                        return;
                    case 88:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.NetProezda,
                                1, "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem,
                                Repository.ItemsInfo[ItemId.NetProezda].Name), 3000);
                        return;
                    case 89:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Kpp, 1,
                                "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem, Repository.ItemsInfo[ItemId.Kpp].Name),
                            3000);
                        return;
                    case 90:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Zabor1, 1,
                                "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem,
                                Repository.ItemsInfo[ItemId.Zabor1].Name), 3000);
                        return;
                    case 91:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Zabor2, 1,
                                "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem,
                                Repository.ItemsInfo[ItemId.Zabor2].Name), 3000);
                        return;
                    case 92:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Airlight, 1,
                                "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem,
                                Repository.ItemsInfo[ItemId.Airlight].Name), 3000);
                        return;
                    case 93:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Camera1, 1,
                                "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouGotItem,
                                Repository.ItemsInfo[ItemId.Camera1].Name), 3000);
                        return;
                    case 94:
                        if (Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Camera2, 1,
                                "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoSpaceInventory), 3000);
            ...
            {
                Log.Write($"callback_policeGuns Exception: {e}");
            }
        }
        ...
        public static void giveGun(ExtPlayer player, WeaponRepository.Hash gun, string weaponstr)
        {
            try
            {
                ...
                var fractionData = GetFractionData(memberFractionData.Id);
                if (fractionData == null)
                    return;

                if (player.HasData($"GET_{gun.ToString()}") &&
                    DateTime.Now < player.GetData<DateTime>($"GET_{gun.ToString()}"))
                {
                    var date = player.GetData<DateTime>($"GET_{gun.ToString()}");
                    var ticks = date.Ticks - DateTime.Now.Ticks;
                    if (ticks <= 0) return;
                    var g = new DateTime(ticks);
                    if (g.Hour >= 1)
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouCanTakeGun1h, gun.ToString(), g.Hour, g.Minute,
                                g.Second), 5000);
                    else
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.YouCanTakeGun, gun.ToString(), g.Minute, g.Second),
                            5000);
                    return;
                }

                var frac = memberFractionData.Id;
                if (!Configs.FractionWeapons[frac].ContainsKey(weaponstr))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.ErrorDostupWeapon), 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NoDostupWeapon), 3000);
                    return;
                }
                ...
                var wType = (ItemId)Enum.Parse(typeof(ItemId), gun.ToString());
                var serial = WeaponRepository.GetSerial(true, memberFractionData.Id);
                if (WeaponRepository.GiveWeapon(player, wType, serial) == -1) return;

                fractionData.Materials -= matsForGun[gun];
                fractionData.UpdateLabel();
                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats,
                    LangFunc.GetText(LangType.Ru, DataName.YouVzyalItem, gun.ToString(), serial));
                var minutes = 5;
                if (memberFractionData.Id == (int)Models.Fractions.POLICE ||
                    memberFractionData.Id == (int)Models.Fractions.SHERIFF) minutes = 10;
                player.SetData($"GET_{gun.ToString()}", DateTime.Now.AddMinutes(minutes));

                GameLog.Stock(memberFractionData.Id, player.GetUUID(), player.Name, $"{gun.ToString()}({serial})", 1,
                    "out");
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.YouGotItem, wType.ToString()), 3000);

                if (memberFractionData.Id == (int)Models.Fractions.POLICE ||
                    memberFractionData.Id == (int)Models.Fractions.SHERIFF ||
                    memberFractionData.Id == (int)Models.Fractions.CITY ||
                    memberFractionData.Id == (int)Models.Fractions.ARMY ||
                    memberFractionData.Id == (int)Models.Fractions.FIB)
                    sendFractionMessage(memberFractionData.Id,
                        LangFunc.GetText(LangType.Ru, DataName.FTakeGun, player.Name, player.Value, gun.ToString(),
                            serial), true);
            }
            catch (Exception e)
            {
                Log.Write($"giveGun Exception: {e}");
            }
        }
        ...
        public static void giveAmmo(ExtPlayer player, ItemId ammoType, int ammo)
        {
            try
            {
                ...
                if (Repository.isFreeSlots(player, ammoType, ammo) != 0) return;
                Repository.AddNewItem(player, $"char_{player.GetUUID()}", "inventory", ammoType, ammo);
                fractionData.Materials -= MatsForAmmoType[ammoType] * ammo;
                fractionData.UpdateLabel();
                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats,
                    LangFunc.GetText(LangType.Ru, DataName.YouVzyalItem, Repository.ItemsInfo[ammoType].Name, ammo));
                GameLog.Stock(memberFractionData.Id, player.GetUUID(), player.Name, ammoType.ToString(), 1, "out");
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.YouGotItem, Repository.ItemsInfo[ammoType].Name, ammo),
                    3000);
                ...
                if (memberFractionData.Id == (int)Models.Fractions.POLICE ||
                    ...
                    memberFractionData.Id == (int)Models.Fractions.FIB)
                    sendFractionMessage(memberFractionData.Id,
                        LangFunc.GetText(LangType.Ru, DataName.FTakeAmmo, player.Name, player.Value,
                            Repository.ItemsInfo[ammoType].Name, ammo), true);
            }
            catch (Exception e)
            {
                Log.Write($"giveAmmo Exception: {e}");
            }
        }
        ...
        public static void TakeFractionAmmo(ExtPlayer player, int ammo)
        {
            try
            {
                ...
                if (ammo >= 1)
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.IncrorectInput), 3000);
            }
            catch (Exception e)
            {
                Log.Write($"enterInterier Exception: {e}");
            }
        }
            ...
            try
            {
                ...
                if (FractionTypes[fracId] == FractionsType.None || FractionTypes[fracId] == FractionsType.Gov)
                {
                    if (FractionTypes[fracId] == FractionsType.None)
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.CantCraftWeapon), 3000);
                            return;
                        }
                    }
                    else
                ...
                else if (FractionTypes[fracId] == FractionsType.Bikers)
                {
                    list = bikersGuns.ToList();
                }
                else if (FractionTypes[fracId] == FractionsType.Nongov)
                {
                    list = nongovGuns.ToList();
                }
                else if (FractionTypes[fracId] == FractionsType.Gangs)
                {
                    list = gangGuns.ToList();
                }
                else if (FractionTypes[fracId] == FractionsType.Mafia)
                {
                    list = mafiaGuns.ToList();
                }


                var _WeaponsData = new List<List<CraftData>>();
                for (var i = 0; i < list.Count; i++)
                {
                    var _CraftsData = new List<CraftData>();
                    foreach (var g in list[i])
                    {
                        var wType = (ItemId)Enum.Parse(typeof(ItemId), g);
                        if (Repository.ItemsInfo.ContainsKey(wType))
                            _CraftsData.Add(new CraftData(Repository.ItemsInfo[wType].Name,
                                Repository.ItemsInfo[wType].Icon, matsForGun[WeaponRepository.GetHash(g)]));
                    }

                    _WeaponsData.Add(_CraftsData);
                }

                var _AmmoData = new List<int>();
                foreach (var ammo in MatsForAmmoType.Values) _AmmoData.Add(ammo);
                Trigger.ClientEvent(player, "client.fraction.craft.open", fracId,
                    JsonConvert.SerializeObject(_WeaponsData), JsonConvert.SerializeObject(_AmmoData));
            }
            catch (Exception e)
            {
                Log.Write($"OpenGunCraftMenu Exception: {e}");
            }
        }
        ...
        public static void Event_WCraft(ExtPlayer player, int frac, int cat, int index)
        {
            try
            {
                ...
                if (FractionTypes[frac] == FractionsType.None || FractionTypes[frac] == FractionsType.Gov)
                {
                    if (FractionTypes[frac] == FractionsType.None)
                    {
                        ...
                        if (organizationData != null)
                        {
                            org = true;
                            list = organizationsGuns.ToList();
                            var familySelected = list[cat][index];
                            if (!organizationData.Schemes.ContainsKey(familySelected) ||
                                !organizationData.Schemes[familySelected])
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.FamilyDoesntSel, familySelected), 3000);
                                return;
                            }
                        }
                        else
                ...
                else if (FractionTypes[frac] == FractionsType.Gangs)
                {
                    list = gangGuns.ToList();
                }
                else if (FractionTypes[frac] == FractionsType.Mafia)
                {
                    list = mafiaGuns.ToList();
                }
                else if (FractionTypes[frac] == FractionsType.Nongov)
                {
                    list = nongovGuns.ToList();
                }
                else if (FractionTypes[frac] == FractionsType.Bikers)
                {
                    list = bikersGuns.ToList();
                }

                if (list.Count < 1 || list.Count < cat + 1 || list[cat].Count < index + 1) return;
                var mItem = Repository.isItem(player, "inventory", ItemId.Material);
                var count = mItem == null ? 0 : mItem.Item.Count;
                var selected = list[cat][index];
                if (frac == (int)Models.Fractions.MERRYWEATHER)
                    switch (selected)
                    {
                        ...
                        case "CombatPistol":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    $"Крафт {selected} для MerryWeather доступен со 2 ранга.", 3000);
                                return;
                            }
                        ...
                        case "Pistol50":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    $"Крафт {selected} для MerryWeather доступен со 3 ранга.", 3000);
                                return;
                            }
                        ...
                        case "SawnOffShotgun":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    $"Крафт {selected} для MerryWeather доступен с 4 ранга.", 3000);
                                return;
                            }
                        ...
                        case "SMGMk2":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    $"Крафт {selected} для MerryWeather доступен с 5 ранга.", 3000);
                                return;
                            }
                        ...
                        case "CarbineRifleMk2":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    $"Крафт {selected} для MerryWeather доступен с 6 ранга.", 3000);
                                return;
                            }
                        ...
                        case "BullpupRifle":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    $"Крафт {selected} для MerryWeather доступен с 8 ранга.", 3000);
                                return;
                            }
                        ...
                        default:
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.CraftError), 3000);
                            return;
                    }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NoMats), 3000);
                    return;
                }

                var wType = (ItemId)Enum.Parse(typeof(ItemId), selected);
                if (WeaponRepository.GiveWeapon(player, wType, WeaponRepository.GetSerial(true, frac, org)) ==
                    -1) return;
                Repository.RemoveIndex(player, mItem.Location, mItem.Index,
                    matsForGun[WeaponRepository.GetHash(selected)]);
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    $"Вы скрафтили {selected} за {matsForGun[WeaponRepository.GetHash(selected)]} матов", 3000);
            }
            catch (Exception e)
            {
                Log.Write($"Event_WCraft Exception: {e}");
            }
        }
        ...
        public static void Event_WCraftAmmo(ExtPlayer player, int frac, int category, int ammo)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.CraftMW2lvl), 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NoInputAmmos), 3000);
                    return;
                }

                var mItem = Repository.isItem(player, "inventory", ItemId.Material);
                var matsCount = mItem == null ? 0 : mItem.Item.Count;
                ...
                if (Repository.isFreeSlots(player, AmmoTypes[category], ammo) != 0) return;
                Repository.RemoveIndex(player, mItem.Location, mItem.Index, MatsForAmmo[category] * ammo);
                Repository.AddNewItem(player, $"char_{player.GetUUID()}", "inventory", AmmoTypes[category], ammo);
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Вы успешно скрафтили {Repository.ItemsInfo[AmmoTypes[category]].Name} x{ammo}", 3000);
            }
            catch (Exception e)
            {
                Log.Write($"Event_WCraftAmmo Exception: {e}");
            }
        }

        private static readonly Dictionary<ItemId, int> MatsForAmmoType = new Dictionary<ItemId, int>
        {
            { ItemId.PistolAmmo, 1 },
        ...
        private static readonly int[] MatsForAmmo = new int[5]
        {
            1, // pistol
            2, // shotgun
            1, // smg
        ...
        private static readonly ItemId[] AmmoTypes = new ItemId[5]
        {
            ItemId.PistolAmmo,
            ItemId.ShotgunsAmmo,
            ItemId.SMGAmmo,
    ...
    internal class Stocks : Script
    {
        ...
        public static void inputStocks(ExtPlayer player, int where, string action, int amount)
        {
            try
            {
                ...
                if (where == 0)
                {
                    ...
                    {
                        case "put_stock":
                            var item = sessionData.SelectData.SelectedStock; //
                            var stockContains = 0;
                            var playerHave = 0;
                            if (item == "mats")
                            {
                                stockContains = fractionData.Materials;
                                var maxstock = GetMaxStock(fractionData.Id);
                                if (stockContains + amount > maxstock)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.WarehouseTooMuch), 3000);
                                    return;
                                }

                                //ItemStruct mItem = Chars.Repository.isItem(player, "inventory", ItemId.Material);
                                //playerHave = (mItem == null) ? 0 : mItem.Item.Count;
                                playerHave = Repository.getCountToLacationItem($"char_{characterData.UUID}",
                                    "inventory", ItemId.Material);
                            }
                            else if (item == "drugs")
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.NarkoWarehouseTooMuch), 3000);
                                    return;
                                }
                            ...
                            else if (item == "medkits")
                            {
                                ...
                                playerHave = Repository.getCountToLacationItem($"char_{characterData.UUID}",
                                    "inventory", ItemId.HealthKit);
                            }

                            if (playerHave < amount)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.NoCoins), 3000);
                                return;
                            }
                            ...
                            if (item == "mats")
                            {
                                ...
                                Repository.Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.Material,
                                    amount);
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats,
                                    LangFunc.GetText(LangType.Ru, DataName.TakenMats, amount));
                                Manager.sendFractionMessage(fractionData.Id,
                                    LangFunc.GetText(LangType.Ru, DataName.FGetMats, player.Name, player.Value, amount),
                                    true);
                            }
                            else if (item == "drugs")
                            {
                                fractionData.Drugs += amount;
                                Repository.Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.Drugs,
                                    amount);
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeDrugs,
                                    LangFunc.GetText(LangType.Ru, DataName.TakenDrugs, amount));
                                Manager.sendFractionMessage(fractionData.Id,
                                    LangFunc.GetText(LangType.Ru, DataName.FGetDurgs, player.Name, player.Value,
                                        amount), true);
                            }
                            else if (item == "money")
                            {
                                ...
                                GameLog.Money($"player({characterData.UUID})", $"frac({fractionData.Id})", amount,
                                    "putStock");
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMoney,
                                    LangFunc.GetText(LangType.Ru, DataName.TakenMoney, Wallet.Format(amount)));
                                Manager.sendFractionMessage(fractionData.Id,
                                    LangFunc.GetText(LangType.Ru, DataName.FGetMoney, player.Name, player.Value,
                                        Wallet.Format(amount)), true);
                            }
                            else if (item == "medkits")
                            {
                                fractionData.MedKits += amount;
                                Repository.Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.HealthKit,
                                    amount);
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits,
                                    LangFunc.GetText(LangType.Ru, DataName.TakenHealthkits, amount));
                                Manager.sendFractionMessage(fractionData.Id,
                                    LangFunc.GetText(LangType.Ru, DataName.FGetHealthKits, player.Name, player.Value,
                                        amount), true);
                            }

                            GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, item, amount, "in");
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.WarehouseLeft, stockContains + amount,
                                    playerHave - amount), 3000);
                            fractionData.UpdateLabel();
                            break;
                        case "take_stock":
                            ...
                            if (item == "mats")
                            {
                                ...
                                playerHave = Repository.getCountToLacationItem($"char_{characterData.UUID}",
                                    "inventory", ItemId.Material);
                                if (playerHave + amount > Repository.ItemsInfo[ItemId.Material].Stack)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.InventoryFilled), 3000);
                                    return;
                                }
                            }
                            else if (item == "drugs")
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.WarehouseEmptyNet), 3000);
                                return;
                            }

                            if (item == "mats")
                            {
                                if (Repository.isFreeSlots(player, ItemId.Material, amount) != 0) return;
                                fractionData.Materials -= amount;
                                Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory",
                                    ItemId.Material, amount);
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats,
                                    LangFunc.GetText(LangType.Ru, DataName.TakeMats, amount));
                                Manager.sendFractionMessage(fractionData.Id,
                                    LangFunc.GetText(LangType.Ru, DataName.FTakenMats, player.Name, player.Value,
                                        amount), true);
                            }
                            else if (item == "drugs")
                            {
                                if (Repository.isFreeSlots(player, ItemId.Drugs, amount) != 0) return;
                                fractionData.Drugs -= amount;
                                Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Drugs,
                                    amount);
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeDrugs,
                                    LangFunc.GetText(LangType.Ru, DataName.TakeNarko, amount));
                                Manager.sendFractionMessage(fractionData.Id,
                                    LangFunc.GetText(LangType.Ru, DataName.FTakenDrugs, player.Name, player.Value,
                                        amount), true);
                            }
                            else if (item == "money")
                            {
                                fractionData.Money -= amount;
                                Wallet.Change(player, amount);
                                GameLog.Money($"frac({fractionData.Id})", $"player({characterData.UUID})", amount,
                                    "takeStock");
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMoney,
                                    LangFunc.GetText(LangType.Ru, DataName.TakeMoney, Wallet.Format(amount)));
                                Manager.sendFractionMessage(fractionData.Id,
                                    LangFunc.GetText(LangType.Ru, DataName.FTakenMoney, player.Name, player.Value,
                                        Wallet.Format(amount)), true);
                            }
                            else if (item == "medkits")
                            {
                                if (Repository.isFreeSlots(player, ItemId.HealthKit, amount) != 0) return;
                                fractionData.MedKits -= amount;
                                Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory",
                                    ItemId.HealthKit, amount);
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits,
                                    LangFunc.GetText(LangType.Ru, DataName.TakeHealthkits, amount));
                                Manager.sendFractionMessage(fractionData.Id,
                                    LangFunc.GetText(LangType.Ru, DataName.FTakenHealthKits, player.Name, player.Value,
                                        amount), true);
                            }
                ...
                else
                {
                    ...
                    if (vehicleLocalData != null)
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.CarCantMoving), 3000);
                            return;
                        }
                        ...
                        switch (action)
                        {
                            case "load_mats":
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.ClubNotInFraction,
                                            Manager.GetName(sessionData.OnFracStock)), 3000);
                                    return;
                                }

                                if (fractionId != (int)Models.Fractions.ARMY &&
                                    !player.IsFractionAccess(RankToAccess.TakeStock)) return;
                                if (vehicle.Model == (uint)VehicleHash.Cargobob)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.ThisVehNoMatsHere), 3000);
                                    return;
                                }
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.SkaldNoMats), 3000);
                                    return;
                                }

                                var maxMats = Stocks.maxMats.ContainsKey(vehicle.Model)
                                    ? Stocks.maxMats[vehicle.Model]
                                    : 600;
                                var curmats = Repository.getCountItem(
                                    VehicleManager.GetVehicleToInventory(vehicle.NumberPlate), ItemId.Material);
                                if (curmats + amount > maxMats)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.LimitOnlyMats, maxMats - curmats), 3000);
                                    return;
                                }

                                Repository.AddNewItem(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                    "vehicle", ItemId.Material, amount, MaxSlots: vMain.GetMaxSlots(vehicle.Model));
                                stockFractionData.Materials -= amount;
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.YouLoadedMat), 3000);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "mats", amount, "out");
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits,
                                    LangFunc.GetText(LangType.Ru, DataName.ZagruzilMatsSoSklad,
                                        Manager.GetName(fractionId), amount));
                                return;
                            case "unload_mats":
                                var count = Repository.getCountToLacationItem(
                                    VehicleManager.GetVehicleToInventory(vehicle.NumberPlate), "vehicle",
                                    ItemId.Material);
                                if (count < amount)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.InCarMats, count), 3000);
                                    return;
                                }
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.OnlyZankudo), 3000);
                                    return;
                                }

                                Repository.Remove(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                    "vehicle", ItemId.Material, amount);
                                stockFractionData.Materials += amount;
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.YouLoadedMats), 3000);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "mats", amount, "in");
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits,
                                    LangFunc.GetText(LangType.Ru, DataName.LoadedMats, Manager.GetName(fractionId),
                                        amount));
                            ...
                            case "load_drugs":
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.ErrorNarkoSklad), 3000);
                                    return;
                                }

                                count = Repository.getCountItem(
                                    VehicleManager.GetVehicleToInventory(vehicle.NumberPlate), ItemId.Drugs);
                                if (count >= vMain.GetMaxSlots(vehicle.Model) *
                                    Repository.ItemsInfo[ItemId.Drugs].Stack)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.CarMaxDrugs), 3000);
                                    return;
                                }

                                if (count + amount > vMain.GetMaxSlots(vehicle.Model) *
                                    Repository.ItemsInfo[ItemId.Drugs].Stack)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.InCarSpace,
                                            vMain.GetMaxSlots(vehicle.Model) *
                                            Repository.ItemsInfo[ItemId.Drugs].Stack - count), 3000);
                                    return;
                                }

                                Repository.AddNewItem(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                    "vehicle", ItemId.Drugs, amount, MaxSlots: vMain.GetMaxSlots(vehicle.Model));
                                stockFractionData.Drugs -= amount;
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.LoadDrugs), 3000);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "drugs", amount, "out");
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeDrugs,
                                    LangFunc.GetText(LangType.Ru, DataName.LloadedDrugs, Manager.GetName(fractionId),
                                        amount));
                                return;
                            case "unload_drugs":
                                count = Repository.getCountToLacationItem(
                                    VehicleManager.GetVehicleToInventory(vehicle.NumberPlate), "vehicle", ItemId.Drugs);
                                if (count < amount)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.VehNoDrugs), 3000);
                                    return;
                                }
                                ...
                                Repository.Remove(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                    "vehicle", ItemId.Drugs, amount);
                                stockFractionData.Drugs += amount;
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.UnloadedDrugs), 3000);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "drugs", amount, "in");
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeDrugs,
                                    LangFunc.GetText(LangType.Ru, DataName.LoadedDrugs, Manager.GetName(fractionId),
                                        amount));
                            ...
                            case "load_medkits":
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.MustWorkDay), 3000);
                                    return;
                                }
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.ErrorAptekasSklad), 3000);
                                    return;
                                }

                                if (Repository.getCountItem(VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                        ItemId.HealthKit) + amount > vMain.GetMaxSlots(vehicle.Model))
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.ErrorMedAmount), 3000);
                                    return;
                                }
                                ...
                                Repository.AddNewItem(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                    "vehicle", ItemId.HealthKit, amount, MaxSlots: vMain.GetMaxSlots(vehicle.Model));
                                fractionData.MedKits -= amount;
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.LoadAptekas), 3000);
                                fractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "medkits", amount,
                                    "out");
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits,
                                    LangFunc.GetText(LangType.Ru, DataName.LoadedAptekasFromSklad,
                                        Manager.GetName(fractionId), amount));
                                return;
                            case "unload_medkits":
                                if (!sessionData.WorkData.OnDuty)
                                ...
                                if (Repository.getCountToLacationItem(
                                        VehicleManager.GetVehicleToInventory(vehicle.NumberPlate), "vehicle",
                                        ItemId.HealthKit) < amount)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                        LangFunc.GetText(LangType.Ru, DataName.VehNoMedkits), 3000);
                                    return;
                                }
                                ...
                                if (fractionId == 8)
                                {
                                    ...
                                    {
                                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                            LangFunc.GetText(LangType.Ru, DataName.SkladNoApteka), 3000);
                                        return;
                                    }
                                }
                                else
                                ...
                                Repository.Remove(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                    "vehicle", ItemId.HealthKit, amount);
                                stockFractionData.MedKits += amount;
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.UnloadedAptekas), 3000);
                                player.AddTableScore(TableTaskId.Item22);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "medkits", amount,
                                    "in");
                                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits,
                                    LangFunc.GetText(LangType.Ru, DataName.LoadedAptekas, Manager.GetName(fractionId),
                                        amount));
                                return;
                        }
                    }
            ...
            {
                Manager.Log.Write($"inputStocks Exception: {e}");
            }
        }
        ...
        public static void OnFractionStock(ExtPlayer player, int fractionId, int list)
        {
                ...
                switch (list)
                {
                    case 1:
                        ...
                        if (vehicleLocalData != null)
                        {
                            ...
                            if (fractionData == null)
                                return;
                            if (fractionData.Id == (int)Models.Fractions.ARMY && DateTime.Now.Hour >= 0 &&
                                DateTime.Now.Hour < 10 && characterData.AdminLVL <= 6)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.SkladFullyClosed), 3000);
                                return;
                            }
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.WarehouseClosed), 3000);
                                return;
                            }
                    ...
                    case 2:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NotOnSkladPoint), 3000);
                            return;
                        }
            ...
            {
                Manager.Log.Write($"interactPressed Exception: {e}");
            }
        }
        ...
        public static async Task SaveFractions(ServerBD db)
        {
            try
            {
                foreach (var fractionId in Manager.Fractions.Keys.ToList())
                    ...
                    {
                        Manager.Log.Write($"saveStocksDic Foreach Exception: {e}");
                    }
            ...
            {
                Manager.Log.Write($"saveStocksDic Exception: {e}");
            }
        }
        ...
        public static void Event_openWeaponsStock(ExtPlayer player)
        {
            try
            {
                ...
                var fracId = player.GetFractionId();
                var memberOrganizationData = player.GetOrganizationMemberData();
                if (fracId == (int)Models.Fractions.None ||
                    (memberOrganizationData != null && sessionData.IsOrgStockActive))
                {
                ...
                else if (fracId > 0)
                {
                    ...
                    Repository.LoadOtherItemsData(player, "Fraction", fracId.ToString(), 5,
                        Repository.InventoryMaxSlots["Fraction"]);
                }
            }
            catch (Exception e)
            {
                Manager.Log.Write($"Event_openWeaponsStock Exception: {e}");
            }
        }
        ...
        public static void OpenFracGarageMenu(ExtPlayer player)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    {
                        var count =
                            Repository.getCountItem(VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                ItemId.Coal) +
                            Repository.getCountItem(VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                ItemId.Iron) +
                            Repository.getCountItem(VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                        ...
                        if (count >= 1)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    "Разгрузить ресурсы можно только на склад армии.", 3000);
                                return;
                            }
                            ...
                            for (var i = 0; i < 4; i++)
                            {
                                ...
                                {
                                    Repository.Remove(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                                        "vehicle", item_type, current_count);
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                "Вы успешно разгрузили ресурсы на склад.", 3000);

                            LoadInfo = LoadInfo.Remove(LoadInfo.Length - 2);
                            Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeOre,
                                $"Разгрузил на склад армии {LoadInfo}.");
                        }
                    }
                }
            }
            ...
            {
                Manager.Log.Write($"OpenFracGarageMenu Exception: {e}");
            }
        }
        ...
        public static void fracgarage(ExtPlayer player, string eventName, string data)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    switch (eventName)
                    {
                        case "loadmats":
                            if (!vehicleLocalData.CanMats) return;
                            if (sessionData.OnFracStock != (int)Models.Fractions.ARMY &&
                                player.GetFractionId() != sessionData.OnFracStock)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    $"Вы не состоите в {Manager.GetName(sessionData.OnFracStock)}", 3000);
                                return;
                            }
            ...
            {
                Manager.Log.Write($"fracgarage Exception: {e}");
            }
        }
        ...
        public static void OpenFracStockMenu(ExtPlayer player)
        {
            try
            {
                ...
                var counter = new List<string>
                {
                    ...
                    Repository.getCountToStockItems($"Fraction_{fractionData.Id}")
                };
            ...
            {
                Manager.Log.Write($"OpenFracStockMenu Exception: {e}");
            }
        }
    ...
    internal class MatsWar : Script
    {
        public static bool isWar;
        public static int matsLeft = 36000;
        private static ExtMarker warMarker;
        private static readonly Vector3 warPosition = new Vector3(-326.3168, -2701.9377, 0.9251);
        private static ExtBlip warblip;

        public static int MatWarDropPositionIndex;
        ...
        public static string MatWarDropTimer;
        public static int MatWarDropHealth = 100;
        public static ExtPlayer MatWarDropHackPlayerInfo;
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                warblip = (ExtBlip)NAPI.Blip.CreateBlip(556, warPosition, 1, 4, Main.StringToU16("National Guard"), 255,
                    0, true, 0, 0);
            }
            catch (Exception e)
            {
                Manager.Log.Write($"onResourceStart Exception: {e}");
            }
        }
        ...
        public static void startWar()
        {
            try
            {
                ...
                matsLeft = 36000;
                warMarker = (ExtMarker)NAPI.Marker.CreateMarker(1, warPosition - new Vector3(0, 0, 5), new Vector3(),
                    new Vector3(), 6f, new Color(155, 0, 0, 255));
                isWar = true;
                Manager.sendFractionMessage((int)Models.Fractions.FAMILY,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int)Models.Fractions.BALLAS,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int)Models.Fractions.VAGOS,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int)Models.Fractions.MARABUNTA,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int)Models.Fractions.BLOOD,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int)Models.Fractions.LCN,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int)Models.Fractions.RUSSIAN,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int)Models.Fractions.YAKUZA,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int)Models.Fractions.THELOST,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int)Models.Fractions.MERRYWEATHER,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGoing));

                //

                Repository.RemoveAll("matwar_100");

                MatWarDropHealth = 100;
                MatWarDropPositionIndex = new Random().Next(0, MatWarDropsPositions.Count);

                Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.BodyArmor, 30, "100", true, 100);
                Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.Revolver, 15,
                    WeaponRepository.GetMatwarSerial(), true, 100);
                Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.AssaultSMG, 10,
                    WeaponRepository.GetMatwarSerial(), true, 100);
                Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.HeavyShotgun, 3,
                    WeaponRepository.GetMatwarSerial(), true, 100);
                Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.MilitaryRifle, 5,
                    WeaponRepository.GetMatwarSerial(), true, 100);
                Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.SMGMk2, 10,
                    WeaponRepository.GetMatwarSerial(), true, 100);
                Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.CombatMG, 2,
                    WeaponRepository.GetMatwarSerial(), true, 100);
                Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.HeavySniper, 1,
                    WeaponRepository.GetMatwarSerial(), true, 100);

                var item_chance = new Random().Next(1, 26);
                if (item_chance >= 20)
                {
                    Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.NavyRevolver, 2,
                        WeaponRepository.GetMatwarSerial(), true, 100);
                    Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.MG, 2,
                        WeaponRepository.GetMatwarSerial(), true, 100);
                }
                else if (item_chance > 10 && item_chance < 20)
                {
                    Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.CombatMGMk2, 1,
                        WeaponRepository.GetMatwarSerial(), true, 100);
                    Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.MarksmanRifle, 3,
                        WeaponRepository.GetMatwarSerial(), true, 100);
                }
                else if (item_chance > 1 && item_chance < 10)
                {
                    Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.MarksmanRifleMk2, 1,
                        WeaponRepository.GetMatwarSerial(), true, 100);
                }
                else if (item_chance == 1)
                {
                    Repository.AddNewItem(null, "matwar_100", "matwar", ItemId.CarCoupon, 1, "Ferrari488");
                }

                if (MatWarDropTimer != null) Timers.Stop(MatWarDropTimer);
                MatWarDropTimer =
                    Timers.StartOnce("MatWarDropTimer", 120000, () => MatWarDropEvent(), true); //change to 120000
            ...
            {
                Manager.Log.Write($"startWar Exception: {e}");
            }
        }
        ...
        public static void endWar()
        {
            try
            {
                NAPI.Task.Run(() =>
                {
                    ...
                    {
                        Manager.Log.Write($"endWar Task Exception: {e}");
                    }
                });
                ...
                Manager.sendFractionMessage((int)Models.Fractions.FAMILY,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGone));
                Manager.sendFractionMessage((int)Models.Fractions.BALLAS,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGone));
                Manager.sendFractionMessage((int)Models.Fractions.VAGOS,
                    LangFunc.GetText(LangType.Ru, DataName.WzmShipGone));
                ...
                foreach (var foreachPlayer in Character.Repository.GetPlayers())
                    ...
                    {
                        Manager.Log.Write($"endWar Players-foreach Exception: {e}");
                    }
            }
            catch (Exception e)
            {
                Manager.Log.Write($"endWar Exception: {e}");
            }
        }
        ...
        public static void MatWarDropEvent()
        {
            try
            {
                foreach (var foreachPlayer in Character.Repository.GetPlayers())
                    ...
                    {
                        if (!foreachPlayer.IsCharacterData()) return;
                        Trigger.ClientEvent(foreachPlayer, "client.matwar.fight.create", 100, 0,
                            MatWarDropsPositions[MatWarDropPositionIndex], 2);
                    }
                    catch (Exception e)
                    {
                        Manager.Log.Write($"MatWarDropEvent Players-foreach Exception: {e}");
                    }
            }
            catch (Exception e)
            {
                Manager.Log.Write($"MatWarDropEvent Exception: {e}");
            }
        }
        ...
        public static void CheckMatWarDropLockStatus(ExtPlayer player, int ShapeId)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.PressEtoLockPick), 3000);
            ...
            {
                Manager.Log.Write($"CheckMatWarDropLockStatus Exception: {e}");
            }
        }
        ...
        public static void StartedMatWarHack(ExtPlayer player, int ShapeId)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.RestrictedForAdmin), 3000);
                    return;
                }

                var armylockpick = Repository.isItem(player, "inventory", ItemId.ArmyLockpick);
                var count = armylockpick == null ? 0 : armylockpick.Item.Count;

                if (count == 0)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NoArmyLockpick), 3000);
                    return;
                }
                ...
                if (ShapeId == 100)
                {
                    if (MatWarDropHealth > 0)
                    {
                        if (MatWarDropHackPlayerInfo != null)
                        {
                            ...
                            if (targetSessionData == null || !targetSessionData.IsAirDropHacking)
                            {
                                MatWarDropHackPlayerInfo = null;
                            }
                            else if (MatWarDropsPositions[MatWarDropPositionIndex]
                                         .DistanceTo(MatWarDropHackPlayerInfo.Position) > 3)
                            {
                                MatWarDropHackPlayerInfo = null;
                            }
                            else
                            {
                                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                    LangFunc.GetText(LangType.Ru, DataName.SomebodyHacking), 3000);
                                return;
                            }
                        }
                    ...
                    {
                        Trigger.ClientEvent(player, "client.updateMatWarHackStatus", false, 0);
                        Repository.LoadOtherItemsData(player, "matwar", ShapeId.ToString(), 10);
                    }
                }
            }
            catch (Exception e)
            {
                Manager.Log.Write($"StartedMatWarHack Exception: {e}");
            }
        }
                ...
                if (ShapeId == 100)
                {
                    ...
                    if (MatWarDropHealth <= 0)
                    {
                        ...
                        if (hack_chance <= 50)
                        {
                            ...
                            ParticleFx.PlayFXonPos(position, 500f, position.X, position.Y, position.Z,
                                "scr_indep_fireworks", "scr_indep_firework_shotburst", 5000);
                        ...
                        var count = armylockpick == null ? 0 : armylockpick.Item.Count;
                        if (count > 0)
                            Repository.Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.ArmyLockpick);
                    }
                }
            }
            catch (Exception e)
            {
                Manager.Log.Write($"MatWarDropChangeLockStatus Exception: {e}");
            }
        }
        ...
        public static void OpenMatWarInventory(ExtPlayer player, int ShapeId)
        {
            ...
            {
                Manager.Log.Write($"OpenMatWarInventory Exception: {e}");
            }
        }
        ...
        public static void OnWar(ExtPlayer player)
        {
            try
            {
                ...
                if (!((fracId >= (int)Models.Fractions.FAMILY && fracId <= (int)Models.Fractions.BLOOD) ||
                      (fracId >= (int)Models.Fractions.LCN && fracId <= (int)Models.Fractions.ARMENIAN) ||
                      (fracId >= (int)Models.Fractions.THELOST && fracId <= (int)Models.Fractions.MERRYWEATHER)))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.YouCantMatsWar), 3000);
                    return;
                }
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.CantMoveMatsVeh), 3000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.LoadingMatsvehUzhe), 3000);
                        return;
                    }

                    if (Repository.getCountItem(VehicleManager.GetVehicleToInventory(vehicle.NumberPlate),
                            ItemId.Material) >= Stocks.maxMats[player.Vehicle.Model])
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.CarMaxMats), 3000);
                        return;
                    }

                    sessionData.TimersData.LoadMatsTimer =
                        Timers.StartOnce(20000, () => Army.loadMaterialsTimer(player), true);
                    vehicleLocalData.LoaderMats = player;
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.LoadingMatsStarted), 3000);
            ...
            {
                Manager.Log.Write($"OnWar Exception: {e}");
            }
        }
        ...
        public static void OutWar(ExtPlayer player)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    var target = vehicleLocalData.LoaderMats;
                    if (!target.IsCharacterData()) return;
                    var targetSessionData = target.GetSessionData();
                    if (targetSessionData.TimersData.LoadMatsTimer != null)
                        Timers.Stop(targetSessionData.TimersData.LoadMatsTimer);
                    ...
                    Notify.Send(target, NotifyType.Warning, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MatLoadingCancelByCheckpoint), 3000);
                }
            }
            catch (Exception e)
            {
                Manager.Log.Write($"OutWar Exception: {e}");
            }
        }
    }
}