...
namespace NeptuneEvo.Fractions.Models
{
    ...
    {
        public GarageData(int FractionId, Vector3 PlayerEnterPos, Vector3 PlayerEnterRot, Vector3 PlayerExitPos,
            Vector3 PlayerExitRot, Vector3 VehEnterPosPoint, Vector3 VehEnterPos, Vector3 VehEnterRot,
            Vector3 VehExitPosPoint, Vector3 VehExitPos, Vector3 VehExitRot, int DefaultDimension = 1750)
        {
