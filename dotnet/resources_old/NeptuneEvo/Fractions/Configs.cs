...
namespace NeptuneEvo.Fractions
{
    internal class Configs : Script
    {
        ...
        public static Dictionary<int, Dictionary<ExtVehicle, string>> FractionDrones =
            new Dictionary<int, Dictionary<ExtVehicle, string>>();


        public static Dictionary<int, Dictionary<string, int>> FractionWeapons =
        ...
        public static void InitFractionDefaultAccessRanks()
        {
            ...
            {
                RankToAccess.Follow, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.OpenStock,
                RankToAccess.StealGuns, RankToAccess.Pocket, RankToAccess.Capture, RankToAccess.CaptureJoin,
                RankToAccess.Cuff, RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank,
                RankToAccess.TakeStock, RankToAccess.TakeMats, RankToAccess.TakeDrugs, RankToAccess.TakeMoney,
                RankToAccess.BuyDrugs, RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock,
                RankToAccess.SetVehicleRank, RankToAccess.DoorControl, RankToAccess.TableWall,
                RankToAccess.EditAllTabletWall, RankToAccess.Logs, RankToAccess.Reprimand,
                RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment
            };

            fractionData.RanksDefaultAccess.Add(1,
                new List<RankToAccess>
                    { RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.CaptureJoin });
            fractionData.RanksDefaultAccess.Add(2,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.CaptureJoin
                });
            fractionData.RanksDefaultAccess.Add(3,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.CaptureJoin
                });
            fractionData.RanksDefaultAccess.Add(4,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.StealGuns, RankToAccess.CaptureJoin
                });
            fractionData.RanksDefaultAccess.Add(5,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.StealGuns, RankToAccess.CaptureJoin
                });
            fractionData.RanksDefaultAccess.Add(6,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.StealGuns, RankToAccess.CaptureJoin
                });
            fractionData.RanksDefaultAccess.Add(7,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.StealGuns, RankToAccess.Capture, RankToAccess.CaptureJoin
                });
            fractionData.RanksDefaultAccess.Add(8,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.StealGuns, RankToAccess.Capture, RankToAccess.CaptureJoin, RankToAccess.TakeStock,
                    RankToAccess.TakeMats, RankToAccess.TakeDrugs, RankToAccess.TakeMedkits,
                    RankToAccess.OpenWeaponStock
                });
            fractionData.RanksDefaultAccess.Add(9,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.StealGuns, RankToAccess.Capture, RankToAccess.CaptureJoin, RankToAccess.TakeStock,
            ...
            fractionData.RanksDefaultAccess.Add(10,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.Pocket, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.StealGuns, RankToAccess.Capture, RankToAccess.CaptureJoin, RankToAccess.TakeStock,
                    RankToAccess.TakeMats, RankToAccess.TakeDrugs, RankToAccess.TakeMedkits,
                    RankToAccess.OpenWeaponStock, RankToAccess.Invite, RankToAccess.UnInvite
                });
            ...
            fractionData.DefaultAccess = new List<RankToAccess>
            {
                RankToAccess.OpenStock, RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank,
                RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Gov,
                RankToAccess.Dep, RankToAccess.OpenWeaponStock, RankToAccess.SetVehicleRank, RankToAccess.DoorControl,
                RankToAccess.TableWall, RankToAccess.EditAllTabletWall, RankToAccess.Logs, RankToAccess.Reprimand,
                RankToAccess.Dron, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment, RankToAccess.ClothesEdit,
                RankToAccess.OpenGunStock
            };
            ...
            fractionData.RanksDefaultAccess.Add(4,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff,
                    RankToAccess.Follow
                });
            fractionData.RanksDefaultAccess.Add(5,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow
                });
            fractionData.RanksDefaultAccess.Add(6,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(7,
                ...
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep
                });
            fractionData.RanksDefaultAccess.Add(8,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(9,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
                    RankToAccess.Invite, RankToAccess.UnInvite
                });
            fractionData.RanksDefaultAccess.Add(10,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(11,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
            ...
            fractionData.RanksDefaultAccess.Add(12,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
                    RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.Gov
                });
            fractionData.RanksDefaultAccess.Add(13,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
                    RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.Gov, RankToAccess.SetRank
                });
            fractionData.RanksDefaultAccess.Add(14,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
            ...
            fractionData.RanksDefaultAccess.Add(15,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
            ...
            fractionData.RanksDefaultAccess.Add(16,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
            ...
            fractionData.RanksDefaultAccess.Add(17,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
            ...
            fractionData.RanksDefaultAccess.Add(18,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
            ...
            fractionData.RanksDefaultAccess.Add(19,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
            ...
            fractionData.RanksDefaultAccess.Add(20,
                new List<RankToAccess>
                {
                    RankToAccess.OpenWeaponStock, RankToAccess.Su, RankToAccess.TakeGunLic, RankToAccess.Ticket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Dep,
                    RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.Gov, RankToAccess.SetRank,
                    RankToAccess.OpenStock
                });
            ...
            fractionData.DefaultAccess = new List<RankToAccess>
            {
                ...
                RankToAccess.Reprimand, RankToAccess.Dron, RankToAccess.VehicleTicket,
                RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment, RankToAccess.ClothesEdit,
                RankToAccess.OpenGunStock
            };
            ...
            fractionData.RanksDefaultAccess.Add(3,
                new List<RankToAccess>
                {
                    RankToAccess.Arrest, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Su,
                    RankToAccess.Follow, RankToAccess.TakeGunLic, RankToAccess.Ticket
                });
            fractionData.RanksDefaultAccess.Add(4,
                new List<RankToAccess>
                {
                    RankToAccess.Arrest, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Su,
                    RankToAccess.Follow, RankToAccess.TakeGunLic, RankToAccess.Ticket, RankToAccess.OpenWeaponStock
                });
            fractionData.RanksDefaultAccess.Add(5,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(10,
                new List<RankToAccess>
                {
                    RankToAccess.Arrest, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Su,
                    RankToAccess.Follow, RankToAccess.TakeGunLic, RankToAccess.Ticket, RankToAccess.OpenWeaponStock,
                    RankToAccess.TakeGuns, RankToAccess.Rfp
                });
            fractionData.RanksDefaultAccess.Add(11,
                new List<RankToAccess>
                {
                    RankToAccess.Arrest, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Su,
                    RankToAccess.Follow, RankToAccess.TakeGunLic, RankToAccess.Ticket, RankToAccess.OpenWeaponStock,
                    RankToAccess.TakeGuns, RankToAccess.Rfp, RankToAccess.TakeHelLic, RankToAccess.TakePlaneLic,
                    RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.Warg,
                    RankToAccess.Dep, RankToAccess.GiveGunLic
                });
            fractionData.RanksDefaultAccess.Add(12,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(13,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.TakeGuns, RankToAccess.Rfp, RankToAccess.TakeHelLic, RankToAccess.TakePlaneLic,
                    RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.Warg,
                    RankToAccess.Dep, RankToAccess.GiveGunLic, RankToAccess.Gov
                });
            fractionData.RanksDefaultAccess.Add(14,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.TakeGuns, RankToAccess.Rfp, RankToAccess.TakeHelLic, RankToAccess.TakePlaneLic,
                    RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.Warg,
                    RankToAccess.Dep, RankToAccess.GiveGunLic, RankToAccess.Gov, RankToAccess.OpenStock
                });
            fractionData.RanksDefaultAccess.Add(15,
                new List<RankToAccess>
                {
            ...
            fractionData.DefaultAccess = new List<RankToAccess>
            {
                RankToAccess.OpenStock, RankToAccess.GiveMedLic, RankToAccess.GivePmLic, RankToAccess.Ems,
                RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.Heal,
                RankToAccess.Medkit, RankToAccess.Gov, RankToAccess.Dep, RankToAccess.SetVehicleRank,
                RankToAccess.DoorControl, RankToAccess.TableWall, RankToAccess.EditAllTabletWall, RankToAccess.Logs,
                RankToAccess.Reprimand, RankToAccess.Dron, RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment,
                RankToAccess.ClothesEdit
            };
            ...
            fractionData.RanksDefaultAccess.Add(4,
                new List<RankToAccess> { RankToAccess.Heal, RankToAccess.Ems, RankToAccess.Medkit });
            fractionData.RanksDefaultAccess.Add(5,
                new List<RankToAccess>
                    { RankToAccess.Heal, RankToAccess.Ems, RankToAccess.Medkit, RankToAccess.GiveMedLic });
            fractionData.RanksDefaultAccess.Add(6,
                new List<RankToAccess>
                    { RankToAccess.Heal, RankToAccess.Ems, RankToAccess.Medkit, RankToAccess.GiveMedLic });
            fractionData.RanksDefaultAccess.Add(7,
            ...
            fractionData.RanksDefaultAccess.Add(9,
                new List<RankToAccess>
                {
                    RankToAccess.Heal, RankToAccess.Ems, RankToAccess.Medkit, RankToAccess.GiveMedLic, RankToAccess.Dep
                });
            fractionData.RanksDefaultAccess.Add(10,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(12,
                ...
                {
                    RankToAccess.Heal, RankToAccess.Ems, RankToAccess.Medkit, RankToAccess.GiveMedLic, RankToAccess.Dep,
                    RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.Gov
                });
            fractionData.RanksDefaultAccess.Add(13,
                new List<RankToAccess>
                {
                    RankToAccess.Heal, RankToAccess.Ems, RankToAccess.Medkit, RankToAccess.GiveMedLic, RankToAccess.Dep,
                    RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.Gov,
                    RankToAccess.OpenStock, RankToAccess.GivePmLic
                });
            fractionData.RanksDefaultAccess.Add(14,
                new List<RankToAccess>
                {
            ...
            {
                RankToAccess.TakeHelLic, RankToAccess.TakePlaneLic, RankToAccess.OpenStock, RankToAccess.Invite,
                RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.Cuff, RankToAccess.Su, RankToAccess.Follow,
                RankToAccess.Arrest, RankToAccess.Rfp, RankToAccess.Warg, RankToAccess.TakeGuns, RankToAccess.InCar,
                RankToAccess.Pull, RankToAccess.Gov, RankToAccess.Dep, RankToAccess.TakeGunLic, RankToAccess.GiveGunLic,
                RankToAccess.OpenWeaponStock, RankToAccess.SetVehicleRank, RankToAccess.DoorControl,
                RankToAccess.TableWall, RankToAccess.EditAllTabletWall, RankToAccess.Logs, RankToAccess.Reprimand,
                RankToAccess.Dron, RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment,
                RankToAccess.ClothesEdit, RankToAccess.OpenGunStock
            };

            fractionData.RanksDefaultAccess.Add(1,
                new List<RankToAccess> { RankToAccess.Follow, RankToAccess.TakeGuns });
            fractionData.RanksDefaultAccess.Add(2,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.TakeGuns, RankToAccess.Cuff, RankToAccess.Su, RankToAccess.Arrest,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.TakeGunLic
                });
            fractionData.RanksDefaultAccess.Add(3,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.TakeGuns, RankToAccess.Cuff, RankToAccess.Su, RankToAccess.Arrest,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.TakeGunLic, RankToAccess.OpenWeaponStock
                });
            fractionData.RanksDefaultAccess.Add(4,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(8,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.TakeGuns, RankToAccess.Cuff, RankToAccess.Su, RankToAccess.Arrest,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.TakeGunLic, RankToAccess.OpenWeaponStock,
                    RankToAccess.Dep, RankToAccess.Rfp, RankToAccess.GiveGunLic
                });
            fractionData.RanksDefaultAccess.Add(9,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(10,
                new List<RankToAccess>
                {
                    RankToAccess.Follow, RankToAccess.TakeGuns, RankToAccess.Cuff, RankToAccess.Su, RankToAccess.Arrest,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.TakeGunLic, RankToAccess.OpenWeaponStock,
                    RankToAccess.Dep, RankToAccess.Rfp, RankToAccess.GiveGunLic, RankToAccess.TakeHelLic,
                    RankToAccess.TakePlaneLic
                });
            fractionData.RanksDefaultAccess.Add(11,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.TakeGunLic, RankToAccess.OpenWeaponStock,
                    RankToAccess.Dep, RankToAccess.Rfp, RankToAccess.GiveGunLic, RankToAccess.TakeHelLic,
                    RankToAccess.TakePlaneLic, RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.Warg
                });
            fractionData.RanksDefaultAccess.Add(12,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(13,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.Dep, RankToAccess.Rfp, RankToAccess.GiveGunLic, RankToAccess.TakeHelLic,
                    RankToAccess.TakePlaneLic, RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.Warg,
                    RankToAccess.SetRank, RankToAccess.OpenStock
                });
            fractionData.RanksDefaultAccess.Add(14,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.Dep, RankToAccess.Rfp, RankToAccess.GiveGunLic, RankToAccess.TakeHelLic,
                    RankToAccess.TakePlaneLic, RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.Warg,
                    RankToAccess.SetRank, RankToAccess.OpenStock, RankToAccess.Gov
                });
            fractionData.RanksDefaultAccess.Add(15,
                new List<RankToAccess>
                {
            ...
            fractionData.DefaultAccess = new List<RankToAccess>
            {
                RankToAccess.InCar, RankToAccess.Pull, RankToAccess.StealGuns, RankToAccess.OpenStock,
                RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.BizWar,
                RankToAccess.BizwarJoin, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.TakeStock,
                RankToAccess.TakeMats, RankToAccess.TakeDrugs, RankToAccess.TakeMoney, RankToAccess.TakeMedkits,
                RankToAccess.Pocket, RankToAccess.OpenWeaponStock, RankToAccess.SetVehicleRank,
                RankToAccess.DoorControl, RankToAccess.TableWall, RankToAccess.EditAllTabletWall, RankToAccess.Logs,
                RankToAccess.Reprimand, RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment
            };

            fractionData.RanksDefaultAccess.Add(1,
                new List<RankToAccess>
                    { RankToAccess.Cuff, RankToAccess.BizwarJoin, RankToAccess.Follow, RankToAccess.Pocket });
            fractionData.RanksDefaultAccess.Add(2,
                new List<RankToAccess>
                {
                    RankToAccess.Cuff, RankToAccess.BizwarJoin, RankToAccess.Follow, RankToAccess.Pocket,
                    RankToAccess.InCar, RankToAccess.Pull
                });
            fractionData.RanksDefaultAccess.Add(3,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(4,
                ...
                {
                    RankToAccess.Cuff, RankToAccess.BizwarJoin, RankToAccess.Follow, RankToAccess.Pocket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.StealGuns
                });
            fractionData.RanksDefaultAccess.Add(5,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(6,
                ...
                {
                    RankToAccess.Cuff, RankToAccess.BizwarJoin, RankToAccess.Follow, RankToAccess.Pocket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.StealGuns, RankToAccess.Invite
                });
            fractionData.RanksDefaultAccess.Add(7,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(8,
                new List<RankToAccess>
                {
                    RankToAccess.Cuff, RankToAccess.BizwarJoin, RankToAccess.Follow, RankToAccess.Pocket,
                    RankToAccess.InCar, RankToAccess.Pull, RankToAccess.StealGuns, RankToAccess.Invite,
                    RankToAccess.TakeDrugs, RankToAccess.OpenStock, RankToAccess.UnInvite, RankToAccess.SetRank,
                    RankToAccess.BizWar, RankToAccess.TakeStock, RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock
                });
            fractionData.RanksDefaultAccess.Add(9,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(10,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.TakeDrugs, RankToAccess.OpenStock, RankToAccess.UnInvite, RankToAccess.SetRank,
                    RankToAccess.BizWar, RankToAccess.TakeStock, RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock,
                    RankToAccess.TakeMats, RankToAccess.TakeMoney
                });
            ...
            fractionData.DefaultAccess = new List<RankToAccess>
            {
                RankToAccess.TakeGuns, RankToAccess.OpenStock, RankToAccess.Invite, RankToAccess.UnInvite,
                RankToAccess.SetRank, RankToAccess.TakeStock, RankToAccess.Gov, RankToAccess.Dep, RankToAccess.InCar,
                RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Follow, RankToAccess.Warg,
                RankToAccess.OpenWeaponStock, RankToAccess.SetVehicleRank, RankToAccess.DoorControl,
                RankToAccess.TableWall, RankToAccess.EditAllTabletWall, RankToAccess.Logs, RankToAccess.Reprimand,
                RankToAccess.Dron, RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment,
                RankToAccess.ClothesEdit, RankToAccess.OpenGunStock
            ...
            fractionData.RanksDefaultAccess.Add(2,
                new List<RankToAccess> { RankToAccess.TakeStock, RankToAccess.InCar, RankToAccess.Pull });
            fractionData.RanksDefaultAccess.Add(3,
                new List<RankToAccess>
                    { RankToAccess.TakeStock, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.OpenWeaponStock });
            fractionData.RanksDefaultAccess.Add(4,
                new List<RankToAccess>
                    { RankToAccess.TakeStock, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.OpenWeaponStock });
            fractionData.RanksDefaultAccess.Add(5,
            ...
            fractionData.RanksDefaultAccess.Add(10,
                ...
                {
                    RankToAccess.TakeStock, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.OpenWeaponStock,
                    RankToAccess.TakeGuns, RankToAccess.Dep, RankToAccess.Cuff, RankToAccess.Follow
                });
            fractionData.RanksDefaultAccess.Add(11,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(16,
                new List<RankToAccess>
                {
                    RankToAccess.TakeStock, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.OpenWeaponStock,
                    RankToAccess.TakeGuns, RankToAccess.Dep, RankToAccess.Cuff, RankToAccess.Follow,
                    RankToAccess.Invite, RankToAccess.Gov
                });
            fractionData.RanksDefaultAccess.Add(17,
                new List<RankToAccess>
                {
                    RankToAccess.TakeStock, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.OpenWeaponStock,
                    RankToAccess.TakeGuns, RankToAccess.Dep, RankToAccess.Cuff, RankToAccess.Follow,
                    RankToAccess.Invite, RankToAccess.Gov, RankToAccess.UnInvite, RankToAccess.SetRank
                });
            fractionData.RanksDefaultAccess.Add(18,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(20,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.TakeGuns, RankToAccess.Dep, RankToAccess.Cuff, RankToAccess.Follow,
                    RankToAccess.Invite, RankToAccess.Gov, RankToAccess.UnInvite, RankToAccess.SetRank,
                    RankToAccess.OpenStock, RankToAccess.Warg
                });
            fractionData.RanksDefaultAccess.Add(21,
                new List<RankToAccess>
                {
                    RankToAccess.TakeStock, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.OpenWeaponStock,
                    RankToAccess.TakeGuns, RankToAccess.Dep, RankToAccess.Cuff, RankToAccess.Follow,
            ...
            fractionData.DefaultAccess = new List<RankToAccess>
            {
                RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.Delad, RankToAccess.Gov,
                RankToAccess.Dep, RankToAccess.DoorControl, RankToAccess.SetVehicleRank, RankToAccess.TableWall,
                RankToAccess.EditAllTabletWall, RankToAccess.Logs, RankToAccess.Reprimand, RankToAccess.Ads,
                RankToAccess.Dron, RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment,
                RankToAccess.ClothesEdit, RankToAccess.StartLiveStream
            };
            ...
            fractionData.RanksDefaultAccess.Add(12,
                new List<RankToAccess> { RankToAccess.Delad, RankToAccess.Ads, RankToAccess.StartLiveStream });
            fractionData.RanksDefaultAccess.Add(13,
                new List<RankToAccess> { RankToAccess.Delad, RankToAccess.Ads, RankToAccess.StartLiveStream });
            fractionData.RanksDefaultAccess.Add(14,
                new List<RankToAccess>
                {
                    RankToAccess.Delad, RankToAccess.Invite, RankToAccess.StartLiveStream, RankToAccess.UnInvite,
                    RankToAccess.SetRank, RankToAccess.Dep, RankToAccess.Ads
                });
            fractionData.RanksDefaultAccess.Add(15,
                new List<RankToAccess>
                {
                    RankToAccess.Delad, RankToAccess.Invite, RankToAccess.StartLiveStream, RankToAccess.UnInvite,
                    RankToAccess.SetRank, RankToAccess.Dep, RankToAccess.Gov, RankToAccess.Ads
                });
            fractionData.RanksDefaultAccess.Add(16,
                new List<RankToAccess>
                {
            ...
            fractionData.DefaultAccess = new List<RankToAccess>
            {
                RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Cuff, RankToAccess.Pocket, RankToAccess.Follow,
                RankToAccess.StealGuns, RankToAccess.BuyDrugs, RankToAccess.OpenStock, RankToAccess.Invite,
                RankToAccess.UnInvite, RankToAccess.SetRank, RankToAccess.TakeStock, RankToAccess.TakeMats,
                RankToAccess.TakeDrugs, RankToAccess.TakeMoney, RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock,
                RankToAccess.SetVehicleRank, RankToAccess.DoorControl, RankToAccess.TableWall,
                RankToAccess.EditAllTabletWall, RankToAccess.Logs, RankToAccess.Reprimand,
                RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment, RankToAccess.ClothesEdit
            };
            ...
            fractionData.RanksDefaultAccess.Add(1,
                new List<RankToAccess>
                {
                    RankToAccess.Cuff, RankToAccess.Pocket, RankToAccess.Follow, RankToAccess.StealGuns,
                    RankToAccess.BuyDrugs
                });
            fractionData.RanksDefaultAccess.Add(2,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(4,
                ...
                {
                    RankToAccess.Cuff, RankToAccess.Pocket, RankToAccess.Follow, RankToAccess.StealGuns,
                    RankToAccess.BuyDrugs, RankToAccess.InCar, RankToAccess.Pull
                });
            fractionData.RanksDefaultAccess.Add(5,
                new List<RankToAccess>
                {
                    RankToAccess.Cuff, RankToAccess.Pocket, RankToAccess.Follow, RankToAccess.StealGuns,
                    RankToAccess.BuyDrugs, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.TakeStock,
                    RankToAccess.TakeMats, RankToAccess.TakeDrugs, RankToAccess.TakeMedkits
                });
            fractionData.RanksDefaultAccess.Add(6,
                new List<RankToAccess>
            ...
            fractionData.RanksDefaultAccess.Add(8,
                new List<RankToAccess>
                {
                    RankToAccess.Cuff, RankToAccess.Pocket, RankToAccess.Follow, RankToAccess.StealGuns,
                    RankToAccess.BuyDrugs, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.TakeStock,
                    RankToAccess.TakeMats, RankToAccess.TakeDrugs, RankToAccess.TakeMedkits, RankToAccess.OpenStock,
                    RankToAccess.OpenWeaponStock, RankToAccess.Invite
                });
            fractionData.RanksDefaultAccess.Add(9,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.BuyDrugs, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.TakeStock,
                    RankToAccess.TakeMats, RankToAccess.TakeDrugs, RankToAccess.TakeMedkits, RankToAccess.OpenStock,
                    RankToAccess.OpenWeaponStock, RankToAccess.Invite, RankToAccess.SetRank, RankToAccess.UnInvite
                });
            fractionData.RanksDefaultAccess.Add(10,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.TakeMats, RankToAccess.TakeDrugs, RankToAccess.TakeMedkits, RankToAccess.OpenStock,
                    RankToAccess.OpenWeaponStock, RankToAccess.Invite, RankToAccess.SetRank, RankToAccess.UnInvite,
                    RankToAccess.TakeMoney
                });

            fractionData = Manager.GetFractionData((int)Models.Fractions.MERRYWEATHER);
            fractionData.DefaultAccess = new List<RankToAccess>
            {
                RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull, RankToAccess.Pocket, RankToAccess.Follow,
                RankToAccess.OpenStock, RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.SetRank,
                RankToAccess.TakeStock, RankToAccess.TakeMats, RankToAccess.TakeDrugs, RankToAccess.TakeMoney,
                RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock, RankToAccess.Dep, RankToAccess.SetVehicleRank,
                RankToAccess.DoorControl, RankToAccess.TableWall, RankToAccess.EditAllTabletWall, RankToAccess.Logs,
                RankToAccess.Reprimand, RankToAccess.CreateDepartment, RankToAccess.DeleteDepartment,
                RankToAccess.ClothesEdit
            };
            ...
            fractionData.RanksDefaultAccess.Add(7,
                new List<RankToAccess>
                {
                    RankToAccess.TakeStock, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.Pocket, RankToAccess.Follow, RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock
                });
            fractionData.RanksDefaultAccess.Add(8,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(10,
                new List<RankToAccess>
                {
                    RankToAccess.TakeStock, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.Pocket, RankToAccess.Follow, RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock,
                    RankToAccess.SetRank, RankToAccess.Invite, RankToAccess.UnInvite
                });
            fractionData.RanksDefaultAccess.Add(11,
                new List<RankToAccess>
                {
                    RankToAccess.TakeStock, RankToAccess.Cuff, RankToAccess.InCar, RankToAccess.Pull,
                    RankToAccess.Pocket, RankToAccess.Follow, RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock,
                    RankToAccess.SetRank, RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.TakeMats,
                    RankToAccess.TakeDrugs, RankToAccess.Dep
                });
            fractionData.RanksDefaultAccess.Add(12,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(13,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.Pocket, RankToAccess.Follow, RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock,
                    RankToAccess.SetRank, RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.TakeMats,
                    RankToAccess.TakeDrugs, RankToAccess.Dep, RankToAccess.OpenStock
                });
            fractionData.RanksDefaultAccess.Add(14,
                new List<RankToAccess>
                {
            ...
            fractionData.RanksDefaultAccess.Add(15,
                new List<RankToAccess>
                {
                    ...
                    RankToAccess.Pocket, RankToAccess.Follow, RankToAccess.TakeMedkits, RankToAccess.OpenWeaponStock,
                    RankToAccess.SetRank, RankToAccess.Invite, RankToAccess.UnInvite, RankToAccess.TakeMats,
                    RankToAccess.TakeDrugs, RankToAccess.Dep, RankToAccess.OpenStock, RankToAccess.TakeMoney
                });
            ...
            fractionData.DefaultAccess = new List<RankToAccess>
            {
                ...
                RankToAccess.GiveGunLic, RankToAccess.OpenWeaponStock, RankToAccess.Ticket, RankToAccess.SetVehicleRank,
                RankToAccess.DoorControl, RankToAccess.TableWall, RankToAccess.EditAllTabletWall, RankToAccess.Logs,
                RankToAccess.Reprimand, RankToAccess.Dron, RankToAccess.VehicleTicket, RankToAccess.CreateDepartment,
                RankToAccess.DeleteDepartment, RankToAccess.ClothesEdit, RankToAccess.OpenGunStock
            };
        ...
        private static void AddFractionRanksData(int fractionId, int rank, string name, int salary, int maxScore,
            List<RankToAccess> access)
        {
        ...
        public static void InitFractionDefaultRanksName()
        {
            ...
            var fractionId = (int)Models.Fractions.FAMILY;
            ...
            AddFractionRanksData(fractionId, 7, "Deputy of Department Manager", 470, 7,
                fractionData.RanksDefaultAccess[7]);
            ...
            AddFractionRanksData(fractionId, 12, "Deputy Chief Department", 905, 12,
                fractionData.RanksDefaultAccess[12]);
            AddFractionRanksData(fractionId, 13, "Chief Department", 970, 13, fractionData.RanksDefaultAccess[13]);
            AddFractionRanksData(fractionId, 14, "Deputy Head Physician", 1035, 14,
                fractionData.RanksDefaultAccess[14]);
            ...
            AddFractionRanksData(fractionId, 10, "Deputy Chief Department", 830, 10,
                fractionData.RanksDefaultAccess[10]);
            ...
            AddFractionRanksData(fractionId, 12, "Deputy Head of Security", 425, 12,
                fractionData.RanksDefaultAccess[12]);
        ...
        public static async void InsertFractionRanks(List<int> fractions)
        {
            try
            {
                ...
                foreach (var fractionId in fractions)
                {
                    var fractionData = Manager.GetFractionData(fractionId);
        ...
        public static void LoadFractionConfigs()
        {
            try
            {
                for (var i = (int)Models.Fractions.FAMILY; i <= FractionCount; i++)
                {
                ...
                using var cmdFraction = new MySqlCommand
                {
                    CommandText = "SELECT * FROM fractions"
                };
                using var resultFraction = MySQL.QueryRead(cmdFraction);
                if (resultFraction != null && resultFraction.Rows.Count > 0)
                    foreach (DataRow dataRow in resultFraction.Rows)
                    {
                        var fractionId = Convert.ToInt32(dataRow["id"]);
                        ...
                        fractionData.Departments =
                            JsonConvert.DeserializeObject<Dictionary<int, DepartmentData>>(dataRow["departments"]
                                .ToString());
                        fractionData.TasksData =
                            JsonConvert.DeserializeObject<TableTaskPlayerData[]>(dataRow["tasksData"].ToString());
                        ...
                        {
                            fractionData.StockLabel = (ExtTextLabel)NAPI.TextLabel.CreateTextLabel("~w~Склад пуст",
                                Stocks.matsCoords[fractionId] + new Vector3(0, 0, 1.5), 10f, 0.4f, 0,
                        ...
                        CustomColShape.CreateCylinderColShape(Stocks.stockCoords[fractionId], 1, 2, 0,
                            ColShapeEnums.FractionStock, fractionId, 2); // stock colshape
                        NAPI.Marker.CreateMarker(1, Stocks.stockCoords[fractionId] - new Vector3(0, 0, 0.7),
                            new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220));
                        NAPI.TextLabel.CreateTextLabel(Main.StringToU16($"~w~Склад ~r~{Manager.GetName(fractionId)}"),
                            new Vector3(Stocks.stockCoords[fractionId].X, Stocks.stockCoords[fractionId].Y,
                                Stocks.stockCoords[fractionId].Z + 0.6), 5F, 0.5F, 0, new Color(255, 255, 255));

                        CustomColShape.CreateCylinderColShape(Stocks.matsCoords[fractionId], 3, 5, 0,
                            ColShapeEnums.FractionStock, fractionId, 1); // garage colshape
                        NAPI.Marker.CreateMarker(1, Stocks.matsCoords[fractionId], new Vector3(), new Vector3(), 3f,
                            new Color(155, 0, 0));

                        var ids = new List<TableTaskId>();
                        var fracId = (Models.Fractions)fractionData.Id;
                        if (fracId != Models.Fractions.None &&
                            NeptuneEvo.Table.Tasks.Repository.FractionTaskIds.ContainsKey(fracId))
                            ids = NeptuneEvo.Table.Tasks.Repository.FractionTaskIds[fracId].ToList();

                        fractionData.TasksData =
                            NeptuneEvo.Table.Tasks.Repository.GetData(
                                JsonConvert.SerializeObject(fractionData.TasksData), ids);
                ...
                using var cmdFractionVehicles = new MySqlCommand
                {
                    CommandText = "SELECT * FROM `fractionvehicles`"
                };
                using var resultFractionVehicles = MySQL.QueryRead(cmdFractionVehicles);
                ...
                using var cmdFractionRanksSetting = new MySqlCommand
                {
                    CommandText = "SELECT * FROM `fractionranks`"
                };
                using var resultFractionRanksSetting = MySQL.QueryRead(cmdFractionRanksSetting);
                if (resultFractionRanksSetting != null && resultFractionRanksSetting.Rows.Count != 0)
                    foreach (DataRow dataRow in resultFractionRanksSetting.Rows)
                    {
                        ...
                        if (access == null || access == "null" || access == "NULL" || access == "-1" ||
                            access.Length <= 1)
                        {
                            ...
                            {
                                CommandText =
                                    "UPDATE `fractionranks` SET `access`=@access WHERE `fraction`=@fraction AND `rank`=@rank"
                            };
                            ucmd.Parameters.AddWithValue("@access",
                                JsonConvert.SerializeObject(fractionData.Ranks[rank].Access));
                ...
                using var cmdFractionaccess = new MySqlCommand
                {
                    CommandText = "SELECT * FROM `fractionaccess`"
                };
                using var resultFractionAccess = MySQL.QueryRead(cmdFractionaccess);
                if (resultFractionAccess != null && resultFractionAccess.Rows.Count != 0)
                    foreach (DataRow dataRow in resultFractionAccess.Rows)
                    {
                        var fraction = Convert.ToInt32(dataRow["fraction"]);
                        var dictionaryWeap =
                            JsonConvert.DeserializeObject<Dictionary<string, int>>(dataRow["weapons"].ToString());
            ...
            {
                Log.Write($"LoadFractionConfigs Exception: {e}");
            }
        }
        ...
        public static void SpawnFractionCars()
        {
            try
            {
                ...
                {
                    var vehname = vehicle.Value.model;
                    ...
                    var veh = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(vehname),
            ...
            {
                Log.Write($"SpawnFractionCars Exception: {e}");
            }
        }
        ...
        public static void RespawnFractionCar(ExtVehicle vehicle)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    var vehname = fractionVehicleData.model;
                    var canmats = vehname.Equals("barracks") || vehname.Equals("cargobob") ||
                                  vehname.Equals("brickade") || vehname.Equals("youga") ||
                                  vehname.Equals("gburrito2") || vehname.Equals("burrito3") ||
                                  vehname.Equals("gburrito") || vehname.Equals("terbyte");
                    var candrugs = vehname.Equals("youga") || vehname.Equals("burrito3") || vehname.Equals("gburrito");
                    var canmeds = vehname.Equals("ambulance") || vehname.Equals("vapidse") ||
                                  vehname.Equals("rumpo2") || vehname.Equals("emsnspeedo") ||
                                  vehname.Equals("emsroamer");
