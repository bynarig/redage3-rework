...
namespace NeptuneEvo.VehicleModel
{
    public class EliteAutoRoom : Script
    {
        ...
        private static readonly float NpcBuyRotation = -97.236244f;
        ...
        public void Event_ResourceStart()
        {
            ...
            Repository.CreateQuest("s_m_m_movprem_01", NpcBuyPosition, NpcBuyRotation,
                title: "~y~NPC~w~ Продавец элитного транспорта", colShapeEnums: ColShapeEnums.EliteAutoRoom);
        }
        ...
        public static void Perform(ExtPlayer player)
        {
            try
            {
                ...
                CarRoom.OpenCarromMenuGos(player, donateVehiclesInfo, false);
            }
            catch (Exception e)
            {
