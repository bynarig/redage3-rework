...
namespace NeptuneEvo.Character.Models
{
    public class CharacterData
    {
        ...
        [JsonIgnore] public int WeddingUUID { get; set; } = 0;
        ...
        [JsonIgnore]
        public Dictionary<int, ComponentVariation> UsedClothes { get; set; } =
            new Dictionary<int, ComponentVariation>();

        [JsonIgnore]
        public Dictionary<int, ComponentVariation> Accessory { get; set; } = new Dictionary<int, ComponentVariation>();

        [JsonIgnore] public string SelectedQuest { get; set; } = Zdobich.QuestName;

        [JsonIgnore] public bool IsForbesShow { get; set; }
