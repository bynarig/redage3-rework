...
namespace NeptuneEvo.MoneySystem
{
    internal class Casino : Script
    {
        ...
        public static int[]
            rednums = new int[18]
                { 1, 3, 5, 7, 9, 12, 14, 16, 18, 19, 21, 23, 25, 27, 30, 32, 34, 36 }; // Все красные числа на рулетке
        ...
        public static void OnResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(casinoChecks[0].X, casinoChecks[0].Y, casinoChecks[0].Z), 5F, 0.3F, 0,
                    new Color(255, 255, 255));
                NAPI.Marker.CreateMarker(21, casinoChecks[0] + new Vector3(0, 0, 0), new Vector3(), new Vector3(), 0.8f,
                    new Color(255, 255, 255, 60));

                CustomColShape.CreateCylinderColShape(casinoChecks[1], 1, 2, 0, ColShapeEnums.Casino, 3);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(casinoChecks[1].X, casinoChecks[1].Y, casinoChecks[1].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255));
                NAPI.Marker.CreateMarker(21, casinoChecks[1] + new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    0.8f, new Color(255, 255, 255, 60));

                CustomColShape.CreateCylinderColShape(casinoChecks[3], 1, 2, 0, ColShapeEnums.Casino, 4);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(casinoChecks[3].X, casinoChecks[3].Y, casinoChecks[3].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255));
                NAPI.Marker.CreateMarker(21, casinoChecks[3] + new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    0.8f, new Color(255, 255, 255, 60));

                CustomColShape.CreateCylinderColShape(casinoChecks[4], 1, 2, 0, ColShapeEnums.Casino, 5);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(casinoChecks[4].X, casinoChecks[4].Y, casinoChecks[4].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255));
                NAPI.Marker.CreateMarker(21, casinoChecks[4] + new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    0.8f, new Color(255, 255, 255, 60));

                CustomColShape.CreateCylinderColShape(casinoChecks[5], 1, 2, 0, ColShapeEnums.Casino, 6);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(casinoChecks[5].X, casinoChecks[5].Y, casinoChecks[5].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255));
                NAPI.Marker.CreateMarker(21, casinoChecks[5] + new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    0.8f, new Color(255, 255, 255, 60));

                CustomColShape.CreateCylinderColShape(casinoChecks[6], 1, 2, 0, ColShapeEnums.Casino, 7);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Нажмите\n~r~'Взаимодействие'"),
                    new Vector3(casinoChecks[6].X, casinoChecks[6].Y, casinoChecks[6].Z + 1), 5F, 0.3F, 0,
                    new Color(255, 255, 255));
                NAPI.Marker.CreateMarker(21, casinoChecks[6] + new Vector3(0, 0, 0.7), new Vector3(), new Vector3(),
                    0.8f, new Color(255, 255, 255, 60));
            ...
            try
            {
                ...
                switch (interact)
                {
                    ...
                    case 6:
                        ...
                        if ((!Main.DoorsControl.ContainsKey("am_3") || Main.DoorsControl["am_3"]) &&
                            player.GetFractionId() != (int)Fractions.Models.Fractions.ARMENIAN)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
