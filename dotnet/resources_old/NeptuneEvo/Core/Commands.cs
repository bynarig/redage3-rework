...
using Repository = NeptuneEvo.Accounts.NewPassword.Repository;
...
namespace NeptuneEvo.Core
{
    internal class Commands : Script
    {
        ...
        public static Dictionary<int, (ExtTextLabel, ExtColShape)> ActionLabels =
            new Dictionary<int, (ExtTextLabel, ExtColShape)>();
        ...
        public static void CMD_govTicket(ExtPlayer player, int id, int sum, string reason)
        {
            ...
            {
                Log.Write($"CMD_govTicket Exception: {e}");
            }
        }
        ...
        public static void CMD_respawnFracCars(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_respawnFracCars Exception: {e}");
            }
        }
        ...
        public static void CMD_givemedlic(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_givemedlic Exception: {e}");
            }
        }
        ...
        public static void CMD_givepmlic(ExtPlayer player, int id, int price)
        {
            ...
            {
                Log.Write($"CMD_givepmlic Exception: {e}");
            }
        }
        ...
        public static void CMD_sellBiz(ExtPlayer player, int id, int price)
        {
            ...
            {
                Log.Write($"CMD_sellBiz Exception: {e}");
            }
        }
        ...
        public static void CMD_ResetPassword(ExtPlayer player, string new_password)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.PassRestrcSymbols), 3000);
                    return;
                }

                Repository.changePassword(player, new_password);
                Notify.Send(player, NotifyType.Alert, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.PassChanged), 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_ResetPassword Exception: {e}");
            }
        }
            ...
            try
            {
                ...
                if (characterData.ArrestTime >= 1)
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        $"Вам осталось сидеть {Convert.ToInt32(characterData.ArrestTime / 60.0)} минут", 3000);
                }
                else if (characterData.DemorganTime >= 1)
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        $"Спец.наказание истечёт через {Convert.ToInt32(characterData.DemorganTime / 60.0)} минут",
                        5000);
                    if (!characterData.DemorganInfo.Admin.Equals("-1"))
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Вас посадил {characterData.DemorganInfo.Admin} по причине: {characterData.DemorganInfo.Reason}",
                            10000);
                }
                else if (characterData.Warns >= 1)
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        $"На аккаунте в данный момент {characterData.Warns} предупреждений", 5000);
                    if (!characterData.WarnInfo.Admin[0].Equals("-1"))
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Предупреждение (1/3) выдано {characterData.WarnInfo.Admin[0]} по причине: {characterData.WarnInfo.Reason[0]}",
                            10000);
                    if (characterData.Warns >= 2 && !characterData.WarnInfo.Admin[1].Equals("-1"))
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Предупреждение (2/3) выдано {characterData.WarnInfo.Admin[1]} по причине: {characterData.WarnInfo.Reason[1]}",
                            10000);
                    if (characterData.Warns >= 3 && !characterData.WarnInfo.Admin[2].Equals("-1"))
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Предупреждение (3/3) выдано {characterData.WarnInfo.Admin[2]} по причине: {characterData.WarnInfo.Reason[2]}",
                            10000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_checkPrisonTime Exception: {e}");
            }
        }
        ...
        public static void CMD_pcheckPrisonTime(ExtPlayer player, int id)
        {
            try
            {
                ...
                if (targetCharacterData.Unmute > 0)
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        $"Игрок {target.Name} замучен еще на {targetCharacterData.Unmute / 60} минут", 3000);

                if (targetCharacterData.ArrestTime >= 1)
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        $"Игроку {target.Name} осталось сидеть {Convert.ToInt32(targetCharacterData.ArrestTime / 60.0)} минут",
                        3000);

                if (targetCharacterData.DemorganTime >= 1)
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        $"Спец.наказание {target.Name} истечёт через {Convert.ToInt32(targetCharacterData.DemorganTime / 60.0)} минут",
                        5000);
                    if (!targetCharacterData.DemorganInfo.Admin.Equals("-1"))
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Его посадил {targetCharacterData.DemorganInfo.Admin} по причине: {targetCharacterData.DemorganInfo.Reason}",
                            10000);
                }
                ...
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        $"На аккаунте {target.Name} в данный момент {targetCharacterData.Warns} предупреждений", 5000);
                    if (!targetCharacterData.WarnInfo.Admin[0].Equals("-1"))
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Предупреждение (1/3) выдано {targetCharacterData.WarnInfo.Admin[0]} по причине: {targetCharacterData.WarnInfo.Reason[0]}",
                            10000);
                    if (targetCharacterData.Warns >= 2 && !targetCharacterData.WarnInfo.Admin[1].Equals("-1"))
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Предупреждение (2/3) выдано {targetCharacterData.WarnInfo.Admin[1]} по причине: {targetCharacterData.WarnInfo.Reason[1]}",
                            10000);
                    if (targetCharacterData.Warns >= 3 && !targetCharacterData.WarnInfo.Admin[2].Equals("-1"))
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"Предупреждение (3/3) выдано {targetCharacterData.WarnInfo.Admin[2]} по причине: {targetCharacterData.WarnInfo.Reason[2]}",
                            10000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_pcheckPrisonTime Exception: {e}");
            }
        }
        ...
        public static void CMD_pMutePlayer(ExtPlayer player, int id)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NoGaggedId), 3000);
                    return;
                }
            ...
            {
                Log.Write($"CMD_pMutePlayer Exception: {e}");
            }
        }
        ...
        public static void CMD_pUnmutePlayer(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_pUnmutePlayer Exception: {e}");
            }
        }
        ...
        public static void CMD_govFracChat(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_govFracChat Exception: {e}");
            }
        }
        ...
        public static void CMD_gov(ExtPlayer player, string msg)
        {
            try
            {
                ...
                if (!sessionData.WorkData.OnDuty && Main.ServerSettings.IsCheckCmdGov &&
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.GlobalBlocked), 4500);
                    return;
                }

                //msg = Main.BlockSymbols(RainbowExploit(msg));
                var testmsg = msg.ToLower();
                if (Main.stringGlobalBlock.Any(c => testmsg.Contains(c)))
                {
                    ...
                    Trigger.SendToAdmins(3,
                        $"{ChatColors.StrongOrange}[A] {player.Name} ({player.Value}) попытался написать в гос.связь: {msg}");
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.RestrictedWordsTableNews), 15000);
                    return;
                }
        ...
        public static void CMD_firejob(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_firejob Exception: {e}");
            }
        }
        ...
        public static void CMD_forget(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.HaveNoFriends), 3000);
                    return;
                }

                Trigger.ClientEvent(player, "openDialog", "FORGET_FRIENDS",
                    LangFunc.GetText(LangType.Ru, DataName.Forget));
            }
            catch (Exception e)
            {
                Log.Write($"CMD_forget Exception: {e}");
            }
        }
        ...
        public static void CMD_disconnect(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_disconnect Exception: {e}");
            }
        }
        ...
        public static void RemoteEvent_F10Rep(ExtPlayer player, string message)
        {
            ...
            {
                Log.Write($"RemoteEvent_F10Rep Exception: {e}");
            }
        }
        ...
        public static void CMD_report(ExtPlayer player, string message)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MsgLonger5Shorter150), 3000);
                    return;
                }

                var nextReport = sessionData.TimingsData.NextReport;
                if (DateTime.Now < nextReport)
                {
                    var ticks = sessionData.TimingsData.NextReport.Ticks - DateTime.Now.Ticks;
                    if (ticks >= 1)
                    {
                        var g = new DateTime(ticks);
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.NextReportCooldown, g.Minute, g.Second), 3000);
                        return;
                    }
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NoReportMute), 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.YouInQueueReport), 5000);
                    return;
                }
            ...
            {
                Log.Write($"CMD_report Exception: {e}");
            }
        }
        ...
        public static void CMD_takegunlic(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_takegunlic Exception: {e}");
            }
        }
        ...
        public static void CMD_takehellic(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_takehellic Exception: {e}");
            }
        }
        ...
        public static void takeplanelic(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"takeplanelic Exception: {e}");
            }
        }
        ...
        public static void CMD_givegunlic(ExtPlayer player, int id, int price)
        {
            ...
            {
                Log.Write($"CMD_givegunlic Exception: {e}");
            }
        }
        ...
        public static void CMD_policeAccept(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_policeAccept Exception: {e}");
            }
        }
        ...
        public static void CMD_ejectTarget(ExtPlayer player, int id)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.YouNotInCarOnVehPlace), 3000);
                    return;
                }
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.YouVikinylPlayer, target.Value), 3000);
                Notify.Send(target, NotifyType.Warning, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.PlayerVikinylYou, player.Value), 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_ejectTarget Exception: {e}");
            }
        }

        public static void
            AcceptDice(ExtPlayer player, ExtPlayer target,
                int price) // player - тот, кому предложили, target - кто предлагал
        {
            try
            {
                var sessionData = player.GetSessionData();
                ...
                if (characterData == null)
                {
                    if (targetSessionData != null && targetCharacterData != null)
                    {
                        ...
                        Notify.Send(target, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.GameCancelledLeft), 3000);
                    }
                ...
                if (player != targetSessionData.DiceData.Target || target != sessionData.DiceData.Target)
                {
                    ...
                    sessionData.DiceData = new DiceData();
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.GameCancelledSboy), 3000);
                    Notify.Send(target, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.GameCancelledSboy), 3000);
                    return;
                }
                ...
                if (UpdateData.CanIChange(player, price, true) != 255 ||
                    UpdateData.CanIChange(target, price, true) != 255)
                {
                    targetSessionData.DiceData = new DiceData();
                    sessionData.DiceData = new DiceData();
                    return;
                ...
                if (!characterData.InCasino || !targetCharacterData.InCasino)
                {
                    ...
                    sessionData.DiceData = new DiceData();
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.GameCancelCuzNoCasino), 3000);
                    Notify.Send(target, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.GameCancelCuzNoCasino), 3000);
                    return;
                }
                ...
                if (sessionData.IsCasinoGame != null || targetSessionData.IsCasinoGame != null)
                {
                    ...
                    sessionData.DiceData = new DiceData();
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.GameCancelled), 3000);
                    Notify.Send(target, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.GameCancelled), 3000);
                    return;
                }

                var number1 = Main.rnd.Next(2, 13); // Выпавший номер для target
                var number2 = Main.rnd.Next(2, 13); // Выпавший номер для player
                ...
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.SameNumbers), 4000);
                    ...
                    if (price == sessionData.DiceData.Money && price == targetSessionData.DiceData.Money)
                    {
                        if (number1 > number2) // Выиграл target
                        {
                            ...
                            Notify.Send(target, NotifyType.Success, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.DiceWin, Wallet.Format(price)), 5000);
                            Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.DiceLose, Wallet.Format(price)), 5000);
                        }
                        else if (number2 > number1) // Выиграл player
                        {
                            GameLog.Money($"player({targetCharacterData.UUID})", $"player({characterData.UUID})", price,
                                "diceWin");
                            Wallet.Change(player, price);
                            Wallet.Change(target, -price);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
            ...
            {
                Log.Write($"AcceptDice Exception: {e}");
                var sessionData = player.GetSessionData();
                if (sessionData == null) return;
                if (player.IsCharacterData())
                {
                    sessionData.DiceData = new DiceData();
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.SystemErrorGame), 3000);
                }
        ...
        public static void callDice(ExtPlayer player, ExtPlayer target, int price)
        {
            try
            {
                ...
                if (!sessionData.CuffedData.Cuffed && !sessionData.DeathData.InDeath)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.DiceMinMax, Main.MinDice, Main.MaxDice), 3000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.Function5lvl), 3000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.PlayerCantUseThis), 3000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.DiceCasinoOnly), 3000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.DiceErrorCasino, sessionData.IsCasinoGame), 3000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.PlayerDiceErrorCasino,
                                targetSessionData.IsCasinoGame), 3000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.PlayerNotEnoughMoney), 3000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.DiceAlreadyPlayer), 3000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.DiceAlreadyYou), 3000);
                        return;
                    }
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.DiceOffer, target.Value, Wallet.Format(price)), 3000);
                    Trigger.ClientEvent(target, "openDialog", "DICE_PLAY",
                        LangFunc.GetText(LangType.Ru, DataName.DiceOffers, player.Value, Wallet.Format(price)));
                }
                else
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NoDice), 3000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"callDice Exception: {e}");
            }
        }
        ...
        public static void CMD_dice(ExtPlayer player, int id, int price)
        {
            ...
            {
                Log.Write($"CMD_dice Exception: {e}");
            }
        }
        ...
        public static void CMD_emsAccept(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_emsAccept Exception: {e}");
            }
        }
        ...
        public static void CMD_pocketTarget(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_pocketTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_buyBiz(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_buyBiz Exception: {e}");
            }
        }
        ...
        public static void CMD_go(ExtPlayer player, int sender_id)
        {
            try
            {
                ...
                if ((memberFractionData.Id >= 6 && memberFractionData.Id <= 9) ||
                    memberFractionData.Id == (int)Fractions.Models.Fractions.ARMY ||
                    memberFractionData.Id == (int)Fractions.Models.Fractions.LSNEWS ||
                    memberFractionData.Id == (int)Fractions.Models.Fractions.SHERIFF)
                {
                    ...
                    var numberInfo = characterData.Sim == -1 ? "" : $" Телефон для связи: {characterData.Sim}";

                    Manager.sendFractionMessage(memberFractionData.Id,
                        "!{#F08080}[F] " + LangFunc.GetText(LangType.Ru, DataName.GovReactToCall, player.Name,
                            player.Value), true);
                    Trigger.SendChatMessage(target,
                        LangFunc.GetText(LangType.Ru, DataName.GovSucReactToCall, player.Name, player.Value) +
                        numberInfo);
        ...
        public static void CMD_setRank(ExtPlayer player, int id, int newrank)
        {
            ...
            {
                Log.Write($"CMD_setRank Exception: {e}");
            }
        }
        ...
        public static void CMD_inviteFrac(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_inviteFrac Exception: {e}");
            }
        }
        ...
        public static void CMD_uninviteFrac(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_uninviteFrac Exception: {e}");
            }
        }
        ...
        public static void CMD_finvite(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_finvite Exception: {e}");
            }
        }
        ...
        public static void CMD_funinvite(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_funinvite Exception: {e}");
            }
        }
        ...
        public static void CMD_fracChat(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_fracChat Exception: {e}");
            }
        }
        ...
        public static void CMD_fracOOCChat(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_fracOOCChat Exception: {e}");
            }
        }
        ...
        public static void CMD_orgChat(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_orgChat Exception: {e}");
            }
        }
        ...
        public static void CMD_orgOOCChat(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_orgOOCChat Exception: {e}");
            }
        }
        ...
        public static void CMD_arrest(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_arrest Exception: {e}");
            }
        }
        ...
        public static void CMD_follow(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_follow Exception: {e}");
            }
        }
        ...
        public static void CMD_unfollow(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_unfollow Exception: {e}");
            }
        }
        ...
        public static void CMD_suByPassport(ExtPlayer player, int pass, int stars, string reason)
        {
            ...
            {
                Log.Write($"CMD_suByPassport Exception: {e}");
            }
        }
        ...
        public static void CMD_carsuByPassport(ExtPlayer player, string number, string reason)
        {
            ...
            {
                Log.Write($"CMD_carsuByPassport Exception: {e}");
            }
        }
        ...
        public static void CMD_inCar(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_inCar Exception: {e}");
            }
        }
        ...
        public static void CMD_inCar2(ExtPlayer player, int id)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NoCarsNear), 3000);
                    return;
                }
                ...
                {
                    if (!foreachPlayer.IsCharacterData() || !foreachPlayer.IsInVehicle ||
                        foreachPlayer.Vehicle != vehicle) continue;
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NoSpaceInCar), 3000);
                    return;
                }
        ...
        public static void CMD_pullOut(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_pullOut Exception: {e}");
            }
        }
        ...
        public static void CMD_warg(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_warg Exception: {e}");
            }
        }
        ...
        public static void CMD_medkit(ExtPlayer player, int id, int price)
        {
            ...
            {
                Log.Write($"CMD_medkit Exception: {e}");
            }
        }
        ...
        public static void CMD_heal(ExtPlayer player, int id, int price)
        {
            ...
            {
                Log.Write($"CMD_heal Exception: {e}");
            }
        }
        ...
        public static void CMD_capture(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_capture Exception: {e}");
            }
        }
        ...
        public static void CMD_mechanicRepair(ExtPlayer player, int id, int price)
        {
            try
            {
                AutoMechanic.mechanicRepair(player, Main.GetPlayerByID(id), price);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_mechanicRepair Exception: {e}");
            }
        }
        ...
        public static void CMD_mechanicSellFuel(ExtPlayer player, int id, int fuel, int pricePerLitr)
        {
            try
            {
                AutoMechanic.mechanicFuel(player, Main.GetPlayerByID(id), fuel, pricePerLitr);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_mechanicSellFuel Exception: {e}");
            }
        }
        ...
        public static void CMD_mechanicBuyFuel(ExtPlayer player, int fuel)
        {
            try
            {
                AutoMechanic.buyFuel(player, fuel);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_mechanicBuyFuel Exception: {e}");
            }
        }
        ...
        public static void CMD_leaders(ExtPlayer player)
        {
            try
            {
                ...
                foreach (var foreachPlayer in Character.Repository.GetPlayers())
                {
                    ...
                    if (foreachMemberFractionData.Id > (int)Fractions.Models.Fractions.None &&
                        foreachFractionData.IsLeader(foreachMemberFractionData.Rank) &&
                        foreachCharacterData.AdminLVL == 0)
                    {
                        var numberInfo = foreachCharacterData.Sim == -1 ? "" : $"({foreachCharacterData.Sim})";
                        ...
                        Trigger.SendChatMessage(player,
                            $"{foreachPlayer.Name} - {Manager.GetName(foreachMemberFractionData.Id)} {numberInfo} {afkTimeInfo}");
                    }
                }
            ...
            {
                Log.Write($"CMD_leaders Exception: {e}");
            }
        }
        ...
        public static void CMD_code(ExtPlayer player, string code)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.Need3Lvl), 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.CodeTooLong), 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.CodeExists), 3000);
                    return;
                }

                sessionData.TempNewRefCode = code;
                Trigger.ClientEvent(player, "openDialog", "CREATE_REF_CODE",
                    LangFunc.GetText(LangType.Ru, DataName.CodeCreateYes));
            }
            catch (Exception e)
            {
                Log.Write($"CMD_code Exception: {e}");
            }
        }
        ...
        public static void CreateRefCode(ExtPlayer player)
        {
            try
            {
                ...
                var characterData = player.GetCharacterData();
                if (characterData == null) return;
                var code = sessionData.TempNewRefCode;
                ...
                var PlayerRefCode = characterData.RefCode;
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.SucRefCreated), 5000);
                ...
                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge,
                    LangFunc.GetText(LangType.Ru, DataName.RefCreate, code), DateTime.Now);

                UpdateData.RedBucks(player, -228, $"Создание реф.кода {code}");
                ...
                Trigger.SetTask(async () =>
                {
                    ...
                    {
                        Log.Write($"CreateRefCode SetTask Exception: {e}");
                    }
                });

                var message = "!{#636363}[A] " + $"Игрок {player.Name} ({player.Value}) создал реф. код: " + code;
                Trigger.SendToAdmins(1, message);
            }
            catch (Exception e)
            {
                Log.Write($"CreateRefCode Exception: {e}");
            }
        }
        ...
        public static void CMD_action(ExtPlayer player, string msg)
        {
            try
            {
                ...
                if (sessionData.IsInLabelActionShape)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.ActionIsNear), 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MsgTooLong), 3000);
                    return;
                }
                ...
                ActionLabels.Add(player.Value,
                    (
                        (ExtTextLabel)NAPI.TextLabel.CreateTextLabel(
                            Main.StringToU16($"{msg}\n~g~(( {player.Name.Replace('_', ' ')} ))"), player.Position, 5f,
                            0.5F, 0, new Color(255, 255, 255), true, UpdateData.GetPlayerDimension(player)),
                        CustomColShape.CreateSphereColShape(player.Position, 5f, UpdateData.GetPlayerDimension(player),
                            ColShapeEnums.ActionLabelShape)
                    )
                );

                foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(player.Position, 5f,
                ...
                var message = "!{#636363}[A] " + $"Игрок {player.Name} ({player.Value}) написал в action: " + msg;
                Trigger.SendToAdmins(1, message);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_action Exception: {e}");
            }
        }
        ...
        public static void CMD_delaction(ExtPlayer player)
        {
            try
            {
                ...
                if (ActionLabels.ContainsKey(player.Value))
                {
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.ActionDeleted), 3000);
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.ActionNotCreated), 3000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_delaction Exception: {e}");
            }
        }
        ...
        public static void CMD_adelactionall(ExtPlayer player)
        {
            try
            {
                ...
                {
                    foreach (var entry in ActionLabels.Values) //Todo
                        try
                        {
                        ...
                        {
                            Log.Write($"CMD_adelactionall foreach #1 Exception: {e}");
                        }

                    ActionLabels.Clear();

                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.YouDeletedActions), 3000);
                    Admin.AdminLog(characterData.AdminLVL,
                        LangFunc.GetText(LangType.Ru, DataName.AdminYouDeletedActions, player.Name, player.Value));
                    ...
                    foreach (var foreachPlayer in Character.Repository.GetPlayers())
                        ...
                        {
                            Log.Write($"CMD_adelactionall foreach #2 Exception: {e}");
                        }
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_adelactionall Exception: {e}");
            }
        }
        ...
        public static void CMD_adelaction(ExtPlayer player, int index)
        {
            try
            {
                ...
                if (ActionLabels.ContainsKey(index))
                {
                    ...
                    {
                        foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(
                                     ActionLabels[index].Item1.Position, 5f, ActionLabels[index].Item1.Dimension))
                        {
                            var foreachSessionData = foreachPlayer.GetSessionData();
                            if (foreachSessionData == null) continue;
                            foreachSessionData.IsInLabelActionShape = false;
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.AdminDeleteAction), 3000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_adelaction Exception: {e}");
            }
        }

        [Interaction(ColShapeEnums.ActionLabelShape, true)]
        public static void EnterActionLabelShape(ExtPlayer player)
        {
            ...
            {
                Log.Write($"EnterActionLabelShape Exception: {e}");
            }
        }
        ...
        public static void OutActionLabelShape(ExtPlayer player)
        {
            ...
            {
                Log.Write($"OutActionLabelShape Exception: {e}");
            }
        }
        ...
        public static void CMD_chatMe(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_chatMe Exception: {e}");
            }
        }
        ...
        public static void CMD_chatDo(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_chatDo Exception: {e}");
            }
        }
        ...
        public static void CMD_chatToDo(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_chatToDo Exception: {e}");
            }
        }
        ...
        public static void CMD_chatWhisper(ExtPlayer player, int id, string msg)
        {
            ...
            {
                Log.Write($"CMD_chatWhisper Exception: {e}");
            }
        }
        ...
        public static void CMD_chatS(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_chatS Exception: {e}");
            }
        }
        ...
        public static void CMD_chatB(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_chatB Exception: {e}");
            }
        }
        ...
        public static void CMD_chatM(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_chatM Exception: {e}");
            }
        }
        ...
        public static void CMD_chatT(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_chatT Exception: {e}");
            }
        }
        ...
        public static void CMD_chatTry(ExtPlayer player, string msg)
        {
            ...
            {
                Log.Write($"CMD_chatTry Exception: {e}");
            }
        }
        ...
        public static void CMD_chatRoll(ExtPlayer player, int first, int second)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Минимальное значение обоих чисел - 0.", 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Максимальное значение чисел - 65535.", 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Второе число должно быть больше, чем первое.", 3000);
                    return;
                }
            ...
            {
                Log.Write($"CMD_chatRoll Exception: {e}");
            }
        }

        #region RP Chat

        public static void RPChat(string cmd, ExtPlayer sender, string message, ExtPlayer target = null,
            string optName = "")
        {
            try
            {
                ...
                var names = new[] { sender.Value };
                if (target != null) names = new[] { sender.Value, target.Value };
                switch (cmd)
                {
                    case "me":
                        foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 10f,
                                     UpdateData.GetPlayerDimension(sender)))
                        {
                            Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "me", "!{#E066FF}{name} " + message,
                                names);
                            ChatHeadOverlay.SendOverlayMessage(foreachPlayer, sender.Value,
                                ChatHeadOverlay.MessageType.Me, message);
                        }
                    ...
                    case "sme":
                        foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 10f,
                                     UpdateData.GetPlayerDimension(sender)))
                        {
                            Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "me", "!{#9466ff}{name} " + message,
                                names);
                            ChatHeadOverlay.SendOverlayMessage(foreachPlayer, sender.Value,
                                ChatHeadOverlay.MessageType.Me, message);
                        }
                    ...
                    case "todo":
                        if (message.IndexOf('*') >= 0)
                        {
                            ...
                            {
                                var genderCh = characterData.Gender ? "" : "а";
                                foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 10f,
                                             UpdateData.GetPlayerDimension(sender)))
                                    Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "todo",
                                        msg + ",!{#E066FF} - сказал" + genderCh + " {name}, " + action, names);
                            }
                        }
                    ...
                    case "do":
                        foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 10f,
                                     UpdateData.GetPlayerDimension(sender)))
                        {
                            Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "do",
                                "!{#E066FF}" + message + " ({name})", names);
                            ChatHeadOverlay.SendOverlayMessage(foreachPlayer, sender.Value,
                                ChatHeadOverlay.MessageType.Do, message);
                        }
                    ...
                    case "sdo":
                        ...
                        return;
                    case "s":
                        foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 30f,
                                     UpdateData.GetPlayerDimension(sender)))
                        {
                            Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "s", "{name} кричит: " + message,
                                names);
                            ChatHeadOverlay.SendOverlayMessage(foreachPlayer, sender.Value,
                                ChatHeadOverlay.MessageType.Message, message);
                        }
                    ...
                    case "b":
                        foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 10f,
                                     UpdateData.GetPlayerDimension(sender)))
                            Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "b", "(( {name}: " + message + " ))",
                                names);
                        return;
                    case "sb":
                        foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 10f,
                            ...
                            if (string.IsNullOrEmpty(optName))
                                Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "b",
                                    "!{#d4d4d4}(( {name} " + message + " ))", names);
                            else
                                Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "b",
                                    "!{#d4d4d4}(( " + $"{optName} " + message + " ))", names);

                        return;
                    case "m":
                        var fracId = sender.GetFractionId();
                        if ((!Configs.IsFractionPolic(fracId) && fracId != (int)Fractions.Models.Fractions.ARMY &&
                             fracId != (int)Fractions.Models.Fractions.MERRYWEATHER) ||
                            !NAPI.Player.IsPlayerInAnyVehicle(sender)) return;
                        var vehicle = (ExtVehicle)sender.Vehicle;
                        var vehicleLocalData = vehicle.GetVehicleLocalData();
                        if (vehicleLocalData != null)
                        {
                            if (vehicleLocalData.Access != VehicleAccess.Fraction) return;
                            if (!Configs.IsFractionPolic(vehicleLocalData.Fraction) &&
                                vehicleLocalData.Fraction != (int)Fractions.Models.Fractions.ARMY &&
                                vehicleLocalData.Fraction != (int)Fractions.Models.Fractions.MERRYWEATHER) return;
                            foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 120f,
                                         UpdateData.GetPlayerDimension(sender)))
                                Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "m",
                                    "!{#FFA500}[Мегафон] {name}: " + message, names);
                        }
                    ...
                    case "t":
                        ...
                        foreach (var foreachPlayer in Character.Repository.GetPlayers())
                        {
                            ...
                            if (foreachCharacterData.WorkID == (int)JobsId.Trucker)
                                if (foreachSessionData.WorkData.OnWork && foreachPlayer.IsInVehicle)
                                    Trigger.SendChatMessage(foreachPlayer,
                                        $"~y~[Рация дальнобойщиков] [{sender.Name}]: {message}");
                        }

                        return;
                    case "w":
                        var targetCharacterData = target.GetCharacterData();
                        if (targetCharacterData == null || sender == target ||
                            sender.Position.DistanceTo(target.Position) >= 2)
                        {
                            Notify.Send(sender, NotifyType.Error, NotifyPosition.BottomCenter, "Игрок слишком далеко.",
                                3000);
                            return;
                        }
                                     ...
                                     UpdateData.GetPlayerDimension(sender)))
                        {
                            var foreachCharacterData = foreachPlayer.GetCharacterData();
                            if (foreachCharacterData == null) continue;
                            if (foreachPlayer.IsCharacterData() && foreachCharacterData.AdminLVL >= 1)
                                Trigger.SendChatMessage(foreachPlayer,
                                    "!{#C5C7C7}" + $"[Шепот] {sender.Name} ({sender.Value}): {message}");
                            else if (foreachPlayer != sender && foreachPlayer != target)
                                Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "w",
                                    "!{#C5C7C7}{name} прошептал что-то {name}", names);
                        }

                        Trigger.SendChatMessage(sender,
                            "!{#C5C7C7}" + $"[Шепот] {sender.Name.Replace('_', ' ')} ({sender.Value}): {message}");
                        ...
                        if (targetFriends.ContainsKey(sender.Name))
                        {
                            if (!targetFriends[sender.Name])
                                Trigger.SendChatMessage(target,
                                    "!{#C5C7C7}" + $"[Шепот] {sender.Name.Split('_')[0]} ({sender.Value}): {message}");
                            else
                                Trigger.SendChatMessage(target,
                                    "!{#C5C7C7}" +
                                    $"[Шепот] {sender.Name.Replace('_', ' ')} ({sender.Value}): {message}");
                        }
                        else
                        {
                            Trigger.SendChatMessage(target,
                                "!{#C5C7C7}" + "[Шепот] " + (characterData.Gender ? "Незнакомец" : "Незнакомка") +
                                $" ({sender.Value}): {message}");
                        }

                        GameLog.AddInfo(
                            $"(WChat) player({characterData.UUID})->player({targetCharacterData.UUID}) {message}");
        ...
        public static void CMD_findPoint(ExtPlayer player)
        {
            ...
            var vehicle = sessionData.DeliveryData.Vehicle;
            var vehicleLocalData = vehicle.GetVehicleLocalData();
            if (vehicleLocalData == null) return;

            var vehaccess = vehicleLocalData.Access;
            var end = sessionData.DeliveryData.Point;
            if (!vehicleLocalData.DeliveryData.JStage) // Машину еще не взяли, нужна точка до машины 
            {
                if (vehaccess == VehicleAccess.DeliveryGang)
                    Trigger.ClientEvent(player, "createWaypoint", CarDelivery.GangSpawnAutos[end].X,
                        CarDelivery.GangSpawnAutos[end].Y);
                else if (vehaccess == VehicleAccess.DeliveryMafia || vehaccess == VehicleAccess.DeliveryBike)
                    Trigger.ClientEvent(player, "createWaypoint", CarDelivery.MafiaEndDelivery[end].X,
                        CarDelivery.MafiaEndDelivery[end].Y);
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.SucMarkerInstallSbyt), 5000);
                return;
            }

            // Машину взяли, нужна точка до места сдачи
            if (vehaccess == VehicleAccess.DeliveryGang)
                Trigger.ClientEvent(player, "createWaypoint", CarDelivery.GangEndDelivery[end].X,
                    CarDelivery.GangEndDelivery[end].Y);
            else if (vehaccess == VehicleAccess.DeliveryMafia || vehaccess == VehicleAccess.DeliveryBike)
                Trigger.ClientEvent(player, "createWaypoint", CarDelivery.MafiaEndDelivery[end].X,
                    CarDelivery.MafiaEndDelivery[end].Y);
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                LangFunc.GetText(LangType.Ru, DataName.SucMarkerInstallSdacha), 5000);
        }
        ...
        public static void CMD_ammo(ExtPlayer player, int ID, int type, int amount = 1)
        {
            try
            {
                ...
                Chars.Repository.AddNewItem(target, $"char_{targetCharacterData.UUID}", "inventory", types[type],
                    amount);
                GameLog.Admin($"{player.Name}", $"giveAmmo({type},{amount})", $"{target.Name}");
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) выдал патроны ({type}|{amount}) {target.Name} ({target.Value})");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_ammo Exception: {e}");
            }
        }
        ...
        public static void CMD_newVehicleNumber(ExtPlayer player, string oldNum, string newNum)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NumberExists), 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.IncorrectInputNewNumber), 3000);
                    return;
                }
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.NewvNum, oldNum, newNum), 3000);

                VehicleManager.SaveNumber(newNum);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_newVehicleNumber Exception: {e}");
            }
        }
        ...
        public static void CMD_killlist(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_killlist Exception: {e}");
            }
        }
        ...
        public static void CMD_redname(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_redname Exception: {e}");
            }
        }
        ...
        public static void CMD_hidenick(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_hidenick Exception: {e}");
            }
        }
        ...
        public static void CMD_hideme(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_hideme Exception: {e}");
            }
        }
        ...
        public static void CMD_givereds(ExtPlayer player, int id, int amount)
        {
            ...
            {
                Log.Write($"CMD_givereds Exception: {e}");
            }
        }
        ...
        public static void CMD_giveredsall(ExtPlayer player, int amount)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Выдать можно минимум 1 RB и максимум 500 RB.", 3000);
                    return;
                }
                ...
                foreach (var foreachPlayer in Character.Repository.GetPlayers())
                {
                    ...
                    UpdateData.RedBucks(foreachPlayer, correctValue, "Отправка RB");
                    Players.Phone.Messages.Repository.AddSystemMessage(foreachPlayer, (int)DefaultNumber.RedAge,
                        LangFunc.GetText(LangType.Ru, DataName.RbIncome, amount, player.Name.Replace('_', ' ')),
                        DateTime.Now);
                }

                NAPI.Chat.SendChatMessageToAll(
                    $"{CommandsAccess.AdminPrefixChat}{player.Name.Replace('_', ' ')} выдал всем игрокам {amount} RedBucks.");
                GameLog.Admin(player.Name, $"giveredsall({amount})", "allOnlinePlayers");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_giveredsall Exception: {e}");
            }
        }
        ...
        public static void CMD_checkProperety(ExtPlayer player, int id)
        {
            try
            {
                ...
                if (targetCharacterData.BizIDs.Count > 0)
                    try
                    {
                        ...
                        Trigger.SendChatMessage(player,
                            $"Игрок владеет бизнесом {BusinessManager.BusinessTypeNames[biz.Type]} (ID:{biz.ID})");
                    }
                    catch
                    {
                        Log.Write("CMD_checkProperety ERROR");
                    }
                ...
                if (house != null)
                {
                    ...
                    {
                        Trigger.SendChatMessage(player,
                            $"Игрок имеет недвижимость (ID{house.ID}) стоимостью ${house.Price} класса '{HouseManager.HouseTypeList[house.Type].Name}'");
                        ...
                        foreach (var number in vehiclesNumber)
                        {
                            ...
                            Trigger.SendChatMessage(player,
                                LangFunc.GetText(LangType.Ru, DataName.PlayerHaveCar, vehicleData.Model, number));
                        }
                    }
                    else
                    {
                        Trigger.SendChatMessage(player,
                            $"Игрок заселен в дом (ID{house.ID}) к {house.Owner} стоимостью ${house.Price} класса '{HouseManager.HouseTypeList[house.Type].Name}'");
            ...
            {
                Log.Write($"CMD_checkProperety Exception: {e}");
            }
        }
        ...
        public static void CMD_checkId(ExtPlayer player, string target)
        {
            try
            {
                    ...
                    foreach (var foreachPlayer in Character.Repository.GetPlayers())
                    {
                        ...
                        if (foreachPlayer.Value == id)
                        {
                            if (foreachCharacterData.AdminLVL >= 6)
                            {
                                ...
                                if (foreachAdminConfig.HideMe && foreachCharacterData.AdminLVL > characterData.AdminLVL)
                                    break;
                            }
                ...
                else
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.Name3Symb), 3000);
                        return;
                    }
                    ...
                    if (players == 0)
                        Trigger.SendChatMessage(player, LangFunc.GetText(LangType.Ru, DataName.CantFindMan));
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_checkId Exception: {e}");
            }
        }
        ...
        public static void CMD_setDim(ExtPlayer player, int id, int dim)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.PlayerOnTestDrive), 3000);
                    return;
                }
                ...
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) выставил Dimension({dim}) {target.Name} ({target.Value})");
                GameLog.Admin($"{player.Name}", $"setDim({dim})", $"{target.Name}");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_setDim Exception: {e}");
            }
        }
        ...
        public static void CMD_checkDim(ExtPlayer player, int id)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.PlayerDimIs,
                        UpdateData.GetPlayerDimension(target).ToString()), 4000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_checkDim Exception: {e}");
            }
        }
        ...
        public static void CMD_setBizMafia(ExtPlayer player, int mafia)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.YouNotOnBiz), 3000);
                    return;
                }
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.MafiaOwnsBiz, mafia, biz.ID), 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_setBizMafia Exception: {e}");
            }
        }
        ...
        public static void CMD_newsimcard(ExtPlayer player, int id, int newnumber)
        {
            try
            {
                ...
                Chars.Repository.AddNewItem(target, $"char_{targetCharacterData.UUID}", "inventory", ItemId.SimCard, 1,
                    newnumber.ToString());

                GameLog.Admin($"{player.Name}", $"newsim({newnumber})", $"{target.Name}");
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.NewvNum, target.Name, newnumber), 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_newsimcard Exception: {e}");
            }
        }
        ...
        public static void CMD_takeOffBusiness(ExtPlayer admin, int bizid, bool byaclear = false)
        {
            try
            {
                ...
                if (characterData == null)
                {
                    ...
                    var targetUuid = Main.PlayerUUIDs[biz.Owner];
                    Trigger.SetTask(async () =>
                    {
                        try
                        {
                            ...
                            if (character == null)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Человек не найден",
                                    3000);
                                return;
                            }
                ...
                {
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.AdminRejectBiz), 3000);
                ...
                GameLog.Money("server", $"player({Main.PlayerUUIDs[owner]})", Convert.ToInt32(biz.SellPrice * 0.8),
                    $"takeoffBiz({biz.ID})");
                Notify.Send(admin, NotifyType.Info, NotifyPosition.BottomCenter,
                    LangFunc.GetText(LangType.Ru, DataName.YouRejectBiz, owner), 3000);
                if (!byaclear)
                    GameLog.Admin($"{admin.Name}", $"takeoffBiz({biz.ID})", "");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_takeOffBusiness Exception: {e}");
            }
        }
        ...
        public static void CMD_MoneyMultiplier(ExtPlayer player, int multi)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        "Возможно установить только от 1 до 5", 3000);
                    return;
                }
                ...
                */
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"MoneyMultiplier изменен на {multi}",
                    3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_MoneyMultiplier Exception: {e}");
            }
        }
        ...
        public static void CMD_expmultiplier(ExtPlayer player, int multi)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"ExpMultiplier изменен на {multi}",
                    3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_expmultiplier Exception: {e}");
            }
        }
        ...
        public static void CMD_offlineDelFraction(ExtPlayer player, string name)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Вы уволили игрока {name} из фракции", 3000);
            ...
            {
                Log.Write($"CMD_offlineDelFraction Exception: {e}");
            }
        }
        ...
        public static void CMD_removeObject(ExtPlayer player)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    "Следующий подобранный предмет будет в бане", 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_removeObject Exception: {e}");
            }
        }
        ...
        public static void CMD_unwarn(ExtPlayer player, int id)
        {
            try
            {
                ...
                NAPI.Chat.SendChatMessageToAll("!{#DF5353}" +
                                               $"Администратор {player.Name} снял предупреждение с игрока {target.Name}({target.Value}).");

                //Chars.Repository.PlayerStats(target);
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Вы сняли варн у игрока {target.Name}, у него осталось {targetCharacterData.Warns} варнов", 3000);
                Notify.Send(target, NotifyType.Info, NotifyPosition.BottomCenter,
                    $"С Вас было снято предупреждение, осталось {targetCharacterData.Warns} варнов", 3000);
                GameLog.Admin($"{player.Name}", AdminCommands.Unwarn, $"{target.Name}");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_unwarn Exception: {e}");
            }
        }
        ...
        public static void CMD_offunwarn(ExtPlayer player, string targetName)
        {
            try
            {
                ...
                if (target.IsCharacterData())
                {
                    ...
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        "Игрок был онлайн, поэтому offunwarn заменён на unwarn", 3000);
                    return;
                }
                ...
                Trigger.SetTask(async () =>
                {
                    try
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                "Ошибка при снятии Warn'а. Сообщите разработчику", 3000);
                            return;
                        }

                        if (warns <= 0)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "У игрока нет варнов",
                                3000);
                            return;
                        }
                        ...
                        {
                            NAPI.Chat.SendChatMessageToAll("!{#DF5353}" +
                                                           $"Администратор {sessionData.Name} снял предупреждение с игрока {targetName} в оффлайне");
                            GameLog.Admin($"{sessionData.Name}", "offUnwarn", $"{targetName}");
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                                $"Вы сняли варн у игрока {targetName}, у него {warns} варнов", 3000);
                        });
            ...
            {
                Log.Write($"CMD_offunwarn Exception: {e}");
            }
        }
        ...
        public static void CMD_respawnCars(ExtPlayer player)
        {
            try
            {
                    ...
                    switch (localData.Access)
                    {
                        ...
                        case VehicleAccess.Organization:
                            ...
                            var vehicleCreate = VehicleStreaming.CreateVehicle(
                                NAPI.Util.GetHashKey(organizationVehicle.model),
                                Organizations.Manager.GaragePositions[organizationVehicle.garageId],
                                Organizations.Manager.GarageRotations[organizationVehicle.garageId], 0, 0,
                                localData.NumberPlate,
                                dimension: (uint)(Organizations.Manager.DefaultDimension + orgId), locked: true,
                                acc: VehicleAccess.OrganizationGarage, fr: orgId, minrank: organizationVehicle.rank,
                                petrol: petrol, dirt: dirt);
                ...
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) отправил все машины на спавн ({countToSpawn} шт.)");
                GameLog.Admin($"{player.Name}", AdminCommands.Spvehs, "All");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_respawnCar Exception: {e}");
            }
        }
            ...
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    switch (vehicleLocalData.Access)
                    {
                        ...
                        default:
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                "Этот транспорт нельзя отправить на спавн.", 3000);
                            return;
                    }

                    Admin.AdminLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) отправил машину на спавн ({vehicle.Value})");
        ...
        public static void CMD_respawnCarID(ExtPlayer player, int id)
        {
            try
            {
                ...
                var characterData = player.GetCharacterData();
                if (characterData == null) return;
                var vehs = Entities.Vehicles.All.Cast<ExtVehicle>();
                foreach (var veh in vehs)
                {
                    ...
                    if (vehicleLocalData != null)
                    {
                        ...
                        Admin.AdminLog(characterData.AdminLVL,
                            $"{player.Name} ({player.Value}) отправил машину на спавн ({veh.Value})");
            ...
            {
                Log.Write($"CMD_respawnCarID Exception: {e}");
            }
        }
        ...
        */
        ...
        public static void CMD_GetMyPromo(ExtPlayer player)
        {
            try
            {
                var characterData = player.GetCharacterData();
                if (characterData == null) return;
                var pcdata = Main.PromoCodes.Values.FirstOrDefault(p => p.CreatorUUID == characterData.UUID);
                if (pcdata == null)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Промокода, который привязан к Вашему персонажу, не найдено", 3000);
                    return;
                }

                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Ваш промокод использовали {pcdata.UsedTimes} раз.", 10000);
                switch (pcdata.RewardVipLvl)
                {
                    case 1:
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            $"Бонусы: Silver VIP на {pcdata.RewardVipDays} дней, {pcdata.RewardMoney}$ и {pcdata.RewardItems.Count} вещей.",
                            10000);
                        break;
                    case 2:
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            $"Бонусы: Gold VIP на {pcdata.RewardVipDays} дней, {pcdata.RewardMoney}$ и {pcdata.RewardItems.Count} вещей.",
                            10000);
                        break;
                    case 3:
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            $"Бонусы: Platinum VIP на {pcdata.RewardVipDays} дней, {pcdata.RewardMoney}$ и {pcdata.RewardItems.Count} вещей.",
                            10000);
                        break;
                    case 4:
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            $"Бонусы: Diamond VIP на {pcdata.RewardVipDays} дней, {pcdata.RewardMoney}$ и {pcdata.RewardItems.Count} вещей.",
                            10000);
                        break;
                    default:
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            $"Бонусы: {pcdata.RewardMoney}$ и {pcdata.RewardItems.Count} вещей.", 10000);
                        break;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                        $"Помимо прочего Вы получаете {pcdata.DonatePercent * 100}% от доната в виде RedBucks на аккаунт {pcdata.DonateLogin}, когда игрок с Вашим промо-кодом пополнит свой счёт (Пример: при 1% за пополнение игроком 100RB Вы получите 1RB).",
                        15000);
                    if (pcdata.DonateReceivedByStreamer != 0)
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            $"За всё время Вы получили {pcdata.DonateReceivedByStreamer} RedBucks за других игроков.",
                            15000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_GetMyPromo Exception: {e}");
            }
        }
                        ...
                        try
                        {
                            foreach (var foreachPlayer in Character.Repository.GetPlayers())
                                try
                                {
                                    var foreachCharacterData = foreachPlayer.GetCharacterData();
                                    if (foreachCharacterData == null) continue;
                                    if (Main.Media.Contains(foreachCharacterData.UUID))
                                        foreachPlayer.SetSharedData("IS_MEDIA", true);
                                    else foreachPlayer.SetSharedData("IS_MEDIA", false);
                                }
                                catch (Exception e)
                                {
                                    Log.Write($"PromoSync Task Foreach Exception: {e}");
                                }
                        }
                        catch (Exception e)
                        {
                            Log.Write($"PromoSync Task Exception: {e}");
                        }

                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            "Промокоды перезагружены успешно!", 3000);
                    });
                });
            }
            catch (Exception e)
            {
                Log.Write($"CMD_PromocmdSync Exception: {e}");
            }
        }
        ...
        public static void CMD_BonuscmdSync(ExtPlayer player)
        {
            try
            {
                ...
                Task.Run(async () =>
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                        "Бонус коды перезагружены успешно!", 3000);
                });
            }
            catch (Exception e)
            {
                Log.Write($"CMD_BonuscmdSync Exception: {e}");
            }
        }
        ...
        public static void CMD_EconomySync(ExtPlayer player)
        {
            try
            {
                ...
                Economy.Init();
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    "Вы успешно перезагрузили экономику сервера из базы данных.", 5000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_EconomySync Exception: {e}");
            }
        }
        ...
        public static void CMD_FracCmdSync(ExtPlayer player, string cmd, byte fractionId, byte access)
        {
            try
            {
                ...
                if (Configs.FractionWeapons[fractionId].ContainsKey(cmd))
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                        $"Вы установили новый уровень доступа ({access}) на оружие/патроны {cmd}", 3000);
                }
                else
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Такого доступа не найдено в этой фракции", 3000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_FracCmdSync Exception: {e}");
            }
        }
        ...
        public static void CMD_setTerritoryColor(ExtPlayer player, int gangid)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Вы не находитесь ни на одном из регионов", 3000);
                    return;
                }

                var terrid = shapeData.Index;
                ...
                region.Save();
                Trigger.ClientEventForAll("setZoneColor", region.ID, GangsCapture.gangPointsColor[gangid]);
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    $"Теперь территорией №{terrid} владеет {Manager.FractionNames[gangid]}", 3000);
                GameLog.Admin($"{player.Name}", $"setColour({terrid},{gangid})", "");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_setTerritoryColor Exception: {e}");
            }
        }
        ...
        public static void CMD_setClothes(ExtPlayer player, int id, int draw, int texture)
        {
            try
            {
                ...
                ConcurrentDictionary<int, ClothesData> clothesData = null;
                switch (id)
                {
                    case 1: // Mask
            ...
            {
                Log.Write($"CMD_setClothes Exception: {e}");
            }
        }
        ...
        public static void CMD_setAccessories(ExtPlayer player, int id, int draw, int texture)
        {
            ...
            {
                Log.Write($"CMD_setAccessories Exception: {e}");
            }
        }
        ...
        public static void CMD_checkwanted(ExtPlayer player, int id)
        {
            try
            {
                ...
                var stars = targetCharacterData.WantedLVL == null ? 0 : targetCharacterData.WantedLVL.Level;
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Кол-во звёзд - {stars}", 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_checkwanted Exception: {e}");
            }
        }
        ...
        public static void CMD_fixcar(ExtPlayer player)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) починил машину ({vehicle.Value})");
                GameLog.Admin($"{player.Name}", "fixcar", $"{vehicle.DisplayName}");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_fixcar Exception: {e}");
            }
        }
        ...
        public static void CMD_fixcarID(ExtPlayer player, int id)
        {
            try
            {
                ...
                foreach (var veh in vehs)
                {
                    ...
                    Admin.AdminLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) починил машину по ID ({veh.Value})");
            ...
            {
                Log.Write($"CMD_fixcarID Exception: {e}");
            }
        }
        ...
        public static void CMD_showPlayerOffStats(ExtPlayer player, string Name)
        {
            try
            {
                ...
                var target = (ExtPlayer)NAPI.Player.GetPlayerFromName(Name);
                if (target != null)
                {
                    CMD_showPlayerStats(player, target.Value);
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        "Игрок с такими именем был онлайн, поэтому offstats заменён на stats", 3000);
                    return;
                }
                ...
                Trigger.SetTask(() =>
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                            $"Игрока с именем {Name} нет в системе", 3000);
                        return;
                    }
                    ...
                    {
                        CommandText =
                            "SELECT login, viplvl, vipdate FROM accounts WHERE character1=@val0 OR character2=@val0 OR character3=@val0"
                    };

                    cmdSELECT.Parameters.AddWithValue("@val0", uuid);
                    using var resultSELECT = MySQL.QueryRead(cmdSELECT);
                    ...
                    var targetMemberFractionData = Manager.GetFractionMemberData(uuid);
                    if (targetMemberFractionData != null)
                    {
                        charData.Add(targetMemberFractionData.Id); //20
                        charData.Add(Manager.GetFractionRankName(targetMemberFractionData.Id,
                            targetMemberFractionData.Rank)); //21
                    }
                    else
                    {
                    ...
                    if (house != null)
                    {
                        ...
                        charData.Add(house.Price == 0
                            ? "$0 / $0"
                            : $"${Wallet.Format(houseBank)} / ${Wallet.Format(Chars.Repository.GetTax(house.Price, vipLvl))}"); //30
                    ...
                    if (bizIDs.Count > 0)
                    {
                        var biz = BusinessManager.BizList[bizIDs[0]];
                        charData.Add(biz.ID); //34
                        var BizBank = (int)Bank.GetBalance(biz.BankID);
                        charData.Add(biz.SellPrice == 0
                            ? "$0 / $0"
                            : $"${Wallet.Format(BizBank)} / ${Wallet.Format(Chars.Repository.GetTax(biz.SellPrice, vipLvl, biz.Tax))}"); //35
                        charData.Add(biz.SellPrice == 0
                            ? "$0"
                            : $"${Wallet.Format(Convert.ToInt32(biz.SellPrice / 100 * biz.Tax))}"); //36
                    ...
                    var _JsonBackPackItemData = new List<InventoryItemData>();

                    var locationName = $"char_{uuid}";
                    if (Chars.Repository.ItemsData.ContainsKey(locationName))
                        foreach (var Location in Chars.Repository.ItemsData[locationName].Keys)
                        {
                            var sortedItemData = Chars.Repository.ItemsData[locationName][Location].Values
                    ...
                    if (SqlBag != 0)
                        _JsonBackPackItemData = JsonConvert.DeserializeObject<List<InventoryItemData>>(Chars.Repository
                            .ClientEventLoadItemsData($"backpack_{SqlBag}", "backpack", 0).Item1);

                    var _ItemsData = new Dictionary<string, List<InventoryItemData>>
                    {
                    ...
                    Trigger.ClientEvent(player, "client.inventory.InitData", JsonConvert.SerializeObject(_ItemsData),
                        false);
                    ...
                    Admin.AdminLog(characterData.AdminLVL,
                        $"{sessionData.Name} ({sessionData.Value}) смотрит offline статистику {Name}");
                });
            }
            catch (Exception e)
            {
                Log.Write($"CMD_showPlayerOffStats Exception: {e}");
            }
        }
        ...
        public static void CMD_showPlayerStats(ExtPlayer player, int id)
        {
            try
            {
                ...
                if (targetCharacterData.AdminLVL >= 6)
                {
                    ...
                    if (targetAdminConfig.HideMe && characterData.AdminLVL < targetCharacterData.AdminLVL)
                    {
                        ...
                        Notify.Send(target, NotifyType.Alert, NotifyPosition.BottomCenter,
                            $"{player.Name} ({player.Value}) попытался посмотреть Вашу статистику (/stats)", 3000);
                        return;
                    }
                }
                ...
                sessionData.LookingStats = true;
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) смотрит статистику {target.Name} ({target.Value})");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_showPlayerStats Exception: {e}");
            }
        }
        ...
        public static void CMD_AllAdmins(ExtPlayer player)
        {
            try
            {
                ...
                foreach (var foreachPlayer in Main.AllAdminsOnline)
                {
                    ...
                    Trigger.SendChatMessage(player,
                        $"[{foreachPlayer.Value}] {foreachPlayer.Name} - {foreachCharacterData.AdminLVL} {afkTimeInfo}");
                }

                Trigger.SendChatMessage(player, "=== ADMINS ONLINE ===");
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) проверяет список администрации в сети");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_AllAdmins Exception: {e}");
            }
        }
        ...
        public static void CMD_AllMedias(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_AllMedias Exception: {e}");
            }
        }
        ...
        public static void CMD_Flycam_Cinema(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_Flycam_Cinema Exception: {e}");
            }
        }
        ...
        private static readonly string[] ModelsAllowedToMedia = new string[30]
        {
            "imporage", "boar", "cat", "chickenhawk", "chimp", "chop", "cormorant", "cow", "coyote", "crow", "deer",
            "hen", "husky",
            "mountainlion", "pig", "pigeon", "poodle", "pug", "rabbit", "rat", "retriever", "rhesus", "rottweiler",
            "seagull", "shepherd",
        ...
        public static void CMD_SetMySkin(ExtPlayer player, string pedModel)
        {
            ...
            {
                Log.Write($"CMD_SetMySkin Exception: {e}");
            }
        }
        ...
        public static void CMD_Clear(ExtPlayer player, int id)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) снял розыск {target.Name} ({target.Value})");
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    $"Вы сняли розыск {target.Name} ({target.Value})", 3000);
            }
            catch (Exception e)
            {
        ...
        public static void CMD_Agl(ExtPlayer player, int id)
        {
            try
            {
                ...
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) выдал комплект лицензий {target.Name} ({target.Value})");
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    $"Вы выдали комплект лицензий {target.Name} ({target.Value})", 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_Clear Exception: {e}");
        ...
        public static void CMD_AllVList(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_AllVList Exception: {e}");
            }
        }
        ...
        public static void CMD_additem(ExtPlayer player, string Name, int Value, string Data)
        {
            try
            {
                ...
                var characterData = player.GetCharacterData();
                if (characterData == null) return;
                var ItemId = (ItemId)Enum.Parse(typeof(ItemId), Name);
            ...
            {
                Log.Write($"CMD_additem Exception: {e}");
            }
        }
        ...
        public static void CMD_goadditem(ExtPlayer player, string Name, int Value, string Data)
        {
            ...
            {
                Log.Write($"CMD_goadditem Exception: {e}");
            }
        }
        ...
        public static void CMD_setprod(ExtPlayer player, int id)
        {
            ...
            {
                if (!player.IsCharacterData()) return;
                if (!CommandsAccess.CanUseCmd(player, AdminCommands.Setprod)) return;
                var accountData = player.GetAccountData();
                if (accountData == null) return;
                var login = accountData.Login;
                if (!BusinessManager.BizList.ContainsKey(id)) return;
                var biz = BusinessManager.BizList[id];
                foreach (var p in biz.Products) p.Lefts = BusinessManager.BusProductsData[p.Name].MaxCount;
                Trigger.SendChatMessage(player, "~r~Вы полностью пополнили склад бизнеса!");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_setprod Exception: {e}");
            }
        }
        ...
        public static void CMD_setproductbyindex(ExtPlayer player, int id, int index, int product)
        {
            try
            {
                ...
                if (!BusinessManager.BizList.ContainsKey(id)) return;
                if (BusinessManager.BizList[id].Products.Count <= index) return;
                BusinessManager.BizList[id].Products[index].Lefts = product;
            }
            catch (Exception e)
            {
                Log.Write($"CMD_setproductbyindex Exception: {e}");
            }
        }
        ...
        public static void CMD_deleteproducts(ExtPlayer player, int id)
        {
            try
            {
                ...
                if (!BusinessManager.BizList.ContainsKey(id)) return;
                var biz = BusinessManager.BizList[id];
                foreach (var p in biz.Products) p.Lefts = 0;
            }
            catch (Exception e)
            {
                Log.Write($"CMD_deleteproducts Exception: {e}");
            }
        }
        ...
        public static void CMD_changeBusinessPrice(ExtPlayer player, int newPrice)
        {
            ...
            {
                Log.Write($"CMD_changeBusinessPrice Exception: {e}");
            }
        }
        ...
        public static void CMD_changeHousePrice(ExtPlayer player, int newPrice)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Вы должны стоять на маркере дома", 3000);
                    return;
                }
            ...
            {
                Log.Write($"CMD_changeHousePrice Exception: {e}");
            }
        }
        ...
        public static void CMD_playAnimation(ExtPlayer player, string dict, string anim, int flag)
        {
            ...
            {
                Log.Write($"CMD_playAnimation Exception: {e}");
            }
        }
        ...
        public static void CMD_stopAnimation(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_stopAnimation Exception: {e}");
            }
        }
            ...
            try
            {
                ...
                switch (item)
                {
                    ...
                    case "money":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Недостаточно прав",
                                3000);
                            return;
                        }
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Вы успешно изменили склад.",
                    1500);
                GameLog.Admin($"{player.Name}", $"changeStock({item},{amount})", "");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_changeStock Exception: {e}");
            }
        }
        ...
        public static void CMD_tpCoord(ExtPlayer player, string cords)
        {
            try
            {
                ...
                if (characterData == null) return;
                cords = cords.Replace(",", "");
                var result = cords.Split(' ');
                var resultCords = new float[3];
                for (var i = 0; i < 3; i++)
                    if (!float.TryParse(result[i], out resultCords[i]))
                    {
                ...
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) телепортировался по координатам {resultCords[0]} {resultCords[1]} {resultCords[2]}");
                NAPI.Entity.SetEntityPosition(player, new Vector3(resultCords[0], resultCords[1], resultCords[2]));
            }
            catch (Exception e)
            {
                Log.Write($"CMD_tpCoord Exception: {e}");
            }
        }
        ...
        public static void CMD_delFrac(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_delFrac Exception: {e}");
            }
        }
        ...
        public static void CMD_SendToCreator(ExtPlayer player, int id)
        {
            try
            {
                ...
                if (characterData.AdminLVL >= 6 || Admin.SendCreatorQueue.ContainsKey(target))
                {
                    ...
                    {
                        Admin.AdminsLog(characterData.AdminLVL,
                            $"{player.Name} ({player.Value}) отправил в creator {target.Name} ({target.Value})");
                    ...
                    else
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                "Подтвердить может только другой администратор!", 3000);
                            return;
                        }

                        Admin.AdminsLog(characterData.AdminLVL,
                            $"{player.Name} ({player.Value}) подтвердил запрос смены внешности от администратора {Admin.SendCreatorQueue[target].Item1}");
                        Admin.AdminsLog(Admin.SendCreatorQueue[target].Item2,
                            $"{Admin.SendCreatorQueue[target].Item1} отправил в creator {target.Name} ({target.Value})");
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            "Вы подтвердили запрос на смену внешности!", 3000);
                    }
                ...
                else
                {
                    ...
                    Trigger.SendToAdmins(2,
                        $"{ChatColors.StrongOrange}[A] Запрос от {player.Name} ({player.Value}) на смену внешности {target.Name}. Чтобы подтвердить действие - введите: /sendcreator {id}");
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_SendToCreator Exception: {e}");
            }
        }
            ...
            try
            {
                ...
                if (vehicleLocalData != null)
                    if (vehicleLocalData.Access == VehicleAccess.Personal)
                    {
                        ...
                        Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                            "Машина будет доступна после респавна", 3000);
                    }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_vehchage Exception: {e}");
            }
        }
        ...
        public static void CMD_setVehiclePetrol(ExtPlayer player, int fuel)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Заправить машину можно только до 200 литров!", 3000);
                    return;
                }
                ...
                {
                    if (vehicleLocalData.Access == VehicleAccess.Personal ||
                        vehicleLocalData.Access == VehicleAccess.Garage)
                    {
                        var number = veh.NumberPlate;
                        var vehicleData = VehicleManager.GetVehicleToNumber(number);
                        if (vehicleData != null)
                    ...
                    Admin.AdminLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) заправил машину ({player.Vehicle.Value},{fuel}л)");
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_setVehiclePetrol Exception: {e}");
            }
        }
        ...
        */
        ...
        public static void CMD_changeNamebyId(ExtPlayer player, int id, string newName)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Неверный ввод нового имени, отсутствует нужный символ!", 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.NameExists), 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Слишком маленькое имя или фамилия!", 3000);
                    return;
                }

                var rg = new Regex(@"^[a-z]+$", RegexOptions.IgnoreCase);
                if (!rg.IsMatch(split[0]))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Неверный ввод нового имени!",
                        3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Неверный ввод новой фамилии!",
                        3000);
                    return;
                }

                var curient = target.Name;
                if (characterData.AdminLVL >= 5 || (Admin.ChangeNameQueue.ContainsKey(curient) &&
                                                    Admin.ChangeNameQueue[curient].Item1 == newName))
                {
                    if (targetCharacterData.AdminLVL >= characterData.AdminLVL && target != player)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            "Нельзя изменить ник администратора, который выше уровнем!", 3000);
                        return;
                    }
                    ...
                    {
                        Admin.AdminsLog(characterData.AdminLVL,
                            $"{player.Name} ({player.Value}) изменил имя {curient} на {newName}");
                    ...
                    else
                    {
                        ...
                        Admin.AdminsLog(characterData.AdminLVL,
                            $"{player.Name} ({player.Value}) подтвердил запрос изменения администратора {Admin.ChangeNameQueue[curient].Item2}");
                        Admin.AdminsLog(Admin.ChangeNameQueue[curient].Item3,
                            $"{Admin.ChangeNameQueue[curient].Item2} изменил имя {curient} на {newName}");
                        GameLog.Admin($"{player.Name}", "changeNameAccept", $"{Admin.ChangeNameQueue[curient].Item2}");
                        GameLog.Admin($"{Admin.ChangeNameQueue[curient].Item2}", $"changeName({newName})",
                            $"{curient}");
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            "Вы подтвердили запрос на изменение имени!", 3000);
                    }
                ...
                else
                {
                    if (Admin.ChangeNameQueue.ContainsKey(curient) && Admin.ChangeNameQueue[curient].Item1 != newName)
                    {
                        Admin.ChangeNameQueue.Remove(curient);
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            "Старый запрос на изменение ника для этого персонажа удалён", 3000);
                    }

                    Admin.ChangeNameQueue.Add(curient, (newName, player.Name, characterData.AdminLVL));
                    Trigger.SendToAdmins(2,
                        $"{ChatColors.StrongOrange}[A] Запрос от {player.Name} ({player.Value}) на смену имени {curient} -> {newName}. Чтобы подтвердить действие - введите: /setname {curient} {newName}");
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_changeNamebyId Exception: {e}");
            }
        }
        ...
        public static void CMD_changeName(ExtPlayer player, string curient, string newName)
        {
            try
            {
                ...
                if (characterData.AdminLVL >= 6 || (Admin.ChangeNameQueue.ContainsKey(curient) &&
                                                    Admin.ChangeNameQueue[curient].Item1 == newName))
                {
                    var target = (ExtPlayer)NAPI.Player.GetPlayerFromName(curient);
                    var targetCharacterData = target.GetCharacterData();
                    if (targetCharacterData != null && targetCharacterData.AdminLVL >= characterData.AdminLVL &&
                        target != player)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            "Нельзя изменить ник администратора, который выше уровнем!", 3000);
                    ...
                    {
                        Admin.AdminsLog(characterData.AdminLVL,
                            $"{player.Name} ({player.Value}) изменил имя {curient} на {newName} в оффлайне");
                        GameLog.Admin($"{player.Name}", $"changeName({newName})", $"{curient}");
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Ник изменен!", 3000);
                    }
                    else
                    {
                        ...
                        Admin.AdminsLog(characterData.AdminLVL,
                            $"{player.Name} ({player.Value}) подтвердил запрос изменения администратора {Admin.ChangeNameQueue[curient].Item2}");
                        Admin.AdminsLog(Admin.ChangeNameQueue[curient].Item3,
                            $"{Admin.ChangeNameQueue[curient].Item2} изменил имя {curient} на {newName} в оффлайне");
                        GameLog.Admin($"{player.Name}", "changeNameAccept", $"{Admin.ChangeNameQueue[curient].Item2}");
                        GameLog.Admin($"{Admin.ChangeNameQueue[curient].Item2}", $"changeName({newName})",
                            $"{curient}");
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                ...
                else
                {
                    ...
                    Admin.ChangeNameQueue.Add(curient, (newName, player.Name, characterData.AdminLVL));
                    Trigger.SendToAdmins(2,
                        $"{ChatColors.StrongOrange}[A] Запрос от {player.Name} ({player.Value}) на смену имени {curient} -> {newName}. Чтобы подтвердить действие - введите: /setnameoff {curient} {newName}");
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_changeName Exception: {e}");
            }
        }
        ...
        public static void CMD_startMatWars(ExtPlayer player)
        {
            try
            {
                ...
                MatsWar.startWar();
                Trigger.SendToAdmins(3,
                    $"{ChatColors.StrongOrange}[A] {player.Name} запустил" + (characterData.Gender ? "" : "а") +
                    " ВЗМ!");
                GameLog.Admin($"{player.Name}", "startMatwars", "");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_startMatWars Exception: {e}");
            }
        }
        ...
        public static void CMD_Stopmatwars(ExtPlayer player)
        {
            try
            {
                ...
                MatsWar.endWar();
                Trigger.SendToAdmins(3,
                    $"{ChatColors.StrongOrange}[A] {player.Name} закончил" + (characterData.Gender ? "" : "а") +
                    " ВЗМ");
        ...
        public static void CMD_StartCam(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_StartCam Exception: {e}");
            }
        }
        ...
        public static void CMD_giveExp(ExtPlayer player, int id, int exp)
        {
            ...
            {
                Log.Write($"CMD_giveExp Exception: {e}");
            }
        }
        ...
        public static void CMD_giveLvl(ExtPlayer player, int id, int lvl)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                    $"Вы выдали игроку {target.Name} ({target.Value}) {lvl} уровней", 3000);
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) выдал {target.Name} ({target.Value}) {lvl} уровней");
                GameLog.Admin($"{player.Name}", $"giveLvl({lvl})", $"{target.Name}");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_giveLvl Exception: {e}");
            }
        }
        ...
        public static void CMD_replaceHousePrices(ExtPlayer player, int type, int newPrice)
        {
            ...
            {
                Log.Write($"CMD_replaceHousePrices Exception: {e}");
            }
        }
        ...
        public static void CMD_deleteHouseOwner(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Вы должны находиться на маркере недвижимости", 3000);
                    return;
                }
            ...
            {
                Log.Write($"CMD_deleteHouseOwner Exception: {e}");
            }
        }
        ...
        public static void CMD_SetTurboTorque(ExtPlayer player, float power = 0f, float torque = 1f)
        {
            ...
            {
                Log.Write($"CMD_SetTurboTorque Exception: {e}");
            }
        }
        ...
        public static void CMD_SetDMGdif(ExtPlayer player, int id, float dmg)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"DAMAGE MODIFIED TO: {dmg}",
                    3000);
                Trigger.ClientEvent(target, "dmgmodif", dmg);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_SetDMGdif Exception: {e}");
            }
        }
        ...
        public static void CMD_SetVehicleMod(ExtPlayer player, int type, string index)
        {
            try
            {
                ...
                if (!player.IsInVehicle) return;
                if (!int.TryParse(index, out var index1))
                {
            ...
            {
                Log.Write($"CMD_SetVehicleMod Exception: {e}");
            }
        }
        ...
        public static void CMD_SetVehicleNeon(ExtPlayer player, byte r, byte g, byte b, byte alpha)
        {
            ...
            {
                Log.Write($"CMD_SetVehicleNeon Exception: {e}");
            }
        }
        ...
        public static void CMD_SetVehicleHealth(ExtPlayer player, int health = 100)
        {
            ...
            {
                Log.Write($"CMD_SetVehicleHealth Exception: {e}");
            }
        }
        ...
        public static void CMD_deleteThisAdminCar(ExtPlayer player)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                    ...
                    {
                        Admin.AdminLog(characterData.AdminLVL,
                            $"{player.Name} ({player.Value}) удалил админ-машину ({vehicle.Value})");
                        VehicleStreaming.DeleteVehicle(vehicle);
            ...
            {
                Log.Write($"CMD_deleteThisAdminCar Exception: {e}");
            }
        }
        ...
        public static void CMD_deleteVehByID(ExtPlayer player, int id)
        {
            try
            {
                ...
                foreach (var veh in Entities.Vehicles.All.Cast<ExtVehicle>())
                {
                    if (veh.Value != id) continue;
            ...
            {
                Log.Write($"CMD_deleteVehByID Exception: {e}");
            }
        }
        ...
        public static void CMD_delMyCars(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_delMyCars Exception: {e}");
            }
        }
        ...
        public static void CMD_saveCoord(ExtPlayer player, string name)
        {
            ...
            {
                Log.Write($"CMD_saveCoord Exception: {e}");
            }
        }
        ...
        public static void CMD_GetMyPosition(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_GetMyPosition Exception: {e}");
            }
        }
        ...
        public static void ACMD_setfractun(ExtPlayer player, int cat = -1, int id = -1)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    if (vehicleLocalData.Access == VehicleAccess.Fraction)
                    {
                        ...
                        var oldtuple = fractionData.Vehicles[number];
                        var oldvehhash = oldtuple.model;
                        var oldvehpos = oldtuple.position;
                        var oldvehrot = oldtuple.rotation;
                        var oldvehrank = oldtuple.rank;
                        var oldvehc1 = oldtuple.color1;
                        var oldvehc2 = oldtuple.color2;
                        ...
                        fractionData.Vehicles[number] = new FractionVehicleData(oldvehhash, oldvehpos, oldvehrot,
                            oldvehrank, oldtuple.defaultRank, oldvehc1, oldvehc2, oldvehdata);
                        Trigger.SetTask(async () =>
                        {
                            try
                            {
            ...
            {
                Log.Write($"ACMD_setfractun Exception: {e}");
            }
        }
        ...
        public static void ACMD_setfracveh(ExtPlayer player, string vehname, int rank, int c1, int c2)
        {
            ...
            {
                Log.Write($"ACMD_setfracveh Exception: {e}");
            }
        }
        ...
        public static void SetFracVehRank(ExtPlayer player, ExtVehicle vehicle, int rank)
        {
            ...
            {
                Log.Write($"CMD_stopServer Exception: {e}");
            }
        }

        public static void SetFracVeh(ExtPlayer player, ExtVehicle vehicle, string vehname, int rank, int c1, int c2,
            bool isMessage = true)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    if (vehicleLocalData.Access == VehicleAccess.Fraction)
                    {
                        ...
                        var canmats = vehname.Equals("barracks") || vehname.Equals("cargobob") ||
                                      vehname.Equals("brickade") || vehname.Equals("youga") ||
                                      vehname.Equals("gburrito2") || vehname.Equals("burrito3") ||
                                      vehname.Equals("gburrito") || vehname.Equals("terbyte");
                        var candrugs = vehname.Equals("youga") || vehname.Equals("burrito3") ||
                                       vehname.Equals("gburrito");
                        var canmeds = vehname.Equals("ambulance") || vehname.Equals("vapidse") ||
                                      vehname.Equals("rumpo2") || vehname.Equals("emsnspeedo") ||
                                      vehname.Equals("emsroamer");


                        var model = fractionData.Vehicles[number].model;
                        ...
                        var pos = NAPI.Entity.GetEntityPosition(vehicle) + new Vector3(0, 0, 0.5);
                        var rot = NAPI.Entity.GetEntityRotation(vehicle);
                        ...
                        var defrank = fractionData.Vehicles[number].defaultRank;
                        fractionData.Vehicles[number] =
                            new FractionVehicleData(model, pos, rot, rank, defrank, c1, c2, data);
        ...
        public static void CMD_SaveServer(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_SaveServer Exception: {e}");
            }
        }
        ...
        public static void CMD_setLeader(ExtPlayer player, int id, int fracid)
        {
            ...
            {
                Log.Write($"CMD_setLeader Exception: {e}");
            }
        }
        ...
        public static void CMD_inv(ExtPlayer player)
        {
            try
            {
                ...
                if (!player.OutgoingSyncDisabled)
                {
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        "Теперь игроки и читеры вас не видят.", 1000);
                }
                else
                {
        ...
        public static void CMD_spectateMode(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_spectateMode Exception: {e}");
            }
        }
        ...
        public static void CMD_unspectateMode(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_unspectateMode Exception: {e}");
            }
        }
        ...
        public static void CMD_Spawn(ExtPlayer player, int id)
        {
            try
            {
                ...
                var targetCharacterData = target.GetCharacterData();
                if (targetCharacterData == null) return;
                if (targetCharacterData.InsideHouseID == -1 && target.Dimension == 0 &&
                    targetCharacterData.DemorganTime <= 0 && targetCharacterData.ArrestTime <= 0 &&
                    ...
                    targetSessionData.SitPos == -1)
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                        "Вы отправили игрока на спавн!", 3000);
                    ...
                    EventSys.SendCoolMsg(target, "Администрация", $"{player.Name}", "Телепортировал Вас на спавн", "",
                        10000);
                    Admin.AdminLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) отправил на спавн {target.Name} ({target.Value})");
            ...
            {
                Log.Write($"CMD_Spawn Exception: {e}");
            }
        }
        ...
        public static void CMD_teleportToMe(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_teleportToMe Exception: {e}");
            }
        }
        ...
        public static void CMD_kill(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_kill Exception: {e}");
            }
        }
        ...
        public static void CMD_revive(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_revive Exception: {e}");
            }
        }
        ...
        public static void CMD_adminHeal(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_adminHeal Exception: {e}");
            }
        }
        ...
        public static void CMD_Delad(ExtPlayer player, int id, string reason)
        {
            try
            {
                ...
                LsNewsSystem.UpdateAnswer(player, id, reason, true);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_adminHeal Exception: {e}");
        ...
        public static void CMD_adminArmor(ExtPlayer player, int id, int ar)
        {
            ...
            {
                Log.Write($"CMD_adminArmor Exception: {e}");
            }
        }
        ...
        public static void CMD_adminFreeze(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_adminFreeze Exception: {e}");
            }
        }
        ...
        public static void CMD_adminUnFreeze(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_adminUnFreeze Exception: {e}");
            }
        }
        ...
        public static void CMD_setAdmin(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_setAdmin Exception: {e}");
            }
        }
        ...
        public static void CMD_OffDelAdmin(ExtPlayer player, string target)
        {
            ...
            {
                Log.Write($"CMD_OffDelAdmin Exception: {e}");
            }
        }
        ...
        public static void CMD_delAdmin(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_delAdmin Exception: {e}");
            }
        }
        ...
        public static void CMD_setAdminRank(ExtPlayer player, int id, int rank)
        {
            ...
            {
                Log.Write($"CMD_setAdminRank Exception: {e}");
            }
        }
        ...
        public static void CMD_offSetAdminRank(ExtPlayer player, string target, int rank)
        {
            ...
            {
                Log.Write($"CMD_offSetAdminRank Exception: {e}");
            }
        }
        ...
        public static void CMD_adminGuns(ExtPlayer player, int id, string wname, string serial)
        {
            ...
            {
                Log.Write($"CMD_adminGuns Exception: {e}");
            }
        }
        ...
        public static void CMD_adminClothes(ExtPlayer player, int id, string wname, string serial)
        {
            ...
            {
                Log.Write($"CMD_adminClothes Exception: {e}");
            }
        }
        ...
        public static void CMD_adminSetSkin(ExtPlayer player, int id, string pedModel)
        {
            ...
            {
                Log.Write($"CMD_adminSetSkin Exception: {e}");
            }
        }
        ...
        public static void CMD_adminOGuns(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_adminOGuns Exception: {e}");
            }
        }
        ...
        public static void CMD_adminGiveMoney(ExtPlayer player, int id, int money)
        {
            ...
            {
                Log.Write($"CMD_adminGiveMoney Exception: {e}");
            }
        }
        ...
        public static void CMD_adminOffGiveMoney(ExtPlayer player, string name, int money)
        {
            ...
            {
                Log.Write($"CMD_adminOffGiveMoney Exception: {e}");
            }
        }
        ...
        public static void CMD_delleader(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_delleader Exception: {e}");
            }
        }
        ...
        public static void CMD_deljob(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_deljob Exception: {e}");
            }
        }
        ...
        public static void CMD_createVehicle(ExtPlayer player, string name, int a, int b)
        {
            try
            {
                ...
                if (vehHash != 0)
                {
                    veh = VehicleStreaming.CreateVehicle(vehHash, player.Position, player.Rotation.Z, 0, 0,
                        acc: VehicleAccess.Admin, by: player.Name, petrol: 9999, engine: true);
                }
                else
                {
                    if (characterData.AdminLVL <= 5)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            "Транспорта с таким названием не было найдено", 3000);
                        return;
                    }

                    veh = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(name), player.Position, player.Rotation.Z,
                        0, 0, acc: VehicleAccess.Admin, by: player.Name, petrol: 9999, engine: true);
                }
                ...
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) создал машину({name},{veh.Value})");
                GameLog.Admin($"{player.Name}", $"vehCreate({name})", "");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_createVehicle Exception: {e}");
            }
        }
            ...
            try
            {
                ...
                if (count >= 1 && count <= 20)
                {
                    ...
                    if (vehHash != 0)
                    {
                        ...
                        {
                            var veh = VehicleStreaming.CreateVehicle(vehHash,
                                new Vector3(player.Position.X + 4 * i, player.Position.Y, player.Position.Z),
                                player.Rotation.Z, a, b, "ADMIN", acc: VehicleAccess.Admin, by: player.Name,
                                petrol: 9999, engine: true);
                            Trigger.Dimension(veh, UpdateData.GetPlayerDimension(player));
                            veh.NumberPlate = "ADMIN";
                            veh.PrimaryColor = a;
                            veh.SecondaryColor = b;
                        ...
                        Admin.AdminLog(characterData.AdminLVL,
                            $"{player.Name} ({player.Value}) создал {count} машин({name})");
                    ...
                    else
                    {
                        ...
                        {
                            var model = NAPI.Util.GetHashKey(name);
                            for (byte i = 0; i != count; i++)
                            {
                                var veh = VehicleStreaming.CreateVehicle(model,
                                    new Vector3(player.Position.X + 4 * i, player.Position.Y, player.Position.Z),
                                    player.Rotation.Z, a, b, "ADMIN", acc: VehicleAccess.Admin, by: player.Name,
                                    petrol: 9999, engine: true);
                                Trigger.Dimension(veh, UpdateData.GetPlayerDimension(player));
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Одновременно создать можно до 20 машин", 3000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_createVehicles Exception: {e}");
            }
        }
        ...
        public static void ACMD_aclear(ExtPlayer player, string target, string reason)
        {
            ...
            {
                Log.Write($"ACMD_aclear Exception: {e}");
            }
        }
        ...
        public static void aclear(ExtPlayer player, string targetName, string reason)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Человек с таким именем не найден", 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        "Невозможно очистить персонажа, который находится в игре", 3000);
                    return;
                }
                ...
                if (Main.stringGlobalBlock.Any(c => reason.Contains(c)))
                {
                    Trigger.SendToAdmins(1,
                        $"{ChatColors.Red}[A] {sessionData.Name} ({sessionData.Value}) был снят системой за причину в наказании: {reason}");
                    Character.BindConfig.Repository.DeleteAdmin(player);
                    return;
                }

                if (!Admin.CheckMe(player, 5)) return;
                var tuuid = Main.PlayerUUIDs[targetName];
                ...
                Trigger.SetTask(() =>
                {
                    try
                    {
                        ...
                        using var result = MySQL.QueryRead(cmd1);
                        if (result != null && result.Rows.Count != 0)
                        {
                            ...
                            if (Convert.ToInt32(row["adminlvl"]) >= characterData.AdminLVL)
                            {
                                Trigger.SendToAdmins(3,
                                    "!{#FF0000}" +
                                    $"[A] {sessionData.Name} ({sessionData.Value}) попытался очистить {targetName} (offline), который имеет выше уровень администратора.");
                                return;
                            }

                            var TBiz = JsonConvert.DeserializeObject<List<int>>(row["biz"].ToString());
                            if (TBiz.Count >= 1 && TBiz[0] >= 1)
                            {
                                ...
                                {
                                    var bizownerUuid = Main.PlayerUUIDs[owner];
                                    ...
                                    using var data = MySQL.QueryRead(cmd2);
                                    var ownerBizs = new List<int>();
                                    var money = 0;
                                ...
                                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                    $"Вы отобрали бизнес у {owner}", 3000);
                            }
                        }
                        else
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                "Не удалось найти персонажа в базе данных", 3000);
                            return;
                        }
                        ...
                        using var result4 = MySQL.QueryRead(cmd4);
                        if (result4 != null && result4.Rows.Count != 0)
                        {
                            var hid = Convert.ToInt32(result4.Rows[0][0]);
                            ...
                            if (house != null)
                            {
                                if (FurnitureManager.HouseFurnitures.ContainsKey(hid))
                                {
                                    ...
                                    foreach (var p in furnitures)
                                        if (Chars.Repository.ItemsData.ContainsKey($"furniture_{hid}_{p.Key}") &&
                                            Chars.Repository.ItemsData[$"furniture_{hid}_{p.Key}"]
                                                .ContainsKey("furniture") &&
                                            Chars.Repository.ItemsData[$"furniture_{hid}_{p.Key}"]["furniture"].Count !=
                                            0)
                                    ...
                                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                        $"Вы удалили из дома {targetName} всю мебель", 3000);
                                }
                                ...
                                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                    $"Вы отобрали недвижимость у {targetName}", 3000);
                                //Chars.Repository.PlayerStats(player);
                            }
                        }
                        ...
                        if (vehiclesNumber.Count > 0)
                        {
                            ...
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                                $"Вы отобрали у {targetName} все машины.", 3000);
                        }
                        // CLEAR MONEY, HOTEL, FRACTION, SIMCARD, PET

                        using var cmd6 = new MySqlCommand
                        {
                            CommandText =
                                "UPDATE `characters` SET `money`=0,`fraction`=0,`fractionlvl`=0,`hotel`=-1,`hotelleft`=0,`sim`=-1,`PetName`='null' WHERE uuid=@val0"
                        };
                        cmd6.Parameters.AddWithValue("@val0", tuuid);
                        MySQL.Query(cmd6);
                        // CLEAR BANK MONEY
                        var bankAcc = Bank.Get(Main.PlayerBankAccs[targetName]);
                        if (bankAcc != null)
                        {
                            bankAcc.Balance = 0;
                            bankAcc.IsSave = true;
                        ...
                        // CLEAR REDBUCKS
                        using var cmd8 = new MySqlCommand
                        {
                            CommandText =
                                "UPDATE accounts SET redbucks=0 WHERE character1=@val0 OR character2=@val0 OR character3=@val0"
                        };
                        ...
                        Trigger.SendPunishment(
                            $"{CommandsAccess.AdminPrefix}{sessionData.Name} полностью обнулил персонажа {targetName}. Причина: {reason}");
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            $"Вы забрали у человека все вещи, деньги с рук и банковского счёта у {targetName}", 3000);
                        GameLog.Admin($"{sessionData.Name}", $"aClear({reason})", $"{targetName}");
                    }
                    catch (Exception e)
                    {
                        Log.Write($"aclear SetTask Exception: {e}");
                    }
                });
            }
            catch (Exception e)
        ...
        public static void CMD_ClearFraction(ExtPlayer player, byte fraction)
        {
            try
            {
                ...
                if (fraction <= (int)Fractions.Models.Fractions.None || fraction > Configs.FractionCount) return;
                GameLog.FracLog(fraction, -1, -1, player.Name, "-1", "fClear");
                Notify.Send(player, NotifyType.Success, NotifyPosition.Center,
                    $"Вы начали очищение фракции {Manager.FractionNames[fraction]}!", 3000);

                SyncThread.FClearBackground(player, fraction);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_ClearFraction Exception: {e}");
            }
        }
        ...
        public static void CMD_Carnumber(ExtPlayer player, string number)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        "Количество символов в номерном знаке не может превышать 8.", 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                        $"Номер машины: {number} | Модель: {vehicleData.Model} | Владелец: {vehicleData.Holder}", 6000);
                    Admin.AdminLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) проверяет владельца машины {number} ({vehicleData.Holder})");
                }
                else
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Не найдено машины с таким номерным знаком.", 3000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_Carnumber Exception: {e}");
            }
        }
        ...
        public static void CMD_ApplyCustom(ExtPlayer player, int cat = -1, int id = -1)
        {
            try
            {
                ...
                switch (cat)
                {
                    ...
                    case 11:
                        ...
                        var turbo = vehicleData.Components.Turbo == 0;
                        player.Vehicle.SetSharedData("TURBO", turbo);
                        break;
                    case 12:
            ...
            {
                Log.Write($"CMD_ApplyCustom Exception: {e}");
            }
        }
        ...
        public static void CMD_ApplyCustomPColor(ExtPlayer player, int r, int g, int b, int mod = -1)
        {
            try
            {
                ...
                if (mod != -1)
                {
                    vehicleData.Components.PrimModColor = mod;
                }
                else
                {
            ...
            {
                Log.Write($"CMD_ApplyCustomPColor Exception: {e}");
            }
        }
        ...
        public static void CMD_ApplyCustomSColor(ExtPlayer player, int r, int g, int b, int mod = -1)
        {
            try
            {
                ...
                if (mod != -1)
                {
                    vehicleData.Components.SecModColor = mod;
                }
                else
                {
            ...
            {
                Log.Write($"CMD_ApplyCustomSColor Exception: {e}");
            }
        }
        ...
        public static void CMD_setWeather(ExtPlayer player, bool toggle)
        {
            ...
            {
                Log.Write($"CMD_setWeather Exception: {e}");
            }
        }
        ...
        public static void CMD_setTime(ExtPlayer player, short hours, short minutes, short seconds)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Некорректные данные, часы 0-23, минуты 0-59, секунды 0-59", 3000);
                    return;
                }

                Admin.TimeChanged = false;
                Admin.AdminLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) установил игровое время({hours} {minutes} {seconds})");
                ...
                if (hours != -1 && minutes != -1 && seconds != -1)
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                        $"Вы заморозили игровое время на {hours}ч. {minutes}м. {seconds}с. Чтобы вернуться, установите -1 -1 -1",
                        3000);
            ...
            {
                Log.Write($"CMD_setTime Exception: {e}");
            }
        }
        ...
        public static void CMD_DelObjects(ExtPlayer player, string locationName)
        {
            try
            {
                ...
                if (!Chars.Repository.ItemsData.ContainsKey(locationName)) return;
            ...
            {
                Log.Write($"CMD_teleport Exception: {e}");
            }
        }
                ...
                if (targetCharacterData.AdminLVL >= 6)
                {
                    ...
                    if (targetAdminConfig.HideMe && characterData.AdminLVL < targetCharacterData.AdminLVL)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.CantFindPlayerWithId), 3000);
                        Notify.Send(target, NotifyType.Alert, NotifyPosition.BottomCenter,
                            $"{player.Name} ({player.Value}) попытался телепортироваться к Вам (/tp)", 3000);
                        return;
                    }
                }

                Admin.AdminsLog(characterData.AdminLVL,
                    $"{player.Name} ({player.Value}) телепортировался к {target.Name} ({target.Value})", 1, "#636363");
                GameLog.Admin($"{player.Name}", $"tp({target.Position.X}, {target.Position.Y}, {target.Position.Z})",
                    $"{target.Name}");
        ...
        public static void CMD_Metpcar(ExtPlayer player, int id)
        {
            try
            {
                ...
                foreach (var veh in vehs)
                {
                    if (veh.Value != id) continue;
                    Admin.AdminsLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) телепортировал машину к себе {veh.DisplayName} ({id})", 1,
                        "#636363", hideAdminLevel: 9);
            ...
            {
                Log.Write($"CMD_tpcar Exception: {e}");
            }
        }
        ...
        public static void CMD_tpTocar(ExtPlayer player, int id)
        {
            try
            {
                ...
                foreach (var veh in vehs)
                {
                    if (veh.Value != id) continue;
                    Admin.AdminsLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) телепортировался к машине {veh.DisplayName} ({id})", 1,
                        "#636363", hideAdminLevel: 9);
            ...
            {
                Log.Write($"CMD_tpTocar Exception: {e}");
            }
        }
        ...
        public static void CMD_tpcarnumber(ExtPlayer player, string veh_number)
        {
            try
            {
                ...
                foreach (var veh in vehs)
                {
                    ...
                    Admin.AdminsLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) телепортировался к машине {veh.DisplayName} (ID: {veh.Value}; Number: {veh.NumberPlate})",
                        1, "#636363", hideAdminLevel: 9);
                    NAPI.Entity.SetEntityPosition(player, veh.Position);
                    Trigger.Dimension(player, UpdateData.GetVehicleDimension(veh));
            ...
            {
                Log.Write($"CMD_tpcarnumber Exception: {e}");
            }
        }
        ...
        public static void CMD_Setdimcar(ExtPlayer player, int id, int newDimensionNumber)
        {
            try
            {
                ...
                foreach (var veh in vehs)
                {
                    if (veh.Value != id) continue;
                    Admin.AdminsLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) изменил dimension машины {veh.DisplayName} ({id}) на {newDimensionNumber}.",
                        1, "#636363", hideAdminLevel: 9);
            ...
            {
                Log.Write($"CMD_Setdimcar Exception: {e}");
            }
        }
        ...
        public static void BanCrime(ExtPlayer player, int pid, string reason)
        {
            try
            {
                ...
                var target = Main.GetPlayerByID(pid);
                var targetCharacterData = target.GetCharacterData();
                if (target != null && targetCharacterData != null)
                {
                    if (targetCharacterData.IsBannedCrime)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            "Игрок уже заблокирован в системах capture и bizwar.", 5000);
                        return;
                    }

                    Trigger.SendPunishment(
                        $"~r~{CommandsAccess.AdminPrefix}{player.Name} ограничил доступ к системам capture и bizwar персонажу {target.Name}({target.Value}) навсегда. Причина: {reason}.",
                        target);
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Игрока с таким ID не было найдено.", 5000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"BanCrime Exception: {e}");
            }
        }
        ...
        public static void Uncrimeban(ExtPlayer player, int pid)
        {
            try
            {
                ...
                if (target != null && targetCharacterData != null)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            "Игрок не заблокирован в системах capture и bizwar.", 5000);
                        return;
                    }

                    Trigger.SendToAdmins(1,
                        $"~r~[A] {player.Name} ({player.Value}) разблокировал в системах capture и bizwar персонажа {target.Name} ({target.Value})");
                    Trigger.SendChatMessage(target,
                        $"Администратор {player.Name} разблокировал вас в системах capture и bizwar.");
            ...
            {
                Log.Write($"Uncrimeban Exception: {e}");
            }
        }
        ...
        public static void OffBanCrime(ExtPlayer player, string name, string reason)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        Notify.Send(target, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.CantFindMan), 3000);
                        return;
                    }
                    ...
                    Trigger.SetTask(async () =>
                    {
                        try
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    "Персонаж уже заблокирован в системах capture и bizwar.", 3000);
                                return;
                            }
                        ...
                        {
                            Log.Write($"Offcrimeban SetTask Exception: {e}");
                        }
                    });
                }
            }
            ...
            {
                Log.Write($"OffBanCrime Exception: {e}");
            }
        }
        ...
        public static void OffUnbanCrime(ExtPlayer player, string name)
        {
                ...
                else
                {
                    ...
                    Trigger.SetTask(async () =>
                    {
                        try
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                    "Персонаж не заблокирован в системах capture и bizwar.", 3000);
                                return;
                            }

                            Trigger.SendToAdmins(1,
                                LangFunc.GetText(LangType.Ru, DataName.UnblockBizAdmin, CommandsAccess.AdminPrefix,
                        ...
                        {
                            Log.Write($"Offuncrimeban SetTask Exception: {e}");
                        }
                    });
                }
            }
            ...
            {
                Log.Write($"OffUnbanCrime Exception: {e}");
            }
        }
        ...
        public static void CMD_flipveh(ExtPlayer player, int id)
        {
            try
            {
                ...
                foreach (var veh in vehs)
                {
                    if (veh.Value != id) continue;
                    Admin.AdminLog(characterData.AdminLVL,
                        $"{player.Name} ({player.Value}) перевернул машину {veh.DisplayName} ({id})");
            ...
            {
                Log.Write($"CMD_flipveh Exception: {e}");
            }
        }
        ...
        public static void CMD_createBiz(ExtPlayer player, int govPrice, int type, double taxes = 0.026)
        {
            ...
            {
                Log.Write($"CMD_createBiz Exception: {e}");
            }
        }
        ...
        public static void CMD_createUnloadPoint(ExtPlayer player, int bizid)
        {
            ...
            {
                Log.Write($"CMD_createUnloadPoint Exception: {e}");
            }
        }
        ...
        public static void CMD_deleteBiz(ExtPlayer player, int bizid)
        {
            ...
            {
                Log.Write($"CMD_deleteBiz Exception: {e}");
            }
        }
        ...
        public static void CMD_changeBizTax(ExtPlayer player, int bizid, double taxes = 0.026)
        {
            ...
            {
                Log.Write($"CMD_changeBizTax Exception: {e}");
            }
        }
        ...
        public static void CMD_createSafe(ExtPlayer player, int id, float distance, int min, int max, string address)
        {
            ...
            {
                Log.Write($"CMD_createSafe Exception: {e}");
            }
        }
        ...
        public static void CMD_removeSafe(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_removeSafe Exception: {e}");
            }
        }
        ...
        public static void CMD_sendTargetToDemorgan(ExtPlayer player, int id, int time, string reason)
        {
            ...
            {
                Log.Write($"CMD_sendTargetToDemorgan Exception: {e}");
            }
        }
        ...
        public static void CMD_LoadIPL(ExtPlayer player, string ipl)
        {
            ...
            {
                Log.Write($"CMD_LoadIPL Exception: {e}");
            }
        }
        ...
        public static void CMD_UnLoadIPL(ExtPlayer player, string ipl)
        {
            ...
            {
                Log.Write($"CMD_UnLoadIPL Exception: {e}");
            }
        }
        ...
        public static void CMD_LoadProp(ExtPlayer player, string str, string inttype = null)
        {
            ...
            {
                Log.Write($"CMD_LoadProp Exception: {e}");
            }
        }
        ...
        public static void CMD_UnLoadProp(ExtPlayer player, string str, string inttype = null)
        {
            ...
            {
                Log.Write($"CMD_UnLoadProp Exception: {e}");
            }
        }
        ...
        public static void CMD_StartEffect(ExtPlayer player, string effect, int dur = 0, bool loop = false)
        {
            ...
            {
                Log.Write($"CMD_StartEffect Exception: {e}");
            }
        }
        ...
        public static void CMD_StopEffect(ExtPlayer player, string effect)
        {
            ...
            {
                Log.Write($"CMD_StopEffect Exception: {e}");
            }
        }
        ...
        public static void CMD_releaseTargetFromDemorgan(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_releaseTargetFromDemorgan Exception: {e}");
            }
        }
        ...
        public static void CMD_offlineJailTarget(ExtPlayer player, string targetName, int time, string reason)
        {
            try
            {
                ...
                if (target.IsCharacterData())
                {
                    ...
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        "Игрок был онлайн, поэтому offjail заменён на jail", 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Вы не можете дать Jail больше, чем на 10080 минут", 3000);
                    return;
                }
                ...
                var demorganinfo = new DemorganInfo
                {
                    Admin = player.Name,
                    Reason = reason
                };
                ...
                Trigger.SendPunishment(
                    $"{CommandsAccess.AdminPrefix}{player.Name} посадил в деморган {targetName} в оффлайне на {time} {deTimeMsg}. Причина: {reason}");
                GameLog.Admin($"{player.Name}", $"demorgan({time}{deTimeMsg},{reason})", $"{targetName}");
            }
            catch (Exception e)
            {
                Log.Write($"CMD_offlineJailTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_Offunjail(ExtPlayer player, string targetName)
        {
            try
            {
                ...
                if (target.IsCharacterData())
                {
                    ...
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        "Игрок был онлайн, поэтому offunjail заменён на unjail", 3000);
                    return;
                }
                ...
                Trigger.SendPunishment(
                    $"{CommandsAccess.AdminPrefix}{player.Name} выпустил из деморгана {targetName.Replace('_', ' ')} в оффлайне.");
        ...
        public static void CMD_offlineWarnTarget(ExtPlayer player, string targetName, string reason)
        {
            try
            {
                ...
                if (target.IsCharacterData())
                {
                    ...
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        "Игрок был онлайн, поэтому offwarn был заменён на warn", 3000);
                    return;
                }
                ...
                Trigger.SetTask(async () =>
                {
                    try
                    {
                        ...
                        {
                            Trigger.SendToAdmins(3,
                                $"{ChatColors.StrongOrange}[A] {sessionData.Name} ({sessionData.Value}) попытался забанить {targetName} (offline), который имеет выше уровень администратора.");
                            return;
                        }
                        ...
                        var memberFractionData = Manager.GetFractionMemberData(character.Uuid);
                        if (memberFractionData != null)
                        {
                            ...
                            Fractions.Player.Repository.RemoveFractionMemberData(memberFractionData.Id,
                                memberFractionData.UUID);
                        }
                        ...
                        Trigger.SetMainTask(() =>
                        {
                            ...
                            Trigger.SendPunishment(
                                $"{CommandsAccess.AdminPrefix}{sessionData.Name} выдал предупреждение игроку {targetName} в оффлайне | {warns}/3. Причина: {reason}");
                        ...
                        if (warns >= 3)
                        {
                            ...
                            Ban.OfflineBanToNickName(targetName, DateTime.Now.AddMinutes(43200), false, "Warns 3/3",
                                "Server");
                        }
                        else
                        {
                    ...
                    {
                        Log.Write($"Offwarn SetTask Exception: {e}");
                    }
                });
            }
            catch (Exception e)
            {
                Log.Write($"CMD_offlineWarnTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_banTarget(ExtPlayer player, int id, int time, string reason)
        {
            ...
            {
                Log.Write($"CMD_banTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_sbanTarget(ExtPlayer player, int id, int time, string reason)
        {
            ...
            {
                Log.Write($"CMD_sbanTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_hardbanTarget(ExtPlayer player, int id, int time, string reason)
        {
            ...
            {
                Log.Write($"CMD_hardbanTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_pritonbanTarget(ExtPlayer player, int id)
        {
            try
            {
                ...
                Trigger.SendPunishment(
                    $"{CommandsAccess.AdminPrefix}{player.Name} отпритонил игрока {targetPlayer.Name}({targetPlayer.Id})");
        ...
        public static void CMD_banLoginTarget(ExtPlayer player, string login, int time, string reason)
        {
            ...
            {
                Log.Write($"CMD_banLoginTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_IsHard(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_IsHard Exception: {e}");
            }
        }
        ...
        public static void CMD_unbanLoginTarget(ExtPlayer player, string login)
        {
            ...
            {
                Log.Write($"CMD_unbanLoginTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_GetLogin(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_GetLogin Exception: {e}");
            }
        }
        ...
        public static void CMD_GetRb(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_GetRb Exception: {e}");
            }
        }
        ...
        public static void CMD_GetVip(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_GetVip Exception: {e}");
            }
        }
        ...
        public static void CMD_offlineBanTarget(ExtPlayer player, string name, int time, string reason)
        {
            ...
            {
                Log.Write($"CMD_offlineBanTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_offlineHardbanTarget(ExtPlayer player, string name, int time, string reason)
        {
            ...
            {
                Log.Write($"CMD_offlineHardbanTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_unbanTarget(ExtPlayer player, string name)
        {
            ...
            {
                Log.Write($"CMD_unbanTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_unhardbanTarget(ExtPlayer player, string name)
        {
            ...
            {
                Log.Write($"CMD_unhardbanTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_unbanIp(ExtPlayer player, string ip)
        {
            try
            {
                ...
                Trigger.SetTask(() => { Admin.unbanIp(player, ip); });
            }
            catch (Exception e)
            {
                Log.Write($"CMD_unbanIp Exception: {e}");
            }
        }
        ...
        public static void CMD_offredbaks(ExtPlayer player, string name, int amount)
        {
            try
            {
                ...
                name = name.ToLower();
                var target = Accounts.Repository.GetPlayerToLogin(name);
                if (target != null)
                {
                    Admin.sendRedbucks(player, Main.GetPlayerByID(target.Value), amount);
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        "Игрок был онлайн, поэтому offgivereds был заменён на givereds", 3000);
                    return;
                }

                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Вы успешно выдали {amount} RedBucks игроку с логином {name}", 3000);
                ...
                Trigger.SetTask(async () =>
                {
                    ...
                    {
                        Log.Write($"offgivereds SetTask Exception: {e}");
                    }
                });
            ...
            {
                Log.Write($"CMD_offredbaks Exception: {e}");
            }
        }
        ...
        public static void CMD_takeMask(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_takeMask Exception: {e}");
            }
        }
        ...
        public static void CMD_muteTarget(ExtPlayer player, int id, int time, string reason)
        {
            ...
            {
                Log.Write($"CMD_muteTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_offlineMuteTarget(ExtPlayer player, string target, int time, string reason)
        {
            ...
            {
                Log.Write($"CMD_offlineMuteTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_Offunmute(ExtPlayer player, string target)
        {
            ...
            {
                Log.Write($"CMD_Offunmute Exception: {e}");
            }
        }
        ...
        public static void CMD_ALog(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_ALog Exception: {e}");
            }
        }
        ...
        public static void CMD_ELog(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_ELog Exception: {e}");
            }
        }
        ...
        public static void CMD_WinLog(ExtPlayer player)
        {
            try
            {
                ...
                if (adminConfig.WinLog)
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Roulette Win Log включен",
                        3000);
                else
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Roulette Win Log выключен",
                        3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_WinLog Exception: {e}");
            }
        }
        ...
        public static void CMD_NickHistory(ExtPlayer player, int id, bool uuid = false)
        {
            try
            {
                ...
                if (DateTime.Now < sessionData.TimingsData.NextNHistory)
                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Нельзя использовать команду чаще, чем раз в 5 секунд.", 3000);
                    return;
                }
                    ...
                    if (targetSessionData != null && targetCharacterData != null)
                        Trigger.SetTask(() =>
                        {
                            try
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                                        "Игрок никогда не менял никнейм", 3000);
                                }
                                else
                                {
                                    Admin.AdminLog(characterData.AdminLVL,
                                        $"{sessionData.Name} ({sessionData.Value}) проверяет историю изменения имён {targetSessionData.Name} ({targetSessionData.Value})");
                                    sessionData.TimingsData.NextNHistory = DateTime.Now.AddSeconds(5);
                                    Trigger.SendChatMessage(player, "=== NICKNAME HISTORY BY ID ===");
                                    foreach (DataRow row in result.Rows)
                                        Trigger.SendChatMessage(player, $"[{row[0]}] {row[2]} -> {row[3]}");
                                    Trigger.SendChatMessage(player, "=== NICKNAME HISTORY BY ID ===");
                                }
                            }
                            catch (Exception e)
                            {
                                Log.Write($"Nhistory 1 SetTask Exception: {e}");
                            }
                        });
                    else
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                    ...
                    if (Main.PlayerNames.ContainsKey(id))
                        Trigger.SetTask(() =>
                        {
                            try
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                                        "Игрок либо никогда не менял никнейм, либо такого номера паспорта не существует",
                                        3000);
                                }
                                else
                                {
                                    Admin.AdminLog(characterData.AdminLVL,
                                        $"{sessionData.Name} ({sessionData.Value}) проверяет историю изменения имён по UUID {id}");
                                    sessionData.TimingsData.NextNHistory = DateTime.Now.AddSeconds(5);
                            ...
                            {
                                Log.Write($"Nhistory 2 SetTask Exception: {e}");
                            }
                        });
                    else
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.NoPlayerWithPass), 3000);
                }
            }
            catch (Exception e)
            {
                Log.Write($"CMD_NickHistory Exception: {e}");
            }
        }
        ...
        public static void CMD_kick(ExtPlayer player, int id, string reason)
        {
            ...
            {
                Log.Write($"CMD_kick Exception: {e}");
            }
        }
        ...
        public static void CMD_silenceKick(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_silenceKick Exception: {e}");
            }
        }
        ...
        public static void CMD_checkGamemode(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_checkGamemode Exception: {e}");
            }
        }
        ...
        public static void CMD_slapPlayer(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_slapPlayer Exception: {e}");
            }
        }
        ...
        public static void CMD_enableGodmode(ExtPlayer player)
        {
            ...
            {
                Log.Write($"CMD_enableGodmode Exception: {e}");
            }
        }
        ...
        public static void CMD_warnTarget(ExtPlayer player, int id, string reason)
        {
            ...
            {
                Log.Write($"CMD_warnTarget Exception: {e}");
            }
        }
        ...
        public static void CMD_CHNum(ExtPlayer player, int a, string b)
        {
            ...
            {
                Log.Write($"CMD_CHNum Exception: {e}");
            }
        }
        ...
        public static void CMD_CInum(ExtPlayer player, int a, byte b = 255, byte c = 255)
        {
            ...
            {
                Log.Write($"CMD_CInum Exception: {e}");
            }
        }
        ...
        public static void CMD_adminSMS(ExtPlayer player, int id, string msg)
        {
            ...
            {
                Log.Write($"CMD_adminSMS Exception: {e}");
            }
        }
        ...
        public static void CMD_adminGlobalChat(ExtPlayer player, string message)
        {
            ...
            {
                Log.Write($"CMD_adminGlobalChat Exception: {e}");
            }
        }
        ...
        public static void CMD_adminGlobalChatAccept(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_adminGlobalChatAccept Exception: {e}");
            }
        }
        ...
        public static void CMD_adminChat(ExtPlayer player, string message)
        {
            ...
            {
                Log.Write($"CMD_adminChat Exception: {e}");
            }
        }
        ...
        public static void CMD_checkKill(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_checkKill Exception: {e}");
            }
        }
        ...
        public static void CMD_tl(ExtPlayer player)
        {
            try
            {
                ...
                {
                    var timerscount = Timers.TimersData.Count();
                    Trigger.SendChatMessage(player, $"~g~Timers count: {timerscount}");
                    if (timerscount <= 30)
                        foreach (var timer in Timers.TimersData.Values)
        ...
        public static void CMD_setVip(ExtPlayer player, int id, int rank, ushort days)
        {
            ...
            {
                Log.Write($"CMD_setVip Exception: {e}");
            }
        }
        ...
        public static void CMD_setOfflineVip(ExtPlayer player, int rank, ushort days, string login)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.CantGiveThatVipLvl), 3000);
                    return;
                }
                ...
                if (target != null)
                {
                    ...
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.SucGiveVipOff), 3000);
                    return;
                }
                ...
                Trigger.SetTask(async () =>
                {
                    try
                    {
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.SucGiveVip, rank, days, login), 3000);
                        GameLog.Admin(sessionData.Name, $"setOffVipLvl({days})", login);
                    }
                    catch (Exception e)
                    {
                        Log.Write($"Offgivevip SetTask Exception: {e}");
                    }
                });
            }
            catch (Exception e)
            {
                Log.Write($"CMD_setOfflineVip Exception: {e}");
            }
        }
        ...
        public static void CMD_checkMoney(ExtPlayer player, int id)
        {
            ...
            {
                Log.Write($"CMD_checkMoney Exception: {e}");
            }
        }
        ...
        public static void CMD_leaveFraction(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.VipForUvalFamily), 5000);
                    return;
                }
            ...
            {
                Log.Write($"CMD_leaveFraction Exception: {e}");
            }
        }
        ...
        public static void LeaveFractionOrg(ExtPlayer player, int index)
        {
            try
            {
                ...
                if (index == 0)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.LeaderCantUval), 5000);
                        return;
                    }

                    Manager.sendFractionMessage(memberFractionData.Id,
                        "!{#FF8C00}[F] " + $"{player.Name} ({player.Value}) уволился по собственному желанию.", true);
                    Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.UnInvite,
                        LangFunc.GetText(LangType.Ru, DataName.SelfUval));
                    ...
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.YouLeaveFraction), 3000);
                }
                else if (index == 1)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.OwnerCantLeave), 5000);
                        return;
                    }

                    Organizations.Player.Repository.RemoveOrganizationMemberData(organizationData.Id, player.GetUUID());

                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.YouLeftFamily), 6000);
                }
            }
            catch (Exception e)
            {
                ...
                switch (result)
                {
                    ...
                    case 2:
                        foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 10f,
                                     UpdateData.GetPlayerDimension(sender)))
                        {
                            Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "try",
                                "!{#E066FF}{name} " + message + " | !{#277C6B}" + " удачно", new[] { sender.Value });
                            ChatHeadOverlay.SendOverlayMessage(foreachPlayer, sender.Value,
                                ChatHeadOverlay.MessageType.Try, message, true);
                        }
                    ...
                    default:
                        ...
                        {
                            Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "try",
                                "!{#E066FF}{name} " + message + " | !{#FF0707}" + " неудачно", new[] { sender.Value });
                            ChatHeadOverlay.SendOverlayMessage(foreachPlayer, sender.Value,
                                ChatHeadOverlay.MessageType.Try, message);
                        }
        ...
        private static void Roll(ExtPlayer sender, int first, int second)
        {
            try
            {
                var result = Main.rnd.Next(first, second + 1);
                foreach (var foreachPlayer in Main.GetPlayersInRadiusOfPosition(sender.Position, 10f,
                             UpdateData.GetPlayerDimension(sender)))
                    Trigger.ClientEvent(foreachPlayer, "sendRPMessage", "roll",
                        "!{#FF8C00}{name} выбросил число " + result + " | !{#e69500}" + first + " - " + second,
                        new[] { sender.Value });
            }
            catch (Exception e)
            {
                Log.Write($"Roll Exception: {e}");
            }
        }
