...
namespace NeptuneEvo.Core
{
    ...
    public class RentZoneData
    {
        ...
        public RentCarId Index { get; set; }
    }
    ...
    public class RentCarData
    {
        ...
        [JsonIgnore] public List<RentCarId> CarsId { get; set; }

        [JsonIgnore] public JobsId Job { get; set; }
    }

    internal class Rentcar : Script
    {
        private static readonly nLog Log = new nLog("Core.Rentcar");

        private static readonly Color[] RentColorData = new Color[9]
        {
            new Color(0, 0, 0),
        ...
        public static RentCarData[] RentCarsData =
        {
            ...
            new RentCarData(104, "rallytruck", 20, new List<RentCarId> { RentCarId.JobCollector },
                JobsId.CashCollector),
        ...
        private static readonly RentCarSpawn[] RentCarsSpawn =
        {
            new RentCarSpawn(1, new Vector3(-174.5694, -181.5158, 43.18488),
                new Vector3(-0.05705871f, -0.1541872f, 340.2171f)),
            new RentCarSpawn(1, new Vector3(-177.9232, -180.3944, 43.1904),
                new Vector3(-0.06142293f, -0.1456173f, 340.7091f)),
            new RentCarSpawn(1, new Vector3(-181.2611, -179.2929, 43.1919),
                new Vector3(0.1182507f, -0.05557432f, 340.5893f)),
            new RentCarSpawn(1, new Vector3(-184.4611, -178.2069, 43.19278),
                new Vector3(0.08228108f, -0.0325385f, 340.8163f)),
            new RentCarSpawn(1, new Vector3(-187.6113, -177.1798, 43.19285),
                new Vector3(0.1143083f, -0.04350877f, 341.3497f)),
            new RentCarSpawn(1, new Vector3(-190.9109, -176.1367, 43.19333),
                new Vector3(0.1034455f, -0.1197823f, 341.5069f)),
            new RentCarSpawn(1, new Vector3(-171.7888, -167.1982, 43.18843),
                new Vector3(0.02188119f, -0.04304371f, 340.8701f)),
            new RentCarSpawn(1, new Vector3(-185.1973, -162.5179, 43.18881),
                new Vector3(0.004956556f, 0.004005647f, 340.1981f)),

            new RentCarSpawn(2, new Vector3(-318.1875, -880.2917, 30.6464),
                new Vector3(-0.0157926f, 0.06523791f, 167.5566f)),
            new RentCarSpawn(2, new Vector3(-302.3612, -899.517, 30.64738),
                new Vector3(-0.007157338f, -0.1631727f, 347.8979f)),
            new RentCarSpawn(2, new Vector3(-305.8806, -898.8257, 30.64716),
                new Vector3(0.04223601f, 0.009893501f, 347.7854f)),
            new RentCarSpawn(2, new Vector3(-298.6348, -900.32, 30.64729),
                new Vector3(0.01027106f, -0.03159515f, 348.1921f)),
            new RentCarSpawn(2, new Vector3(-309.5218, -898.0364, 30.6459),
                new Vector3(-0.01406786f, 0.04576958f, 347.7824f)),
            new RentCarSpawn(2, new Vector3(-310.9652, -881.8445, 30.64712),
                new Vector3(-0.02186359f, -0.007394671f, 168.2584f)),
            new RentCarSpawn(2, new Vector3(-327.623, -894.1865, 30.63894),
                new Vector3(0.04555815f, 0.001252634f, 347.9704f)),
            new RentCarSpawn(2, new Vector3(-336.3365, -876.4655, 30.63833),
                new Vector3(-0.07224572f, 0.05279379f, 168.0992f)),
            new RentCarSpawn(2, new Vector3(-308.0478, -908.5814, 30.64372),
                new Vector3(-0.002515211f, 0.007317593f, 167.9839f)),
            new RentCarSpawn(2, new Vector3(-311.6236, -907.824, 30.64331),
                new Vector3(0.01597843f, -0.00578986f, 168.8448f)),
            new RentCarSpawn(2, new Vector3(-315.1973, -907.0726, 30.64338),
                new Vector3(0.01928982f, 0.05517132f, 168.0546f)),
            new RentCarSpawn(2, new Vector3(-326.0757, -904.7607, 30.64476),
                new Vector3(0.05742029f, -0.01690229f, 168.2157f)),
            new RentCarSpawn(2, new Vector3(-340.6255, -901.6813, 30.64166),
                new Vector3(0.008807567f, 0.09599815f, 168.0399f)),
            new RentCarSpawn(2, new Vector3(-326.1788, -952.576, 30.64692),
                new Vector3(-0.03110901f, -0.002700633f, 249.9506f)),
            new RentCarSpawn(2, new Vector3(-322.3165, -942.0166, 30.64689),
                new Vector3(-0.02742851f, -0.007622322f, 250.173f)),
            new RentCarSpawn(2, new Vector3(-318.5148, -931.6251, 30.64681),
                new Vector3(-0.04162052f, -0.02506509f, 250.2673f)),
            new RentCarSpawn(2, new Vector3(-329.161, -931.6671, 30.64772),
                new Vector3(0.05298815f, 0.005889944f, 69.63324f)),
            new RentCarSpawn(2, new Vector3(-333.0364, -942.1367, 30.64668),
                new Vector3(0.004267561f, 0.0138743f, 69.8418f)),
            new RentCarSpawn(2, new Vector3(-336.8081, -952.5752, 30.647),
                new Vector3(0.04734382f, 0.001573325f, 70.02142f)),
            new RentCarSpawn(2, new Vector3(-346.6637, -973.3312, 30.64714),
                new Vector3(-0.02138184f, -0.1341068f, 340.0938f)),

            new RentCarSpawn(3, new Vector3(-50.89787, -2104.142, 16.2709),
                new Vector3(-0.01726568f, -0.003165648f, 199.6255f)),
            new RentCarSpawn(3, new Vector3(-45.99706, -2096.494, 16.27115),
                new Vector3(0.051618f, -0.05478308f, 19.47269f)),
            new RentCarSpawn(3, new Vector3(-57.41492, -2106.457, 16.27176),
                new Vector3(-0.05241027f, 0.06955543f, 199.8726f)),
            new RentCarSpawn(3, new Vector3(-55.92258, -2099.988, 16.27176),
                new Vector3(0.07695632f, -0.006316445f, 19.3454f)),
            new RentCarSpawn(3, new Vector3(-59.25963, -2101.211, 16.27102),
                new Vector3(0.01589091f, 0.005760496f, 19.73538f)),
            new RentCarSpawn(3, new Vector3(-62.62508, -2102.37, 16.27156),
                new Vector3(0.06013114f, -0.09574953f, 19.39182f)),
            new RentCarSpawn(3, new Vector3(-69.12244, -2104.7, 16.27135),
                new Vector3(0.06034426f, -0.01935717f, 19.37039f)),
            new RentCarSpawn(3, new Vector3(-67.21611, -2109.933, 16.27152),
                new Vector3(-0.0583914f, -0.01969231f, 199.7879f)),


            new RentCarSpawn(4, new Vector3(-1870.1871, -353.87296, 48.820972),
                new Vector3(0.03433925, -0.3792338, 51.227726)),
            new RentCarSpawn(4, new Vector3(-1865.5391, -357.62314, 48.811714),
                new Vector3(0.10642323, -0.36502266, 51.194057)),
            new RentCarSpawn(4, new Vector3(-1859.9497, -362.15063, 48.81001),
                new Vector3(-0.10591185, -0.7230112, 51.150387)),
            new RentCarSpawn(4, new Vector3(-1854.031, -367.87408, 48.78867),
                new Vector3(0.2960477, -0.89521986, 44.22902)),
            ...
            new RentCarSpawn(5, new Vector3(-897.9762, -2338.008, 6.285205),
                new Vector3(0.4563178, -0.01475238, 59.53125)),
            new RentCarSpawn(5, new Vector3(-896.0508, -2335.092, 6.284833),
                new Vector3(0.3837851, -0.07570215, 59.5777)),
            new RentCarSpawn(5, new Vector3(-894.3827, -2332.052, 6.284529),
                new Vector3(0.0461585, -0.08129423, 58.94998)),
            new RentCarSpawn(5, new Vector3(-892.9431, -2328.928, 6.285657),
                new Vector3(0.4100015, -0.006029424, 59.83563)),
            new RentCarSpawn(5, new Vector3(-890.9929, -2326.119, 6.284601),
                new Vector3(0.5029823, -0.008816821, 59.24673)),
            new RentCarSpawn(5, new Vector3(-889.317, -2323.177, 6.285734),
                new Vector3(-0.4272468, -0.0414784, 239.4405)),
            new RentCarSpawn(5, new Vector3(-902.3571, -2327.442, 6.285857),
                new Vector3(0.4593074, -0.0718815, 59.3819)),
            new RentCarSpawn(5, new Vector3(-900.6923, -2324.279, 6.285465),
                new Vector3(-0.4276452, 0.008349739, 239.0667)),
            new RentCarSpawn(5, new Vector3(-899.0521, -2321.255, 6.284715),
                new Vector3(-0.4067092, 0.08733013, 239.4432)),
            new RentCarSpawn(5, new Vector3(-897.3215, -2318.225, 6.28545),
                new Vector3(-0.4077923, 0.0009872941, 239.7602)),

            new RentCarSpawn(6, new Vector3(430.771, -1163.992, 28.86712),
                new Vector3(-0.3971694, -0.1512112, 268.8827)),
            new RentCarSpawn(6, new Vector3(430.7942, -1160.919, 28.86791),
                new Vector3(-0.3884627, -0.1953789, 269.2471)),
            new RentCarSpawn(6, new Vector3(430.8293, -1157.821, 28.8676),
                new Vector3(-0.3838955, -0.1580842, 268.8311)),
            new RentCarSpawn(6, new Vector3(431.3412, -1154.808, 28.86795),
                new Vector3(-0.4068561, -0.185202, 269.0997)),
            new RentCarSpawn(6, new Vector3(450.2335, -1154.799, 28.86864),
                new Vector3(-0.3733782, -0.2515301, 270.0211)),
            new RentCarSpawn(6, new Vector3(450.963, -1157.918, 28.86827),
                new Vector3(-0.3490867, -0.2214924, 269.2381)),
            new RentCarSpawn(6, new Vector3(466.7895, -1160.866, 28.867727),
                new Vector3(0.4831736, 0.1689919, 88.4624)),
            ...
            new RentCarSpawn(6, new Vector3(466.7534, -1151.801, 28.86844),
                new Vector3(0.3878667, 0.2117222, 88.62674)),

            new RentCarSpawn(7, new Vector3(451.8294, 241.589, 102.7857),
                new Vector3(-0.4219078, -0.06872021, 250.1397)),
            new RentCarSpawn(7, new Vector3(452.911, 245.4417, 102.7855),
                new Vector3(-0.4284297, -0.05800131, 249.7882)),
            new RentCarSpawn(7, new Vector3(454.3848, 249.2663, 102.7852),
                new Vector3(-0.4381595, -0.06327292, 249.4981)),
            new RentCarSpawn(7, new Vector3(455.9629, 253.0731, 102.7846),
                new Vector3(-0.3863182, -0.01275678, 248.7229)),
            new RentCarSpawn(7, new Vector3(457.2606, 257.1321, 102.7847),
                new Vector3(-0.3928577, 0.009186273, 248.616)),
            new RentCarSpawn(7, new Vector3(458.5437, 261.1554, 102.7775),
                new Vector3(-0.04348389, -0.1405418, 247.9011)),
            new RentCarSpawn(7, new Vector3(474.82, 258.1346, 102.7508), new Vector3(1.066143, 0.2817946, 67.78595)),
            new RentCarSpawn(7, new Vector3(473.1094, 254.5523, 102.7824),
                new Vector3(0.7669627, 0.004181491, 67.50043)),
            new RentCarSpawn(7, new Vector3(471.8403, 250.4892, 102.7856),
                new Vector3(0.4057048, 0.04992635, 68.24734)),
            new RentCarSpawn(7, new Vector3(470.3324, 246.4821, 102.7858),
                new Vector3(0.4291589, 0.05247339, 69.04037)),
            ...
            new RentCarSpawn(9, new Vector3(-512.2274, 48.3715, 52.15555),
                new Vector3(0.3769324, 0.06426719, 84.32648)),
            ...
            new RentCarSpawn(9, new Vector3(-511.2399, 58.76492, 85.27954),
                new Vector3(0.4060883, 0.09852947, 85.27954)),
            new RentCarSpawn(9, new Vector3(-510.7679, 62.07866, 52.1559),
                new Vector3(0.3325565, 0.09247382, 85.27368)),
            new RentCarSpawn(9, new Vector3(-510.7644, 65.54324, 52.15617),
                new Vector3(0.3875904, 0.1701448, 85.24359)),
            new RentCarSpawn(9, new Vector3(-519.9171, 66.44729, 52.16188),
                new Vector3(0.2810165, 0.1737145, 84.83469)),
            new RentCarSpawn(9, new Vector3(-520.3444, 63.01442, 52.15625),
                new Vector3(0.3766993, 0.05146263, 85.13681)),
            new RentCarSpawn(9, new Vector3(-522.2057, 56.09792, 52.15612),
                new Vector3(0.3802727, 0.06624217, 83.50162)),
            new RentCarSpawn(9, new Vector3(-522.3361, 52.66425, 52.15601),
                new Vector3(0.3874057, 0.1123808, 83.55823)),

            new RentCarSpawn(10, new Vector3(-1110.0714, -1687.2632, 3.9690647),
                new Vector3(1.414125, -9.993989, 123.23767)),
            new RentCarSpawn(10, new Vector3(-1110.706, -1686.3707, 3.9668412),
                new Vector3(1.414125, -9.993989, 123.23767)),
            new RentCarSpawn(10, new Vector3(-1111.2255, -1685.5366, 3.9628434),
                new Vector3(1.414125, -9.993989, 123.23767)),
            new RentCarSpawn(10, new Vector3(-1111.7163, -1684.698, 3.958074),
                new Vector3(1.414125, -9.993989, 123.23767)),
            new RentCarSpawn(10, new Vector3(-1113.8, -1681.3245, 3.7240539),
                new Vector3(1.414125, -9.993989, 123.23767)),

            new RentCarSpawn(11, new Vector3(-2033.8209, -144.04314, 26.91546),
                new Vector3(1.6794965, -3.8138664, 11.867685)),
            new RentCarSpawn(11, new Vector3(-2037.5754, -144.74968, 26.645937),
                new Vector3(1.6794965, -3.8138664, 11.867685)),
            new RentCarSpawn(11, new Vector3(-2041.4047, -146.07176, 26.258629),
                new Vector3(1.6794965, -3.8138664, 11.867685)),
            new RentCarSpawn(11, new Vector3(-2045.335, -146.86227, 25.958672),
                new Vector3(1.6794965, -3.8138664, 11.867685)),
            new RentCarSpawn(11, new Vector3(-2020.643, -140.14137, 27.943287),
                new Vector3(1.6794965, -3.8138664, 11.867685)),


            new RentCarSpawn(12, new Vector3(-745.3629, -1468.709, 5.656288),
                new Vector3(-0.036325663, 0.011740752, -39.67728)),
            new RentCarSpawn(12, new Vector3(-722.495, -1440.7362, 5.150613),
                new Vector3(-0.036325663, 0.011740752, -39.67728)),
            new RentCarSpawn(12, new Vector3(-745.56995, -1434.0243, 5.6562576),
                new Vector3(-0.036325663, 0.011740752, -39.67728)),
            new RentCarSpawn(12, new Vector3(-760.76086, -1451.5165, 5.1507726),
                new Vector3(-0.036325663, 0.011740752, -39.67728)),
            new RentCarSpawn(12, new Vector3(-721.09955, -1470.0712, 5.1487603),
                new Vector3(-0.036325663, 0.011740752, -39.67728)),
            ...
            new RentCarSpawn(14, new Vector3(-1632.236, -1165.9996, 0.6303333),
                new Vector3(6.93445, -0.1506541, 132.22064)),
            new RentCarSpawn(14, new Vector3(-1628.162, -1171.5198, 0.29829717),
                new Vector3(6.93445, -0.1506541, 132.22064)),
            new RentCarSpawn(14, new Vector3(-1626.0686, -1178.5404, 0.23963523),
                new Vector3(6.93445, -0.1506541, 132.22064)),
            new RentCarSpawn(14, new Vector3(-1639.209, -1161.8162, 0.33406627),
                new Vector3(6.93445, -0.1506541, 132.22064)),

            new RentCarSpawn(15, new Vector3(1704.5836, 3765.2153, 34.47876),
                new Vector3(0.75567406, 1.393849, -43.4506)),
            new RentCarSpawn(16, new Vector3(1034.3667, -768.3401, 58.108864),
                new Vector3(0.05719879, 0.018552255, -123.13604)),
            new RentCarSpawn(17, new Vector3(939.675, 152.07137, 80.936646),
                new Vector3(0.0025635208, 0.045237403, -99.849365)),
            new RentCarSpawn(18, new Vector3(-1528.9316, -441.73447, 35.548016),
                new Vector3(0.004259539, 0.039786126, -40.206657)),
            new RentCarSpawn(19, new Vector3(-815.7129, -1098.1162, 11.002188),
                new Vector3(-2.0329742, 0.6184526, -60.136856)),
            new RentCarSpawn(20, new Vector3(666.50916, 677.23474, 129.01698),
                new Vector3(-0.007891121, 0.07989738, -169.08899)),
            new RentCarSpawn(21, new Vector3(224.46017, 1190.2013, 225.56647), new Vector3(0.0, 0.0587127, -76.008934)),
            new RentCarSpawn(22, new Vector3(-2298.184, 432.209, 174.57285),
                new Vector3(-0.0010881771, 0.02322577, 83.91831)),

            new RentCarSpawn(23, new Vector3(393.37677, -641.63324, 28.607044),
                new Vector3(0.029187638, 0.02156517, -90.404854)),
            new RentCarSpawn(23, new Vector3(392.59622, -638.68616, 28.500456),
                new Vector3(0.029187638, 0.02156517, -90.404854)),
            new RentCarSpawn(23, new Vector3(392.97382, -644.4817, 28.500397),
                new Vector3(0.029187638, 0.02156517, -90.404854)),
            new RentCarSpawn(23, new Vector3(392.7322, -646.9236, 28.500397),
                new Vector3(0.029187638, 0.02156517, -90.404854)),
            new RentCarSpawn(23, new Vector3(392.94098, -649.8968, 28.500372),
                new Vector3(0.029187638, 0.02156517, -90.404854)),
            new RentCarSpawn(23, new Vector3(394.044, -652.29694, 28.500374),
                new Vector3(0.029187638, 0.02156517, -90.404854)),
            new RentCarSpawn(23, new Vector3(393.366, -654.85095, 28.500374),
                new Vector3(0.029187638, 0.02156517, -90.404854)),
            new RentCarSpawn(23, new Vector3(393.30997, -657.5077, 28.50092),
                new Vector3(0.029187638, 0.02156517, -90.404854)),

            new RentCarSpawn(24, new Vector3(581.05286, 2737.7097, 42.094994),
                new Vector3(0.8488338, -0.13431707, -176.13246)),
            new RentCarSpawn(25, new Vector3(2759.5288, 3451.1345, 55.994274),
                new Vector3(0.5461421, 0.9669539, 67.04312)),
            new RentCarSpawn(26, new Vector3(-87.695526, 6352.424, 31.5962),
                new Vector3(-0.0012338621, 0.011630188, -133.93575)),
            new RentCarSpawn(27, new Vector3(-3141.3203, 1117.3033, 20.808395),
                new Vector3(-0.121122316, 0.10135113, -80.176315)),
            new RentCarSpawn(28, new Vector3(-369.13602, -192.6861, 37.23995),
                new Vector3(-2.2892237, 1.984975, 114.70944)),
            new RentCarSpawn(29, new Vector3(1691.1672, 4782.2334, 42.027508),
                new Vector3(-0.0001255144, 0.031130577, 90.62616)),

            new RentCarSpawn(30, new Vector3(902.8164, -191.28867, 73.90146),
                new Vector3(-0.027476171, 0.1384309, 57.97243)),
            new RentCarSpawn(30, new Vector3(898.3195, -184.01509, 73.89375),
                new Vector3(1.1147208, 1.2942469, -121.70208)),
            new RentCarSpawn(30, new Vector3(899.8642, -180.81726, 73.964355),
                new Vector3(2.363212, 1.3178126, -121.72175)),
            new RentCarSpawn(30, new Vector3(904.24, -188.6237, 73.917786),
                new Vector3(-0.16111109, -1.857971, 58.03828)),
            new RentCarSpawn(30, new Vector3(905.93585, -185.80649, 74.099236),
                new Vector3(-0.70865935, -3.5652447, 58.61184)),
            new RentCarSpawn(30, new Vector3(908.05286, -182.84102, 74.27756),
                new Vector3(-0.71112895, -1.2539438, 57.55628)),
            new RentCarSpawn(30, new Vector3(914.0668, -160.31645, 74.86101),
                new Vector3(-3.011666, 2.961873, -166.9159)),
            new RentCarSpawn(30, new Vector3(911.6437, -164.16058, 74.451675),
                new Vector3(-2.2028284, 4.2686715, -167.0033)),
            new RentCarSpawn(30, new Vector3(919.3124, -163.84875, 74.89035),
                new Vector3(-2.6110318, -1.199865, 99.85049)),
            new RentCarSpawn(30, new Vector3(917.83545, -167.19456, 74.68027),
                new Vector3(-4.4208026, -0.9922294, 101.08802)),
            new RentCarSpawn(30, new Vector3(914.87036, -170.95316, 74.47221),
                new Vector3(-2.322488, 0.40433708, 100.489685)),

            new RentCarSpawn(31, new Vector3(-1330.758, 44.09792, 53.48625),
                new Vector3(1.926815, -0.7770224, 272.733)),
            new RentCarSpawn(31, new Vector3(-1331.057, 45.90104, 53.48906),
                new Vector3(1.926815, -0.7770224, 272.733)),
            new RentCarSpawn(31, new Vector3(-1331.293, 49.59402, 53.4978),
                new Vector3(0.06539849, -1.081534, 269.8514)),
            new RentCarSpawn(31, new Vector3(-1331.297, 51.49276, 53.5071), new Vector3(-1.502, -1.38771, 274.4296)),
            new RentCarSpawn(31, new Vector3(-1331.475, 53.58579, 53.53268),
                new Vector3(0.578413, 0.2098309, 272.2005)),

            new RentCarSpawn(32, new Vector3(461.65768, -611.4021, 28.48324),
                new Vector3(-0.02752222, 0.001027761, 34.50727)),
            new RentCarSpawn(32, new Vector3(460.96286, -619.0856, 28.486208),
                new Vector3(-0.0284836, 0.0007392637, 34.50727)),
            new RentCarSpawn(32, new Vector3(460.36304, -626.06683, 28.473759),
                new Vector3(-0.0414436, -0.04651098, 34.50727)),

            new RentCarSpawn(33, new Vector3(1035.6702, -2502.8691, 28.976217),
                new Vector3(-0.32226002, -1.2020961, 86.26333)), //Trucker
            new RentCarSpawn(33, new Vector3(981.342, -2514.422, 28.874794),
                new Vector3(-0.30495864, 0.030388767, -5.5115523)),
            new RentCarSpawn(33, new Vector3(993.47327, -2542.1565, 28.877434),
                new Vector3(-0.28843352, -0.39391035, -4.709389)),
            new RentCarSpawn(33, new Vector3(988.2242, -2543.508, 28.875763),
                new Vector3(-0.30184668, -0.0022361565, -5.125958)),
            new RentCarSpawn(33, new Vector3(982.9293, -2543.0437, 28.875128),
                new Vector3(-0.31403106, -0.013987683, -5.1128516)),
            new RentCarSpawn(33, new Vector3(977.26227, -2542.8386, 28.874996),
                new Vector3(-0.3078568, -0.018375935, -4.5746417)),
            new RentCarSpawn(33, new Vector3(971.58997, -2542.7356, 28.87525),
                new Vector3(-0.300278, 0.0011830402, -4.473188)),
            new RentCarSpawn(33, new Vector3(966.72253, -2493.0432, 28.875286),
                new Vector3(-0.29982027, 0.018019041, -95.18963)),


            new RentCarSpawn(34, new Vector3(-251.7521, -800.73, 32.06821),
                new Vector3(-0.07124979, -0.6522369, 70.50944)),
            new RentCarSpawn(34, new Vector3(-253.78963, -806.3217, 31.997648),
                new Vector3(-0.75878817, -1.0553579, 70.19326)),
            new RentCarSpawn(34, new Vector3(-255.43657, -810.9291, 31.910107),
                new Vector3(-0.82312196, -1.3626906, 68.64489)),
            new RentCarSpawn(34, new Vector3(-183.51378, -833.24915, 30.606346),
                new Vector3(-2.5574489, -0.053839557, 161.146)),


            new RentCarSpawn(35, new Vector3(-214.27658, -1396.4149, 31.479969),
                new Vector3(-0.0070513403, 0.24732511, -1.8451166)),
            new RentCarSpawn(35, new Vector3(-211.02673, -1395.2876, 31.460701),
                new Vector3(0.05056099, 0.21844293, -2.5574648)),
            new RentCarSpawn(35, new Vector3(-207.78726, -1393.2866, 31.460423),
                new Vector3(0.09259284, -0.056687277, -4.7259603)),
            new RentCarSpawn(35, new Vector3(-204.34955, -1390.8542, 31.464195),
                new Vector3(0.118800394, -0.014325082, -4.841728)),
            new RentCarSpawn(35, new Vector3(-200.95221, -1389.2278, 31.467638),
                new Vector3(0.19828947, -0.027469337, -3.9036434)),


            new RentCarSpawn(36, new Vector3(1026.7847, 2655.2761, 39.033),
                new Vector3(1.4389486, -10.552636, 3.4545832)),
            new RentCarSpawn(37, new Vector3(1708.8262, 3322.749, 40.63515),
                new Vector3(1.61088, -4.9899263, 104.962944)),
            new RentCarSpawn(38, new Vector3(1724.642, 3032.9932, 61.131077),
                new Vector3(-8.666602, -11.257494, 28.72162)),
            new RentCarSpawn(39, new Vector3(142.37561, 6642.599, 31.03968),
                new Vector3(1.6741208, -7.467835, -134.68036)),
            new RentCarSpawn(40, new Vector3(1433.9878, 6327.6343, 23.490828),
                new Vector3(0.41281283, -10.429041, 9.506355)),
            new RentCarSpawn(41, new Vector3(266.994, 2576.17, 44.550083),
                new Vector3(1.8884326, -10.119145, 94.80255)),
            new RentCarSpawn(42, new Vector3(-2171.7441, 4284.0054, 48.57687),
                new Vector3(-0.19050123, -9.797245, -116.29667)),
            new RentCarSpawn(43, new Vector3(2558.0513, 4638.4062, 33.555645),
                new Vector3(1.4744326, -12.007178, 34.060837)),
            ...
            new RentCarSpawn(46, new Vector3(-1129.0437, 2695.0698, 18.278246),
                new Vector3(1.0227525, -14.280303, 132.4395)),
            new RentCarSpawn(47, new Vector3(-2653.5247, 2537.4373, 2.491056),
                new Vector3(3.386247, -14.864119, -169.03465)),
            new RentCarSpawn(48, new Vector3(-1831.0725, 4717.8604, 4.3654637),
                new Vector3(10.0039215, -14.434008, -11.664999)),
            new RentCarSpawn(49, new Vector3(1650.6614, 4822.275, 42.01151), new Vector3(0, 0, -79.82406)),
            new RentCarSpawn(50, new Vector3(3300.8755, 5421.423, 14.806988),
                new Vector3(-0.36866316, -15.634828, 105.4096)),
            new RentCarSpawn(51, new Vector3(2833.4812, -718.2979, 1.2482079),
                new Vector3(3.0830255, -9.975561, 56.42447)),
            new RentCarSpawn(52, new Vector3(1419.703, 3658.0242, 34.245663), new Vector3(0, 0, -69.4306)),
            new RentCarSpawn(53, new Vector3(839.58594, -3207.73, 5.383651),
                new Vector3(1.3912914, -8.619342, -177.07631)),
            ...
            new RentCarSpawn(56, new Vector3(-1237.633, -1393.4529, 3.5960727),
                new Vector3(1.3184941, -5.553617, 28.4425)),
            new RentCarSpawn(57, new Vector3(1394.9974, -2070.8127, 51.47276),
                new Vector3(0.9165503, -14.998191, 42.2178)),

            //
            new RentCarSpawn(58, new Vector3(143.00418, 88.87534, 84.470924),
                new Vector3(11.759784, 11.679694, -108.32673)),
            new RentCarSpawn(58, new Vector3(115.86591, 99.75133, 81.20775),
                new Vector3(2.0681894, 2.7572758, -109.89315)),
            new RentCarSpawn(58, new Vector3(78.28004, 105.85141, 79.4785),
                new Vector3(1.6316543, 0.6632541, -110.39596)),
            new RentCarSpawn(58, new Vector3(89.00515, 101.92234, 79.38229),
                new Vector3(-1.5315505, 1.6411599, -110.40726)),
            //
            new RentCarSpawn(59, new Vector3(-472.08853, -312.73453, 34.352623),
                new Vector3(2.2234323, 0.110054456, 22.536076)),
            new RentCarSpawn(59, new Vector3(-469.5927, -311.55832, 34.356796),
                new Vector3(2.2234323, 0.110054456, 22.536076)),
            new RentCarSpawn(59, new Vector3(-481.6924, -316.39682, 34.369534),
                new Vector3(2.2234323, 0.110054456, 22.536076)),
            new RentCarSpawn(59, new Vector3(-479.127, -315.04065, 34.377766),
                new Vector3(2.2234323, 0.110054456, 22.536076)),

            //
            new RentCarSpawn(60, new Vector3(-229.7352, -2655.4016, 5.561528),
                new Vector3(0.2472642, 0.0266275, -1.2886565)),
            new RentCarSpawn(60, new Vector3(-225.03607, -2656.1172, 5.561744),
                new Vector3(0.1952224, -0.0025922605, 0.61881626)),

            //
            new RentCarSpawn(61, new Vector3(-2347.691, 3435.4895, 28.729162),
                new Vector3(-7.3660207, 1.7780894, 139.44058)),
            new RentCarSpawn(61, new Vector3(-2350.7917, 3437.5107, 28.548496),
                new Vector3(-10.955082, 1.3881285, 134.61066))
        };

        public static RentZoneData[] RentPedsData =
        {
            ...
            new RentZoneData(2, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(-280.0288, -889.7692, 31.0806), 252.4524f, RentCarId.Civilian),
            ...
            new RentZoneData(6, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(453.2874, -1149.766, 29.29178), 180.0f, RentCarId.Civilian),
            new RentZoneData(7, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(461.9777, 217.6612, 103.1002), 0.0f, RentCarId.Civilian),
            ...
            new RentZoneData(14, "s_m_y_uscg_01", LangFunc.GetText(LangType.Ru, DataName.BoatRent),
                new Vector3(-1606.993, -1127.9418, 2.1554325), 0.0f, RentCarId.WaterBased),
            ...
            new RentZoneData(18, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(-1541.2733, -437.8889, 35.596672), -79.82406f, RentCarId.Civilian),
            new RentZoneData(19, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(-820.0671, -1100.6382, 11.156218), -59.84502f, RentCarId.Civilian),
            ...
            new RentZoneData(23, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(394.68338, -633.62024, 28.70693), -88.82406f, RentCarId.Civilian),
            ...
            new RentZoneData(30, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.TaxiRent),
                new Vector3(899.3858, -172.74521, 74.01804), -149.6f, RentCarId.JobTaxi),
            new RentZoneData(31, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.LandmowerRent),
                new Vector3(-1330.482, 42.12986, 53.48915), 0.0f, RentCarId.JobLawnmower),
            new RentZoneData(32, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.BusRent),
                new Vector3(435.23758, -653.01117, 28.730534), 78.42807f, RentCarId.JobBus),
            new RentZoneData(33, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.FuraRent),
                new Vector3(1018.9361, -2511.5688, 28.480877), 142.21999f, RentCarId.JobTrucker),
            new RentZoneData(34, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.FurgonRent),
                new Vector3(-196.52617, -830.6757, 30.771637), -65.649086f, RentCarId.JobCollector),
            new RentZoneData(35, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.MechanikRent),
                new Vector3(-229.61082, -1378.2086, 31.258224), 179.0f, RentCarId.JobMechanic),
            ...
            new RentZoneData(51, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(2830.9817, -710.8333, 1.97693), 81.07968f, RentCarId.Civilian),
            ...
            new RentZoneData(54, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(-330.19974, -2464.6208, 6.0006385), 142.68982f, RentCarId.Civilian),
            ...
            new RentZoneData(56, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(-1237.501, -1395.8168, 4.141041), 122.99152f, RentCarId.Civilian),
            new RentZoneData(57, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(1389.4164, -2073.133, 51.99858), 53.371437f, RentCarId.Civilian),
            //
            new RentZoneData(58, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.FurgonRent2),
                new Vector3(136.40952, 94.93223, 83.507645), 102.5f, RentCarId.JobPostman), // Postal NPC
            new RentZoneData(59, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(-478.59937, -304.3146, 35.113594), -157f, RentCarId.Civilian),
            new RentZoneData(60, "a_m_y_genstreet_01", LangFunc.GetText(LangType.Ru, DataName.CarRent),
                new Vector3(-227.15689, -2666.8054, 6.0002985), 7.2f, RentCarId.Civilian) // НУПАУАУАУ
        ...
        private static readonly IReadOnlyDictionary<RentCarId, RentBlipData> RentBlipsData =
            new Dictionary<RentCarId, RentBlipData>
            {
        ...
        private static readonly Dictionary<int, int> PedsToRentCarId = new Dictionary<int, int>();
        private static readonly Dictionary<int, int> RentCarsSpawnCount = new Dictionary<int, int>();
            ...
            try
            {
                ...
                if (seatid == 0 && vehicleLocalData != null && vehicleLocalData.Access == VehicleAccess.Rent)
                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.AlreadyRented), 3000);
                    VehicleManager.WarpPlayerOutOfVehicle(player);
                }
            }
            catch (Exception e)
            {
                Log.Write($"Event_OnPlayerEnterVehicle Exception: {e}");
            }
        }
                    ...
                    if (sessionData.RentData != null)
                    {
                        ...
                        if (prefix != string.Empty)
                            Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.RentCarWas, prefix), 3000);
        ...
        public void Init()
        {
            ...
            {
                var i = 0;
                foreach (var rentPedData in RentPedsData)
                {
                    if (!RentBlipsData.ContainsKey(rentPedData.Index)) continue;
                    var rentBlisessionData = RentBlipsData[rentPedData.Index];

                    if (rentPedData.ZoneId < 36 || rentPedData.ZoneId > 57)
                        Main.CreateBlip(new Main.BlipData(rentBlisessionData.BlipId, rentBlisessionData.BlipName,
                            rentPedData.Position, rentBlisessionData.Color, true));

                    var ped = Repository.CreateQuest(rentPedData.Skin, rentPedData.Position, rentPedData.Heading,
                        title: $"~y~NPC~w~ {rentPedData.Title}", colShapeEnums: ColShapeEnums.RentCar);
        ...
        public static void OnRentMenu(ExtPlayer player, int Index)
        {
            ...
            {
                Log.Write($"OnRentMenu Exception: {e}");
            }
        }
            ...
            try
            {
                ...
                if (player.IsInVehicle)
                {
                    ...
                    Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Rent,
                        LangFunc.GetText(LangType.Ru, DataName.CantRentAuto), DateTime.Now);
                    return;
                }
                ...
                if (sessionData.RentData != null)
                {
                    ...
                    Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Rent,
                        LangFunc.GetText(LangType.Ru, DataName.AlreadyRent), DateTime.Now);
                    return;
                }

                if (0 > carId || carId >= RentCarsData.Length) return;
                var rentCarsData = RentCarsData[carId];
                ...
                switch (rentCarsData.Job)
                {
                    case JobsId.Taxi:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.NoLicenceC), 10000);
                            return;
                        }
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.BeforeNeedToWork), 3000);
                            return;
                        }

                        var jobLevelInfo = characterData.JobSkills.ContainsKey((int)JobsId.Taxi)
                            ? Main.GetPlayerJobLevelBonus((int)JobsId.Taxi, characterData.JobSkills[(int)JobsId.Taxi])
                            : (0, 1);
                        if ((jobLevelInfo.Item1 <= 1 && rentCarsData.Model != "taxi") ||
                            (jobLevelInfo.Item1 >= 2 && jobLevelInfo.Item1 <= 4 &&
                             rentCarsData.Model != "cognoscenti" && rentCarsData.Model != "bmwm5"))
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.VehicleNotAvaible, rentCarsData.Model,
                                    jobLevelInfo.Item1), 8000);
                            return;
                        }
                    ...
                    case JobsId.Trucker:
                        ...
                        jobLevelInfo = characterData.JobSkills.ContainsKey((int)JobsId.Trucker)
                            ? Main.GetPlayerJobLevelBonus((int)JobsId.Trucker,
                                characterData.JobSkills[(int)JobsId.Trucker])
                            : (0, 1);
                        if ((jobLevelInfo.Item1 <= 1 && rentCarsData.Model != "pounder") ||
                            (jobLevelInfo.Item1 >= 2 && jobLevelInfo.Item1 <= 3 && rentCarsData.Model != "pounder" &&
                             rentCarsData.Model != "benson"))
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.VehicleNotAvaible, rentCarsData.Model,
                                    jobLevelInfo.Item1), 8000);
                    ...
                    case JobsId.Bus:
                        ...
                        jobLevelInfo = characterData.JobSkills.ContainsKey((int)JobsId.Bus)
                        ...
                        if ((jobLevelInfo.Item1 <= 2 && rentCarsData.Model != "airbus") ||
                            (jobLevelInfo.Item1 >= 3 && jobLevelInfo.Item1 <= 4 && rentCarsData.Model != "airbus" &&
                             rentCarsData.Model != "bus"))
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.VehicleNotAvaible, rentCarsData.Model,
                                    jobLevelInfo.Item1), 8000);
                    ...
                    case JobsId.CashCollector:
                        ...
                        jobLevelInfo = characterData.JobSkills.ContainsKey((int)JobsId.CashCollector)
                            ? Main.GetPlayerJobLevelBonus((int)JobsId.CashCollector,
                                characterData.JobSkills[(int)JobsId.CashCollector])
                            : (0, 1);
                        if ((jobLevelInfo.Item1 <= 2 && rentCarsData.Model != "stockade") ||
                            (jobLevelInfo.Item1 >= 3 && jobLevelInfo.Item1 <= 4 && rentCarsData.Model != "stockade" &&
                             rentCarsData.Model != "terbyte"))
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.Ru, DataName.VehicleNotAvaible, rentCarsData.Model,
                                    jobLevelInfo.Item1), 8000);
                ...
                var price = rentCarsData.Price > 0
                    ? GetRentCarCash(accountData.VipLvl, characterData.LVL, rentCarsData.Price * hour)
                    : 0;
                ...
                var spawnId = GetRentCarSpawn(RentPedsData[PedsToRentCarId[zoneId]].ZoneId);
                if (spawnId == -1) return;
                var rentCarsSpawn = RentCarsSpawn[spawnId];

                var number = $"RCAR{player.Value}";
                ...
                switch (rentCarsData.Job)
                {
                    case JobsId.None:
                        ...
                        vehicleCreate = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(rentCarsData.Model),
                            rentCarsSpawn.Position, rentCarsSpawn.Rotation.Z, 1, 1, number, acc: VehicleAccess.Rent,
                            petrol: 9999);
                        break;
                    case JobsId.Lawnmower:
                        number = VehicleManager.GenerateNumber(VehicleAccess.Work, "LAWN-"); //$"LAWN-{player.Value}";
                        vehicleCreate = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(rentCarsData.Model),
                            rentCarsSpawn.Position, rentCarsSpawn.Rotation.Z, 1, 1, number, acc: VehicleAccess.Work,
                            work: JobsId.Lawnmower, petrol: 9999, workdriv: characterData.UUID);
                        break;
                    case JobsId.Taxi:
                        number = VehicleManager.GenerateNumber(VehicleAccess.Work, "TAXI-"); //$"TAXI-{player.Value}";
                        vehicleCreate = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(rentCarsData.Model),
                            rentCarsSpawn.Position, rentCarsSpawn.Rotation.Z, 1, 1, number, acc: VehicleAccess.Work,
                            work: JobsId.Taxi, petrol: 9999, workdriv: characterData.UUID);
                        break;
                    case JobsId.Bus:
                        number = VehicleManager.GenerateNumber(VehicleAccess.Work, "BUS-"); //$"BUS-{player.Value}";
                        vehicleCreate = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(rentCarsData.Model),
                            rentCarsSpawn.Position, rentCarsSpawn.Rotation.Z, 1, 1, number, acc: VehicleAccess.Work,
                            work: JobsId.Bus, petrol: 9999, workdriv: characterData.UUID);
                        break;
                    case JobsId.Trucker:
                        number = VehicleManager.GenerateNumber(VehicleAccess.Work, "TRUCK-"); //$"TRUCK-{player.Value}";
                        vehicleCreate = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(rentCarsData.Model),
                            rentCarsSpawn.Position, rentCarsSpawn.Rotation.Z, 1, 1, number, acc: VehicleAccess.Work,
                            work: JobsId.Trucker, petrol: 9999, workdriv: characterData.UUID);
                        break;
                    case JobsId.CashCollector:
                        number = VehicleManager.GenerateNumber(VehicleAccess.Work,
                            "CLR-"); //$"COLLECTOR-{player.Value}";
                        vehicleCreate = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(rentCarsData.Model),
                            rentCarsSpawn.Position, rentCarsSpawn.Rotation.Z, 1, 1, number, acc: VehicleAccess.Work,
                            work: JobsId.CashCollector, petrol: 9999, workdriv: characterData.UUID);
                        break;
                    case JobsId.CarMechanic:
                        number = VehicleManager.GenerateNumber(VehicleAccess.Work, "MECH-"); //$"MECH-{player.Value}";
                        vehicleCreate = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(rentCarsData.Model),
                            rentCarsSpawn.Position, rentCarsSpawn.Rotation.Z, 1, 1, number, acc: VehicleAccess.Work,
                            work: JobsId.CarMechanic, petrol: 9999, workdriv: characterData.UUID);
                        break;
                    case JobsId.Postman:
                        number = VehicleManager.GenerateNumber(VehicleAccess.Work, "POST-"); //$"POSTAL-{player.Value}";
                        vehicleCreate = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(rentCarsData.Model),
                            rentCarsSpawn.Position, rentCarsSpawn.Rotation.Z, 111, 111, number, acc: VehicleAccess.Work,
                            work: JobsId.Postman, petrol: 9999, workdriv: characterData.UUID);
                        break;
                }
                ...
                switch (rentCarsData.Job)
                {
                    ...
                    case JobsId.Trucker:
                        ...
                        Jobs.Repository.OnPlayerExitVehicle(player, vehicleCreate);
                        Truckers.StartWork(player);
                        break;
                    case JobsId.CashCollector:
                        Jobs.Repository.OnPlayerExitVehicle(player, vehicleCreate);
                        Collector.StartWork(player);
                        break;
                }
                ...
                var correctMessage = LangFunc.GetText(LangType.Ru, DataName.hours);
                if (hour == 1) correctMessage = LangFunc.GetText(LangType.Ru, DataName.hour);
                else if (hour == 2 || hour == 3 || hour == 4)
                    correctMessage = LangFunc.GetText(LangType.Ru, DataName.houra);
                ...
                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Rent,
                    LangFunc.GetText(LangType.Ru, DataName.SuccRentVehJob, rentCarsData.Model), DateTime.Now);
                BattlePass.Repository.UpdateReward(player, 26);

                sessionData.RentData = new RentData(rentCarsData.Price, DateTime.Now.AddMinutes(60 * hour),
                    vehicleCreate, rentCarsData.Model, number, rentCarsData.Job != JobsId.None);
        ...
        public static void OnPlayerSpawn(ExtPlayer player)
        {
            ...
            var vehicle = Entities.Vehicles.All.Cast<ExtVehicle>()
                .Where(v => v.VehicleLocalData != null)
                .Where(v => v.VehicleLocalData.Access == VehicleAccess.Rent ||
                            v.VehicleLocalData.Access == VehicleAccess.Work)
            ...
            if (vehicleLocalData != null)
            {
                ...
                sessionData.RentData = new RentData(vehicleLocalData.RentCarPrice, vehicleLocalData.RentCarTime,
                    vehicle, vehicleLocalData.RentCarModel, vehicleLocalData.NumberPlate,
        ...
        private static int GetRentCarSpawn(int ZoneId)
        {
            ...
            var i = 0;
            foreach (var _rentCarsSpawn in RentCarsSpawn)
            {
        ...
        {
            Trigger.SetMainTask(() => { OnReturnVehicleTask(player, msg); });
        }
        ...
        private static void OnReturnVehicleTask(ExtPlayer player, bool msg = false)
        {
            try
            {
                ...
                if (sessionData.RentData != null)
                {
                    ...
                    if (msg)
                        Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Rent,
                            LangFunc.GetText(LangType.Ru, DataName.CancelledRent), DateTime.Now);
            ...
            {
                Log.Write($"OnReturnVehicle Exception: {e}");
            }
        }
                ...
                switch (listItem)
                {
                    case "gpstrack":
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.MarkSelected), 3000);
                        return;
                    case "datetime":
                        var price = GetRentCarCash(accountData.VipLvl, characterData.LVL, rent.Price);
                        Trigger.ClientEvent(player, "openDialog", "RENTCARI_DATETIME",
                            LangFunc.GetText(LangType.Ru, DataName.RentExpandConfirm, rent.Date, Wallet.Format(price)));
                        return;
                    case "stoprent":
                        Trigger.ClientEvent(player, "openDialog", "RENTCARI_STOPRENT",
                            LangFunc.GetText(LangType.Ru, DataName.RentCancelConfirm, rent.Date));
                        return;
                }
            }
            catch (Exception e)
            {
                Log.Write($"callback_selectedrentcarss Exception: {e}");
            }
        }
