...
namespace NeptuneEvo.Organizations
{
    internal class Manager : Script
    {
        ...
        public static RankToAccess[] OrganizationDefaultAccess =
        {
            RankToAccess.Invite,
        ...
        private static readonly Dictionary<int, OrganizationData> Organizations =
            new Dictionary<int, OrganizationData>();

        public static Dictionary<int, List<OrganizationMemberData>> AllMembers =
            new Dictionary<int, List<OrganizationMemberData>>();
        ...
        private static readonly Vector3[] OutsideGarage = new Vector3[17]
        {
        ...
        public static void onResourceStart()
        {
            try
            {
                ...
                for (byte i = 0; i < 3; i++)
                {
                    CustomColShape.CreateCylinderColShape(CraftPositions[i], 2, 2, NAPI.GlobalDimension,
                        ColShapeEnums.Organizations, 1); //Крафт
                    NAPI.Marker.CreateMarker(1, CraftPositions[i] - new Vector3(0, 0, 1.5), new Vector3(),
                        new Vector3(), 2f, new Color(255, 255, 255, 220));
                }

                //Stock
                for (byte i = 0; i < 3; i++)
                {
                    CustomColShape.CreateCylinderColShape(StockPositions[i], 2, 2, NAPI.GlobalDimension,
                        ColShapeEnums.Organizations, 2);
                    NAPI.Marker.CreateMarker(1, StockPositions[i] - new Vector3(0, 0, 1.5), new Vector3(),
                        new Vector3(), 2f, new Color(255, 255, 255, 220));
                }

                //Garage Enter
                NAPI.Marker.CreateMarker(1, new Vector3(-793.943, 303.561, 84.70), new Vector3(), new Vector3(), 3f,
                    new Color(255, 255, 0, 60));
                CustomColShape.CreateCylinderColShape(new Vector3(-793.943, 303.561, 85.70), 3f, 3f,
                    NAPI.GlobalDimension, ColShapeEnums.Organizations, 3);
                ...
                NAPI.Marker.CreateMarker(1, new Vector3(-1067.1245, -88.08039, -97.89984), new Vector3(), new Vector3(),
                    2f, new Color(255, 255, 255, 60), dimension: NAPI.GlobalDimension);
                ...
                //
                NAPI.TextLabel.CreateTextLabel("~w~В гараж", new Vector3(-1000.14856, -774.0971, 61.734413), 5f, 0.3f,
                    0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.Marker.CreateMarker(1, new Vector3(-1000.14856, -774.0971, 60.734413), new Vector3(),
                    new Vector3(), 2f, new Color(255, 255, 255, 60));
                CustomColShape.CreateCylinderColShape(new Vector3(-1000.14856, -774.0971, 60.734413), 2f, 2f,
                    NAPI.GlobalDimension, ColShapeEnums.Organizations, 5);
                //
                NAPI.TextLabel.CreateTextLabel("~w~В гараж", new Vector3(-1000.14856, -774.0971, 60.734413), 5f, 0.3f,
                    0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.Marker.CreateMarker(1, new Vector3(-1000.14856, -774.0971, 60.734413), new Vector3(),
                    new Vector3(), 2f, new Color(255, 255, 255, 60));
                CustomColShape.CreateCylinderColShape(new Vector3(-1000.14856, -774.0971, 60.734413), 2f, 2f,
                ...
                //Office Exit
                NAPI.TextLabel.CreateTextLabel("~w~На улицу", new Vector3(-1003.197, -774.2839, 61.8944), 5f, 0.3f, 0,
                    new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.Marker.CreateMarker(1, new Vector3(-1003.197, -774.2839, 60.8944), new Vector3(), new Vector3(),
                    2f, new Color(255, 255, 255, 60));
                CustomColShape.CreateCylinderColShape(new Vector3(-1003.197, -774.2839, 61.8944), 2f, 2f,
                    NAPI.GlobalDimension, ColShapeEnums.Organizations, 6);
                //
                NAPI.TextLabel.CreateTextLabel("~w~На улицу", new Vector3(-1003.197, -774.2839, 61.8944), 5f, 0.3f, 0,
                    new Color(255, 255, 255), true, NAPI.GlobalDimension);
                NAPI.Marker.CreateMarker(1, new Vector3(-1003.197, -774.2839, 60.8944), new Vector3(), new Vector3(),
                ...
                NAPI.Marker.CreateMarker(1, new Vector3(-1003.197, -774.2839, 60.8944), new Vector3(), new Vector3(),
                    2f, new Color(255, 255, 255, 60));
                CustomColShape.CreateCylinderColShape(new Vector3(-1003.197, -774.2839, 60.8944), 2f, 2f,
                    NAPI.GlobalDimension, ColShapeEnums.Organizations, 6);
                ...
                Repository.CreateQuest("ig_jackie", new Vector3(-773.945, 313.0294, 85.70606), 177.9122f, 0, "npc_org",
                    ColShapeEnums.OrgCreate, "~y~NPC~w~ Полли\n Директор Организации", false);
                ...
                {
                    var orgId = Convert.ToInt32(Row["Organization"]);
                    var OwnerUUID = Convert.ToInt32(Row["OwnerUUID"]);
                    var name = Row["Name"].ToString();
                    var upgrade = Convert.ToByte(Row["OfficeUP"]);
                    var customs = Convert.ToBoolean(Row["Customs"]);
                    var stock = Convert.ToBoolean(Row["Stock"]);
                    var crimeoptions = Convert.ToBoolean(Row["CrimeOptions"]);
                    var pistolscheme = Convert.ToBoolean(Row["PistolScheme"]);
                    var pistolmk2scheme = Convert.ToBoolean(Row["PistolMk2Scheme"]);
                    var pistol50scheme = Convert.ToBoolean(Row["Pistol50Scheme"]);
                    var heavypistolscheme = Convert.ToBoolean(Row["HeavyPistolScheme"]);
                    var pumpshotgunscheme = Convert.ToBoolean(Row["PumpShotgunScheme"]);
                    var dbarrelshotgunscheme = Convert.ToBoolean(Row["DoubleBarrelShotgunScheme"]);
                    var sawnoffscheme = Convert.ToBoolean(Row["SawnOffShotgunScheme"]);
                    var minismgscheme = Convert.ToBoolean(Row["MiniSMGScheme"]);
                    var smgmk2scheme = Convert.ToBoolean(Row["SMGMk2Scheme"]);
                    var machinepistolscheme = Convert.ToBoolean(Row["MachinePistolScheme"]);
                    var microsmgscheme = Convert.ToBoolean(Row["MicroSMGScheme"]);
                    var combatpdwscheme = Convert.ToBoolean(Row["CombatPDWScheme"]);
                    var compactriflescheme = Convert.ToBoolean(Row["CompactRifleScheme"]);
                    var assaultriflescheme = Convert.ToBoolean(Row["AssaultRifleScheme"]);
                    var armorscheme = Convert.ToBoolean(Row["ArmorScheme"]);
                    var drugs = Convert.ToInt32(Row["Drugs"]);
                    var mats = Convert.ToInt32(Row["Mats"]);
                    var medkits = Convert.ToInt32(Row["MedKits"]);
                    var money = Convert.ToInt32(Row["Money"]);
                    var isopen = Convert.ToBoolean(Row["IsOpen"]);
                    var status = Convert.ToBoolean(Row["Status"]);
                    var blipid = Convert.ToInt32(Row["BlipID"]);
                    var blipc = Convert.ToByte(Row["BlipColor"]);
                    var blippos = JsonConvert.DeserializeObject<Vector3>(Row["BlipXYZ"].ToString());
                    var ranks = Row["Ranks"].ToString();
                    ...
                    organizationData.Departments =
                        JsonConvert.DeserializeObject<Dictionary<int, DepartmentData>>(Row["departments"].ToString());
                    ...
                    CustomColShape.CreateCylinderColShape(new Vector3(-1396.274, -480.7186, 57.100), 2f, 2f,
                        organizationData.GetDimension(), ColShapeEnums.Organizations, 4);
                    ...
                    {
                        if (stock)
                            organizationData.StockLabel = (ExtTextLabel)NAPI.TextLabel.CreateTextLabel(
                                Main.StringToU16($"~y~Склад {name}"), StockPositions[upgrade], 5F, 0.5F, 0,
                                new Color(255, 255, 255), true, organizationData.GetDimension());
                        else
                            organizationData.StockLabel = (ExtTextLabel)NAPI.TextLabel.CreateTextLabel(
                                Main.StringToU16($"~y~Склад {name}\n~r~Не активен"), StockPositions[upgrade], 5F, 0.5F,
                                0, new Color(255, 255, 255), true, organizationData.GetDimension());

                        if (blipid != -1)
                            organizationData.Blip = (ExtBlip)NAPI.Blip.CreateBlip(organizationData.BlipId,
                                organizationData.BlipPosition, 1, organizationData.BlipColor, name, 255, 0, true, 0, 0);
                    }
                ...
                using var cmdOrgvehicles = new MySqlCommand
                {
                    CommandText = "SELECT * FROM `orgvehicles`"
                };
                using var resultOrgvehicles = MySQL.QueryRead(cmdOrgvehicles);
                ...
                foreach (DataRow Row in resultOrgvehicles.Rows)
                {
                    ...
                    var position = Convert.ToByte(Row["position"]);
                    ...
                    var dirt = (float)Row["dirt"];
                    var petrol = Convert.ToInt32(Row["petrol"]);
                    organizationData.Vehicles.Add(number,
                        new OrganizationVehicleData(model, minrank, position, dirt, petrol, components));
                }
                ...
                foreach (var organizationData in Organizations.Values)
                    if (organizationData.Status)
                        foreach (var organizationVehicle in organizationData.Vehicles)
                            SpawnOrganizationCar(organizationData.Id, organizationVehicle.Key,
                                organizationVehicle.Value);
            }
            catch (Exception e)
            {
        ...
        public static void DeleteVehicle(ExtPlayer player, string number, bool type)
        {
            try
            {
                ...
                if (!organizationData.Vehicles.ContainsKey(number))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Такого транспорта более нет в Вашей семье.", 3000);
                    return;
                }
                ...
                if (!type)
                {
                    ...
                    Trigger.ClientEvent(player, "openDialog", "ORGCAR_SELL_TOGOV",
                        $"Вы действительно хотите продать государству {model} ({number}) за ${Wallet.Format(price)}?");
                }
                else
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                        $"Вы продали {model} ({number}) за {Wallet.Format(price)}$", 3000);
                    ...
                    var vehicle =
                        VehicleData.LocalData.Repository.GetVehicleToNumber(VehicleAccess.Organization, number);
                    if (vehicle != null)
                    {
                    ...
                    {
                        Log.Write(
                            $"Organization {organizationData.Id} error in selling vehicle {model} ({number}) for ${price}",
                            nLog.Type.Error);
                        Admin.ErrorLog(
                            $"[Organizations] {organizationData.Name}: can not find vehicle({number}) (selling for ${price})");
                    }
            ...
            {
                Log.Write($"DeleteVehicle Exception: {e}");
            }
        }
        ...
        public static string CreateVehicle(int orgId, string model, Color color)
        {
            try
            {
                ...
                var veh = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(model), GaragePositions[position],
                    GarageRotations[position], 0, 0, number, dimension: organizationData.GetDimension(), locked: true,
                    acc: VehicleAccess.OrganizationGarage, fr: orgId, minrank: 0, petrol: 100, dirt: 0.0f);
                VehicleManager.OrgApplyCustomization(veh, data);
                return number;
            }
            catch (Exception e)
            {
                Log.Write($"CreateVehicle Exception: {e}");
                return "ERROR";
            }
        }
        ...
        public static void CMD_setfamily(ExtPlayer player, int orgId, int status)
        {
            try
            {
                ...
                if (organizationData == null)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Такой семьи не существует",
                        3000);
                    return;
                }
                ...
                if (status == 1)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            "У этой семьи уже активны нелегальные возможности.", 3000);
                        return;
                    }
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        $"Вы включили нелегальные возможности для семьи #{orgId}.", 3000);
                }
                else if (status == 0)
                {
                    if (!organizationData.CrimeOptions)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            "У этой семьи отключены нелегальные возможности.", 3000);
                        return;
                    }
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                        $"Вы отключили нелегальные возможности для семьи #{orgId}.", 3000);
                }
            ...
            {
                Log.Write($"CMD_setfamily Exception: {e}");
            }
        }
        ...
        public static void CMD_SetOrganizationBlip(ExtPlayer player, int orgId, int sprite, byte color)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Данный Sprite нанести невозможно", 3000);
                    return;
                }

                if (color < 1 || color > 85)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Данный цвет нанести невозможно",
                        3000);
                    return;
                }
                ...
                organizationData.Blip = (ExtBlip)NAPI.Blip.CreateBlip(organizationData.BlipId,
                    organizationData.BlipPosition, 1, organizationData.BlipColor, organizationData.Name, 255, 0, true,
                    0, 0);
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                    $"Метка для семьи {organizationData.Name} установлена.", 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_SetOrganizationBlip Exception: {e}");
            }
        }
        ...
        public static void CMD_DeleteOrganizationBlip(ExtPlayer player, int orgId)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                    $"Метка семьи {organizationData.Name} удалена.", 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CMD_DeleteOrganizationBlip Exception: {e}");
            }
        }
        ...
        public static string GenerateNumber(int orgid)
        {
            ...
            var vehiclesNumbers = Organizations.Values
            ...
            do
            {
                ...
                for (var i = 0; i < 4; i++) number += (char)Rnd.Next(48, 57);
                number += (char)Rnd.Next(65, 90);
        ...
        public static void SetFracRankOffline(ExtPlayer player, int uuid, int rank)
        {
            try
            {
                ...
                if (targetMemberOrganizationData.Rank > rank)
                    Table.Logs.Repository.AddLogs(player, OrganizationLogsType.SetRank,
                        $"Понизил оффлайн {targetMemberOrganizationData.Name} ({memberOrganizationData.UUID}) в должности ({targetMemberOrganizationData.Rank} -> {rank})");
                else
                    Table.Logs.Repository.AddLogs(player, OrganizationLogsType.SetRank,
                        $"Повысил оффлайн {targetMemberOrganizationData.Name} ({memberOrganizationData.UUID}) в должности ({targetMemberOrganizationData.Rank} -> {rank})");

                Player.Repository.SetRank(organizationData.Id, uuid, rank);

                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Вы изменили ранг игрока {targetMemberOrganizationData.Name} на {organizationData.Ranks[rank].Name}",
                    6000);
            }
            catch (Exception e)
            {
        ...
        public static void SetFracRank(ExtPlayer player, ExtPlayer target, int newRank)
        {
            try
            {
                ...
                if (targetMemberOrganizationData.Rank > newRank)
                    Table.Logs.Repository.AddLogs(player, OrganizationLogsType.SetRank,
                        $"Понизил {target.Name} ({targetMemberOrganizationData.UUID}) в должности ({targetMemberOrganizationData.Rank} -> {newRank})");
                else
                    Table.Logs.Repository.AddLogs(player, OrganizationLogsType.SetRank,
                        $"Повысил {target.Name} ({targetMemberOrganizationData.UUID}) в должности ({targetMemberOrganizationData.Rank} -> {newRank})");
                ...
                Notify.Send(target, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Теперь вы {organizationData.Ranks[newRank].Name} в семье", 6000);
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Вы изменили ранг игрока {target.Name} на {organizationData.Ranks[newRank].Name}", 6000);
            }
            catch (Exception e)
            {
        ...
        public static void InviteToOrganization(ExtPlayer sender, ExtPlayer target)
        {
            try
            {
                ...
                {
                    Notify.Send(sender, NotifyType.Error, NotifyPosition.BottomCenter, "Игрок уже состоит в семье",
                        3000);
                    return;
                }
                ...
                if (targetCharacterData.LVL < 1)
                {
                    Notify.Send(sender, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Необходим как минимум 1 уровень для приглашcения игрока в семью", 3000);
                    return;
                }
                ...
                Trigger.ClientEvent(target, "openDialog", "INVITED_ORG",
                    $"{sender.Name} пригласил Вас в семью {organizationData.Name}");
                Notify.Send(sender, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Вы пригласили в семью {target.Name}", 3000);
                //Chars.Repository.PlayerStats(target);
            }
            catch (Exception e)
            {
                Log.Write($"InviteToOrganization Exception: {e}");
            }
        }
        ...
        public static void UnInviteFromOrganization(ExtPlayer sender, ExtPlayer target)
        {
            try
            {
                ...
                Player.Repository.RemoveOrganizationMemberData(memberOrganizationData.Id, target.GetUUID());

                Notify.Send(target, NotifyType.Warning, NotifyPosition.BottomCenter,
                    $"Вас выгнали из семьи {organizationData.Name}", 3000);
                Notify.Send(sender, NotifyType.Success, NotifyPosition.BottomCenter,
                    $"Вы выгнали из семьи {target.Name}", 3000);
                Table.Logs.Repository.AddLogs(sender, OrganizationLogsType.UnInvite,
                    $"Выгнал {target.Name} ({target.GetUUID()})");
            }
            catch (Exception e)
            {
                Log.Write($"UnInviteFromOrganization Exception: {e}");
            }
        }
        ...
        public static bool StockBuy(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Склад уже установлен для Вашей семьи.", 3000);
                    return false;
                }

                if (UpdateData.CanIChange(player, Main.PricesSettings.StockPrice, true) != 255) return false;
                Wallet.Change(player, -Main.PricesSettings.StockPrice);
                ...
                organizationData.StockLabel = (ExtTextLabel)NAPI.TextLabel.CreateTextLabel(
                    Main.StringToU16($"~y~Склад {organizationData.Name}"),
                    StockPositions[organizationData.OfficeUpgrade], 5F, 0.5F, 0, new Color(255, 255, 255), true,
                    organizationData.GetDimension());
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Вы купили склад для семьи!",
                    3000);
                GameLog.Money($"player({player.GetUUID()})", "server", Main.PricesSettings.StockPrice,
                    $"OrgStockBuy({organizationData.Id})");
                return true;
            }
            catch (Exception e)
            {
                Log.Write($"StockBuy Exception: {e}");
            }
        ...
        public static bool UpdateCrimeOptions(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "У Вас не хватает RedBucks для улучшения семьи.", 3000);
                    return false;
                }

                UpdateData.RedBucks(player, -Main.PricesSettings.UpdateTypeOrganization, "Улучшение семьи");
                GameLog.Money($"player({player.GetUUID()})", "server", Main.PricesSettings.UpdateTypeOrganization,
                    $"OrgUpgrade2({organizationData.Id})");
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Вы сменили тип организации!",
                    3000);
                return true;
            }
            catch (Exception e)
        ...
        public static bool SchemeBuy(ExtPlayer player, string scheme, int price = -1)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Эта схема уже куплена в Вашей семье.", 3000);
                    return false;
                }

                if (UpdateData.CanIChange(player, price, true) != 255) return false;
                Wallet.Change(player, -price);
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Вы купили чертёж для семьи!",
                    3000);
                GameLog.Money($"player({player.GetUUID()})", "server", Main.PricesSettings.StockPrice,
                    $"OrgScheme{scheme}Buy({organizationData.Id})");
                return true;
            }
            catch (Exception e)
            {
                Log.Write($"SchemeBuy Exception: {e}");
            }
        ...
        public static async Task SaveOrganizations(ServerBD db)
        {
            try
            {
                foreach (var organizationData in Organizations.Values)
                    ...
                    {
                        Log.Write($"SaveOrganizations Foreach Exception: {e}");
                    }
            ...
            {
                Log.Write($"SaveOrganizations Exception: {e}");
            }
        }
        ...
        public static void NewDay()
        {
            try
            {
                foreach (var orgId in Organizations.Keys.ToList())
                    ...
                    {
                        Log.Write($"NewDay Foreach Exception: {e}");
                    }
            }
            catch (Exception e)
            {
                Log.Write($"NewDay Exception: {e}");
            }
        }
        ...
        private static async Task SaveOrgsVehicles(ServerBD db, int orgId)
        {
            ...
            {
                Log.Write($"SaveOrgsVehicles Exception: {e}");
            }
        }
        ...
        public static bool UpgradeOrganization(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Вы не должны находиться в транспорте во время покупки улучшения.", 3000);
                    return false;
                }

                if (upgraded == 0)
                {
                    if (!Wallet.Change(player, -Main.PricesSettings.FirstOrgPrice))
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            "У Вас не хватает денег для улучшения семьи.", 3000);
                        return false;
                    }

                    GameLog.Money($"player({player.GetUUID()})", "server", Main.PricesSettings.FirstOrgPrice,
                        $"OrgUpgrade({organizationData.Id})");
                }
                else if (upgraded == 1)
                {
                    ...
                    UpdateData.RedBucks(player, -Main.PricesSettings.SecondOrgPrice, "Улучшение семьи");
                    GameLog.Money($"player({player.GetUUID()})", "server", Main.PricesSettings.SecondOrgPrice,
                        $"OrgUpgrade2({organizationData.Id})");
                }
            ...
            {
                Log.Write($"UpgradeOrganization Exception: {e}");
            }
        ...
        public static void CreateOrganization(ExtPlayer player, bool isCrime, string orgName)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.Block10Min), 4500);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Недоступно для администрации.",
                        3000);
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "Для создания семьи Вы не должны иметь предупреждений (Warns).", 3000);
                    Trigger.ClientEvent(player, "client.org.create.close");
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MaxRankNameLenght), 4500);
                    return;
                }

                var testmsg = orgName.ToLower();
                if (Main.ServerNumber != 0 && (testmsg.Equals("admins") || testmsg.Equals("admin") ||
                                               testmsg.Equals("administrator") ||
                                               testmsg.Equals("administrators"))) return;
                if (Main.stringGlobalBlock.Any(c => testmsg.Contains(c)))
                {
                    ...
                    Trigger.SendToAdmins(3,
                        "!{#636363}[A] " + LangFunc.GetText(LangType.Ru, DataName.AdminAlertFTableNews, player.Name,
                            player.Value, orgName));
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        $"К сожалению, семья с названием {orgName} уже существует.", 3000);
                    return;
                }

                if (!Wallet.Change(player, -Main.PricesSettings.CreateOrgPrice))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        "У Вас не хватает денег для создания семьи.", 3000);
                    Trigger.ClientEvent(player, "client.org.create.close");
                    return;
                }
                        ...
                        Trigger.SetMainTask(() =>
                        {
                            try
                            {
                                ...
                                CustomColShape.CreateCylinderColShape(new Vector3(-1396.274, -480.7186, 57.100), 2f, 2f,
                                    organizationData.GetDimension(), ColShapeEnums.Organizations, 4);
                                organizationData.StockLabel = (ExtTextLabel)NAPI.TextLabel.CreateTextLabel(
                                    Main.StringToU16($"~y~Склад {orgName}\n~r~Не активен"), StockPositions[0], 5F, 0.5F,
                                    0, new Color(255, 255, 255), true, organizationData.GetDimension());
                                ...
                                SendPlayer(player);
                                NAPI.Chat.SendChatMessageToAll("!{#50C878}" +
                                                               $"В штате была зарегистрирована новая семья - {orgName}!");

                                EventSys.SendCoolMsg(player, "Семья", "Создание семьи",
                                    $"Поздравляем Вас с регистрацией собственной семьи - {orgName}!", "", 10000);
                                ...
                                GameLog.Money($"player({characterData.UUID})", "server",
                                    Main.PricesSettings.CreateOrgPrice, $"CreateOrg({id})");
                            }
                            catch (Exception e)
                            {
                                Debugs.Repository.Exception(e);
            ...
            {
                Log.Write($"CreateOrganization Exception: {e}");
            }
        }

        public static void UpdateForMembers(int orgId, OrganizationOfficeTypeUpdate type, int count, bool unload = true,
            bool load = true)
        {
            try
            {
            ...
            {
                Log.Write($"UpdateForMembers Exception: {e}");
            }
        }
        ...
        public static void OpenOrgStock(ExtPlayer player)
        {
            ...
            {
                Log.Write($"OpenOrgStock Exception: {e}");
            }
        }
        ...
        public static void CraftBodyArmor(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, "Недоступно для вашей семьи.",
                        5000);
                    return;
                }
                ...
                if (Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.BodyArmor, 1,
                        "100") == -1)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                    "Вы скрафтили бронежилет с 100% прочностью.", 3000);
            }
            catch (Exception e)
            {
                Log.Write($"CraftBodyArmor Exception: {e}");
            }
        }
        ...
        public static void OpenStock(ExtPlayer player)
        {
            ...
            {
                Log.Write($"OpenStock Exception: {e}");
            }
        }
        ...
        public static void OpenWeaponStock(ExtPlayer player)
        {
            try
            {
                ...
                Chars.Repository.LoadOtherItemsData(player, "Organization", organizationData.Id.ToString(), 6,
                    Chars.Repository.InventoryMaxSlots["Organization"]);
            }
            catch (Exception e)
            {
                Log.Write($"OpenWeaponStock Exception: {e}");
            }
        }
        ...
        public static void inputStocks(ExtPlayer player, string action, int amount)
        {
                ...
                switch (action)
                {
                    case "put_stock":
                        ...
                        if (item == "mats")
                        {
                            ...
                            playerHave = Chars.Repository.getCountToLacationItem($"char_{characterData.UUID}",
                        ...
                        if (item == "mats")
                        {
                            ...
                            Chars.Repository.Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.Material,
                                amount);
                            Table.Logs.Repository.AddLogs(player, OrganizationLogsType.TakeMats,
                                $"Положил на склад материалы (x{amount})");
                        }
                        else if (item == "drugs")
                        {
                            ...
                            Chars.Repository.Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.Drugs,
                                amount);
                            Table.Logs.Repository.AddLogs(player, OrganizationLogsType.TakeDrugs,
                                $"Положил на склад наркотики (x{amount})");
                        }
                        else if (item == "money")
                        {
                            ...
                            GameLog.Money($"player({characterData.UUID})", $"org({organizationData.Id})", amount,
                                "putStock");
                            Table.Logs.Repository.AddLogs(player, OrganizationLogsType.TakeMoney,
                                $"Положил на склад деньги (${Wallet.Format(amount)})");
                        }
                        else if (item == "medkits")
                        {
                            ...
                            Chars.Repository.Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.HealthKit,
                                amount);
                            Table.Logs.Repository.AddLogs(player, OrganizationLogsType.TakeMedkits,
                                $"Положил на склад аптечки (x{amount})");
                        }

                        //GameLog.Stock(cdata.FractionID, cdata.UUID, player.Name, item, amount, "in");
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter,
                            $"На складе осталось {stockContains + amount}, у Вас {playerHave - amount}", 3000);
                        break;
                    case "take_stock":
                        ...
                        if (item == "mats")
                        {
                            stockContains = organizationData.Materials;
                            playerHave =
                                Chars.Repository.getCountItem($"char_{characterData.UUID}", ItemId.Material, false);
                        ...
                        else if (item == "drugs")
                        {
                            stockContains = organizationData.Drugs;
                            playerHave =
                                Chars.Repository.getCountItem($"char_{characterData.UUID}", ItemId.Drugs, false);
                        ...
                        {
                            stockContains = organizationData.MedKits;
                            playerHave = Chars.Repository.getCountItem($"char_{characterData.UUID}", ItemId.HealthKit,
                                false);
                        }
                        ...
                        if (item == "mats")
                        {
                            ...
                            Table.Logs.Repository.AddLogs(player, OrganizationLogsType.TakeMats,
                                $"Взял со склада материалы (x{amount})");
                        }
                        else if (item == "drugs")
                        {
                            ...
                            Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Drugs,
                                amount);
                            Table.Logs.Repository.AddLogs(player, OrganizationLogsType.TakeDrugs,
                                $"Взял со склада наркотики (x{amount})");
                        }
                        else if (item == "money")
                        {
                            var lastMulti = organizationData.MoneyMultiplier();
                            ...
                            Wallet.Change(player, amount);
                            GameLog.Money($"org({organizationData.Id})", $"player({characterData.UUID})", amount,
                                "takeStock");
                            Table.Logs.Repository.AddLogs(player, OrganizationLogsType.TakeMoney,
                                $"Взял со склада деньги (${Wallet.Format(amount)})");
                        }
                        else if (item == "medkits")
                        {
                            ...
                            Table.Logs.Repository.AddLogs(player, OrganizationLogsType.TakeMedkits,
                                $"Взял со склада аптечки (x{amount})");
                        }
            ...
            {
                Log.Write($"inputStocks Exception: {e}");
            }
        }
                    ...
                    case 1:
                        ...
                        if (!organizationData.Schemes["Armor"])
                        {
                            Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter,
                                "Недоступно для вашей семьи.", 5000);
                            return;
                        }

                        Trigger.ClientEvent(player, "openDialog", "CONFIRM_BUY_ORGBODYARMOUR",
                            "Вы действительно хотите скрафтить 100% бронежилет, стомостью 400 материалов?");
                        return;
                    case 2:
                        OpenStock(player);
                        return;
        ...
        private static void callback_organizations(ExtPlayer player, object listItem) /// Никитос Чини
        {
            try
            {
                ...
                switch (listItem)
                {
                    case "createorg":
                        ...
                        frameList.List.Add(
                            new ListData(LangFunc.GetText(LangType.Ru, DataName.OfficePreview), "ofprev"));

                        //frameList.List.Add(new ListData(LangFunc.GetText(LangType.Ru, DataName.OfficeUpg), "ofprevinfo"));

                        frameList.List.Add(new ListData(LangFunc.GetText(LangType.Ru, DataName.GaragePreview),
                            "garprev"));
                        ...
                        frameList.List.Add(new ListData(
                            LangFunc.GetText(LangType.Ru, DataName.CreatePrice, Main.PricesSettings.CreateOrgPrice),
                            "createorg"));
            ...
            {
                Log.Write($"callback_organizations Exception: {e}");
            }
        }
            ...
            try
            {
                ...
                switch (listItem)
                {
                    ...
                    case "createorg":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                "Вы уже находитесь в семье.", 5000);
                            return;
                        }

                        Trigger.ClientEvent(player, "openDialog", "CreateOrg",
                            $"Вы уверены, что хотите создать свою семью? Названием семьи служит Ваша фамилия, при создании за сумму {Main.PricesSettings.CreateOrgPrice}$ Вы получаете гараж на 5 т.с и офис начального уровня, а так же семейный чат (/fc /fcb).");
                        break;
                }
            }
            catch (Exception e)
            {
                Log.Write($"callback_organizations1 Exception: {e}");
            }
        }
        ...
        public static void SendPlayerToGarage(ExtPlayer player)
        {
            ...
            {
                Log.Write($"SendPlayerToGarage Exception: {e}");
            }
        }
        ...
        public static void RemovePlayerFromGarage(ExtPlayer player)
        {
            ...
            {
                Log.Write($"RemovePlayerFromGarage Exception: {e}");
            }
        }
        ...
        public static void SendPlayer(ExtPlayer player, bool force = false)
        {
            try
            {
                ...
                Trigger.Dimension(player, organizationData.GetDimension());
                characterData.InsideOrganizationID = organizationData.Id;
                Trigger.ClientEvent(player, "OfficeAllPropLoad",
                    OrganizationTypeList[organizationData.OfficeUpgrade].Item3, organizationData.MoneyMultiplier(),
                    organizationData.DrugsMultiplier(), organizationData.MedKitsMultiplier(),
                    organizationData.MaterialsMultiplier());
            }
            catch (Exception e)
            {
        ...
        public static void organizationChat(ExtPlayer player, string message)
        {
            try
            {
                ...
                var status = organizationData.Ranks.ContainsKey(memberOrganizationData.Rank)
                    ? $"{organizationData.Ranks[memberOrganizationData.Rank].Name} "
                    : "Нет ";
                var msgSender = "!{#50C878}" +
                                $"[FC]{GetDepartmentTag(organizationData.Id, memberOrganizationData.DepartmentId)} " +
                                status + player.Name.Replace('_', ' ') + " (" + player.Value + "): " +
            ...
            {
                Log.Write($"organizationChat Exception: {e}");
            }
        }
        ...
        public static void organizationChatOOC(ExtPlayer player, string message)
        {
            ...
            {
                Log.Write($"organizationChatOOC Exception: {e}");
            }
        }
        ...
        public static void SetVehicleIntoGarage(ExtPlayer player)
        {
            try
            {
                ...
                var veh = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(organizationVehicles.model),
                    GaragePositions[organizationVehicles.garageId], GarageRotations[organizationVehicles.garageId], 0,
                    0, vehicleLocalData.NumberPlate, dimension: organizationData.GetDimension(), locked: true,
                    acc: VehicleAccess.OrganizationGarage, fr: organizationData.Id, minrank: organizationVehicles.rank,
                    petrol: petrol, dirt: dirt);
                VehicleManager.OrgApplyCustomization(veh, organizationVehicles.customization);
            }
            catch (Exception e)
            {
                Log.Write($"SetVehicleIntoGarage Exception: {e}");
            }
        }
        ...
        public static void GetVehicleFromGarage(ExtPlayer player, ExtVehicle vehicle, int orgId)
        {
            ...
            {
                Log.Write($"GetVehicleFromGarage Exception: {e}");
            }
        }

        public static void SpawnOrganizationCar(int orgId, string number, OrganizationVehicleData vehicleOrgData,
            Vector3 pos = null, float rot = 0f)
        {
            try
            {
                var organizationData = GetOrganizationData(orgId);
                ...
                var veh = VehicleStreaming.CreateVehicle(NAPI.Util.GetHashKey(vehicleOrgData.model),
                    pos != null ? pos : GaragePositions[vehicleOrgData.garageId],
                    pos != null ? rot : GarageRotations[vehicleOrgData.garageId], 0, 0, number,
                    dimension: pos != null ? 0 : organizationData.GetDimension(), locked: true,
                    acc: VehicleAccess.OrganizationGarage, fr: orgId, minrank: vehicleOrgData.rank,
                    petrol: vehicleOrgData.petrol, dirt: vehicleOrgData.dirt);
                VehicleManager.OrgApplyCustomization(veh, organizationVehicle.customization);
            }
            catch (Exception e)
            {
                Log.Write($"SpawnOrganizationCars Foreach Exception: {e}");
            }
        }
    }
}