    ...
    public class Repository
    {
        ...
        public static void Init()
        {
            ...
            for (byte i = 0; i != BusinessManager.BusinessTypeNames.Length; i++)
            {
                ...
                if (posList.Count > 0)
                    recentCategory.Items.Add(
                        new GpsItem($"Ближайший '{BusinessManager.BusinessTypeNames[i]}'", posList));
            }
            ...
            foreach (var item in Bus.BusStations.Values)
                posList.Add(new List<object>
                {
                    item.X,
                    item.Y
            ...
            */
            ...
            bizCategory.Items.Add(new GpsItem("Exotic DonateRoom", DonateAutoRoom.NpcBuyPosition.X,
                DonateAutoRoom.NpcBuyPosition.Y));
            bizCategory.Items.Add(new GpsItem("Elite AutoRoom", EliteAutoRoom.NpcBuyPosition.X,
                EliteAutoRoom.NpcBuyPosition.Y));
            bizCategory.Items.Add(new GpsItem("AirRoom", AirAutoRoom.NpcBuyPosition.X, AirAutoRoom.NpcBuyPosition.Y));
            ...
            gosCategory.Items.Add(new GpsItem("City Hall", Cityhall.GpsPosition.X, Cityhall.GpsPosition.Y));
            gosCategory.Items.Add(new GpsItem("National Guard", -294.8565f, -2605.4185f));
            gosCategory.Items.Add(new GpsItem("LSPD", Police.GunsPosition.X, Police.GunsPosition.Y));
            gosCategory.Items.Add(new GpsItem("EMS", Ems.emsCheckpoints[0].X, Ems.emsCheckpoints[0].Y));
            gosCategory.Items.Add(new GpsItem("FIB", Fbi.GpsPosition.X, Fbi.GpsPosition.Y));
            gosCategory.Items.Add(new GpsItem("NEWS", LsNewsSystem.LSNewsCoords[0].X, LsNewsSystem.LSNewsCoords[0].Y));
            gosCategory.Items.Add(new GpsItem("SHERIFF 1", Sheriff.FirstPosition.X, Sheriff.FirstPosition.Y));
            gosCategory.Items.Add(new GpsItem("SHERIFF 2", Sheriff.SecondPosition.X, Sheriff.SecondPosition.Y));
            ...
            weaponsCategory.Items.Add(new GpsItem("The Families", Manager.FractionSpawns[1].X,
                Manager.FractionSpawns[1].Y));
            weaponsCategory.Items.Add(new GpsItem("The Ballas Gang", Manager.FractionSpawns[2].X,
                Manager.FractionSpawns[2].Y));
            weaponsCategory.Items.Add(new GpsItem("Los Santos Vagos", Manager.FractionSpawns[3].X,
                Manager.FractionSpawns[3].Y));
            weaponsCategory.Items.Add(new GpsItem("Marabunta Grande", Manager.FractionSpawns[4].X,
                Manager.FractionSpawns[4].Y));
            weaponsCategory.Items.Add(new GpsItem("Blood Street", Manager.FractionSpawns[5].X,
                Manager.FractionSpawns[5].Y));
            ...
            mafiaCategory.Items.Add(new GpsItem("La Cosa Nostra", Manager.FractionSpawns[10].X,
                Manager.FractionSpawns[10].Y));
            mafiaCategory.Items.Add(new GpsItem("Russian Mafia", Manager.FractionSpawns[11].X,
                Manager.FractionSpawns[11].Y));
            mafiaCategory.Items.Add(new GpsItem("Yakuza", Manager.FractionSpawns[12].X, Manager.FractionSpawns[12].Y));
            mafiaCategory.Items.Add(new GpsItem("Armenian Mafia", Manager.FractionSpawns[13].X,
                Manager.FractionSpawns[13].Y));
            ...
            {
                new GpsItem("Центр занятости", -116.56201f, -604.71436f),
                new GpsItem("Электростанция", 724.9625f, 133.9959f),
            ...
            clubsCategory.Items.Add(new GpsItem("Главный рынок", TentList.PositionGps[0].X, TentList.PositionGps[0].Y));
            clubsCategory.Items.Add(new GpsItem("Черный рынок", TentList.PositionGps[1].X, TentList.PositionGps[1].Y));
            ...
            clubsCategory.Items.Add(new GpsItem("Мебельный магазин", FurnitureManager.FurnitureBuyPos.X,
                FurnitureManager.FurnitureBuyPos.Y));
            clubsCategory.Items.Add(new GpsItem("Почта", 132.9969f, 96.3529f));
            clubsCategory.Items.Add(new GpsItem("Штрафстоянка", Ticket.PedPos.X, Ticket.PedPos.Y));
        ...
        public static void OnPointDefault(ExtPlayer player, string name)
        {
            ...
            if (name == "frac" && memberFractionData != null) position = Manager.FractionSpawns[memberFractionData.Id];
