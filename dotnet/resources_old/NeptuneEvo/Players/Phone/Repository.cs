    ...
    public class Repository
    {
        ...
        public static void Init(ExtPlayer player, PhoneData phoneData)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "client.phone.initBalckList",
                    JsonConvert.SerializeObject(phoneData.BlackList));
                ...
                Trigger.ClientEvent(player, "client.phone.settings.init",
                    JsonConvert.SerializeObject(phoneData.Settings));
            ...
            {
                Console.WriteLine($"StartWork Exception: {e}");
            }
        }
    }
}