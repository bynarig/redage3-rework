...
namespace NeptuneEvo.Houses
{
    public class HouseFurniture
    {
        ...
        [JsonIgnore] public Object obj { get; private set; }

        public Object Create(uint Dimension)
        {
            try
            {
            ...
            {
                FurnitureManager.Log.Write($"Create Exception: {e}");
                return null;
            }
        }
    }
    ...
    internal class FurnitureManager : Script
    {
        public static readonly nLog Log = new nLog("Houses.HouseFurniture");

        public static Dictionary<int, Dictionary<int, HouseFurniture>> HouseFurnitures =
            new Dictionary<int, Dictionary<int, HouseFurniture>>();
        ...
        {
            {
                "Оружейный сейф", new ShopFurnitureBuy("prop_ld_int_safe_01", "Хранилища", 0,
            ...
            {
                "Шкаф с одеждой", new ShopFurnitureBuy("bkr_prop_biker_garage_locker_01", "Хранилища", 1,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.WoodOak, 44 },
                        { ItemId.WoodMaple, 20 },
            ...
            {
                "Шкаф с предметами", new ShopFurnitureBuy("hei_heist_bed_chestdrawer_04", "Хранилища", 2,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.WoodOak, 44 },
                        { ItemId.WoodMaple, 20 },
            ...
            {
                "Взломостойкий сейф", new ShopFurnitureBuy("p_secret_weapon_02", "Хранилища", 3,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Iron, 1000 },
                        { ItemId.Gold, 200 },
            ...
            {
                "Пинг-понг", new ShopFurnitureBuy("ch_prop_vault_painting_01a", "Картины", 5,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.WoodOak, 80 }
                    })
            ...
            {
                "Стримснайперы", new ShopFurnitureBuy("ch_prop_vault_painting_01b", "Картины", 6,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.WoodMaple, 40 }
                    })
            ...
            {
                "Переговоры", new ShopFurnitureBuy("ch_prop_vault_painting_01h", "Картины", 8,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.WoodOak, 80 }
                    })
            ...
            {
                "Монахиня", new ShopFurnitureBuy("vw_prop_casino_art_statue_04a", "Статуи", 12,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Gold, 1000 }
                    })
            ...
            {
                "Monkey King", new ShopFurnitureBuy("vw_prop_vw_pogo_gold_01a", "Фигурки", 15,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Iron, 100 }
                    })
            ...
            {
                "Кубок FIFA", new ShopFurnitureBuy("sum_prop_ac_wifaaward_01a", "Фигурки", 17,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Emerald, 13 }
                    })
            ...
            {
                "Шампанское", new ShopFurnitureBuy("xs_prop_trophy_champ_01a", "Фигурки", 18,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Iron, 100 }
                    })
            ...
            {
                "Маленькое дерево", new ShopFurnitureBuy("prop_plant_int_01a", "Растения", 20,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.WoodPine, 20 }
                    })
            ...
            {
                "Денежное дерево", new ShopFurnitureBuy("prop_plant_int_04b", "Растения", 23,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.WoodMaple, 40 }
                    })
            ...
            {
                "Кактус", new ShopFurnitureBuy("vw_prop_casino_art_plant_12a", "Растения", 24,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.WoodMaple, 27 }
                    })
            ...
            {
                "Бриллиантовая ёлка", new ShopFurnitureBuy("ch_prop_ch_diamond_xmastree", "Ёлки", 26,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Ruby, 150 }
                    })
            ...
            {
                "Счётная машинка", new ShopFurnitureBuy("bkr_prop_money_counter", "Драгоценности", 27,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Iron, 200 }
                    })
            ...
            {
                "Горка денег", new ShopFurnitureBuy("bkr_prop_moneypack_03a", "Драгоценности", 28,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Gold, 1000 }
                    })
            ...
            {
                "Гора денег", new ShopFurnitureBuy("ba_prop_battle_moneypack_02a", "Драгоценности", 29,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Gold, 3000 }
                    })
            ...
            {
                "Ящик денег", new ShopFurnitureBuy("ex_prop_crate_money_bc", "Драгоценности", 30,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Gold, 5000 }
                    })
            ...
            {
                "Ящик с золотом", new ShopFurnitureBuy("prop_ld_gold_chest", "Драгоценности", 31,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Gold, 300 }
                    })
            ...
            {
                "Тележка с золотом", new ShopFurnitureBuy("p_large_gold_s", "Драгоценности", 32,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Gold, 10000 }
                    })
            ...
            {
                "Кейс с деньгами", new ShopFurnitureBuy("prop_cash_case_02", "Драгоценности", 33,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.Gold, 1700 }
                    })
            ...
            {
                "Романтический набор", new ShopFurnitureBuy("ba_prop_club_champset", "Алкоголь", 35,
                    new Dictionary<ItemId, int>
                    {
                        { ItemId.WoodOak, 110 }
                    })
        ...
        public static void Init()
        {
            try
            {
                ...
                foreach (DataRow Row in result.Rows)
                    ...
                    {
                        Log.Write($"FurnitureManager Foreach Exception: {e}");
                    }
                ...
                Repository.CreateQuest("s_m_y_airworker", FurnitureBuyPos, -64.57715f, questName: QuestName,
                    title: "~y~NPC~w~ Иван\nПродавец мебели", colShapeEnums: ColShapeEnums.FurnitureBuy);
            }
            catch (Exception e)
            {
                Log.Write($"FurnitureManager Exception: {e}");
            }
        }
            ...
            try
            {
                if (!HouseFurnitures.ContainsKey(id))
                {
                    ...
                    cmd.Parameters.AddWithValue("@val1",
                        JsonConvert.SerializeObject(new Dictionary<int, HouseFurniture>()));
        ...
        public static void NewFurniture(int id, string name)
        {
            ...
            {
                Log.Write($"newFurniture Exception: {e}");
            }
        }
        ...
        public void ClientEvent_acceptEdit(ExtPlayer player, float X, float Y, float Z, float XX, float YY, float ZZ)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MebelDomTooFar), 5000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                        LangFunc.GetText(LangType.Ru, DataName.MebelError), 5000);
                    return;
                }

                var furnitures = HouseFurnitures[house.ID];
                foreach (var p in furnitures.Values)
                    if (p != null && p.IsSet && p.Position != null && p.Position.DistanceTo(pos) <= 0.5f)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                            LangFunc.GetText(LangType.Ru, DataName.MebelTooNear), 3000);
                        return;
                    }

                var id = sessionData.HouseData.EditID;
                furnitures[id].IsSet = true;
                var rot = new Vector3(XX, YY, ZZ);
            ...
            {
                Log.Write($"ClientEvent_acceptEdit Exception: {e}");
            }
        }
        ...
        public void ClientEvent_cancelEdit(ExtPlayer player)
        {
            ...
            {
                Log.Write($"ClientEvent_cancelEdit Exception: {e}");
            }
        }
    }
}