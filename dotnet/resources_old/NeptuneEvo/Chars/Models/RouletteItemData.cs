namespace NeptuneEvo.Chars.Models
{
    ...
    public class RouletteItemData
    {
        ...
        ///     <see cref="Count" />
        /// </param>
        public RouletteItemData(string Name, string Desc, string Image, int ValueMin, int ValueMax, int ReturnRB,
            int Percent, RouletteColor Color = RouletteColor.Blue, bool IsChatMessage = false,
            bool IsHudMessage = false, ItemId ItemId = ItemId.Debug, string ItemData = "")
        {
            this.Name = Name;
            this.Desc = Desc;
            this.Image = Image;
