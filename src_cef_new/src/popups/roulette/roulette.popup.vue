...
const closeCase = () => (window as any).router?.setPopUp?.('')
...
<template>
  <div v-if="isLoad" id="popuponate__roulette">
    <div v-if="isPopup" id="newdonate__popup" class="active">
      <PoputWin :set-popup="(setPopup as any)" :popup-data="(dataPopup as any)" />
    </div>
    ...
    <div class="newdonate__roulette-container">
        ...
        <div v-if="currentCount > indexCase" class="newdonate__roulette-main">
          ...
          >
            <div
              ...
              :tooltip="item.title"
            >
              <div class="roulette-element__img" :style="`background-image: url(${cloud + 'img/roulette/' + item.image + '.png'})`" />
            </div>
          </div>
        </div>
      </template>
      <div class="newdonate__roulette-buttons">
        ...
        <div class="newdonate__button_small" @click="closeCase()">
      ...
      <div class="newdonate__roulette-items">
        <div
          ...
          :tooltip="value.title"
        >
          <div class="roulette-element__img" :style="`background-image: url(${cloud + 'img/roulette/' + value.image + '.png'})`" />
        </div>
      </div>
    </div>
  </div>
