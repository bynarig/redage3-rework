    ...
    <div class="donatepopup__payments">
      <div class="box-between">
        <div class="box-column">
          ...
          <div class="donatepopup__button"><span class="gray">{{ !selectType ? 'В эквиваленте' : 'К оплате' }}: </span>{{ getPrice(data.data[selectType], selectType) }} {{ translateText('popups', 'руб') }}.</div>
        </div>
      ...
      <div class="donatepopup__grid">
        ...
        <div class="donatepopup__element" :class="{ active: selectType === 1 }" @click="selectType = 1">
          <div class="donatepopup__element_label">{{ translateText('popups', 'Скидка') }} {{ 100 - Math.round(data.data[1] / getPrice(data.data[0], 0) * 100) }}%</div>
